...
| **activity_code_ids** | list[str] | Deprecated. The set of activity code IDs associated with this time off plan. | [optional] |
| **time_off_limits** | [list[TimeOffLimitReference]](TimeOffLimitReference) | Deprecated. The set of time off limit IDs associated with this time off plan. | [optional] |
| **auto_approval_rule** | str | Deprecated. Auto approval rule for this time off plan | [optional] |
