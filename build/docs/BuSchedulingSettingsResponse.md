...
| **allow_work_plan_per_minute_granularity** | **bool** | Indicates whether or not per minute granularity for scheduling will be enabled for this business unit | [optional] |
