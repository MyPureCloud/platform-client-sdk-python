...
| **existing_shifts** | [**list[AlternativeShiftAgentScheduledShift]**](AlternativeShiftAgentScheduledShift.html) | The existing shifts from the offer, may be empty | |
| **offered_shifts** | [**list[AlternativeShiftAgentScheduledShift]**](AlternativeShiftAgentScheduledShift.html) | The offered shifts from the offer, may be empty | |
...
| **management_unit** | [**ManagementUnitReference**](ManagementUnitReference.html) | The management unit of this alternative shift trade request | |
...
| **admin_reviewed_by** | [**UserReference**](UserReference.html) | The admin who reviewed this alternative shift trade after system denial | [optional] |
