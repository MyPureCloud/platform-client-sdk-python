...
| **query_type** | str | Query type to use. Use groupBy for all matching results, and topN/bottomN for N results ordered by the sortMetric. Default is groupBy. | [optional] |
| **sort_metric** | [AgentCopilotAggregationSort](AgentCopilotAggregationSort) | Required when requesting multiple metrics. Only applicable for topN/bottomN query type. | [optional] |
