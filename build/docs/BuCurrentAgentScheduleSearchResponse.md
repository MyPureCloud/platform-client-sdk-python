...
|------------ | ------------- | ------------- | -------------|
| **agent_schedules** | [**list[BuAgentScheduleSearchResponse]**](BuAgentScheduleSearchResponse.html) | The requested agent schedules | [optional] |
| **business_unit_time_zone** | **str** | The time zone configured for the business unit to which this schedule applies | [optional] |
| **published_schedules** | [**list[BuAgentSchedulePublishedScheduleReference]**](BuAgentSchedulePublishedScheduleReference.html) | References to all published week schedules overlapping the start/end date query parameters | [optional] |
