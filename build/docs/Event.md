...
| **customer_id** | **str** | Primary identifier of the customer in the source of the events. | |
| **customer_id_type** | **str** | Type of primary identifier (e.g. cookie, email, phone, salesforce). | |
