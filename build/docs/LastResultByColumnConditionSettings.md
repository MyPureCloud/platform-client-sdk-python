...
| **whats_app_column_name** | str | The name of the contact column to evaluate for WhatsApp. | [optional] |
| **whats_app_wrapup_codes** | list[str] | A list of wrapup code identifiers to match for WhatsApp. | [optional] |
