...
| **created_by** | [User](User) | User that created the library. | [optional] |
...
| **response_type** | str | This value is deprecated. Responses representing message templates may be added to any library. | [optional] |
