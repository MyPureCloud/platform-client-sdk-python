...
| **include_policy_based_recordings** | bool | Whether to include policy-based recordings for the action, default value &#x3D; true | [optional] |
| **include_snippet_recordings** | bool | Whether to include snippet recordings for the action, default value &#x3D; true | [optional] |
...
| **conversation_query** | [AsyncConversationQuery](AsyncConversationQuery) | Conversation Query. Note: After the recording is created, it might take up to 48 hours for the recording to be included in the submitted job query.  This result depends on the analytics data lake job completion. See also: https://developer.genesys.cloud/analyticsdatamanagement/analytics/jobs/conversation-details-job#data-availability. | [optional] |
