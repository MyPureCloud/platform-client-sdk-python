...
| **edge_group** | [DomainEntityRef](DomainEntityRef) | The identifier of the edge group that will place the calls. Can be set to specify custom edge group instead of default one. | [optional] |
