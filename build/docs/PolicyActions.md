...
| **media_transcriptions** | [list[MediaTranscription]](MediaTranscription) | Deprecated. The Voci and Call Journey transcription integrations are no longer supported. | [optional] |
