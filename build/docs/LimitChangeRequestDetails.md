...
| **created_by** | **str** | The user who created the change request | [optional] |
...
| **status_history** | [**list[StatusChange]**](StatusChange.html) | List of statuses that a limit change request has gone through | [optional] |
...
| **last_changed_by** | **str** | The user who last updated the status of the limit change request | [optional] |
