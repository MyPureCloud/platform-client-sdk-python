...
| **offered_per_interval** | **list[float]** | Forecast offered counts per interval for this week of the forecast | |
| **average_handle_time_seconds_per_interval** | **list[float]** | Forecast average handle time per interval in seconds | |
