...
try:
    ...
    print("Exception when calling AIStudioApi->delete_agentic_virtualagent_jobs: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling AIStudioApi->get_agentic_virtualagent: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling AIStudioApi->get_agentic_virtualagent_job: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling AIStudioApi->get_agentic_virtualagents: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling AIStudioApi->patch_agentic_virtualagent: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling AIStudioApi->post_agentic_virtualagent_version_jobs: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling AIStudioApi->post_agentic_virtualagents: %s\n" % e)
```
