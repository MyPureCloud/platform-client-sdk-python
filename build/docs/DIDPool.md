...
| **start_phone_number** | str | The starting phone number for the range of this DID pool. Must be in E.164 format | |
| **end_phone_number** | str | The ending phone number for the range of this DID pool. Must be in E.164 format | |
| **comments** | str |  | [optional] |
| **provider** | str | The provider for this DID pool | [optional] |
