...
| **trigger_with_outcome_probability_conditions** | [**list[OutcomeProbabilityCondition]**](OutcomeProbabilityCondition.html) | (deprecated - use triggerWithOutcomeQuantileConditions instead) Probability conditions for outcomes that must be satisfied to trigger the action map. | [optional] |
...
| **action_map_schedule_groups** | [**PatchActionMapScheduleGroups**](PatchActionMapScheduleGroups.html) | The action map&#39;s associated schedule groups. | [optional] |
