...
| **internal_message_id** | str | The internal message communication ID. | [optional] |
| **target_user** | [AddressableEntityRef](AddressableEntityRef) | The user participant on receiving side of the internal message conversation. | [optional] |
| **source_user** | [AddressableEntityRef](AddressableEntityRef) | The user participant on sending side of the internal message conversation. | [optional] |
