...
| **oauth_client_names** | **list[str]** | Behaves like a SQL WHERE with multiple AND operators. Specifies a list of OAuth client names to be queried. | [optional] |
| **http_methods** | **list[str]** | Behaves like a SQL WHERE with multiple AND operators. Specifies a list of HTTP methods to be queried. | [optional] |
| **template_uris** | **list[str]** | Behaves like a SQL WHERE with multiple AND operators. Specifies a list of Template Uris to be queried. | [optional] |
