...
| **modified_by** | [**UserReference**](UserReference.html) | User that last changed the setting. | [optional] |
| **modified_by_client** | [**DomainEntityRef**](DomainEntityRef.html) | OAuth client that last changed the setting. | [optional] |
