...
| **total_event_count** | **int** | The total count of events performed by the customer across all sessions. | [optional] |
| **total_pageview_count** | **int** | The total count of pageviews performed by the customer across all sessions. | [optional] |
...
| **traits** | [**dict(str, CustomEventAttribute)**](CustomEventAttribute.html) | User-defined traits associated with a particular event. | [optional] |
