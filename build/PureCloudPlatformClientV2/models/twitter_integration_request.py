...
class TwitterIntegrationRequest(object):
    ...
    def signup_code(self) -> str:
        """
        Gets the signup_code of this TwitterIntegrationRequest.
        The authorization code returned from the signup flow to request access tokens later on

        :return: The signup_code of this TwitterIntegrationRequest.
        :rtype: str
        """
    ...
    def signup_code(self, signup_code: str) -> None:
        """
        Sets the signup_code of this TwitterIntegrationRequest.
        The authorization code returned from the signup flow to request access tokens later on

        :param signup_code: The signup_code of this TwitterIntegrationRequest.
        :type: str
        """
    ...
    def app_id(self) -> str:
        """
        Gets the app_id of this TwitterIntegrationRequest.
        The appId of the Twitter app to register the integration on

        :return: The app_id of this TwitterIntegrationRequest.
        :rtype: str
        """
        return self._app_id
    ...
    def app_id(self, app_id: str) -> None:
        """
        Sets the app_id of this TwitterIntegrationRequest.
        The appId of the Twitter app to register the integration on

        :param app_id: The app_id of this TwitterIntegrationRequest.
        :type: str
        """
    ...
    def code_challenge(self) -> str:
        """
        Gets the code_challenge of this TwitterIntegrationRequest.
        The codeChallenge used during the signup flow

        :return: The code_challenge of this TwitterIntegrationRequest.
        :rtype: str
        """
    ...
    def code_challenge(self, code_challenge: str) -> None:
        """
        Sets the code_challenge of this TwitterIntegrationRequest.
        The codeChallenge used during the signup flow

        :param code_challenge: The code_challenge of this TwitterIntegrationRequest.
        :type: str
        """
    ...
    def redirect_uri(self) -> str:
        """
        Gets the redirect_uri of this TwitterIntegrationRequest.
        The redirectUri used during the signup flow

        :return: The redirect_uri of this TwitterIntegrationRequest.
        :rtype: str
        """
    ...
    def redirect_uri(self, redirect_uri: str) -> None:
        """
        Sets the redirect_uri of this TwitterIntegrationRequest.
        The redirectUri used during the signup flow

        :param redirect_uri: The redirect_uri of this TwitterIntegrationRequest.
        :type: str
        """
