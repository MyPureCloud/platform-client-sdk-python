...
class ShiftStartVariance(object):
    ...
    def applicable_days(self, applicable_days: List[str]) -> None:
        """
    ...
    @property
    def max_shift_start_variance_minutes(self) -> int:
        """
    ...
    def max_shift_start_variance_minutes(self, max_shift_start_variance_minutes: int) -> None:
        """
