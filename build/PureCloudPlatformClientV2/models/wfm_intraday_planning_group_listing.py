...
class WfmIntradayPlanningGroupListing(object):
    """
    ...
    def __init__(self) -> None:
        """
        WfmIntradayPlanningGroupListing - a model defined in Swagger
    ...
    def entities(self) -> List['ForecastPlanningGroupResponse']:
        """
        Gets the entities of this WfmIntradayPlanningGroupListing.


        :return: The entities of this WfmIntradayPlanningGroupListing.
        :rtype: list[ForecastPlanningGroupResponse]
        """
        return self._entities

    @entities.setter
    def entities(self, entities: List['ForecastPlanningGroupResponse']) -> None:
        """
        Sets the entities of this WfmIntradayPlanningGroupListing.


        :param entities: The entities of this WfmIntradayPlanningGroupListing.
    ...
    def no_data_reason(self) -> str:
        """
        Gets the no_data_reason of this WfmIntradayPlanningGroupListing.
        The reason there was no data for the request

        :return: The no_data_reason of this WfmIntradayPlanningGroupListing.
        :rtype: str
        """
    ...
    def no_data_reason(self, no_data_reason: str) -> None:
        """
        Sets the no_data_reason of this WfmIntradayPlanningGroupListing.
        The reason there was no data for the request
