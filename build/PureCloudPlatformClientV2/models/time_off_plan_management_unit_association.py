...
class TimeOffPlanManagementUnitAssociation(object):
    """
    ...
    def __init__(self) -> None:
        """
        TimeOffPlanManagementUnitAssociation - a model defined in Swagger
    ...
    def management_unit(self) -> 'ManagementUnitReference':
        """
        Gets the management_unit of this TimeOffPlanManagementUnitAssociation.
        Management unit to which this time-off plan belongs

        :return: The management_unit of this TimeOffPlanManagementUnitAssociation.
    ...
    def management_unit(self, management_unit: 'ManagementUnitReference') -> None:
        """
        Sets the management_unit of this TimeOffPlanManagementUnitAssociation.
        Management unit to which this time-off plan belongs

        :param management_unit: The management_unit of this TimeOffPlanManagementUnitAssociation.
    ...
    def staffing_groups(self) -> List['StaffingGroupReference']:
        """
        Gets the staffing_groups of this TimeOffPlanManagementUnitAssociation.
        Staffing groups to which this time-off plan applies. If not defined, the plan applies to the management unit

        :return: The staffing_groups of this TimeOffPlanManagementUnitAssociation.
    ...
    def staffing_groups(self, staffing_groups: List['StaffingGroupReference']) -> None:
        """
        Sets the staffing_groups of this TimeOffPlanManagementUnitAssociation.
        Staffing groups to which this time-off plan applies. If not defined, the plan applies to the management unit

        :param staffing_groups: The staffing_groups of this TimeOffPlanManagementUnitAssociation.
