...
if TYPE_CHECKING:
    from . import AnalyticsEvaluation
    from . import AnalyticsParticipantWithoutAttributes
    from . import AnalyticsResolution
    from . import AnalyticsSurvey
...
class AnalyticsConversationWithoutAttributes(object):
    ...
    def conference_start(self) -> datetime:
        """
        Gets the conference_start of this AnalyticsConversationWithoutAttributes.
        The start time of a conference call. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z

        :return: The conference_start of this AnalyticsConversationWithoutAttributes.
        :rtype: datetime
        """
    ...
    def conference_start(self, conference_start: datetime) -> None:
        """
        Sets the conference_start of this AnalyticsConversationWithoutAttributes.
        The start time of a conference call. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z

        :param conference_start: The conference_start of this AnalyticsConversationWithoutAttributes.
        :type: datetime
        """
    ...
    def conversation_end(self, conversation_end: datetime) -> None:
        """
    ...
    @property
    def conversation_start(self) -> datetime:
        """
    ...
    def conversation_start(self, conversation_start: datetime) -> None:
        """
    ...
    def inactivity_timeout(self) -> datetime:
        """
        Gets the inactivity_timeout of this AnalyticsConversationWithoutAttributes.
        ...
        :return: The inactivity_timeout of this AnalyticsConversationWithoutAttributes.
        :rtype: datetime
        """
    ...
    def inactivity_timeout(self, inactivity_timeout: datetime) -> None:
        """
        Sets the inactivity_timeout of this AnalyticsConversationWithoutAttributes.
        The time in the future, after which this conversation would be considered inactive. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z

        :param inactivity_timeout: The inactivity_timeout of this AnalyticsConversationWithoutAttributes.
        :type: datetime
        """
    ...
    @property
    def media_stats_min_conversation_mos(self) -> float:
        """
    ...
    def media_stats_min_conversation_mos(self, media_stats_min_conversation_mos: float) -> None:
        """
    ...
    @property
    def media_stats_min_conversation_r_factor(self) -> float:
        """
    ...
    def media_stats_min_conversation_r_factor(self, media_stats_min_conversation_r_factor: float) -> None:
        """
    ...
    def originating_social_media_public(self) -> bool:
        """
        Gets the originating_social_media_public of this AnalyticsConversationWithoutAttributes.
        Indicates that the conversation originated from a public message on social media

        :return: The originating_social_media_public of this AnalyticsConversationWithoutAttributes.
        :rtype: bool
        """
    ...
    def originating_social_media_public(self, originating_social_media_public: bool) -> None:
        """
        Sets the originating_social_media_public of this AnalyticsConversationWithoutAttributes.
        Indicates that the conversation originated from a public message on social media

        :param originating_social_media_public: The originating_social_media_public of this AnalyticsConversationWithoutAttributes.
        :type: bool
        """
    ...
    @property
    def evaluations(self) -> List['AnalyticsEvaluation']:
        """
    ...
    @evaluations.setter
    def evaluations(self, evaluations: List['AnalyticsEvaluation']) -> None:
        """
    ...
    @property
    def surveys(self) -> List['AnalyticsSurvey']:
        """
    ...
    @surveys.setter
    def surveys(self, surveys: List['AnalyticsSurvey']) -> None:
        """
    ...
    @property
    def resolutions(self) -> List['AnalyticsResolution']:
        """
    ...
    @resolutions.setter
    def resolutions(self, resolutions: List['AnalyticsResolution']) -> None:
        """
    ...
    @property
    def participants(self) -> List['AnalyticsParticipantWithoutAttributes']:
        """
    ...
    @participants.setter
    def participants(self, participants: List['AnalyticsParticipantWithoutAttributes']) -> None:
        """
