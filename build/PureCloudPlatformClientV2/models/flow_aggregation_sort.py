...
class FlowAggregationSort(object):
    """
    ...
    def __init__(self) -> None:
        """
        FlowAggregationSort - a model defined in Swagger
    ...
    def name(self) -> str:
        """
        Gets the name of this FlowAggregationSort.
        Name of the metric used for sorting values.

        :return: The name of this FlowAggregationSort.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name: str) -> None:
        """
        Sets the name of this FlowAggregationSort.
        Name of the metric used for sorting values.

        :param name: The name of this FlowAggregationSort.
        :type: str
        """
    ...
    def function(self) -> str:
        """
        Gets the function of this FlowAggregationSort.
        Aggregation function used for the sort metric.

        :return: The function of this FlowAggregationSort.
        :rtype: str
        """
    ...
    def function(self, function: str) -> None:
        """
        Sets the function of this FlowAggregationSort.
        Aggregation function used for the sort metric.

        :param function: The function of this FlowAggregationSort.
        :type: str
        """
