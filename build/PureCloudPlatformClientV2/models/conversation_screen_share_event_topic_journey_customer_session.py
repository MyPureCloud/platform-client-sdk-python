...
class ConversationScreenShareEventTopicJourneyCustomerSession(object):
    """
    ...
    def __init__(self):
        """
        ConversationScreenShareEventTopicJourneyCustomerSession - a model defined in Swagger
