...
if TYPE_CHECKING:
    from . import CampaignRuleActionEntities
...
class CampaignRuleAction(object):
    ...
    @property
    def parameters(self) -> 'CampaignRuleParameters':
        """
    ...
    @parameters.setter
    def parameters(self, parameters: 'CampaignRuleParameters') -> None:
        """
    ...
    def action_type(self, action_type: str) -> None:
        ...
        allowed_values = ["turnOnCampaign", "turnOffCampaign", "turnOnSequence", "turnOffSequence", "setCampaignPriority", "recycleCampaign", "setCampaignDialingMode", "setCampaignAbandonRate", "setCampaignNumberOfLines", "setCampaignWeight", "setCampaignMaxCallsPerAgent", "changeCampaignQueue"]
    ...
    @property
    def campaign_rule_action_entities(self) -> 'CampaignRuleActionEntities':
        """
    ...
    def campaign_rule_action_entities(self, campaign_rule_action_entities: 'CampaignRuleActionEntities') -> None:
        """
