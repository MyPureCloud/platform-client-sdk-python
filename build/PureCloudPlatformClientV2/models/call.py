...
class Call(object):
    ...
    def initial_state(self) -> str:
        """
        Gets the initial_state of this Call.
        The initial connection state of this communication.

        :return: The initial_state of this Call.
        :rtype: str
        """
    ...
    def initial_state(self, initial_state: str) -> None:
        """
        Sets the initial_state of this Call.
        The initial connection state of this communication.

        :param initial_state: The initial_state of this Call.
        :type: str
        """
    ...
    def recorders_state(self) -> 'RecordersState':
        """
        Gets the recorders_state of this Call.
        Contains the states of different recorders.

        :return: The recorders_state of this Call.
    ...
    def recorders_state(self, recorders_state: 'RecordersState') -> None:
        """
        Sets the recorders_state of this Call.
        Contains the states of different recorders.

        :param recorders_state: The recorders_state of this Call.
        :type: RecordersState
        """
    ...
    def after_call_work_required(self) -> bool:
        """
        Gets the after_call_work_required of this Call.
        Indicates if after-call work is required for a communication. Only used when the ACW Setting is Agent Requested.

        :return: The after_call_work_required of this Call.
        :rtype: bool
        """
    ...
    def after_call_work_required(self, after_call_work_required: bool) -> None:
        """
        Sets the after_call_work_required of this Call.
        Indicates if after-call work is required for a communication. Only used when the ACW Setting is Agent Requested.

        :param after_call_work_required: The after_call_work_required of this Call.
        :type: bool
        """
    ...
    def agent_assistant_id(self) -> str:
        """
        Gets the agent_assistant_id of this Call.
        UUID of virtual agent assistant that provide suggestions to the agent participant during the conversation.

        :return: The agent_assistant_id of this Call.
        :rtype: str
        """
    ...
    def agent_assistant_id(self, agent_assistant_id: str) -> None:
        """
        Sets the agent_assistant_id of this Call.
        UUID of virtual agent assistant that provide suggestions to the agent participant during the conversation.

        :param agent_assistant_id: The agent_assistant_id of this Call.
        :type: str
        """
    ...
    def transfer_source(self) -> str:
        """
        Gets the transfer_source of this Call.
        Indicates how call reaches the agent.

        :return: The transfer_source of this Call.
        :rtype: str
        """
    ...
    def transfer_source(self, transfer_source: str) -> None:
        """
        Sets the transfer_source of this Call.
        Indicates how call reaches the agent.

        :param transfer_source: The transfer_source of this Call.
        :type: str
        """
    ...
    def queue_media_settings(self) -> 'ConversationQueueMediaSettings':
        """
        Gets the queue_media_settings of this Call.
        Represents the queue settings for this media type.

        :return: The queue_media_settings of this Call.
    ...
    def queue_media_settings(self, queue_media_settings: 'ConversationQueueMediaSettings') -> None:
        """
        Sets the queue_media_settings of this Call.
        Represents the queue settings for this media type.

        :param queue_media_settings: The queue_media_settings of this Call.
    ...
    def client_ip_address(self) -> str:
        """
        Gets the client_ip_address of this Call.
        The reported client IP of the phone for the call.

        :return: The client_ip_address of this Call.
        :rtype: str
        """
    ...
    def client_ip_address(self, client_ip_address: str) -> None:
        """
        Sets the client_ip_address of this Call.
        The reported client IP of the phone for the call.

        :param client_ip_address: The client_ip_address of this Call.
        :type: str
        """
