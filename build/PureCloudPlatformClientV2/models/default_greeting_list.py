...
class DefaultGreetingList(object):
    ...
    @owner.setter
    def owner(self, owner: 'GreetingOwner') -> None:
        """
    ...
    @property
    def greetings(self) -> Dict[str, 'Greeting']:
        """
    ...
    @greetings.setter
    def greetings(self, greetings: Dict[str, 'Greeting']) -> None:
        """
