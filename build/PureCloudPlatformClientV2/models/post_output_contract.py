...
class PostOutputContract(object):
    """
    ...
    def __init__(self):
        """
        PostOutputContract - a model defined in Swagger
    ...
    def success_schema(self):
        """
        Gets the success_schema of this PostOutputContract.
        JSON schema that defines the transformed, successful result that will be sent back to the caller.

        :return: The success_schema of this PostOutputContract.
    ...
    def success_schema(self, success_schema):
        """
        Sets the success_schema of this PostOutputContract.
        JSON schema that defines the transformed, successful result that will be sent back to the caller.

        :param success_schema: The success_schema of this PostOutputContract.
