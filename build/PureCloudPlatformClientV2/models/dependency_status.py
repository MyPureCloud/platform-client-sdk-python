...
class DependencyStatus(object):
    ...
    @build_id.setter
    def build_id(self, build_id: str) -> None:
        """
    ...
    def status(self, status: str) -> None:
        ...
        if isinstance(status, int):
            status = str(status)
        allowed_values = ["BUILDINCOMPLETE", "BUILDINITIALIZING", "BUILDINPROGRESS", "BUILDQUEUED", "NOTBUILT", "OPERATIONAL", "OPERATIONALNEEDSREBUILD"]
    ...
    @property
    def failed_objects(self) -> List['FailedObject']:
        """
    ...
    def failed_objects(self, failed_objects: List['FailedObject']) -> None:
        """
