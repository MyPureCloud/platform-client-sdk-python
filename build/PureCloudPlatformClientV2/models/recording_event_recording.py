...
if TYPE_CHECKING:
    from . import RecordingEventMediaResult
...
class RecordingEventRecording(object):
    ...
    @property
    def media_uris(self) -> List['RecordingEventMediaResult']:
        """
    ...
    @media_uris.setter
    def media_uris(self, media_uris: List['RecordingEventMediaResult']) -> None:
        """
