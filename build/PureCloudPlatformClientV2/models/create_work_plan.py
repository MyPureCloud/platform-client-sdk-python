...
if TYPE_CHECKING:
    from . import CreateWorkPlanShift
...
class CreateWorkPlan(object):
    ...
    def minimum_consecutive_non_working_minutes_per_week(self, minimum_consecutive_non_working_minutes_per_week: int) -> None:
        ...
        :param minimum_consecutive_non_working_minutes_per_week: The minimum_consecutive_non_working_minutes_per_week of this CreateWorkPlan.
        :type: int
        """
    ...
    def constrain_maximum_consecutive_working_days(self) -> bool:
        """
        Gets the constrain_maximum_consecutive_working_days of this CreateWorkPlan.
        Whether to constrain the maximum consecutive working days

        :return: The constrain_maximum_consecutive_working_days of this CreateWorkPlan.
        :rtype: bool
        """
    ...
    def constrain_maximum_consecutive_working_days(self, constrain_maximum_consecutive_working_days: bool) -> None:
        """
        Sets the constrain_maximum_consecutive_working_days of this CreateWorkPlan.
        Whether to constrain the maximum consecutive working days

        :param constrain_maximum_consecutive_working_days: The constrain_maximum_consecutive_working_days of this CreateWorkPlan.
        :type: bool
        """
    ...
    def minimum_paid_minutes_per_planning_period(self) -> int:
        """
        Gets the minimum_paid_minutes_per_planning_period of this CreateWorkPlan.
        Minimum paid minutes in the planning period

        :return: The minimum_paid_minutes_per_planning_period of this CreateWorkPlan.
        :rtype: int
        """
    ...
    def minimum_paid_minutes_per_planning_period(self, minimum_paid_minutes_per_planning_period: int) -> None:
        """
        Sets the minimum_paid_minutes_per_planning_period of this CreateWorkPlan.
        Minimum paid minutes in the planning period

        :param minimum_paid_minutes_per_planning_period: The minimum_paid_minutes_per_planning_period of this CreateWorkPlan.
        :type: int
        """
    ...
    def maximum_paid_minutes_per_planning_period(self) -> int:
        """
        Gets the maximum_paid_minutes_per_planning_period of this CreateWorkPlan.
        Maximum paid minutes in the planning period

        :return: The maximum_paid_minutes_per_planning_period of this CreateWorkPlan.
        :rtype: int
        """
    ...
    def maximum_paid_minutes_per_planning_period(self, maximum_paid_minutes_per_planning_period: int) -> None:
        """
        Sets the maximum_paid_minutes_per_planning_period of this CreateWorkPlan.
        Maximum paid minutes in the planning period

        :param maximum_paid_minutes_per_planning_period: The maximum_paid_minutes_per_planning_period of this CreateWorkPlan.
        :type: int
        """
    ...
    def optional_days(self) -> 'SetWrapperDayOfWeek':
        """
        Gets the optional_days of this CreateWorkPlan.
        Optional days to schedule for this work plan

        :return: The optional_days of this CreateWorkPlan.
    ...
    def optional_days(self, optional_days: 'SetWrapperDayOfWeek') -> None:
        """
        Sets the optional_days of this CreateWorkPlan.
        Optional days to schedule for this work plan

        :param optional_days: The optional_days of this CreateWorkPlan.
    ...
    def shift_start_variance_type(self) -> str:
        """
        Gets the shift_start_variance_type of this CreateWorkPlan.
        This constraint ensures that an agent starts each workday within a user-defined time threshold

        :return: The shift_start_variance_type of this CreateWorkPlan.
        :rtype: str
        """
    ...
    def shift_start_variance_type(self, shift_start_variance_type: str) -> None:
        """
        Sets the shift_start_variance_type of this CreateWorkPlan.
        This constraint ensures that an agent starts each workday within a user-defined time threshold

        :param shift_start_variance_type: The shift_start_variance_type of this CreateWorkPlan.
        :type: str
        """
    ...
    def shift_start_variance_period(self) -> str:
        """
        Gets the shift_start_variance_period of this CreateWorkPlan.
        The length of the period over which the maximum shift start time variance is applied

        :return: The shift_start_variance_period of this CreateWorkPlan.
        :rtype: str
        """
    ...
    def shift_start_variance_period(self, shift_start_variance_period: str) -> None:
        """
        Sets the shift_start_variance_period of this CreateWorkPlan.
        The length of the period over which the maximum shift start time variance is applied

        :param shift_start_variance_period: The shift_start_variance_period of this CreateWorkPlan.
        :type: str
        """
    ...
    def shift_start_variances(self) -> 'ListWrapperShiftStartVariance':
        """
        Gets the shift_start_variances of this CreateWorkPlan.
        Variance in minutes among start times of shifts in this work plan

        :return: The shift_start_variances of this CreateWorkPlan.
    ...
    def shift_start_variances(self, shift_start_variances: 'ListWrapperShiftStartVariance') -> None:
        """
        Sets the shift_start_variances of this CreateWorkPlan.
        Variance in minutes among start times of shifts in this work plan

        :param shift_start_variances: The shift_start_variances of this CreateWorkPlan.
    ...
    @property
    def shifts(self) -> List['CreateWorkPlanShift']:
        """
        Gets the shifts of this CreateWorkPlan.
        Shifts in this work plan

        :return: The shifts of this CreateWorkPlan.
        :rtype: list[CreateWorkPlanShift]
        """
        return self._shifts

    @shifts.setter
    def shifts(self, shifts: List['CreateWorkPlanShift']) -> None:
        """
        Sets the shifts of this CreateWorkPlan.
        Shifts in this work plan

        :param shifts: The shifts of this CreateWorkPlan.
    ...
    def agents(self) -> List['UserReference']:
        """
        Gets the agents of this CreateWorkPlan.
        Agents in this work plan

        :return: The agents of this CreateWorkPlan.
    ...
    def agents(self, agents: List['UserReference']) -> None:
        """
        Sets the agents of this CreateWorkPlan.
        Agents in this work plan

        :param agents: The agents of this CreateWorkPlan.
