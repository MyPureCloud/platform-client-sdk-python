...
if TYPE_CHECKING:
    from . import CreateShareRequestMember
    from . import SharedEntity
...
class CreateShareRequest(object):
    ...
    @property
    def shared_entity(self) -> 'SharedEntity':
        """
    ...
    def shared_entity(self, shared_entity: 'SharedEntity') -> None:
        """
    ...
    @member.setter
    def member(self, member: 'SharedEntity') -> None:
        """
    ...
    @property
    def members(self) -> List['CreateShareRequestMember']:
        """
    ...
    @members.setter
    def members(self, members: List['CreateShareRequestMember']) -> None:
        """
