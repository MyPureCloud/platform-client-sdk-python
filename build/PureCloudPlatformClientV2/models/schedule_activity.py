...
class ScheduleActivity(object):
    ...
    def __init__(self):
        """
        ScheduleActivity - a model defined in Swagger
    ...
    def date_start(self):
        """
        Gets the date_start of this ScheduleActivity.
        ...
        :return: The date_start of this ScheduleActivity.
        :rtype: datetime
        """
    ...
    def date_start(self, date_start):
        """
        Sets the date_start of this ScheduleActivity.
        The start date/time of this activity. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z

        :param date_start: The date_start of this ScheduleActivity.
        :type: datetime
        """
    ...
    def length_minutes(self):
        """
        Gets the length_minutes of this ScheduleActivity.
        The length of this activity in minutes

        :return: The length_minutes of this ScheduleActivity.
        :rtype: int
        """
    ...
    def length_minutes(self, length_minutes):
        """
        Sets the length_minutes of this ScheduleActivity.
        The length of this activity in minutes

        :param length_minutes: The length_minutes of this ScheduleActivity.
        :type: int
        """
    ...
    def description(self):
        """
        Gets the description of this ScheduleActivity.
        The description of this activity

        :return: The description of this ScheduleActivity.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this ScheduleActivity.
        The description of this activity

        :param description: The description of this ScheduleActivity.
        :type: str
        """
    ...
    def activity_code_id(self):
        """
        Gets the activity_code_id of this ScheduleActivity.
        The ID of the activity code associated with this activity

        :return: The activity_code_id of this ScheduleActivity.
        :rtype: str
        """
    ...
    def activity_code_id(self, activity_code_id):
        """
        Sets the activity_code_id of this ScheduleActivity.
        The ID of the activity code associated with this activity

        :param activity_code_id: The activity_code_id of this ScheduleActivity.
        :type: str
        """
    ...
    def paid(self):
        """
        Gets the paid of this ScheduleActivity.
        Whether this activity is paid

        :return: The paid of this ScheduleActivity.
        :rtype: bool
        """
        return self._paid
    ...
    def paid(self, paid):
        """
        Sets the paid of this ScheduleActivity.
        Whether this activity is paid

        :param paid: The paid of this ScheduleActivity.
        :type: bool
        """
    ...
    def time_off_request_id(self):
        """
        Gets the time_off_request_id of this ScheduleActivity.
        The ID of the time off request associated with this activity, if applicable

        :return: The time_off_request_id of this ScheduleActivity.
        :rtype: str
        """
    ...
    def time_off_request_id(self, time_off_request_id):
        """
        Sets the time_off_request_id of this ScheduleActivity.
        The ID of the time off request associated with this activity, if applicable

        :param time_off_request_id: The time_off_request_id of this ScheduleActivity.
        :type: str
        """
    ...
    def external_activity_id(self):
        """
        Gets the external_activity_id of this ScheduleActivity.
        The ID of the external activity associated with this activity, if applicable

        :return: The external_activity_id of this ScheduleActivity.
        :rtype: str
        """
    ...
    def external_activity_id(self, external_activity_id):
        """
        Sets the external_activity_id of this ScheduleActivity.
        The ID of the external activity associated with this activity, if applicable

        :param external_activity_id: The external_activity_id of this ScheduleActivity.
        :type: str
        """
    ...
    def external_activity_type(self):
        """
        Gets the external_activity_type of this ScheduleActivity.
        The type of the external activity associated with this activity, if applicable

        :return: The external_activity_type of this ScheduleActivity.
        :rtype: str
        """
    ...
    def external_activity_type(self, external_activity_type):
        """
        Sets the external_activity_type of this ScheduleActivity.
        The type of the external activity associated with this activity, if applicable

        :param external_activity_type: The external_activity_type of this ScheduleActivity.
        :type: str
        """
