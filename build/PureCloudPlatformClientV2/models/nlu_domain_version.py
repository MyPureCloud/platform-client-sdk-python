...
if TYPE_CHECKING:
    from . import IntentDefinition
    from . import NamedEntityDefinition
    from . import NamedEntityTypeDefinition
...
class NluDomainVersion(object):
    ...
    def training_status(self, training_status: str) -> None:
        """
    ...
    @intents.setter
    def intents(self, intents: List['IntentDefinition']) -> None:
        """
    ...
    @property
    def entity_types(self) -> List['NamedEntityTypeDefinition']:
        """
    ...
    @entity_types.setter
    def entity_types(self, entity_types: List['NamedEntityTypeDefinition']) -> None:
        """
    ...
    @property
    def entities(self) -> List['NamedEntityDefinition']:
        """
    ...
    @entities.setter
    def entities(self, entities: List['NamedEntityDefinition']) -> None:
        """
