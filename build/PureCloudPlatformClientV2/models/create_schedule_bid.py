...
class CreateScheduleBid(object):
    """
    ...
    def __init__(self) -> None:
        """
        CreateScheduleBid - a model defined in Swagger
    ...
    def name(self) -> str:
        """
        Gets the name of this CreateScheduleBid.
        The name of the schedule bid

        :return: The name of this CreateScheduleBid.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name: str) -> None:
        """
        Sets the name of this CreateScheduleBid.
        The name of the schedule bid

        :param name: The name of this CreateScheduleBid.
        :type: str
        """
    ...
    def forecast(self) -> 'BuShortTermForecastWeekReference':
        """
        Gets the forecast of this CreateScheduleBid.
        The selected forecast used for schedule set generation for this bid

        :return: The forecast of this CreateScheduleBid.
    ...
    def forecast(self, forecast: 'BuShortTermForecastWeekReference') -> None:
        """
        Sets the forecast of this CreateScheduleBid.
        The selected forecast used for schedule set generation for this bid

        :param forecast: The forecast of this CreateScheduleBid.
    ...
    def bid_window_start_date(self) -> date:
        """
        Gets the bid_window_start_date of this CreateScheduleBid.
        ...
        :return: The bid_window_start_date of this CreateScheduleBid.
        :rtype: date
        """
    ...
    def bid_window_start_date(self, bid_window_start_date: date) -> None:
        """
        Sets the bid_window_start_date of this CreateScheduleBid.
        The bid start date where agents start participating in schedule bidding relative to the business unit time zone in yyyy-MM-dd format. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd

        :param bid_window_start_date: The bid_window_start_date of this CreateScheduleBid.
        :type: date
        """
    ...
    def bid_window_end_date(self) -> date:
        """
        Gets the bid_window_end_date of this CreateScheduleBid.
        ...
        :return: The bid_window_end_date of this CreateScheduleBid.
        :rtype: date
        """
    ...
    def bid_window_end_date(self, bid_window_end_date: date) -> None:
        """
        Sets the bid_window_end_date of this CreateScheduleBid.
        The bid end date relative to the business unit time zone in yyyy-MM-dd format. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd

        :param bid_window_end_date: The bid_window_end_date of this CreateScheduleBid.
        :type: date
        """
    ...
    def effective_date(self) -> date:
        """
        Gets the effective_date of this CreateScheduleBid.
        ...
        :return: The effective_date of this CreateScheduleBid.
        :rtype: date
        """
    ...
    def effective_date(self, effective_date: date) -> None:
        """
        Sets the effective_date of this CreateScheduleBid.
        The date when schedule sets would be effective for schedule generation relative to the business unit time zone in yyyy-MM-dd format. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd

        :param effective_date: The effective_date of this CreateScheduleBid.
        :type: date
        """
    ...
    def weeks_to_schedule(self) -> int:
        """
        Gets the weeks_to_schedule of this CreateScheduleBid.
        The number of weeks to generate schedule set through this bid

        :return: The weeks_to_schedule of this CreateScheduleBid.
        :rtype: int
        """
    ...
    def weeks_to_schedule(self, weeks_to_schedule: int) -> None:
        """
        Sets the weeks_to_schedule of this CreateScheduleBid.
        The number of weeks to generate schedule set through this bid

        :param weeks_to_schedule: The weeks_to_schedule of this CreateScheduleBid.
        :type: int
        """
    ...
    def end_overrides_and_rotations(self) -> bool:
        """
        Gets the end_overrides_and_rotations of this CreateScheduleBid.
        If true, all existing overrides, work plan rotations will be ended one day before effective date of this bid

        :return: The end_overrides_and_rotations of this CreateScheduleBid.
        :rtype: bool
        """
    ...
    def end_overrides_and_rotations(self, end_overrides_and_rotations: bool) -> None:
        """
        Sets the end_overrides_and_rotations of this CreateScheduleBid.
        If true, all existing overrides, work plan rotations will be ended one day before effective date of this bid

        :param end_overrides_and_rotations: The end_overrides_and_rotations of this CreateScheduleBid.
        :type: bool
        """
    ...
    def agent_ranking_type(self) -> str:
        """
        Gets the agent_ranking_type of this CreateScheduleBid.
        The type of agent ranking selected for this bid

        :return: The agent_ranking_type of this CreateScheduleBid.
        :rtype: str
        """
    ...
    def agent_ranking_type(self, agent_ranking_type: str) -> None:
        """
        Sets the agent_ranking_type of this CreateScheduleBid.
        The type of agent ranking selected for this bid

        :param agent_ranking_type: The agent_ranking_type of this CreateScheduleBid.
        :type: str
        """
    ...
    def ranking_tiebreaker_type(self) -> str:
        """
        Gets the ranking_tiebreaker_type of this CreateScheduleBid.
        Ranking tiebreaker to be used

        :return: The ranking_tiebreaker_type of this CreateScheduleBid.
        :rtype: str
        """
    ...
    def ranking_tiebreaker_type(self, ranking_tiebreaker_type: str) -> None:
        """
        Sets the ranking_tiebreaker_type of this CreateScheduleBid.
        Ranking tiebreaker to be used

        :param ranking_tiebreaker_type: The ranking_tiebreaker_type of this CreateScheduleBid.
        :type: str
        """
