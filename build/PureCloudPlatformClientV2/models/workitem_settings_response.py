...
if TYPE_CHECKING:
    from . import StepplansWorktypeReference

class WorkitemSettingsResponse(object):
    """
    ...
    def __init__(self) -> None:
        """
        WorkitemSettingsResponse - a model defined in Swagger
        ...
        """
        self.swagger_types = {
            'worktype': 'StepplansWorktypeReference'
        }
