...
class DecisionTableInputColumn(object):
    """
    ...
    def __init__(self) -> None:
        """
        DecisionTableInputColumn - a model defined in Swagger
    ...
    def id(self) -> str:
        """
        Gets the id of this DecisionTableInputColumn.
        The id of the column.

        :return: The id of this DecisionTableInputColumn.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id: str) -> None:
        """
        Sets the id of this DecisionTableInputColumn.
        The id of the column.

        :param id: The id of this DecisionTableInputColumn.
        :type: str
        """
    ...
    def defaults_to(self, defaults_to: 'DecisionTableColumnDefaultRowValue') -> None:
        """
        Sets the defaults_to of this DecisionTableInputColumn.
        The default row value for this column that will complete the condition expression where no value is provided by a row.

        :param defaults_to: The defaults_to of this DecisionTableInputColumn.
    ...
    def expression(self) -> 'DecisionTableInputColumnExpression':
        """
        Gets the expression of this DecisionTableInputColumn.
        ...
        :return: The expression of this DecisionTableInputColumn.
    ...
    def expression(self, expression: 'DecisionTableInputColumnExpression') -> None:
        """
        Sets the expression of this DecisionTableInputColumn.
        The input column condition expression, comprising the left side and comparator of a logical condition in the form of left|comparator|right, where each row of the decision table will provide the right side to form a complete condition

        :param expression: The expression of this DecisionTableInputColumn.
