...
class DialerResponsesetConfigChangeReaction(object):
    ...
    def get_additional_properties(self) -> Dict[str, object]:
        """
        Gets the get_additional_properties of this DialerResponsesetConfigChangeReaction.


        :return: The get_additional_properties of this DialerResponsesetConfigChangeReaction.
        :rtype: dict(str, object)
        """
    ...
    def get_additional_properties(self, get_additional_properties: Dict[str, object]) -> None:
        """
        Sets the get_additional_properties of this DialerResponsesetConfigChangeReaction.


        :param get_additional_properties: The get_additional_properties of this DialerResponsesetConfigChangeReaction.
        :type: dict(str, object)
        """
