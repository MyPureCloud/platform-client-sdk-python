...
if TYPE_CHECKING:
    from . import BuForecastTimeSeriesResult
...
class BuForecastGenerationPlanningGroupResult(object):
    ...
    @property
    def metric_results(self) -> List['BuForecastTimeSeriesResult']:
        """
    ...
    def metric_results(self, metric_results: List['BuForecastTimeSeriesResult']) -> None:
        """
