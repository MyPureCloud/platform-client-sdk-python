...
class TrustRequest(object):
    ...
    @trustee.setter
    def trustee(self, trustee: 'Organization') -> None:
        """
    ...
    @users.setter
    def users(self, users: List['OrgUser']) -> None:
        """
    ...
    @property
    def groups(self) -> List['TrustGroup']:
        """
    ...
    @groups.setter
    def groups(self, groups: List['TrustGroup']) -> None:
        """
