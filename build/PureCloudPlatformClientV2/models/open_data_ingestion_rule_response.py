...
class OpenDataIngestionRuleResponse(object):
    ...
    def countries(self) -> List[str]:
        """
        Gets the countries of this OpenDataIngestionRuleResponse.
        ...
        :return: The countries of this OpenDataIngestionRuleResponse.
        :rtype: list[str]
        """
    ...
    def countries(self, countries: List[str]) -> None:
        """
        Sets the countries of this OpenDataIngestionRuleResponse.
        The countries is available only on twitter data ingestion rule. ISO 3166-1 alpha-2 country codes where Data Ingestion Rules should apply. Defaults to worldwide.

        :param countries: The countries of this OpenDataIngestionRuleResponse.
        :type: list[str]
        """
