...
class ConversationContentButtonResponse(object):
    """
    ...
    def __init__(self) -> None:
        """
        ConversationContentButtonResponse - a model defined in Swagger
    ...
    def type(self) -> str:
        """
        Gets the type of this ConversationContentButtonResponse.
        Describes the button that resulted in the Button Response.

        :return: The type of this ConversationContentButtonResponse.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type: str) -> None:
        """
        Sets the type of this ConversationContentButtonResponse.
        Describes the button that resulted in the Button Response.

        :param type: The type of this ConversationContentButtonResponse.
        :type: str
        """
        if isinstance(type, int):
            type = str(type)
        allowed_values = ["Button", "QuickReply", "DatePicker", "ListPicker", "Form"]
    ...
    def text(self) -> str:
        """
        Gets the text of this ConversationContentButtonResponse.
        The response text from the button click.

        :return: The text of this ConversationContentButtonResponse.
        :rtype: str
        """
        return self._text
    ...
    def text(self, text: str) -> None:
        """
        Sets the text of this ConversationContentButtonResponse.
        The response text from the button click.

        :param text: The text of this ConversationContentButtonResponse.
        :type: str
        """
    ...
    def payload(self) -> str:
        """
        Gets the payload of this ConversationContentButtonResponse.
        The response payload associated with the clicked button.

        :return: The payload of this ConversationContentButtonResponse.
        :rtype: str
        """
    ...
    def payload(self, payload: str) -> None:
        """
        Sets the payload of this ConversationContentButtonResponse.
        The response payload associated with the clicked button.

        :param payload: The payload of this ConversationContentButtonResponse.
        :type: str
        """
