...
class JourneyAggregationView(object):
    """
    ...
    def __init__(self) -> None:
        """
        JourneyAggregationView - a model defined in Swagger
    ...
    def target(self) -> str:
        """
        Gets the target of this JourneyAggregationView.
        Target metric name

        :return: The target of this JourneyAggregationView.
        :rtype: str
        """
        return self._target
    ...
    def target(self, target: str) -> None:
        """
        Sets the target of this JourneyAggregationView.
        Target metric name
    ...
    def name(self) -> str:
        """
        Gets the name of this JourneyAggregationView.
        A unique name for this view. Must be distinct from other views and built-in metric names.

        :return: The name of this JourneyAggregationView.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name: str) -> None:
        """
        Sets the name of this JourneyAggregationView.
        A unique name for this view. Must be distinct from other views and built-in metric names.

        :param name: The name of this JourneyAggregationView.
        :type: str
        """
    ...
    def function(self) -> str:
        """
        Gets the function of this JourneyAggregationView.
        Type of view you wish to create

        :return: The function of this JourneyAggregationView.
        :rtype: str
        """
    ...
    def function(self, function: str) -> None:
        """
        Sets the function of this JourneyAggregationView.
        Type of view you wish to create
    ...
    def range(self) -> 'AggregationRange':
        """
        Gets the range of this JourneyAggregationView.
        Range of numbers for slicing up data

        :return: The range of this JourneyAggregationView.
    ...
    def range(self, range: 'AggregationRange') -> None:
        """
        Sets the range of this JourneyAggregationView.
        Range of numbers for slicing up data

        :param range: The range of this JourneyAggregationView.
