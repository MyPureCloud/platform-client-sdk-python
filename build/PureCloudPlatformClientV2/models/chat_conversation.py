...
if TYPE_CHECKING:
    from . import ChatMediaParticipant
...
class ChatConversation(object):
    ...
    @property
    def participants(self) -> List['ChatMediaParticipant']:
        """
    ...
    @participants.setter
    def participants(self, participants: List['ChatMediaParticipant']) -> None:
        """
    ...
    def inactivity_timeout(self) -> datetime:
        """
        Gets the inactivity_timeout of this ChatConversation.
        ...
        :return: The inactivity_timeout of this ChatConversation.
        :rtype: datetime
        """
    ...
    def inactivity_timeout(self, inactivity_timeout: datetime) -> None:
        """
        Sets the inactivity_timeout of this ChatConversation.
        The time in the future, after which this conversation would be considered inactive. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z

        :param inactivity_timeout: The inactivity_timeout of this ChatConversation.
        :type: datetime
        """
    ...
    def divisions(self) -> List['ConversationDivisionMembership']:
        """
        Gets the divisions of this ChatConversation.
        Identifiers of divisions associated with this conversation.

        :return: The divisions of this ChatConversation.
    ...
    def divisions(self, divisions: List['ConversationDivisionMembership']) -> None:
        """
        Sets the divisions of this ChatConversation.
        Identifiers of divisions associated with this conversation.

        :param divisions: The divisions of this ChatConversation.
