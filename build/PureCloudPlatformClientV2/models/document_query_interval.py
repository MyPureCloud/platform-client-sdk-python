...
class DocumentQueryInterval(object):
    """
    ...
    def __init__(self) -> None:
        """
        DocumentQueryInterval - a model defined in Swagger
    ...
    def field(self) -> str:
        """
        Gets the field of this DocumentQueryInterval.
        Specifies the date field to be used for date and time range.

        :return: The field of this DocumentQueryInterval.
        :rtype: str
        """
        return self._field
    ...
    def field(self, field: str) -> None:
        """
        Sets the field of this DocumentQueryInterval.
        Specifies the date field to be used for date and time range.
    ...
    def value(self) -> str:
        """
        Gets the value of this DocumentQueryInterval.
        ...
        :return: The value of this DocumentQueryInterval.
        :rtype: str
        """
        return self._value
    ...
    def value(self, value: str) -> None:
        """
        Sets the value of this DocumentQueryInterval.
        Specifies the date and time range for filtering the documents. Intervals are represented as an ISO-8601 string. For example: YYYY-MM-DDThh:mm:ss/YYYY-MM-DDThh:mm:ss

        :param value: The value of this DocumentQueryInterval.
        :type: str
        """
