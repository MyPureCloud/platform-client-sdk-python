...
class TimeOffSettingsResponse(object):
    """
    ...
    def __init__(self) -> None:
        """
        TimeOffSettingsResponse - a model defined in Swagger
    ...
    def submission_range_enforced(self) -> bool:
        """
        Gets the submission_range_enforced of this TimeOffSettingsResponse.
        Whether to enforce a submission range for agent time off requests

        :return: The submission_range_enforced of this TimeOffSettingsResponse.
        :rtype: bool
        """
    ...
    def submission_range_enforced(self, submission_range_enforced: bool) -> None:
        """
        Sets the submission_range_enforced of this TimeOffSettingsResponse.
        Whether to enforce a submission range for agent time off requests

        :param submission_range_enforced: The submission_range_enforced of this TimeOffSettingsResponse.
        :type: bool
        """
    ...
    def submission_earliest_days_from_now(self) -> int:
        """
        Gets the submission_earliest_days_from_now of this TimeOffSettingsResponse.
        ...
        :return: The submission_earliest_days_from_now of this TimeOffSettingsResponse.
        :rtype: int
        """
    ...
    def submission_earliest_days_from_now(self, submission_earliest_days_from_now: int) -> None:
        """
        Sets the submission_earliest_days_from_now of this TimeOffSettingsResponse.
        The earliest number of days from now for which an agent can submit a time off request.  Use negative numbers to indicate days in the past

        :param submission_earliest_days_from_now: The submission_earliest_days_from_now of this TimeOffSettingsResponse.
        :type: int
        """
    ...
    def submission_latest_days_from_now(self) -> int:
        """
        Gets the submission_latest_days_from_now of this TimeOffSettingsResponse.
        The latest number of days from now for which an agent can submit a time off request

        :return: The submission_latest_days_from_now of this TimeOffSettingsResponse.
        :rtype: int
        """
    ...
    def submission_latest_days_from_now(self, submission_latest_days_from_now: int) -> None:
        """
        Sets the submission_latest_days_from_now of this TimeOffSettingsResponse.
        The latest number of days from now for which an agent can submit a time off request

        :param submission_latest_days_from_now: The submission_latest_days_from_now of this TimeOffSettingsResponse.
        :type: int
        """
