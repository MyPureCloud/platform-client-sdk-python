...
class ConversationReason(object):
    """
    ...
    def __init__(self):
        """
        ConversationReason - a model defined in Swagger
    ...
    def code(self):
        """
        Gets the code of this ConversationReason.
        The reason code for the failed message receipt.

        :return: The code of this ConversationReason.
        :rtype: str
        """
        return self._code
    ...
    def code(self, code):
        """
        Sets the code of this ConversationReason.
        The reason code for the failed message receipt.
    ...
    def message(self):
        """
        Gets the message of this ConversationReason.
        Description of the reason for the failed message receipt.

        :return: The message of this ConversationReason.
        :rtype: str
        """
    ...
    def message(self, message):
        """
        Sets the message of this ConversationReason.
        Description of the reason for the failed message receipt.

        :param message: The message of this ConversationReason.
        :type: str
        """
