...
if TYPE_CHECKING:
    from . import WfmBuShortTermForecastImportCompleteTopicBuForecastModification
    from . import WfmBuShortTermForecastImportCompleteTopicForecastSourceDayPointer
    from . import WfmBuShortTermForecastImportCompleteTopicWfmVersionedEntityMetadata
...
class WfmBuShortTermForecastImportCompleteTopicBuShortTermForecast(object):
    ...
    @property
    def source_days(self) -> List['WfmBuShortTermForecastImportCompleteTopicForecastSourceDayPointer']:
        """
    ...
    @source_days.setter
    def source_days(self, source_days: List['WfmBuShortTermForecastImportCompleteTopicForecastSourceDayPointer']) -> None:
        """
    ...
    @property
    def modifications(self) -> List['WfmBuShortTermForecastImportCompleteTopicBuForecastModification']:
        """
    ...
    def modifications(self, modifications: List['WfmBuShortTermForecastImportCompleteTopicBuForecastModification']) -> None:
        """
    ...
    @property
    def metadata(self) -> 'WfmBuShortTermForecastImportCompleteTopicWfmVersionedEntityMetadata':
        """
    ...
    @metadata.setter
    def metadata(self, metadata: 'WfmBuShortTermForecastImportCompleteTopicWfmVersionedEntityMetadata') -> None:
        """
    ...
    def can_use_for_scheduling(self) -> bool:
        """
        Gets the can_use_for_scheduling of this WfmBuShortTermForecastImportCompleteTopicBuShortTermForecast.


        :return: The can_use_for_scheduling of this WfmBuShortTermForecastImportCompleteTopicBuShortTermForecast.
        :rtype: bool
        """
    ...
    def can_use_for_scheduling(self, can_use_for_scheduling: bool) -> None:
        """
        Sets the can_use_for_scheduling of this WfmBuShortTermForecastImportCompleteTopicBuShortTermForecast.


        :param can_use_for_scheduling: The can_use_for_scheduling of this WfmBuShortTermForecastImportCompleteTopicBuShortTermForecast.
        :type: bool
        """
