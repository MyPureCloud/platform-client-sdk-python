...
class ReportingInterval(object):
    """
    ...
    def __init__(self) -> None:
        """
        ReportingInterval - a model defined in Swagger
    ...
    def interval_type(self) -> str:
        """
        Gets the interval_type of this ReportingInterval.
        The granularity of the reporting interval period

        :return: The interval_type of this ReportingInterval.
        :rtype: str
        """
        return self._interval_type

    @interval_type.setter
    def interval_type(self, interval_type: str) -> None:
        """
        Sets the interval_type of this ReportingInterval.
        The granularity of the reporting interval period
        ...
        if interval_type.lower() not in map(str.lower, allowed_values):
            ...
            self._interval_type = "outdated_sdk_version"
        else:
    ...
    def interval_value(self) -> int:
        """
        Gets the interval_value of this ReportingInterval.
        The value of the reporting interval period for a given interval type

        :return: The interval_value of this ReportingInterval.
        :rtype: int
        """
        return self._interval_value

    @interval_value.setter
    def interval_value(self, interval_value: int) -> None:
        """
        Sets the interval_value of this ReportingInterval.
        The value of the reporting interval period for a given interval type

        :param interval_value: The interval_value of this ReportingInterval.
        :type: int
        """
