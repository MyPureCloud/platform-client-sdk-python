...
if TYPE_CHECKING:
    from . import ConversationCobrowseEventTopicScoredAgent
    from . import ConversationCobrowseEventTopicUriReference

class ConversationCobrowseEventTopicConversationRoutingData(object):
    """
    ...
    def __init__(self) -> None:
        """
        ConversationCobrowseEventTopicConversationRoutingData - a model defined in Swagger
        ...
        self.swagger_types = {
            ...
            'priority': 'int',
            'skills': 'list[ConversationCobrowseEventTopicUriReference]',
            'scored_agents': 'list[ConversationCobrowseEventTopicScoredAgent]',
            'skill_expression_id': 'ConversationCobrowseEventTopicUriReference'
        }
    ...
    @property
    def language(self) -> 'ConversationCobrowseEventTopicUriReference':
        """
    ...
    @language.setter
    def language(self, language: 'ConversationCobrowseEventTopicUriReference') -> None:
        """
    ...
    @property
    def skills(self) -> List['ConversationCobrowseEventTopicUriReference']:
        """
    ...
    @skills.setter
    def skills(self, skills: List['ConversationCobrowseEventTopicUriReference']) -> None:
        """
    ...
    @property
    def scored_agents(self) -> List['ConversationCobrowseEventTopicScoredAgent']:
        """
    ...
    def scored_agents(self, scored_agents: List['ConversationCobrowseEventTopicScoredAgent']) -> None:
        """
    ...
    @property
    def skill_expression_id(self) -> 'ConversationCobrowseEventTopicUriReference':
        """
        Gets the skill_expression_id of this ConversationCobrowseEventTopicConversationRoutingData.
        A UriReference for a resource

        :return: The skill_expression_id of this ConversationCobrowseEventTopicConversationRoutingData.
        :rtype: ConversationCobrowseEventTopicUriReference
        """
        return self._skill_expression_id

    @skill_expression_id.setter
    def skill_expression_id(self, skill_expression_id: 'ConversationCobrowseEventTopicUriReference') -> None:
        """
        Sets the skill_expression_id of this ConversationCobrowseEventTopicConversationRoutingData.
        A UriReference for a resource

        :param skill_expression_id: The skill_expression_id of this ConversationCobrowseEventTopicConversationRoutingData.
        :type: ConversationCobrowseEventTopicUriReference
        """
