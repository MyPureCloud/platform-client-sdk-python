...
class WebChatConfig(object):
    ...
    def __init__(self):
        """
        WebChatConfig - a model defined in Swagger
    ...
    def web_chat_skin(self):
        """
        Gets the web_chat_skin of this WebChatConfig.
        css class to be applied to the web chat widget.

        :return: The web_chat_skin of this WebChatConfig.
        :rtype: str
        """
    ...
    def web_chat_skin(self, web_chat_skin):
        """
        Sets the web_chat_skin of this WebChatConfig.
        css class to be applied to the web chat widget.
