...
if TYPE_CHECKING:
    from . import RecipientAdditionalIdentifier
...
class MessagingRecipient(object):
    ...
    def external_contact_id(self) -> str:
        """
        Gets the external_contact_id of this MessagingRecipient.
        The identifier of the external contact.

        :return: The external_contact_id of this MessagingRecipient.
        :rtype: str
        """
    ...
    def external_contact_id(self, external_contact_id: str) -> None:
        """
        Sets the external_contact_id of this MessagingRecipient.
        The identifier of the external contact.

        :param external_contact_id: The external_contact_id of this MessagingRecipient.
        :type: str
        """
    ...
    @property
    def additional_ids(self) -> List['RecipientAdditionalIdentifier']:
        """
        Gets the additional_ids of this MessagingRecipient.
        List of recipient additional identifiers

        :return: The additional_ids of this MessagingRecipient.
        :rtype: list[RecipientAdditionalIdentifier]
        """
        return self._additional_ids

    @additional_ids.setter
    def additional_ids(self, additional_ids: List['RecipientAdditionalIdentifier']) -> None:
        """
        Sets the additional_ids of this MessagingRecipient.
        List of recipient additional identifiers

        :param additional_ids: The additional_ids of this MessagingRecipient.
