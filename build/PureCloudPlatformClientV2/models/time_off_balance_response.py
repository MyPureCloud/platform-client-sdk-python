...
class TimeOffBalanceResponse(object):
    """
    ...
    def __init__(self):
        """
        TimeOffBalanceResponse - a model defined in Swagger
    ...
    def activity_code_id(self):
        """
        Gets the activity_code_id of this TimeOffBalanceResponse.
        The ID for activity code associated with time off balance

        :return: The activity_code_id of this TimeOffBalanceResponse.
        :rtype: str
        """
    ...
    def activity_code_id(self, activity_code_id):
        """
        Sets the activity_code_id of this TimeOffBalanceResponse.
        The ID for activity code associated with time off balance

        :param activity_code_id: The activity_code_id of this TimeOffBalanceResponse.
        :type: str
        """
    ...
    @property
    def hris_time_off_type_id(self):
        """
        Gets the hris_time_off_type_id of this TimeOffBalanceResponse.
        The ID of the time off type configured in HRIS integration

        :return: The hris_time_off_type_id of this TimeOffBalanceResponse.
        :rtype: str
        """
        return self._hris_time_off_type_id

    @hris_time_off_type_id.setter
    def hris_time_off_type_id(self, hris_time_off_type_id):
        """
        Sets the hris_time_off_type_id of this TimeOffBalanceResponse.
        The ID of the time off type configured in HRIS integration

        :param hris_time_off_type_id: The hris_time_off_type_id of this TimeOffBalanceResponse.
        :type: str
        """
    ...
    def start_date(self):
        """
        Gets the start_date of this TimeOffBalanceResponse.
        ...
        :return: The start_date of this TimeOffBalanceResponse.
        :rtype: date
        """
    ...
    def start_date(self, start_date):
        """
        Sets the start_date of this TimeOffBalanceResponse.
        The Start date of the requested date range. The end date is determined by the size of interval list. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd

        :param start_date: The start_date of this TimeOffBalanceResponse.
        :type: date
        """
    ...
    @property
    def balance_minutes_per_day(self):
        """
        Gets the balance_minutes_per_day of this TimeOffBalanceResponse.
        The list of available time off balance values in minutes for each day

        :return: The balance_minutes_per_day of this TimeOffBalanceResponse.
        :rtype: list[int]
        """
        return self._balance_minutes_per_day

    @balance_minutes_per_day.setter
    def balance_minutes_per_day(self, balance_minutes_per_day):
        """
        Sets the balance_minutes_per_day of this TimeOffBalanceResponse.
        The list of available time off balance values in minutes for each day

        :param balance_minutes_per_day: The balance_minutes_per_day of this TimeOffBalanceResponse.
        :type: list[int]
        """
