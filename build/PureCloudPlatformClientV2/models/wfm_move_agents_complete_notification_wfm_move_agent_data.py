...
class WfmMoveAgentsCompleteNotificationWfmMoveAgentData(object):
    """
    ...
    def __init__(self):
        """
        WfmMoveAgentsCompleteNotificationWfmMoveAgentData - a model defined in Swagger
    ...
    def user(self):
        """
        Gets the user of this WfmMoveAgentsCompleteNotificationWfmMoveAgentData.
    ...
    def user(self, user):
        """
        Sets the user of this WfmMoveAgentsCompleteNotificationWfmMoveAgentData.
