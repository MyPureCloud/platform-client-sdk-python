...
class AnalyticsConversationSegment(object):
    ...
    def disconnect_type(self, disconnect_type: str) -> None:
        ...
        allowed_values = ["client", "conferenceTransfer", "consultTransfer", "dndEndpoint", "dndTransfer", "endpoint", "error", "forwardTransfer", "inactivity", "noAnswerTransfer", "notAvailableTransfer", "other", "peer", "sessionExpired", "spam", "system", "takeover", "timeout", "transfer", "transportFailure", "uncallable"]
