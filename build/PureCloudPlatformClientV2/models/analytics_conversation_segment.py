...
class AnalyticsConversationSegment(object):
    ...
    def disconnect_type(self, disconnect_type: str) -> None:
        ...
        allowed_values = ["client", "conferenceTransfer", "consultTransfer", "dndEndpoint", "dndTransfer", "endpoint", "error", "forwardTransfer", "noAnswerTransfer", "notAvailableTransfer", "other", "peer", "spam", "system", "timeout", "transfer", "transportFailure", "uncallable", "inactivity"]
