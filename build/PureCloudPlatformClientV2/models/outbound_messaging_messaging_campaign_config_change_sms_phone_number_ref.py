...
class OutboundMessagingMessagingCampaignConfigChangeSmsPhoneNumberRef(object):
    """
    ...
    def __init__(self):
        """
        OutboundMessagingMessagingCampaignConfigChangeSmsPhoneNumberRef - a model defined in Swagger
