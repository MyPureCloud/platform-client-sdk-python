...
if TYPE_CHECKING:
    from . import DocumentBodyTableCellBlock
    from . import DocumentBodyTableRowBlockProperties

class DocumentBodyTableRowBlock(object):
    """
    ...
    def __init__(self) -> None:
        """
        DocumentBodyTableRowBlock - a model defined in Swagger
    ...
    def properties(self) -> 'DocumentBodyTableRowBlockProperties':
        """
        Gets the properties of this DocumentBodyTableRowBlock.
        The properties for the table rows.

        :return: The properties of this DocumentBodyTableRowBlock.
    ...
    def properties(self, properties: 'DocumentBodyTableRowBlockProperties') -> None:
        """
        Sets the properties of this DocumentBodyTableRowBlock.
        The properties for the table rows.

        :param properties: The properties of this DocumentBodyTableRowBlock.
