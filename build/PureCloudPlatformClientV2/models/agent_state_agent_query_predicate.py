...
class AgentStateAgentQueryPredicate(object):
    ...
    def dimension(self, dimension: str) -> None:
        ...
        allowed_values = ["activeQueueId", "inactiveQueueId", "queueId", "assignedSkillId", "assignedLanguageId", "divisionId", "userId", "managerId", "systemPresence", "organizationPresenceId", "routingStatus", "isOutOfOffice", "online", "teamId", "managementUnitId", "businessUnitId", "adherenceState", "adherenceImpact", "scheduledActivityCodeId", "scheduledActivityCategory", "actualActivityCategory"]
