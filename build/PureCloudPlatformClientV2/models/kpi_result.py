...
class KpiResult(object):
    ...
    @kpi_total_on.setter
    def kpi_total_on(self, kpi_total_on: int) -> None:
        """
    ...
    def kpi_total_off(self, kpi_total_off: int) -> None:
        """
    ...
    @property
    def interaction_count_on(self) -> int:
        """
    ...
    def interaction_count_on(self, interaction_count_on: int) -> None:
        """
    ...
    @property
    def interaction_count_off(self) -> int:
        """
    ...
    def interaction_count_off(self, interaction_count_off: int) -> None:
        """
