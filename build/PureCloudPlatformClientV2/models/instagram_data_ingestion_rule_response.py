...
class InstagramDataIngestionRuleResponse(object):
    """
    ...
    def __init__(self) -> None:
        """
        InstagramDataIngestionRuleResponse - a model defined in Swagger
    ...
    def id(self) -> str:
        """
        Gets the id of this InstagramDataIngestionRuleResponse.
        ID of the Instagram data ingestion rule.

        :return: The id of this InstagramDataIngestionRuleResponse.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id: str) -> None:
        """
        Sets the id of this InstagramDataIngestionRuleResponse.
        ID of the Instagram data ingestion rule.

        :param id: The id of this InstagramDataIngestionRuleResponse.
        :type: str
        """
    ...
    def name(self) -> str:
        """
        Gets the name of this InstagramDataIngestionRuleResponse.
        The name of the data ingestion rule.

        :return: The name of this InstagramDataIngestionRuleResponse.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name: str) -> None:
        """
        Sets the name of this InstagramDataIngestionRuleResponse.
        The name of the data ingestion rule.

        :param name: The name of this InstagramDataIngestionRuleResponse.
        :type: str
        """
    ...
    def description(self) -> str:
        """
        Gets the description of this InstagramDataIngestionRuleResponse.
        A description of the data ingestion rule.

        :return: The description of this InstagramDataIngestionRuleResponse.
        :rtype: str
        """
    ...
    def description(self, description: str) -> None:
        """
        Sets the description of this InstagramDataIngestionRuleResponse.
        A description of the data ingestion rule.

        :param description: The description of this InstagramDataIngestionRuleResponse.
        :type: str
        """
    ...
    def status(self) -> str:
        """
        Gets the status of this InstagramDataIngestionRuleResponse.
        The status of the data ingestion rule.

        :return: The status of this InstagramDataIngestionRuleResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status: str) -> None:
        """
        Sets the status of this InstagramDataIngestionRuleResponse.
        The status of the data ingestion rule.

        :param status: The status of this InstagramDataIngestionRuleResponse.
        :type: str
        """
    ...
    def version(self) -> int:
        """
        Gets the version of this InstagramDataIngestionRuleResponse.
        The version number of the data ingestion rule.

        :return: The version of this InstagramDataIngestionRuleResponse.
        :rtype: int
        """
    ...
    def version(self, version: int) -> None:
        """
        Sets the version of this InstagramDataIngestionRuleResponse.
        The version number of the data ingestion rule.

        :param version: The version of this InstagramDataIngestionRuleResponse.
        :type: int
        """
    ...
    def ingestion_rule_info(self) -> 'MessageInfo':
        """
        Gets the ingestion_rule_info of this InstagramDataIngestionRuleResponse.
        The Info about ingestion rule.

        :return: The ingestion_rule_info of this InstagramDataIngestionRuleResponse.
        :rtype: MessageInfo
        """
    ...
    def ingestion_rule_info(self, ingestion_rule_info: 'MessageInfo') -> None:
        """
        Sets the ingestion_rule_info of this InstagramDataIngestionRuleResponse.
        The Info about ingestion rule.

        :param ingestion_rule_info: The ingestion_rule_info of this InstagramDataIngestionRuleResponse.
        :type: MessageInfo
        """
    ...
    def countries(self) -> List[str]:
        """
        Gets the countries of this InstagramDataIngestionRuleResponse.
        ...
        :return: The countries of this InstagramDataIngestionRuleResponse.
        :rtype: list[str]
        """
    ...
    def countries(self, countries: List[str]) -> None:
        """
        Sets the countries of this InstagramDataIngestionRuleResponse.
        The countries is available only on twitter data ingestion rule. ISO 3166-1 alpha-2 country codes where Data Ingestion Rules should apply. Defaults to worldwide.

        :param countries: The countries of this InstagramDataIngestionRuleResponse.
        :type: list[str]
        """
    ...
    def self_uri(self) -> str:
        """
        Gets the self_uri of this InstagramDataIngestionRuleResponse.
        The URI for this object

        :return: The self_uri of this InstagramDataIngestionRuleResponse.
        :rtype: str
        """
    ...
    def self_uri(self, self_uri: str) -> None:
        """
        Sets the self_uri of this InstagramDataIngestionRuleResponse.
        The URI for this object

        :param self_uri: The self_uri of this InstagramDataIngestionRuleResponse.
        :type: str
        """
