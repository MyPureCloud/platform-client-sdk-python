...
class WorkdayPeriod(object):
    ...
    def __init__(self) -> None:
        """
        WorkdayPeriod - a model defined in Swagger
    ...
    def date_start_workday(self) -> date:
        """
        Gets the date_start_workday of this WorkdayPeriod.
        Start workday used as the date range. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd

        :return: The date_start_workday of this WorkdayPeriod.
        :rtype: date
        """
    ...
    def date_start_workday(self, date_start_workday: date) -> None:
        """
        Sets the date_start_workday of this WorkdayPeriod.
        Start workday used as the date range. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd

        :param date_start_workday: The date_start_workday of this WorkdayPeriod.
        :type: date
        """
    ...
    def date_end_workday(self) -> date:
        """
        Gets the date_end_workday of this WorkdayPeriod.
        End workday used as the date range. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd

        :return: The date_end_workday of this WorkdayPeriod.
        :rtype: date
        """
    ...
    def date_end_workday(self, date_end_workday: date) -> None:
        """
        Sets the date_end_workday of this WorkdayPeriod.
        End workday used as the date range. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd

        :param date_end_workday: The date_end_workday of this WorkdayPeriod.
        :type: date
        """
