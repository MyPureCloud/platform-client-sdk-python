...
class OutboundMessagingMessagingCampaignConfigChangeContactSort(object):
    """
    ...
    def __init__(self) -> None:
        """
        OutboundMessagingMessagingCampaignConfigChangeContactSort - a model defined in Swagger
    ...
    def field_name(self) -> str:
        """
        Gets the field_name of this OutboundMessagingMessagingCampaignConfigChangeContactSort.


        :return: The field_name of this OutboundMessagingMessagingCampaignConfigChangeContactSort.
        :rtype: str
        """
    ...
    def field_name(self, field_name: str) -> None:
        """
        Sets the field_name of this OutboundMessagingMessagingCampaignConfigChangeContactSort.


        :param field_name: The field_name of this OutboundMessagingMessagingCampaignConfigChangeContactSort.
        :type: str
        """
    ...
    def direction(self) -> str:
        """
        Gets the direction of this OutboundMessagingMessagingCampaignConfigChangeContactSort.


        :return: The direction of this OutboundMessagingMessagingCampaignConfigChangeContactSort.
        :rtype: str
        """
    ...
    def direction(self, direction: str) -> None:
        """
        Sets the direction of this OutboundMessagingMessagingCampaignConfigChangeContactSort.


        :param direction: The direction of this OutboundMessagingMessagingCampaignConfigChangeContactSort.
        :type: str
        """
    ...
    def get_additional_properties(self) -> Dict[str, object]:
        """
        Gets the get_additional_properties of this OutboundMessagingMessagingCampaignConfigChangeContactSort.


        :return: The get_additional_properties of this OutboundMessagingMessagingCampaignConfigChangeContactSort.
        :rtype: dict(str, object)
        """
    ...
    def get_additional_properties(self, get_additional_properties: Dict[str, object]) -> None:
        """
        Sets the get_additional_properties of this OutboundMessagingMessagingCampaignConfigChangeContactSort.


        :param get_additional_properties: The get_additional_properties of this OutboundMessagingMessagingCampaignConfigChangeContactSort.
        :type: dict(str, object)
        """
