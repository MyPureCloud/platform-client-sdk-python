...
class OutboundMessagingMessagingCampaignConfigChangeErrorDetail(object):
    """
    ...
    def __init__(self):
        """
        OutboundMessagingMessagingCampaignConfigChangeErrorDetail - a model defined in Swagger
