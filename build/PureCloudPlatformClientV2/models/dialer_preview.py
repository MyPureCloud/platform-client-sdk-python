...
class DialerPreview(object):
    ...
    @property
    def phone_number_columns(self) -> List['PhoneNumberColumn']:
        """
    ...
    def phone_number_columns(self, phone_number_columns: List['PhoneNumberColumn']) -> None:
        """
