...
class AlternativeShiftJobResponse(object):
    """
    ...
    def __init__(self) -> None:
        """
        AlternativeShiftJobResponse - a model defined in Swagger
    ...
    def id(self) -> str:
        """
        Gets the id of this AlternativeShiftJobResponse.
        The globally unique identifier for the object.

        :return: The id of this AlternativeShiftJobResponse.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id: str) -> None:
        """
        Sets the id of this AlternativeShiftJobResponse.
        The globally unique identifier for the object.

        :param id: The id of this AlternativeShiftJobResponse.
        :type: str
        """
    ...
    def status(self) -> str:
        """
        Gets the status of this AlternativeShiftJobResponse.
        The status of the alternative shift job

        :return: The status of this AlternativeShiftJobResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status: str) -> None:
        """
        Sets the status of this AlternativeShiftJobResponse.
        The status of the alternative shift job

        :param status: The status of this AlternativeShiftJobResponse.
        :type: str
        """
    ...
    def type(self) -> str:
        """
        Gets the type of this AlternativeShiftJobResponse.
        The type of job

        :return: The type of this AlternativeShiftJobResponse.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type: str) -> None:
        """
        Sets the type of this AlternativeShiftJobResponse.
        The type of job

        :param type: The type of this AlternativeShiftJobResponse.
        :type: str
        """
    ...
    def download_url(self) -> str:
        """
        Gets the download_url of this AlternativeShiftJobResponse.
        The URL where completed results are available, only set if status == 'Complete'

        :return: The download_url of this AlternativeShiftJobResponse.
        :rtype: str
        """
    ...
    def download_url(self, download_url: str) -> None:
        """
        Sets the download_url of this AlternativeShiftJobResponse.
        The URL where completed results are available, only set if status == 'Complete'

        :param download_url: The download_url of this AlternativeShiftJobResponse.
        :type: str
        """
    ...
    def error(self) -> 'ErrorBody':
        """
        Gets the error of this AlternativeShiftJobResponse.
        Any error information, only set if the status == 'Error'

        :return: The error of this AlternativeShiftJobResponse.
        :rtype: ErrorBody
        """
        return self._error
    ...
    def error(self, error: 'ErrorBody') -> None:
        """
        Sets the error of this AlternativeShiftJobResponse.
        Any error information, only set if the status == 'Error'

        :param error: The error of this AlternativeShiftJobResponse.
        :type: ErrorBody
        """
    ...
    def view_offers_results(self) -> 'AlternativeShiftOffersViewResponseTemplate':
        """
        Gets the view_offers_results of this AlternativeShiftJobResponse.
        Schema template for deserializing data returned from the downloadUrl. Use if type == 'ListOffers' or 'SearchOffers'

        :return: The view_offers_results of this AlternativeShiftJobResponse.
    ...
    def view_offers_results(self, view_offers_results: 'AlternativeShiftOffersViewResponseTemplate') -> None:
        """
        Sets the view_offers_results of this AlternativeShiftJobResponse.
        Schema template for deserializing data returned from the downloadUrl. Use if type == 'ListOffers' or 'SearchOffers'

        :param view_offers_results: The view_offers_results of this AlternativeShiftJobResponse.
    ...
    def view_trades_results(self) -> 'AlternativeShiftTradesViewResponseTemplate':
        """
        Gets the view_trades_results of this AlternativeShiftJobResponse.
        Schema template for deserializing data returned from the downloadUrl. Use if type == 'ListUserTrades' or 'SearchTrades'

        :return: The view_trades_results of this AlternativeShiftJobResponse.
    ...
    def view_trades_results(self, view_trades_results: 'AlternativeShiftTradesViewResponseTemplate') -> None:
        """
        Sets the view_trades_results of this AlternativeShiftJobResponse.
        Schema template for deserializing data returned from the downloadUrl. Use if type == 'ListUserTrades' or 'SearchTrades'

        :param view_trades_results: The view_trades_results of this AlternativeShiftJobResponse.
    ...
    def bulk_update_trades_results(self) -> 'AlternativeShiftBulkUpdateTradesResponseTemplate':
        """
        Gets the bulk_update_trades_results of this AlternativeShiftJobResponse.
        Schema template for deserializing data returned from the downloadUrl. Use if type == 'BulkUpdateTrades'

        :return: The bulk_update_trades_results of this AlternativeShiftJobResponse.
    ...
    def bulk_update_trades_results(self, bulk_update_trades_results: 'AlternativeShiftBulkUpdateTradesResponseTemplate') -> None:
        """
        Sets the bulk_update_trades_results of this AlternativeShiftJobResponse.
        Schema template for deserializing data returned from the downloadUrl. Use if type == 'BulkUpdateTrades'

        :param bulk_update_trades_results: The bulk_update_trades_results of this AlternativeShiftJobResponse.
    ...
    def self_uri(self) -> str:
        """
        Gets the self_uri of this AlternativeShiftJobResponse.
        The URI for this object

        :return: The self_uri of this AlternativeShiftJobResponse.
        :rtype: str
        """
    ...
    def self_uri(self, self_uri: str) -> None:
        """
        Sets the self_uri of this AlternativeShiftJobResponse.
        The URI for this object

        :param self_uri: The self_uri of this AlternativeShiftJobResponse.
        :type: str
        """
