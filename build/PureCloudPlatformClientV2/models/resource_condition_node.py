...
if TYPE_CHECKING:
    from . import ResourceConditionValue
...
class ResourceConditionNode(object):
    ...
    @property
    def operands(self) -> List['ResourceConditionValue']:
        """
    ...
    @operands.setter
    def operands(self, operands: List['ResourceConditionValue']) -> None:
        """
    ...
    @property
    def terms(self) -> List['ResourceConditionNode']:
        """
    ...
    @terms.setter
    def terms(self, terms: List['ResourceConditionNode']) -> None:
        """
