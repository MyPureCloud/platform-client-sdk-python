...
class OutboundMessagingMessagingCampaignConfigChangeResponseRef(object):
    """
    ...
    def __init__(self):
        """
        OutboundMessagingMessagingCampaignConfigChangeResponseRef - a model defined in Swagger
