...
class OpenDataIngestionRuleVersionResponse(object):
    """
    ...
    def __init__(self) -> None:
        """
        OpenDataIngestionRuleVersionResponse - a model defined in Swagger
    ...
    def id(self) -> str:
        """
        Gets the id of this OpenDataIngestionRuleVersionResponse.
        ID of the open data ingestion rule.

        :return: The id of this OpenDataIngestionRuleVersionResponse.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id: str) -> None:
        """
        Sets the id of this OpenDataIngestionRuleVersionResponse.
        ID of the open data ingestion rule.

        :param id: The id of this OpenDataIngestionRuleVersionResponse.
        :type: str
        """
    ...
    def name(self) -> str:
        """
        Gets the name of this OpenDataIngestionRuleVersionResponse.
        The name of the data ingestion rule.

        :return: The name of this OpenDataIngestionRuleVersionResponse.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name: str) -> None:
        """
        Sets the name of this OpenDataIngestionRuleVersionResponse.
        The name of the data ingestion rule.

        :param name: The name of this OpenDataIngestionRuleVersionResponse.
        :type: str
        """
    ...
    def description(self) -> str:
        """
        Gets the description of this OpenDataIngestionRuleVersionResponse.
        A description of the data ingestion rule.

        :return: The description of this OpenDataIngestionRuleVersionResponse.
        :rtype: str
        """
    ...
    def description(self, description: str) -> None:
        """
        Sets the description of this OpenDataIngestionRuleVersionResponse.
        A description of the data ingestion rule.

        :param description: The description of this OpenDataIngestionRuleVersionResponse.
        :type: str
        """
    ...
    def date_created(self) -> datetime:
        """
        Gets the date_created of this OpenDataIngestionRuleVersionResponse.
        ...
        :return: The date_created of this OpenDataIngestionRuleVersionResponse.
        :rtype: datetime
        """
    ...
    def date_created(self, date_created: datetime) -> None:
        """
        Sets the date_created of this OpenDataIngestionRuleVersionResponse.
        Timestamp indicating when the data ingestion rule was created. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z

        :param date_created: The date_created of this OpenDataIngestionRuleVersionResponse.
        :type: datetime
        """
    ...
    def date_modified(self) -> datetime:
        """
        Gets the date_modified of this OpenDataIngestionRuleVersionResponse.
        ...
        :return: The date_modified of this OpenDataIngestionRuleVersionResponse.
        :rtype: datetime
        """
    ...
    def date_modified(self, date_modified: datetime) -> None:
        """
        Sets the date_modified of this OpenDataIngestionRuleVersionResponse.
        Timestamp indicating when the data ingestion rule was last updated. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z

        :param date_modified: The date_modified of this OpenDataIngestionRuleVersionResponse.
        :type: datetime
        """
    ...
    def ingestion_rule_info(self) -> 'MessageInfo':
        """
        Gets the ingestion_rule_info of this OpenDataIngestionRuleVersionResponse.
        The Info about ingestion rule.

        :return: The ingestion_rule_info of this OpenDataIngestionRuleVersionResponse.
        :rtype: MessageInfo
        """
    ...
    def ingestion_rule_info(self, ingestion_rule_info: 'MessageInfo') -> None:
        """
        Sets the ingestion_rule_info of this OpenDataIngestionRuleVersionResponse.
        The Info about ingestion rule.

        :param ingestion_rule_info: The ingestion_rule_info of this OpenDataIngestionRuleVersionResponse.
        :type: MessageInfo
        """
    ...
    def external_source(self) -> 'DomainEntityRef':
        """
        Gets the external_source of this OpenDataIngestionRuleVersionResponse.
        The external source associated with this open data ingestion rule, which is used when performing identity resolution

        :return: The external_source of this OpenDataIngestionRuleVersionResponse.
    ...
    def external_source(self, external_source: 'DomainEntityRef') -> None:
        """
        Sets the external_source of this OpenDataIngestionRuleVersionResponse.
        The external source associated with this open data ingestion rule, which is used when performing identity resolution

        :param external_source: The external_source of this OpenDataIngestionRuleVersionResponse.
    ...
    def self_uri(self) -> str:
        """
        Gets the self_uri of this OpenDataIngestionRuleVersionResponse.
        The URI for this object

        :return: The self_uri of this OpenDataIngestionRuleVersionResponse.
        :rtype: str
        """
    ...
    def self_uri(self, self_uri: str) -> None:
        """
        Sets the self_uri of this OpenDataIngestionRuleVersionResponse.
        The URI for this object

        :param self_uri: The self_uri of this OpenDataIngestionRuleVersionResponse.
        :type: str
        """
