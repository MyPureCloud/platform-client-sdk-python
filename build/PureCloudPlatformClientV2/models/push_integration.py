...
class PushIntegration(object):
    ...
    def __init__(self) -> None:
        """
        PushIntegration - a model defined in Swagger
    ...
    def provider(self) -> str:
        """
        Gets the provider of this PushIntegration.
        The integration provider associated with the deployment

        :return: The provider of this PushIntegration.
        :rtype: str
        """
    ...
    def provider(self, provider: str) -> None:
        """
        Sets the provider of this PushIntegration.
        The integration provider associated with the deployment

        :param provider: The provider of this PushIntegration.
        :type: str
        """
        if isinstance(provider, int):
            provider = str(provider)
        allowed_values = ["APNS", "FCM"]
