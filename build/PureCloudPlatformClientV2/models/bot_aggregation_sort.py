...
class BotAggregationSort(object):
    """
    ...
    def __init__(self) -> None:
        """
        BotAggregationSort - a model defined in Swagger
    ...
    def name(self) -> str:
        """
        Gets the name of this BotAggregationSort.
        Name of the metric used for sorting values.

        :return: The name of this BotAggregationSort.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name: str) -> None:
        """
        Sets the name of this BotAggregationSort.
        Name of the metric used for sorting values.

        :param name: The name of this BotAggregationSort.
        :type: str
        """
    ...
    def function(self) -> str:
        """
        Gets the function of this BotAggregationSort.
        Aggregation function used for the sort metric.

        :return: The function of this BotAggregationSort.
        :rtype: str
        """
    ...
    def function(self, function: str) -> None:
        """
        Sets the function of this BotAggregationSort.
        Aggregation function used for the sort metric.

        :param function: The function of this BotAggregationSort.
        :type: str
        """
