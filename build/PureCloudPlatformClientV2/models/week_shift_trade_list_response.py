...
if TYPE_CHECKING:
    from . import WeekShiftTradeResponse
...
class WeekShiftTradeListResponse(object):
    ...
    @property
    def entities(self) -> List['WeekShiftTradeResponse']:
        """
    ...
    @entities.setter
    def entities(self, entities: List['WeekShiftTradeResponse']) -> None:
        """
    ...
    def download_url(self) -> str:
        """
        Gets the download_url of this WeekShiftTradeListResponse.
        ...
        :return: The download_url of this WeekShiftTradeListResponse.
        :rtype: str
        """
    ...
    def download_url(self, download_url: str) -> None:
        """
        Sets the download_url of this WeekShiftTradeListResponse.
        URL from which to fetch results for requests with a large result set. If populated, the downloaded data will conform to the same schema as would normally be returned, excepting downloaded data will never itself contain a downloadUrl

        :param download_url: The download_url of this WeekShiftTradeListResponse.
        :type: str
        """
