...
class MoveAgentResponse(object):
    """
    ...
    def __init__(self) -> None:
        """
        MoveAgentResponse - a model defined in Swagger
    ...
    def user(self) -> 'UserReference':
        """
        Gets the user of this MoveAgentResponse.
        The user associated with the move

        :return: The user of this MoveAgentResponse.
        :rtype: UserReference
        """
        return self._user
    ...
    def user(self, user: 'UserReference') -> None:
        """
        Sets the user of this MoveAgentResponse.
        The user associated with the move

        :param user: The user of this MoveAgentResponse.
        :type: UserReference
        """
    ...
    def result(self) -> str:
        """
        Gets the result of this MoveAgentResponse.
        The result of the move

        :return: The result of this MoveAgentResponse.
        :rtype: str
        """
        return self._result
    ...
    def result(self, result: str) -> None:
        """
        Sets the result of this MoveAgentResponse.
        The result of the move

        :param result: The result of this MoveAgentResponse.
        :type: str
        """
