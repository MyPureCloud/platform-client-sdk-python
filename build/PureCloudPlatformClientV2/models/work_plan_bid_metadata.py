...
class WorkPlanBidMetadata(object):
    """
    ...
    def __init__(self) -> None:
        """
        WorkPlanBidMetadata - a model defined in Swagger
    ...
    def created_by(self) -> 'UserReference':
        """
        Gets the created_by of this WorkPlanBidMetadata.
        The user who created the associated entity

        :return: The created_by of this WorkPlanBidMetadata.
        :rtype: UserReference
        """
    ...
    def created_by(self, created_by: 'UserReference') -> None:
        """
        Sets the created_by of this WorkPlanBidMetadata.
        The user who created the associated entity

        :param created_by: The created_by of this WorkPlanBidMetadata.
        :type: UserReference
        """
    ...
    def created_date(self, created_date: datetime) -> None:
        """
        Sets the created_date of this WorkPlanBidMetadata.
        The date the entity created. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z

        :param created_date: The created_date of this WorkPlanBidMetadata.
        :type: datetime
        """
    ...
    def modified_date(self, modified_date: datetime) -> None:
        """
        Sets the modified_date of this WorkPlanBidMetadata.
        The entity last modified date. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z

        :param modified_date: The modified_date of this WorkPlanBidMetadata.
        :type: datetime
        """
