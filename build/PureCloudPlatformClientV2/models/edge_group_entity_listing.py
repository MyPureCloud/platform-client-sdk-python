...
class EdgeGroupEntityListing(object):
    ...
    @property
    def entities(self) -> List['EdgeGroup']:
        """
    ...
    @entities.setter
    def entities(self, entities: List['EdgeGroup']) -> None:
        """
    ...
    def total_number_of_entities(self) -> int:
        """
        Gets the total_number_of_entities of this EdgeGroupEntityListing.
        The total organization-wide number of entities.

        :return: The total_number_of_entities of this EdgeGroupEntityListing.
        :rtype: int
        """
    ...
    def total_number_of_entities(self, total_number_of_entities: int) -> None:
        """
        Sets the total_number_of_entities of this EdgeGroupEntityListing.
        The total organization-wide number of entities.

        :param total_number_of_entities: The total_number_of_entities of this EdgeGroupEntityListing.
        :type: int
        """
