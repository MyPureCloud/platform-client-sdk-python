...
if TYPE_CHECKING:
    from . import ConversationVideoEventTopicConversationDivisionMembership
...
class ConversationVideoEventTopicVideoConversation(object):
    ...
    def __init__(self) -> None:
        ...
        self.swagger_types = {
            ...
            'divisions': 'list[ConversationVideoEventTopicConversationDivisionMembership]'
        }
    ...
    def access_attributes(self) -> List[str]:
        """
        Gets the access_attributes of this ConversationVideoEventTopicVideoConversation.


        :return: The access_attributes of this ConversationVideoEventTopicVideoConversation.
        :rtype: list[str]
        """
    ...
    def access_attributes(self, access_attributes: List[str]) -> None:
        """
        Sets the access_attributes of this ConversationVideoEventTopicVideoConversation.


        :param access_attributes: The access_attributes of this ConversationVideoEventTopicVideoConversation.
        :type: list[str]
        """
    ...
    def inactivity_timeout(self) -> datetime:
        """
        Gets the inactivity_timeout of this ConversationVideoEventTopicVideoConversation.


        :return: The inactivity_timeout of this ConversationVideoEventTopicVideoConversation.
        :rtype: datetime
        """
    ...
    def inactivity_timeout(self, inactivity_timeout: datetime) -> None:
        """
        Sets the inactivity_timeout of this ConversationVideoEventTopicVideoConversation.


        :param inactivity_timeout: The inactivity_timeout of this ConversationVideoEventTopicVideoConversation.
        :type: datetime
        """
    ...
    @property
    def divisions(self) -> List['ConversationVideoEventTopicConversationDivisionMembership']:
        """
    ...
    @divisions.setter
    def divisions(self, divisions: List['ConversationVideoEventTopicConversationDivisionMembership']) -> None:
        """
        Sets the divisions of this ConversationVideoEventTopicVideoConversation.
