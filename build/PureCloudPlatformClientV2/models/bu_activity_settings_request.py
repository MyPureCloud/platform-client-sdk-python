...
class BuActivitySettingsRequest(object):
    """
    ...
    def __init__(self) -> None:
        """
        BuActivitySettingsRequest - a model defined in Swagger
        ...
        """
        self.swagger_types = {
            'default_activity_code_id': 'str'
        }

        self.attribute_map = {
            'default_activity_code_id': 'defaultActivityCodeId'
        }

        self._default_activity_code_id = None
    ...
    def default_activity_code_id(self) -> str:
        ...
        :rtype: str
        """
        return self._default_activity_code_id

    @default_activity_code_id.setter
    def default_activity_code_id(self, default_activity_code_id: str) -> None:
        ...
        self._default_activity_code_id = default_activity_code_id
