...
class DialerSequenceScheduleConfigChangeScheduleInterval(object):
    """
    ...
    def __init__(self) -> None:
        """
        DialerSequenceScheduleConfigChangeScheduleInterval - a model defined in Swagger
    ...
    def get_additional_properties(self) -> Dict[str, object]:
        """
        Gets the get_additional_properties of this DialerSequenceScheduleConfigChangeScheduleInterval.


        :return: The get_additional_properties of this DialerSequenceScheduleConfigChangeScheduleInterval.
        :rtype: dict(str, object)
        """
    ...
    def get_additional_properties(self, get_additional_properties: Dict[str, object]) -> None:
        """
        Sets the get_additional_properties of this DialerSequenceScheduleConfigChangeScheduleInterval.


        :param get_additional_properties: The get_additional_properties of this DialerSequenceScheduleConfigChangeScheduleInterval.
        :type: dict(str, object)
        """
