...
class JourneySegment(object):
    ...
    def name(self):
        """
        Gets the name of this JourneySegment.


        :return: The name of this JourneySegment.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this JourneySegment.


        :param name: The name of this JourneySegment.
        :type: str
        """
