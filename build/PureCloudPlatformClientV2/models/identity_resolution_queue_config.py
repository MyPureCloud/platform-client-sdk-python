...
class IdentityResolutionQueueConfig(object):
    ...
    def __init__(self) -> None:
        """
        IdentityResolutionQueueConfig - a model defined in Swagger
        ...
        self.attribute_map = {
            'call_on_behalf_of_queue': 'callOnBehalfOfQueue'
        }
    ...
    def call_on_behalf_of_queue(self, call_on_behalf_of_queue: 'IdentityResolutionConfig') -> None:
        ...
        self._call_on_behalf_of_queue = call_on_behalf_of_queue
