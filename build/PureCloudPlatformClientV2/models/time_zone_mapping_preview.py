...
class TimeZoneMappingPreview(object):
    ...
    @property
    def contacts_per_time_zone(self) -> Dict[str, int]:
        """
    ...
    def contacts_per_time_zone(self, contacts_per_time_zone: Dict[str, int]) -> None:
        """
    ...
    @property
    def contacts_mapped_using_zip_code(self) -> Dict[str, int]:
        """
    ...
    def contacts_mapped_using_zip_code(self, contacts_mapped_using_zip_code: Dict[str, int]) -> None:
        """
    ...
    @property
    def contacts_mapped_to_a_single_zone(self) -> int:
        """
    ...
    def contacts_mapped_to_a_single_zone(self, contacts_mapped_to_a_single_zone: int) -> None:
        """
    ...
    @property
    def contacts_mapped_to_a_single_zone_using_zip_code(self) -> int:
        """
    ...
    def contacts_mapped_to_a_single_zone_using_zip_code(self, contacts_mapped_to_a_single_zone_using_zip_code: int) -> None:
        """
    ...
    @property
    def contacts_mapped_to_multiple_zones(self) -> int:
        """
    ...
    def contacts_mapped_to_multiple_zones(self, contacts_mapped_to_multiple_zones: int) -> None:
        """
    ...
    @property
    def contacts_mapped_to_multiple_zones_using_zip_code(self) -> int:
        """
    ...
    def contacts_mapped_to_multiple_zones_using_zip_code(self, contacts_mapped_to_multiple_zones_using_zip_code: int) -> None:
        """
    ...
    @property
    def contacts_in_default_window(self) -> int:
        """
    ...
    def contacts_in_default_window(self, contacts_in_default_window: int) -> None:
        """
    ...
    @property
    def contact_list_size(self) -> int:
        """
    ...
    def contact_list_size(self, contact_list_size: int) -> None:
        """
