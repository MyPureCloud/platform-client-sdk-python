...
class AgentStateCountsRequest(object):
    """
    ...
    def __init__(self) -> None:
        """
        AgentStateCountsRequest - a model defined in Swagger
    ...
    def user_filter(self) -> 'AgentStateUserFilter':
        """
        Gets the user_filter of this AgentStateCountsRequest.
        Filters that target user-level data

        :return: The user_filter of this AgentStateCountsRequest.
    ...
    def user_filter(self, user_filter: 'AgentStateUserFilter') -> None:
        """
        Sets the user_filter of this AgentStateCountsRequest.
        Filters that target user-level data

        :param user_filter: The user_filter of this AgentStateCountsRequest.
    ...
    def session_filter(self) -> 'AgentStateSessionFilter':
        """
        Gets the session_filter of this AgentStateCountsRequest.
        Filters that target session-level data

        :return: The session_filter of this AgentStateCountsRequest.
    ...
    def session_filter(self, session_filter: 'AgentStateSessionFilter') -> None:
        """
        Sets the session_filter of this AgentStateCountsRequest.
        Filters that target session-level data

        :param session_filter: The session_filter of this AgentStateCountsRequest.
