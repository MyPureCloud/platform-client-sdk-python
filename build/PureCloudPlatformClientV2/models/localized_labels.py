...
class LocalizedLabels(object):
    ...
    def __init__(self) -> None:
        """
        LocalizedLabels - a model defined in Swagger
    ...
    def key(self, key: str) -> None:
        ...
        if isinstance(key, int):
            key = str(key)
        allowed_values = ["MessengerHomeHeaderTitle", "MessengerHomeHeaderSubTitle", "PushNotificationTitle", "PushNotificationBody", "MessengerLauncherButtonText"]
