...
class GoogleBusinessProfileDataIngestionRuleResponse(object):
    ...
    def ingestion_rule_info(self) -> 'MessageInfo':
        """
        Gets the ingestion_rule_info of this GoogleBusinessProfileDataIngestionRuleResponse.
        The Info about ingestion rule.

        :return: The ingestion_rule_info of this GoogleBusinessProfileDataIngestionRuleResponse.
        :rtype: MessageInfo
        """
    ...
    def ingestion_rule_info(self, ingestion_rule_info: 'MessageInfo') -> None:
        """
        Sets the ingestion_rule_info of this GoogleBusinessProfileDataIngestionRuleResponse.
        The Info about ingestion rule.

        :param ingestion_rule_info: The ingestion_rule_info of this GoogleBusinessProfileDataIngestionRuleResponse.
        :type: MessageInfo
        """
    ...
    def countries(self) -> List[str]:
        """
        Gets the countries of this GoogleBusinessProfileDataIngestionRuleResponse.
        ...
        :return: The countries of this GoogleBusinessProfileDataIngestionRuleResponse.
        :rtype: list[str]
        """
    ...
    def countries(self, countries: List[str]) -> None:
        """
        Sets the countries of this GoogleBusinessProfileDataIngestionRuleResponse.
        The countries is available only on twitter data ingestion rule. ISO 3166-1 alpha-2 country codes where Data Ingestion Rules should apply. Defaults to worldwide.

        :param countries: The countries of this GoogleBusinessProfileDataIngestionRuleResponse.
        :type: list[str]
        """
