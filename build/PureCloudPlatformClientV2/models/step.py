...
class Step(object):
    ...
    def date_created(self, date_created: datetime) -> None:
        """
        Sets the date_created of this Step.
        The Step creation date. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z

        :param date_created: The date_created of this Step.
        :type: datetime
        """
    ...
    def date_modified(self, date_modified: datetime) -> None:
        """
        Sets the date_modified of this Step.
        The Step modification date. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z

        :param date_modified: The date_modified of this Step.
        :type: datetime
        """
    ...
    def date_completed(self, date_completed: datetime) -> None:
        """
        Sets the date_completed of this Step.
        The Step completion date. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z

        :param date_completed: The date_completed of this Step.
        :type: datetime
        """
    ...
    def date_started(self, date_started: datetime) -> None:
        """
        Sets the date_started of this Step.
        The Step start date. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z

        :param date_started: The date_started of this Step.
        :type: datetime
        """
    ...
    def modified_by(self) -> 'UserReference':
        """
        Gets the modified_by of this Step.
        The ID of the User who modified the Step.

        :return: The modified_by of this Step.
        :rtype: UserReference
        """
    ...
    def modified_by(self, modified_by: 'UserReference') -> None:
        """
        Sets the modified_by of this Step.
        The ID of the User who modified the Step.

        :param modified_by: The modified_by of this Step.
        :type: UserReference
        """
    ...
    def version(self) -> int:
        """
        Gets the version of this Step.
        The version of the Step.

        :return: The version of this Step.
        :rtype: int
        """
    ...
    def version(self, version: int) -> None:
        """
        Sets the version of this Step.
        The version of the Step.

        :param version: The version of this Step.
        :type: int
        """
    ...
    def self_uri(self) -> str:
        """
        Gets the self_uri of this Step.
        The URI for this object

        :return: The self_uri of this Step.
        :rtype: str
        """
    ...
    def self_uri(self, self_uri: str) -> None:
        """
        Sets the self_uri of this Step.
        The URI for this object

        :param self_uri: The self_uri of this Step.
        :type: str
        """
