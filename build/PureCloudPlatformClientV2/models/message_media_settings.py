...
class MessageMediaSettings(object):
    ...
    def __init__(self) -> None:
        """
        MessageMediaSettings - a model defined in Swagger
    ...
    def enable_auto_answer(self) -> bool:
        """
        Gets the enable_auto_answer of this MessageMediaSettings.
        ...
        :return: The enable_auto_answer of this MessageMediaSettings.
        :rtype: bool
        """
    ...
    def enable_auto_answer(self, enable_auto_answer: bool) -> None:
        """
        Sets the enable_auto_answer of this MessageMediaSettings.
        Indicates if auto-answer is enabled for the given media type or subtype (default is false).  Subtype settings take precedence over media type settings.

        :param enable_auto_answer: The enable_auto_answer of this MessageMediaSettings.
        :type: bool
        """
    ...
    def alerting_timeout_seconds(self) -> int:
        """
        Gets the alerting_timeout_seconds of this MessageMediaSettings.
        The alerting timeout for the media type, in seconds

        :return: The alerting_timeout_seconds of this MessageMediaSettings.
        :rtype: int
        """
    ...
    def alerting_timeout_seconds(self, alerting_timeout_seconds: int) -> None:
        """
        Sets the alerting_timeout_seconds of this MessageMediaSettings.
        The alerting timeout for the media type, in seconds

        :param alerting_timeout_seconds: The alerting_timeout_seconds of this MessageMediaSettings.
        :type: int
        """
    ...
    def service_level(self) -> 'ServiceLevel':
        """
        Gets the service_level of this MessageMediaSettings.
        The targeted service level for the media type

        :return: The service_level of this MessageMediaSettings.
        :rtype: ServiceLevel
        """
    ...
    def service_level(self, service_level: 'ServiceLevel') -> None:
        """
        Sets the service_level of this MessageMediaSettings.
        The targeted service level for the media type

        :param service_level: The service_level of this MessageMediaSettings.
        :type: ServiceLevel
        """
    ...
    def auto_answer_alert_tone_seconds(self) -> float:
        """
        Gets the auto_answer_alert_tone_seconds of this MessageMediaSettings.
        How long to play the alerting tone for an auto-answer interaction

        :return: The auto_answer_alert_tone_seconds of this MessageMediaSettings.
        :rtype: float
        """
    ...
    def auto_answer_alert_tone_seconds(self, auto_answer_alert_tone_seconds: float) -> None:
        """
        Sets the auto_answer_alert_tone_seconds of this MessageMediaSettings.
        How long to play the alerting tone for an auto-answer interaction

        :param auto_answer_alert_tone_seconds: The auto_answer_alert_tone_seconds of this MessageMediaSettings.
        :type: float
        """
    ...
    def manual_answer_alert_tone_seconds(self) -> float:
        """
        Gets the manual_answer_alert_tone_seconds of this MessageMediaSettings.
        How long to play the alerting tone for a manual-answer interaction

        :return: The manual_answer_alert_tone_seconds of this MessageMediaSettings.
        :rtype: float
        """
    ...
    def manual_answer_alert_tone_seconds(self, manual_answer_alert_tone_seconds: float) -> None:
        """
        Sets the manual_answer_alert_tone_seconds of this MessageMediaSettings.
        How long to play the alerting tone for a manual-answer interaction

        :param manual_answer_alert_tone_seconds: The manual_answer_alert_tone_seconds of this MessageMediaSettings.
        :type: float
        """
