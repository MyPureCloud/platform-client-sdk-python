...
if TYPE_CHECKING:
    from . import AuditMessage
    from . import FacetInfo
...
class AuditSearchResult(object):
    ...
    @property
    def facet_info(self) -> List['FacetInfo']:
        """
    ...
    @facet_info.setter
    def facet_info(self, facet_info: List['FacetInfo']) -> None:
        """
    ...
    @property
    def audit_messages(self) -> List['AuditMessage']:
        """
    ...
    def audit_messages(self, audit_messages: List['AuditMessage']) -> None:
        """
