...
class AgentGreeting(object):
    ...
    def __init__(self) -> None:
        """
        AgentGreeting - a model defined in Swagger
    ...
    def id(self) -> str:
        """
        Gets the id of this AgentGreeting.
        The globally unique identifier for the object.

        :return: The id of this AgentGreeting.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id: str) -> None:
        """
        Sets the id of this AgentGreeting.
        The globally unique identifier for the object.

        :param id: The id of this AgentGreeting.
        :type: str
        """
    ...
    def name(self) -> str:
        """
        Gets the name of this AgentGreeting.


        :return: The name of this AgentGreeting.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name: str) -> None:
        """
        Sets the name of this AgentGreeting.


        :param name: The name of this AgentGreeting.
        :type: str
        """
    ...
    def inbound_prompt(self) -> 'Prompt':
        ...
        :rtype: Prompt
        """
        return self._inbound_prompt

    @inbound_prompt.setter
    def inbound_prompt(self, inbound_prompt: 'Prompt') -> None:
        ...
        self._inbound_prompt = inbound_prompt
    ...
    def outbound_prompt(self) -> 'Prompt':
        ...
        :rtype: Prompt
        """
        return self._outbound_prompt

    @outbound_prompt.setter
    ...
    def self_uri(self) -> str:
        """
        Gets the self_uri of this AgentGreeting.
        The URI for this object

        :return: The self_uri of this AgentGreeting.
        :rtype: str
        """
    ...
    def self_uri(self, self_uri: str) -> None:
        """
        Sets the self_uri of this AgentGreeting.
        The URI for this object

        :param self_uri: The self_uri of this AgentGreeting.
        :type: str
        """
