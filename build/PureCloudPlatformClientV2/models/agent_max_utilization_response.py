...
class AgentMaxUtilizationResponse(object):
    ...
    def __init__(self) -> None:
        """
        AgentMaxUtilizationResponse - a model defined in Swagger
    ...
    def utilization(self) -> Dict[str, 'MediaUtilization']:
        """
        Gets the utilization of this AgentMaxUtilizationResponse.
        Map of media type to utilization settings.

        :return: The utilization of this AgentMaxUtilizationResponse.
    ...
    def utilization(self, utilization: Dict[str, 'MediaUtilization']) -> None:
        """
        Sets the utilization of this AgentMaxUtilizationResponse.
        Map of media type to utilization settings.

        :param utilization: The utilization of this AgentMaxUtilizationResponse.
    ...
    def level(self) -> str:
        """
        Gets the level of this AgentMaxUtilizationResponse.


        :return: The level of this AgentMaxUtilizationResponse.
        :rtype: str
        """
        return self._level
    ...
    def level(self, level: str) -> None:
        """
        Sets the level of this AgentMaxUtilizationResponse.


        :param level: The level of this AgentMaxUtilizationResponse.
        :type: str
        """
