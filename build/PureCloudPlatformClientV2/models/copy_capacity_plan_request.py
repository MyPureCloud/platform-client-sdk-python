...
class CopyCapacityPlanRequest(object):
    """
    ...
    def __init__(self) -> None:
        """
        CopyCapacityPlanRequest - a model defined in Swagger
    ...
    def name(self) -> str:
        """
        Gets the name of this CopyCapacityPlanRequest.
        The name of the new capacity plan

        :return: The name of this CopyCapacityPlanRequest.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name: str) -> None:
        """
        Sets the name of this CopyCapacityPlanRequest.
        The name of the new capacity plan

        :param name: The name of this CopyCapacityPlanRequest.
        :type: str
        """
    ...
    def description(self) -> str:
        """
        Gets the description of this CopyCapacityPlanRequest.
        Description of the new capacity plan

        :return: The description of this CopyCapacityPlanRequest.
        :rtype: str
        """
    ...
    def description(self, description: str) -> None:
        """
        Sets the description of this CopyCapacityPlanRequest.
        Description of the new capacity plan

        :param description: The description of this CopyCapacityPlanRequest.
        :type: str
        """
    ...
    def start_business_unit_date(self) -> date:
        """
        Gets the start_business_unit_date of this CopyCapacityPlanRequest.
        ...
        :return: The start_business_unit_date of this CopyCapacityPlanRequest.
        :rtype: date
        """
    ...
    def start_business_unit_date(self, start_business_unit_date: date) -> None:
        """
        Sets the start_business_unit_date of this CopyCapacityPlanRequest.
        The start date for the capacity plan relative to the business unit time zone in yyyy-MM-dd format. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd

        :param start_business_unit_date: The start_business_unit_date of this CopyCapacityPlanRequest.
        :type: date
        """
    ...
    def end_business_unit_date(self) -> date:
        """
        Gets the end_business_unit_date of this CopyCapacityPlanRequest.
        ...
        :return: The end_business_unit_date of this CopyCapacityPlanRequest.
        :rtype: date
        """
    ...
    def end_business_unit_date(self, end_business_unit_date: date) -> None:
        """
        Sets the end_business_unit_date of this CopyCapacityPlanRequest.
        The end date for the capacity plan relative to the business unit time zone in yyyy-MM-dd format. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd

        :param end_business_unit_date: The end_business_unit_date of this CopyCapacityPlanRequest.
        :type: date
        """
    ...
    def forecast(self, forecast: 'ValueWrapperBuShortTermForecastReference') -> None:
        """
        Sets the forecast of this CopyCapacityPlanRequest.
        The selected forecast for this capacity plan. Uses forecast from original capacity plan if not specified

        :param forecast: The forecast of this CopyCapacityPlanRequest.
