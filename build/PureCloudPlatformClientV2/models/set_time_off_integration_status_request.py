...
class SetTimeOffIntegrationStatusRequest(object):
    """
    ...
    def __init__(self) -> None:
        """
        SetTimeOffIntegrationStatusRequest - a model defined in Swagger
    ...
    def integration_status(self) -> str:
        """
        Gets the integration_status of this SetTimeOffIntegrationStatusRequest.
        The integration status value for the time off request

        :return: The integration_status of this SetTimeOffIntegrationStatusRequest.
        :rtype: str
        """
    ...
    def integration_status(self, integration_status: str) -> None:
        """
        Sets the integration_status of this SetTimeOffIntegrationStatusRequest.
        The integration status value for the time off request

        :param integration_status: The integration_status of this SetTimeOffIntegrationStatusRequest.
        :type: str
        """
