...
if TYPE_CHECKING:
    from . import QueueConversationVideoEventTopicCall
    from . import QueueConversationVideoEventTopicCallback
    from . import QueueConversationVideoEventTopicChat
    from . import QueueConversationVideoEventTopicCobrowse
    from . import QueueConversationVideoEventTopicConversationRoutingData
    ...
    from . import QueueConversationVideoEventTopicWorkflow
...
class QueueConversationVideoEventTopicParticipant(object):
    ...
    def __init__(self) -> None:
        ...
        self.swagger_types = {
            ...
            'workflow': 'QueueConversationVideoEventTopicWorkflow'
        }
    ...
    def external_contact_initial_division_id(self) -> str:
        """
        Gets the external_contact_initial_division_id of this QueueConversationVideoEventTopicParticipant.
        ...
        :return: The external_contact_initial_division_id of this QueueConversationVideoEventTopicParticipant.
        :rtype: str
        """
    ...
    def external_contact_initial_division_id(self, external_contact_initial_division_id: str) -> None:
        """
        Sets the external_contact_initial_division_id of this QueueConversationVideoEventTopicParticipant.
        If this participant represents an external contact, then this will be the initial division for the external contact. This value will not be updated if the external contact is reassigned.

        :param external_contact_initial_division_id: The external_contact_initial_division_id of this QueueConversationVideoEventTopicParticipant.
        :type: str
        """
    ...
    @property
    def conversation_routing_data(self) -> 'QueueConversationVideoEventTopicConversationRoutingData':
        """
    ...
    def conversation_routing_data(self, conversation_routing_data: 'QueueConversationVideoEventTopicConversationRoutingData') -> None:
        """
    ...
    def media_roles(self) -> List[str]:
        """
        Gets the media_roles of this QueueConversationVideoEventTopicParticipant.
        List of roles this participant's media has had on the conversation, ie monitor, coach, etc.

        :return: The media_roles of this QueueConversationVideoEventTopicParticipant.
        :rtype: list[str]
        """
    ...
    def media_roles(self, media_roles: List[str]) -> None:
        """
        Sets the media_roles of this QueueConversationVideoEventTopicParticipant.
        List of roles this participant's media has had on the conversation, ie monitor, coach, etc.

        :param media_roles: The media_roles of this QueueConversationVideoEventTopicParticipant.
        :type: list[str]
        """
    ...
    @property
    def calls(self) -> List['QueueConversationVideoEventTopicCall']:
        """
    ...
    @calls.setter
    def calls(self, calls: List['QueueConversationVideoEventTopicCall']) -> None:
        """
    ...
    @property
    def callbacks(self) -> List['QueueConversationVideoEventTopicCallback']:
        """
    ...
    @callbacks.setter
    def callbacks(self, callbacks: List['QueueConversationVideoEventTopicCallback']) -> None:
        """
    ...
    @property
    def chats(self) -> List['QueueConversationVideoEventTopicChat']:
        """
    ...
    @chats.setter
    def chats(self, chats: List['QueueConversationVideoEventTopicChat']) -> None:
        """
    ...
    @property
    def cobrowsesessions(self) -> List['QueueConversationVideoEventTopicCobrowse']:
        """
    ...
    def cobrowsesessions(self, cobrowsesessions: List['QueueConversationVideoEventTopicCobrowse']) -> None:
        """
    ...
    @property
    def emails(self) -> List['QueueConversationVideoEventTopicEmail']:
        """
    ...
    @emails.setter
    def emails(self, emails: List['QueueConversationVideoEventTopicEmail']) -> None:
        """
    ...
    @property
    def messages(self) -> List['QueueConversationVideoEventTopicMessage']:
        """
    ...
    @messages.setter
    def messages(self, messages: List['QueueConversationVideoEventTopicMessage']) -> None:
        """
    ...
    @property
    def internal_messages(self) -> List['QueueConversationVideoEventTopicInternalMessage']:
        """
        Gets the internal_messages of this QueueConversationVideoEventTopicParticipant.


        :return: The internal_messages of this QueueConversationVideoEventTopicParticipant.
        :rtype: list[QueueConversationVideoEventTopicInternalMessage]
        """
        return self._internal_messages

    @internal_messages.setter
    def internal_messages(self, internal_messages: List['QueueConversationVideoEventTopicInternalMessage']) -> None:
        """
        Sets the internal_messages of this QueueConversationVideoEventTopicParticipant.


        :param internal_messages: The internal_messages of this QueueConversationVideoEventTopicParticipant.
        :type: list[QueueConversationVideoEventTopicInternalMessage]
        """
    ...
    @screenshares.setter
    def screenshares(self, screenshares: List['QueueConversationVideoEventTopicScreenShare']) -> None:
        """
    ...
    @property
    def social_expressions(self) -> List['QueueConversationVideoEventTopicSocialExpression']:
        """
    ...
    def social_expressions(self, social_expressions: List['QueueConversationVideoEventTopicSocialExpression']) -> None:
        """
    ...
    @property
    def videos(self) -> List['QueueConversationVideoEventTopicVideo']:
        """
    ...
    @videos.setter
    def videos(self, videos: List['QueueConversationVideoEventTopicVideo']) -> None:
        """
    ...
    @property
    def workflow(self) -> 'QueueConversationVideoEventTopicWorkflow':
        """
        Gets the workflow of this QueueConversationVideoEventTopicParticipant.


        :return: The workflow of this QueueConversationVideoEventTopicParticipant.
        :rtype: QueueConversationVideoEventTopicWorkflow
        """
        return self._workflow

    @workflow.setter
    def workflow(self, workflow: 'QueueConversationVideoEventTopicWorkflow') -> None:
        """
        Sets the workflow of this QueueConversationVideoEventTopicParticipant.


        :param workflow: The workflow of this QueueConversationVideoEventTopicParticipant.
