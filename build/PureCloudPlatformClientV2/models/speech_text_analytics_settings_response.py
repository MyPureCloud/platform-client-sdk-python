...
class SpeechTextAnalyticsSettingsResponse(object):
    """
    ...
    def __init__(self) -> None:
        """
        SpeechTextAnalyticsSettingsResponse - a model defined in Swagger
    ...
    def default_program(self) -> 'AddressableEntityRef':
        """
        Gets the default_program of this SpeechTextAnalyticsSettingsResponse.
        Setting to choose name for the default program for topic detection

        :return: The default_program of this SpeechTextAnalyticsSettingsResponse.
        :rtype: AddressableEntityRef
        """
        return self._default_program

    @default_program.setter
    def default_program(self, default_program: 'AddressableEntityRef') -> None:
        """
        Sets the default_program of this SpeechTextAnalyticsSettingsResponse.
        Setting to choose name for the default program for topic detection

        :param default_program: The default_program of this SpeechTextAnalyticsSettingsResponse.
    ...
    def expected_dialects(self) -> List[str]:
        """
        Gets the expected_dialects of this SpeechTextAnalyticsSettingsResponse.
        Setting to choose expected dialects

        :return: The expected_dialects of this SpeechTextAnalyticsSettingsResponse.
        :rtype: list[str]
        """
    ...
    def expected_dialects(self, expected_dialects: List[str]) -> None:
        """
        Sets the expected_dialects of this SpeechTextAnalyticsSettingsResponse.
        Setting to choose expected dialects

        :param expected_dialects: The expected_dialects of this SpeechTextAnalyticsSettingsResponse.
        :type: list[str]
        """
    ...
    def agent_empathy_enabled(self) -> bool:
        """
        Gets the agent_empathy_enabled of this SpeechTextAnalyticsSettingsResponse.
        Setting to enable/disable Agent Empathy setting

        :return: The agent_empathy_enabled of this SpeechTextAnalyticsSettingsResponse.
        :rtype: bool
        """
    ...
    def agent_empathy_enabled(self, agent_empathy_enabled: bool) -> None:
        """
        Sets the agent_empathy_enabled of this SpeechTextAnalyticsSettingsResponse.
        Setting to enable/disable Agent Empathy setting

        :param agent_empathy_enabled: The agent_empathy_enabled of this SpeechTextAnalyticsSettingsResponse.
        :type: bool
        """
