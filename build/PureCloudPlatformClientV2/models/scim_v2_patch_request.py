...
if TYPE_CHECKING:
    from . import ScimV2PatchOperation

class ScimV2PatchRequest(object):
    """
    ...
    def __init__(self) -> None:
        """
        ScimV2PatchRequest - a model defined in Swagger
        ...
        self.swagger_types = {
            'schemas': 'list[str]',
            'operations': 'list[ScimV2PatchOperation]'
        }
    ...
    @property
    def operations(self) -> List['ScimV2PatchOperation']:
        """
    ...
    @operations.setter
    def operations(self, operations: List['ScimV2PatchOperation']) -> None:
        """
