...
class DataTableRowEntityListing(object):
    """
    ...
    def __init__(self) -> None:
        """
        DataTableRowEntityListing - a model defined in Swagger
    ...
    def entities(self) -> List[Dict[str, object]]:
        """
        Gets the entities of this DataTableRowEntityListing.


        :return: The entities of this DataTableRowEntityListing.
        :rtype: list[dict(str, object)]
        """
        return self._entities

    @entities.setter
    def entities(self, entities: List[Dict[str, object]]) -> None:
        """
        Sets the entities of this DataTableRowEntityListing.


        :param entities: The entities of this DataTableRowEntityListing.
    ...
    def page_size(self) -> int:
        """
        Gets the page_size of this DataTableRowEntityListing.


        :return: The page_size of this DataTableRowEntityListing.
        :rtype: int
        """
    ...
    def page_size(self, page_size: int) -> None:
        """
        Sets the page_size of this DataTableRowEntityListing.


        :param page_size: The page_size of this DataTableRowEntityListing.
        :type: int
        """
    ...
    def page_number(self) -> int:
        """
        Gets the page_number of this DataTableRowEntityListing.


        :return: The page_number of this DataTableRowEntityListing.
        :rtype: int
        """
    ...
    def page_number(self, page_number: int) -> None:
        """
        Sets the page_number of this DataTableRowEntityListing.


        :param page_number: The page_number of this DataTableRowEntityListing.
        :type: int
        """
    ...
    def total(self) -> int:
        """
        Gets the total of this DataTableRowEntityListing.


        :return: The total of this DataTableRowEntityListing.
        :rtype: int
        """
        return self._total
    ...
    def total(self, total: int) -> None:
        """
        Sets the total of this DataTableRowEntityListing.


        :param total: The total of this DataTableRowEntityListing.
        :type: int
        """
    ...
    def page_count(self) -> int:
        """
        Gets the page_count of this DataTableRowEntityListing.


        :return: The page_count of this DataTableRowEntityListing.
        :rtype: int
        """
    ...
    def page_count(self, page_count: int) -> None:
        """
        Sets the page_count of this DataTableRowEntityListing.


        :param page_count: The page_count of this DataTableRowEntityListing.
        :type: int
        """
