...
class QueueConversationCallEventTopicErrorBody(object):
    ...
    @property
    def details(self) -> List['QueueConversationCallEventTopicDetail']:
        """
    ...
    @details.setter
    def details(self, details: List['QueueConversationCallEventTopicDetail']) -> None:
        """
    ...
    @property
    def errors(self) -> List['QueueConversationCallEventTopicErrorBody']:
        """
    ...
    @errors.setter
    def errors(self, errors: List['QueueConversationCallEventTopicErrorBody']) -> None:
        """
