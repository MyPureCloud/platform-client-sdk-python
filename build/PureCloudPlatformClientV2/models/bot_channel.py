...
class BotChannel(object):
    ...
    def __init__(self) -> None:
        """
        BotChannel - a model defined in Swagger
    ...
    def input_modes(self) -> List[str]:
        """
        Gets the input_modes of this BotChannel.
        The input modes for the channel.

        :return: The input_modes of this BotChannel.
        :rtype: list[str]
        """
    ...
    def input_modes(self, input_modes: List[str]) -> None:
        """
        Sets the input_modes of this BotChannel.
        The input modes for the channel.

        :param input_modes: The input_modes of this BotChannel.
        :type: list[str]
        """
    ...
    def output_modes(self) -> List[str]:
        """
        Gets the output_modes of this BotChannel.
        The output modes for the channel.

        :return: The output_modes of this BotChannel.
        :rtype: list[str]
        """
    ...
    def output_modes(self, output_modes: List[str]) -> None:
        """
        Sets the output_modes of this BotChannel.
        The output modes for the channel.

        :param output_modes: The output_modes of this BotChannel.
        :type: list[str]
        """
    ...
    def user_agent(self) -> 'TextBotUserAgent':
        """
        Gets the user_agent of this BotChannel.
        Information about the end user agent calling the bot flow.

        :return: The user_agent of this BotChannel.
    ...
    def user_agent(self, user_agent: 'TextBotUserAgent') -> None:
        """
        Sets the user_agent of this BotChannel.
        Information about the end user agent calling the bot flow.

        :param user_agent: The user_agent of this BotChannel.
