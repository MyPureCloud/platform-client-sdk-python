...
class WfmBulkShiftTradeStateUpdateNotificationTopicWfmVersionedEntityMetadata(object):
    ...
    @property
    def modified_by(self) -> 'WfmBulkShiftTradeStateUpdateNotificationTopicUserReference':
        """
    ...
    @modified_by.setter
    def modified_by(self, modified_by: 'WfmBulkShiftTradeStateUpdateNotificationTopicUserReference') -> None:
        """
