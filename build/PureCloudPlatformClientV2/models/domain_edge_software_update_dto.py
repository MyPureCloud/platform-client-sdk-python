...
if TYPE_CHECKING:
    from . import DomainEdgeSoftwareVersionDto
...
class DomainEdgeSoftwareUpdateDto(object):
    ...
    @property
    def version(self) -> 'DomainEdgeSoftwareVersionDto':
        """
    ...
    @version.setter
    def version(self, version: 'DomainEdgeSoftwareVersionDto') -> None:
        """
    ...
    @property
    def max_download_rate(self) -> int:
        """
    ...
    def max_download_rate(self, max_download_rate: int) -> None:
        """
    ...
    @property
    def download_start_time(self) -> datetime:
        """
    ...
    def download_start_time(self, download_start_time: datetime) -> None:
        """
    ...
    @property
    def execute_start_time(self) -> datetime:
        """
    ...
    def execute_start_time(self, execute_start_time: datetime) -> None:
        """
    ...
    @property
    def execute_stop_time(self) -> datetime:
        """
    ...
    def execute_stop_time(self, execute_stop_time: datetime) -> None:
        """
    ...
    def execute_on_idle(self, execute_on_idle: bool) -> None:
        """
    ...
    @property
    def call_draining_wait_time_seconds(self) -> int:
        """
    ...
    def call_draining_wait_time_seconds(self, call_draining_wait_time_seconds: int) -> None:
        """
