...
class DocumentVariation(object):
    """
    ...
    def __init__(self) -> None:
        """
        DocumentVariation - a model defined in Swagger
    ...
    def id(self) -> str:
        """
        Gets the id of this DocumentVariation.
        The globally unique identifier for the variation.

        :return: The id of this DocumentVariation.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id: str) -> None:
        """
        Sets the id of this DocumentVariation.
        The globally unique identifier for the variation.

        :param id: The id of this DocumentVariation.
        :type: str
        """
    ...
    def date_created(self) -> datetime:
        """
        Gets the date_created of this DocumentVariation.
        ...
        :return: The date_created of this DocumentVariation.
        :rtype: datetime
        """
    ...
    def date_created(self, date_created: datetime) -> None:
        """
        Sets the date_created of this DocumentVariation.
        The creation date-time for the document variation. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z

        :param date_created: The date_created of this DocumentVariation.
        :type: datetime
        """
    ...
    def date_modified(self) -> datetime:
        """
        Gets the date_modified of this DocumentVariation.
        ...
        :return: The date_modified of this DocumentVariation.
        :rtype: datetime
        """
    ...
    def date_modified(self, date_modified: datetime) -> None:
        """
        Sets the date_modified of this DocumentVariation.
        The last modification date-time for the document variation. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z

        :param date_modified: The date_modified of this DocumentVariation.
        :type: datetime
        """
    ...
    def document_version(self) -> 'AddressableEntityRef':
        """
        Gets the document_version of this DocumentVariation.
        The version of the document.

        :return: The document_version of this DocumentVariation.
    ...
    def document_version(self, document_version: 'AddressableEntityRef') -> None:
        """
        Sets the document_version of this DocumentVariation.
        The version of the document.

        :param document_version: The document_version of this DocumentVariation.
    ...
    def contexts(self) -> List['DocumentVariationContext']:
        """
        Gets the contexts of this DocumentVariation.
        The context values associated with the variation.

        :return: The contexts of this DocumentVariation.
    ...
    def contexts(self, contexts: List['DocumentVariationContext']) -> None:
        """
        Sets the contexts of this DocumentVariation.
        The context values associated with the variation.

        :param contexts: The contexts of this DocumentVariation.
    ...
    def document(self) -> 'KnowledgeDocumentReference':
        """
        Gets the document of this DocumentVariation.
        The reference to document to which the variation is associated.

        :return: The document of this DocumentVariation.
    ...
    def document(self, document: 'KnowledgeDocumentReference') -> None:
        """
        Sets the document of this DocumentVariation.
        The reference to document to which the variation is associated.

        :param document: The document of this DocumentVariation.
    ...
    def self_uri(self) -> str:
        """
        Gets the self_uri of this DocumentVariation.
        The URI for this object

        :return: The self_uri of this DocumentVariation.
        :rtype: str
        """
    ...
    def self_uri(self, self_uri: str) -> None:
        """
        Sets the self_uri of this DocumentVariation.
        The URI for this object

        :param self_uri: The self_uri of this DocumentVariation.
        :type: str
        """
