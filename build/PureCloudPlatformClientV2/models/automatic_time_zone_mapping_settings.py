...
if TYPE_CHECKING:
    from . import CallableWindow

class AutomaticTimeZoneMappingSettings(object):
    """
    ...
    def __init__(self) -> None:
        """
        AutomaticTimeZoneMappingSettings - a model defined in Swagger
    ...
    @property
    def callable_windows(self) -> List['CallableWindow']:
        """
        Gets the callable_windows of this AutomaticTimeZoneMappingSettings.
        The time intervals to use for automatic time zone mapping.

        :return: The callable_windows of this AutomaticTimeZoneMappingSettings.
        :rtype: list[CallableWindow]
        """
        return self._callable_windows

    @callable_windows.setter
    def callable_windows(self, callable_windows: List['CallableWindow']) -> None:
        """
        Sets the callable_windows of this AutomaticTimeZoneMappingSettings.
        The time intervals to use for automatic time zone mapping.

        :param callable_windows: The callable_windows of this AutomaticTimeZoneMappingSettings.
    ...
    def supported_countries(self, supported_countries: List[str]) -> None:
        """
