...
class ConversationAccessAttributesUpdate(object):
    """
    ...
    def __init__(self) -> None:
        """
        ConversationAccessAttributesUpdate - a model defined in Swagger
    ...
    def access_attributes(self) -> List[str]:
        """
        Gets the access_attributes of this ConversationAccessAttributesUpdate.
        ...
        :return: The access_attributes of this ConversationAccessAttributesUpdate.
        :rtype: list[str]
        """
    ...
    def access_attributes(self, access_attributes: List[str]) -> None:
        """
        Sets the access_attributes of this ConversationAccessAttributesUpdate.
        The attributes that define which users may access a conversation. Values must be non-null, non-blank, and contain only alphanumeric characters, hyphens, and underscores.

        :param access_attributes: The access_attributes of this ConversationAccessAttributesUpdate.
        :type: list[str]
        """
