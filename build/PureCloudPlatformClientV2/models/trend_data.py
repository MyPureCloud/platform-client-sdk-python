...
class TrendData(object):
    ...
    def __init__(self) -> None:
        """
        TrendData - a model defined in Swagger
    ...
    def date_start_workday(self) -> date:
        """
        Gets the date_start_workday of this TrendData.
        Start workday used as the date range. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd

        :return: The date_start_workday of this TrendData.
        :rtype: date
        """
    ...
    def date_start_workday(self, date_start_workday: date) -> None:
        """
        Sets the date_start_workday of this TrendData.
        Start workday used as the date range. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd

        :param date_start_workday: The date_start_workday of this TrendData.
        :type: date
        """
    ...
    def date_end_workday(self) -> date:
        """
        Gets the date_end_workday of this TrendData.
        End workday used as the date range. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd

        :return: The date_end_workday of this TrendData.
        :rtype: date
        """
    ...
    def date_end_workday(self, date_end_workday: date) -> None:
        """
        Sets the date_end_workday of this TrendData.
        End workday used as the date range. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd

        :param date_end_workday: The date_end_workday of this TrendData.
        :type: date
        """
    ...
    def percent_of_goal(self) -> float:
        """
        Gets the percent_of_goal of this TrendData.
        Percent of goal

        :return: The percent_of_goal of this TrendData.
        :rtype: float
        """
    ...
    def percent_of_goal(self, percent_of_goal: float) -> None:
        """
        Sets the percent_of_goal of this TrendData.
        Percent of goal

        :param percent_of_goal: The percent_of_goal of this TrendData.
        :type: float
        """
