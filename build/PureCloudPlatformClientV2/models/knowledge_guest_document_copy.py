...
class KnowledgeGuestDocumentCopy(object):
    """
    ...
    def __init__(self) -> None:
        """
        KnowledgeGuestDocumentCopy - a model defined in Swagger
    ...
    def document_variation_id(self) -> str:
        """
        Gets the document_variation_id of this KnowledgeGuestDocumentCopy.
        The variation of the document whose content was copied.

        :return: The document_variation_id of this KnowledgeGuestDocumentCopy.
        :rtype: str
        """
    ...
    def document_variation_id(self, document_variation_id: str) -> None:
        """
        Sets the document_variation_id of this KnowledgeGuestDocumentCopy.
        The variation of the document whose content was copied.

        :param document_variation_id: The document_variation_id of this KnowledgeGuestDocumentCopy.
        :type: str
        """
    ...
    def document_version_id(self) -> str:
        """
        Gets the document_version_id of this KnowledgeGuestDocumentCopy.
        The version of the document whose content was copied.

        :return: The document_version_id of this KnowledgeGuestDocumentCopy.
        :rtype: str
        """
    ...
    def document_version_id(self, document_version_id: str) -> None:
        """
        Sets the document_version_id of this KnowledgeGuestDocumentCopy.
        The version of the document whose content was copied.

        :param document_version_id: The document_version_id of this KnowledgeGuestDocumentCopy.
        :type: str
        """
    ...
    def search_id(self) -> str:
        """
        Gets the search_id of this KnowledgeGuestDocumentCopy.
        The search that surfaced the document whose content was copied.

        :return: The search_id of this KnowledgeGuestDocumentCopy.
        :rtype: str
        """
    ...
    def search_id(self, search_id: str) -> None:
        """
        Sets the search_id of this KnowledgeGuestDocumentCopy.
        The search that surfaced the document whose content was copied.

        :param search_id: The search_id of this KnowledgeGuestDocumentCopy.
        :type: str
        """
    ...
    def query_type(self) -> str:
        """
        Gets the query_type of this KnowledgeGuestDocumentCopy.
        The type of the query that surfaced the document.

        :return: The query_type of this KnowledgeGuestDocumentCopy.
        :rtype: str
        """
    ...
    def query_type(self, query_type: str) -> None:
        """
        Sets the query_type of this KnowledgeGuestDocumentCopy.
        The type of the query that surfaced the document.

        :param query_type: The query_type of this KnowledgeGuestDocumentCopy.
        :type: str
        """
    ...
    def session_id(self) -> str:
        """
        Gets the session_id of this KnowledgeGuestDocumentCopy.
        Knowledge session ID.

        :return: The session_id of this KnowledgeGuestDocumentCopy.
        :rtype: str
        """
    ...
    def session_id(self, session_id: str) -> None:
        """
        Sets the session_id of this KnowledgeGuestDocumentCopy.
        Knowledge session ID.

        :param session_id: The session_id of this KnowledgeGuestDocumentCopy.
        :type: str
        """
    ...
    def application(self) -> 'KnowledgeGuestSearchClientApplication':
        """
        Gets the application of this KnowledgeGuestDocumentCopy.
        The client application in which the document content was copied.

        :return: The application of this KnowledgeGuestDocumentCopy.
    ...
    def application(self, application: 'KnowledgeGuestSearchClientApplication') -> None:
        """
        Sets the application of this KnowledgeGuestDocumentCopy.
        The client application in which the document content was copied.

        :param application: The application of this KnowledgeGuestDocumentCopy.
