...
class DecisionTableOutputColumnRequest(object):
    """
    ...
    def __init__(self) -> None:
        """
        DecisionTableOutputColumnRequest - a model defined in Swagger
    ...
    def defaults_to(self) -> 'DecisionTableColumnDefaultRowValue':
        """
        Gets the defaults_to of this DecisionTableOutputColumnRequest.
        The default row value for this column that will be used for an output value where no value  is provided by a row.

        :return: The defaults_to of this DecisionTableOutputColumnRequest.
    ...
    def defaults_to(self, defaults_to: 'DecisionTableColumnDefaultRowValue') -> None:
        """
        Sets the defaults_to of this DecisionTableOutputColumnRequest.
        The default row value for this column that will be used for an output value where no value  is provided by a row.

        :param defaults_to: The defaults_to of this DecisionTableOutputColumnRequest.
    ...
    def value(self) -> 'OutputValue':
        """
        Gets the value of this DecisionTableOutputColumnRequest.
        The output data of this column that will be provided by each row.

        :return: The value of this DecisionTableOutputColumnRequest.
        :rtype: OutputValue
        """
        return self._value
    ...
    def value(self, value: 'OutputValue') -> None:
        """
        Sets the value of this DecisionTableOutputColumnRequest.
        The output data of this column that will be provided by each row.

        :param value: The value of this DecisionTableOutputColumnRequest.
        :type: OutputValue
        """
