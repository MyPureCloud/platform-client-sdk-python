...
class PutDecisionTableRowRequest(object):
    """
    ...
    def __init__(self) -> None:
        """
        PutDecisionTableRowRequest - a model defined in Swagger
    ...
    def inputs(self) -> Dict[str, 'DecisionTableRowParameterValue']:
        """
        Gets the inputs of this PutDecisionTableRowRequest.
        ...
        :return: The inputs of this PutDecisionTableRowRequest.
    ...
    def inputs(self, inputs: Dict[str, 'DecisionTableRowParameterValue']) -> None:
        """
        Sets the inputs of this PutDecisionTableRowRequest.
        The full updated input values of the row. The key for this map is the column ID the row value relates. Column IDs are available from the decision table entity

        :param inputs: The inputs of this PutDecisionTableRowRequest.
    ...
    def outputs(self) -> Dict[str, 'DecisionTableRowParameterValue']:
        """
        Gets the outputs of this PutDecisionTableRowRequest.
        ...
        :return: The outputs of this PutDecisionTableRowRequest.
        :rtype: dict(str, DecisionTableRowParameterValue)
        """
    ...
    def outputs(self, outputs: Dict[str, 'DecisionTableRowParameterValue']) -> None:
        """
        Sets the outputs of this PutDecisionTableRowRequest.
        The full updated output values of the row. The key for this map is the column ID the row value relates. Column IDs are available from the decision table entity

        :param outputs: The outputs of this PutDecisionTableRowRequest.
        :type: dict(str, DecisionTableRowParameterValue)
        """
