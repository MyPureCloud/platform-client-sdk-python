...
class DialerContactlistConfigChangeImportStatus(object):
    ...
    def get_additional_properties(self) -> Dict[str, object]:
        """
        Gets the get_additional_properties of this DialerContactlistConfigChangeImportStatus.


        :return: The get_additional_properties of this DialerContactlistConfigChangeImportStatus.
        :rtype: dict(str, object)
        """
    ...
    def get_additional_properties(self, get_additional_properties: Dict[str, object]) -> None:
        """
        Sets the get_additional_properties of this DialerContactlistConfigChangeImportStatus.


        :param get_additional_properties: The get_additional_properties of this DialerContactlistConfigChangeImportStatus.
        :type: dict(str, object)
        """
