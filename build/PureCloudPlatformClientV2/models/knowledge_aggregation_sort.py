...
class KnowledgeAggregationSort(object):
    """
    ...
    def __init__(self) -> None:
        """
        KnowledgeAggregationSort - a model defined in Swagger
    ...
    def name(self) -> str:
        """
        Gets the name of this KnowledgeAggregationSort.
        Name of the metric used for sorting values.

        :return: The name of this KnowledgeAggregationSort.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name: str) -> None:
        """
        Sets the name of this KnowledgeAggregationSort.
        Name of the metric used for sorting values.

        :param name: The name of this KnowledgeAggregationSort.
        :type: str
        """
    ...
    def function(self) -> str:
        """
        Gets the function of this KnowledgeAggregationSort.
        Aggregation function used for the sort metric.

        :return: The function of this KnowledgeAggregationSort.
        :rtype: str
        """
    ...
    def function(self, function: str) -> None:
        """
        Sets the function of this KnowledgeAggregationSort.
        Aggregation function used for the sort metric.

        :param function: The function of this KnowledgeAggregationSort.
        :type: str
        """
