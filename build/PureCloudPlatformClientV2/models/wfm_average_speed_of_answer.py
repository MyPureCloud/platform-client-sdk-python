...
class WfmAverageSpeedOfAnswer(object):
    """
    ...
    def __init__(self):
        """
        WfmAverageSpeedOfAnswer - a model defined in Swagger
    ...
    def seconds(self):
        """
        Gets the seconds of this WfmAverageSpeedOfAnswer.
        The target average speed of answer (ASA) in seconds. Required if include == true

        :return: The seconds of this WfmAverageSpeedOfAnswer.
        :rtype: int
        """
    ...
    def seconds(self, seconds):
        """
        Sets the seconds of this WfmAverageSpeedOfAnswer.
        The target average speed of answer (ASA) in seconds. Required if include == true

        :param seconds: The seconds of this WfmAverageSpeedOfAnswer.
        :type: int
        """
