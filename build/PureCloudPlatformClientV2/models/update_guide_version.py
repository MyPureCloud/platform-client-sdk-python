...
class UpdateGuideVersion(object):
    ...
    def knowledge_settings(self) -> 'AuthoringKnowledgeSettings':
        """
        Gets the knowledge_settings of this UpdateGuideVersion.
        The knowledge settings associated with this version of the guide.

        :return: The knowledge_settings of this UpdateGuideVersion.
    ...
    def knowledge_settings(self, knowledge_settings: 'AuthoringKnowledgeSettings') -> None:
        """
        Sets the knowledge_settings of this UpdateGuideVersion.
        The knowledge settings associated with this version of the guide.

        :param knowledge_settings: The knowledge_settings of this UpdateGuideVersion.
