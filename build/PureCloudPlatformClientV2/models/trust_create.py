...
class TrustCreate(object):
    ...
    @property
    def users(self) -> List['TrustMemberCreate']:
        """
    ...
    @users.setter
    def users(self, users: List['TrustMemberCreate']) -> None:
        """
    ...
    @property
    def groups(self) -> List['TrustMemberCreate']:
        """
    ...
    @groups.setter
    def groups(self, groups: List['TrustMemberCreate']) -> None:
        """
