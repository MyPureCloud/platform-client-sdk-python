...
class AgentCopilotAggregationSort(object):
    """
    ...
    def __init__(self) -> None:
        """
        AgentCopilotAggregationSort - a model defined in Swagger
    ...
    def name(self) -> str:
        """
        Gets the name of this AgentCopilotAggregationSort.
        Name of the metric used for sorting values.

        :return: The name of this AgentCopilotAggregationSort.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name: str) -> None:
        """
        Sets the name of this AgentCopilotAggregationSort.
        Name of the metric used for sorting values.

        :param name: The name of this AgentCopilotAggregationSort.
        :type: str
        """
    ...
    def function(self) -> str:
        """
        Gets the function of this AgentCopilotAggregationSort.
        Aggregation function used for the sort metric.

        :return: The function of this AgentCopilotAggregationSort.
        :rtype: str
        """
    ...
    def function(self, function: str) -> None:
        """
        Sets the function of this AgentCopilotAggregationSort.
        Aggregation function used for the sort metric.

        :param function: The function of this AgentCopilotAggregationSort.
        :type: str
        """
