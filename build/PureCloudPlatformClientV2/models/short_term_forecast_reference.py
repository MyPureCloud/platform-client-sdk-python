...
class ShortTermForecastReference(object):
    """
    ...
    def __init__(self):
        """
        ShortTermForecastReference - a model defined in Swagger
    ...
    def week_date(self):
        """
        Gets the week_date of this ShortTermForecastReference.
        The weekDate of the short term forecast in yyyy-MM-dd format

        :return: The week_date of this ShortTermForecastReference.
        :rtype: str
        """
    ...
    def week_date(self, week_date):
        """
        Sets the week_date of this ShortTermForecastReference.
        The weekDate of the short term forecast in yyyy-MM-dd format

        :param week_date: The week_date of this ShortTermForecastReference.
        :type: str
        """
    ...
    def description(self):
        """
        Gets the description of this ShortTermForecastReference.
        The description of the short term forecast

        :return: The description of this ShortTermForecastReference.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this ShortTermForecastReference.
        The description of the short term forecast

        :param description: The description of this ShortTermForecastReference.
        :type: str
        """
