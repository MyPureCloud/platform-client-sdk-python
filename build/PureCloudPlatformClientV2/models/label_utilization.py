...
class LabelUtilization(object):
    ...
    def __init__(self) -> None:
        """
        LabelUtilization - a model defined in Swagger
    ...
    def maximum_capacity(self) -> int:
        """
        Gets the maximum_capacity of this LabelUtilization.
        Defines the maximum number of interactions with this label that an agent can handle at one time.

        :return: The maximum_capacity of this LabelUtilization.
        :rtype: int
        """
    ...
    def maximum_capacity(self, maximum_capacity: int) -> None:
        """
        Sets the maximum_capacity of this LabelUtilization.
        Defines the maximum number of interactions with this label that an agent can handle at one time.

        :param maximum_capacity: The maximum_capacity of this LabelUtilization.
        :type: int
        """
