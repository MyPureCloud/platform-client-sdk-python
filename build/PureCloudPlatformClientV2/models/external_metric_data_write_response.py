...
if TYPE_CHECKING:
    from . import ExternalMetricDataProcessedItem
    from . import ExternalMetricDataUnprocessedItem
...
class ExternalMetricDataWriteResponse(object):
    ...
    @property
    def processed_entities(self) -> List['ExternalMetricDataProcessedItem']:
        """
    ...
    def processed_entities(self, processed_entities: List['ExternalMetricDataProcessedItem']) -> None:
        """
    ...
    @property
    def unprocessed_entities(self) -> List['ExternalMetricDataUnprocessedItem']:
        """
    ...
    def unprocessed_entities(self, unprocessed_entities: List['ExternalMetricDataUnprocessedItem']) -> None:
        """
