...
class PredictedAnswer(object):
    ...
    def __init__(self) -> None:
        """
        PredictedAnswer - a model defined in Swagger
    ...
    def answer_id(self) -> str:
        """
        Gets the answer_id of this PredictedAnswer.
        The unique identifier of the suggested predicted answer.

        :return: The answer_id of this PredictedAnswer.
        :rtype: str
        """
    ...
    def answer_id(self, answer_id: str) -> None:
        """
        Sets the answer_id of this PredictedAnswer.
        The unique identifier of the suggested predicted answer.

        :param answer_id: The answer_id of this PredictedAnswer.
        :type: str
        """
    ...
    def explanation(self) -> str:
        """
        Gets the explanation of this PredictedAnswer.
        An explanation providing the reasoning behind the suggested answer.

        :return: The explanation of this PredictedAnswer.
        :rtype: str
        """
    ...
    def explanation(self, explanation: str) -> None:
        """
        Sets the explanation of this PredictedAnswer.
        An explanation providing the reasoning behind the suggested answer.

        :param explanation: The explanation of this PredictedAnswer.
        :type: str
        """
    ...
    def failure_type(self) -> str:
        """
        Gets the failure_type of this PredictedAnswer.
        Describes the type of error associated with the predicted answer.

        :return: The failure_type of this PredictedAnswer.
        :rtype: str
        """
    ...
    def failure_type(self, failure_type: str) -> None:
        """
        Sets the failure_type of this PredictedAnswer.
        Describes the type of error associated with the predicted answer.

        :param failure_type: The failure_type of this PredictedAnswer.
        :type: str
        """
