...
class AuditLogMessage(object):
    ...
    def entity_type(self, entity_type):
        ...
        :type: str
        """
        allowed_values = ["AccessToken", "AttemptLimits", "AuthOrganization", "AuthUser", "BulkActions", "Calibration", "CallableTimeSet", "CallAnalysisResponseSet", "Campaign", "CampaignRule", "CampaignSchedule", "ChangeRequest", "ClickstreamSettings", "Configuration", "ConfigurationVersion", "ContactList", "ContactListFilter", "Deployment", "DashboardSettings", "DependencyTrackingBuild", "DID", "DIDPool", "DNCList", "Document", "Edge", "EdgeGroup", "EmergencyGroup", "Evaluation", "EvaluationForm", "EventType", "Exports", "Extension", "ExtensionPool", "ExternalMetricDefinition", "Feedback", "Flow", "FlowMilestone", "FlowOutcome", "Forecast", "InsightSettings", "Integration", "IVR", "Line", "LineBase", "MaxOrgRoutingUtilizationCapacity", "MessagingCampaign", "NumberPlan", "OAuthClient", "OAuthClientAuthorization", "OrganizationAuthorizationTrust", "OrganizationAuthorizationUserTrust", "OrganizationSettings", "OrphanedRecording", "OutboundRoute", "Outcome", "Phone", "PhoneBase", "Policy", "Predictor", "Program", "Prompt", "PromptResource", "Queue", "Recording", "RecordingAnnotation", "RecordingSettings", "Response", "Role", "RoutingTranscriptionSettings", "RuleSet", "Schedule", "ScheduledExports", "ScheduleGroup", "ScreenRecording", "Segment", "SentimentFeedback", "Sequence", "SequenceSchedule", "SessionType", "Site", "SpeechTextAnalyticsSettings", "Survey", "SurveyForm", "Team", "Topic", "TranscriptionSettings", "Trigger", "Trunk", "TrunkBase", "UserPresence", "VoicemailPolicy", "VoicemailUserPolicy", "Webhook", "WorkPlan", "Workspace", "WrapupCode", "WrapUpCodeMapping", "ConversationPhoneNumber", "ConversationRecipient", "ConversationAccount", "ConversationDefaultSupportedContent", "ConversationThreadingWindow"]
