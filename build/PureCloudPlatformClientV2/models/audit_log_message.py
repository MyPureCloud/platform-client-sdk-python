...
class AuditLogMessage(object):
    ...
    def entity_type(self, entity_type):
        ...
        :type: str
        """
        allowed_values = ["AccessToken", "Annotation", "Appointment", "AttemptLimits", "AuthOrganization", "AuthUser", "Bulk", "BulkActions", "Calibration", "CallableTimeSet", "CallAnalysisResponseSet", "Campaign", "CampaignRule", "CampaignSchedule", "ChangeRequest", "ClickstreamSettings", "Configuration", "ConfigurationVersion", "ContactList", "ContactListFilter", "Deployment", "DashboardSettings", "DependencyTrackingBuild", "DID", "DIDPool", "DNCList", "Document", "Edge", "EdgeGroup", "EmergencyGroup", "Evaluation", "EvaluationForm", "EventType", "Exports", "Extension", "ExtensionPool", "ExternalMetricData", "ExternalMetricDefinition", "Feedback", "Flow", "FlowMilestone", "FlowOutcome", "Forecast", "HistoricalData", "InsightSettings", "Integration", "IVR", "Line", "LineBase", "MaxOrgRoutingUtilizationCapacity", "MessagingCampaign", "Metric", "NumberPlan", "OAuthClient", "OAuthClientAuthorization", "OrganizationAuthorizationTrust", "OrganizationAuthorizationUserTrust", "OrganizationSettings", "OrphanedRecording", "OutboundRoute", "Outcome", "Phone", "PhoneBase", "Policy", "Predictor", "Program", "Prompt", "PromptResource", "Queue", "Recording", "RecordingAnnotation", "RecordingSettings", "Response", "Role", "Row", "RoutingTranscriptionSettings", "RuleSet", "Schedule", "ScheduledExports", "ScheduleGroup", "Schema", "ScreenRecording", "Segment", "SentimentFeedback", "Sequence", "SequenceSchedule", "SessionType", "Site", "SpeechTextAnalyticsSettings", "Status", "Survey", "SurveyForm", "Team", "Topic", "TranscriptionSettings", "Trigger", "Trunk", "TrunkBase", "UserPresence", "VoicemailPolicy", "VoicemailUserPolicy", "Webhook", "WorkPlan", "Workspace", "WrapupCode", "WrapUpCodeMapping", "ConversationPhoneNumber", "ConversationRecipient", "ConversationAccount", "ConversationDefaultSupportedContent", "ConversationThreadingWindow", "SupportedContent"]
