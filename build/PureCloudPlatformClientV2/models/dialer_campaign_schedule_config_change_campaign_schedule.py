...
if TYPE_CHECKING:
    from . import DialerCampaignScheduleConfigChangeScheduleInterval
    from . import DialerCampaignScheduleConfigChangeScheduleRecurrence
    from . import DialerCampaignScheduleConfigChangeUriReference

class DialerCampaignScheduleConfigChangeCampaignSchedule(object):
    """
    ...
    def __init__(self) -> None:
        """
        DialerCampaignScheduleConfigChangeCampaignSchedule - a model defined in Swagger
        ...
        self.swagger_types = {
            ...
            'recurrences': 'list[DialerCampaignScheduleConfigChangeScheduleRecurrence]',
            'time_zone': 'str',
    ...
    @property
    def intervals(self) -> List['DialerCampaignScheduleConfigChangeScheduleInterval']:
        """
    ...
    @intervals.setter
    def intervals(self, intervals: List['DialerCampaignScheduleConfigChangeScheduleInterval']) -> None:
        """
    ...
    @property
    def recurrences(self) -> List['DialerCampaignScheduleConfigChangeScheduleRecurrence']:
        """
        Gets the recurrences of this DialerCampaignScheduleConfigChangeCampaignSchedule.
        a list of recurrences for a schedule

        :return: The recurrences of this DialerCampaignScheduleConfigChangeCampaignSchedule.
        :rtype: list[DialerCampaignScheduleConfigChangeScheduleRecurrence]
        """
        return self._recurrences

    @recurrences.setter
    def recurrences(self, recurrences: List['DialerCampaignScheduleConfigChangeScheduleRecurrence']) -> None:
        """
        Sets the recurrences of this DialerCampaignScheduleConfigChangeCampaignSchedule.
        a list of recurrences for a schedule

        :param recurrences: The recurrences of this DialerCampaignScheduleConfigChangeCampaignSchedule.
        :type: list[DialerCampaignScheduleConfigChangeScheduleRecurrence]
        """
    ...
    @property
    def campaign(self) -> 'DialerCampaignScheduleConfigChangeUriReference':
        """
        Gets the campaign of this DialerCampaignScheduleConfigChangeCampaignSchedule.


        :return: The campaign of this DialerCampaignScheduleConfigChangeCampaignSchedule.
        :rtype: DialerCampaignScheduleConfigChangeUriReference
        """
        return self._campaign

    @campaign.setter
    def campaign(self, campaign: 'DialerCampaignScheduleConfigChangeUriReference') -> None:
        """
        Sets the campaign of this DialerCampaignScheduleConfigChangeCampaignSchedule.


        :param campaign: The campaign of this DialerCampaignScheduleConfigChangeCampaignSchedule.
    ...
    def get_additional_properties(self) -> Dict[str, object]:
        """
        Gets the get_additional_properties of this DialerCampaignScheduleConfigChangeCampaignSchedule.


        :return: The get_additional_properties of this DialerCampaignScheduleConfigChangeCampaignSchedule.
        :rtype: dict(str, object)
        """
    ...
    def get_additional_properties(self, get_additional_properties: Dict[str, object]) -> None:
        """
        Sets the get_additional_properties of this DialerCampaignScheduleConfigChangeCampaignSchedule.


        :param get_additional_properties: The get_additional_properties of this DialerCampaignScheduleConfigChangeCampaignSchedule.
        :type: dict(str, object)
        """
