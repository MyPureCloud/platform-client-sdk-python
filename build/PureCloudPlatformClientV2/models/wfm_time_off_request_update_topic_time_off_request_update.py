...
if TYPE_CHECKING:
    from . import WfmTimeOffRequestUpdateTopicUserReference
...
class WfmTimeOffRequestUpdateTopicTimeOffRequestUpdate(object):
    ...
    @property
    def user(self) -> 'WfmTimeOffRequestUpdateTopicUserReference':
        """
    ...
    @user.setter
    def user(self, user: 'WfmTimeOffRequestUpdateTopicUserReference') -> None:
        """
    ...
    def substatus(self, substatus: str) -> None:
        ...
        allowed_values = ["AdvanceTimeElapsed", "AutoApproved", "InsufficientBalance", "InvalidDailyDuration", "OutsideShift", "OverlapsRestrictedActivityCode", "RemovedFromWaitlist", "Waitlisted"]
    ...
    @property
    def partial_day_start_date_times(self) -> List[str]:
        """
    ...
    def partial_day_start_date_times(self, partial_day_start_date_times: List[str]) -> None:
        """
    ...
    def submitted_date(self, submitted_date: str) -> None:
        """
    ...
    @submitted_by.setter
    def submitted_by(self, submitted_by: str) -> None:
        """
    ...
    def modified_date(self, modified_date: str) -> None:
        """
