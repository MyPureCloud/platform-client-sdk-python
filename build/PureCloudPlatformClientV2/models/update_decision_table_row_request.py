...
class UpdateDecisionTableRowRequest(object):
    """
    ...
    def __init__(self) -> None:
        """
        UpdateDecisionTableRowRequest - a model defined in Swagger
    ...
    def inputs(self) -> Dict[str, 'DecisionTableRowParameterValue']:
        """
        Gets the inputs of this UpdateDecisionTableRowRequest.
        ...
        :return: The inputs of this UpdateDecisionTableRowRequest.
    ...
    def inputs(self, inputs: Dict[str, 'DecisionTableRowParameterValue']) -> None:
        """
        Sets the inputs of this UpdateDecisionTableRowRequest.
        The updated input values of the row. The key for this map is the column ID the row value relates. Column IDs are available from the decision table entity

        :param inputs: The inputs of this UpdateDecisionTableRowRequest.
    ...
    def outputs(self) -> Dict[str, 'DecisionTableRowParameterValue']:
        """
        Gets the outputs of this UpdateDecisionTableRowRequest.
        ...
        :return: The outputs of this UpdateDecisionTableRowRequest.
        :rtype: dict(str, DecisionTableRowParameterValue)
        """
    ...
    def outputs(self, outputs: Dict[str, 'DecisionTableRowParameterValue']) -> None:
        """
        Sets the outputs of this UpdateDecisionTableRowRequest.
        The updated output values of the row. The key for this map is the column ID the row value relates. Column IDs are available from the decision table entity

        :param outputs: The outputs of this UpdateDecisionTableRowRequest.
        :type: dict(str, DecisionTableRowParameterValue)
        """
