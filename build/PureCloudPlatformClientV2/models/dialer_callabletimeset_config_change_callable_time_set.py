...
if TYPE_CHECKING:
    from . import DialerCallabletimesetConfigChangeCallableTime
...
class DialerCallabletimesetConfigChangeCallableTimeSet(object):
    ...
    def callable_times(self, callable_times: List['DialerCallabletimesetConfigChangeCallableTime']) -> None:
        """
