...
class TwitterDataIngestionRuleResponse(object):
    """
    ...
    def __init__(self) -> None:
        """
        TwitterDataIngestionRuleResponse - a model defined in Swagger
    ...
    def id(self) -> str:
        """
        Gets the id of this TwitterDataIngestionRuleResponse.
        ID of the data ingestion rule.

        :return: The id of this TwitterDataIngestionRuleResponse.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id: str) -> None:
        """
        Sets the id of this TwitterDataIngestionRuleResponse.
        ID of the data ingestion rule.

        :param id: The id of this TwitterDataIngestionRuleResponse.
        :type: str
        """
    ...
    def name(self) -> str:
        """
        Gets the name of this TwitterDataIngestionRuleResponse.
        The name of the data ingestion rule.

        :return: The name of this TwitterDataIngestionRuleResponse.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name: str) -> None:
        """
        Sets the name of this TwitterDataIngestionRuleResponse.
        The name of the data ingestion rule.

        :param name: The name of this TwitterDataIngestionRuleResponse.
        :type: str
        """
    ...
    def description(self) -> str:
        """
        Gets the description of this TwitterDataIngestionRuleResponse.
        A description of the data ingestion rule.

        :return: The description of this TwitterDataIngestionRuleResponse.
        :rtype: str
        """
    ...
    def description(self, description: str) -> None:
        """
        Sets the description of this TwitterDataIngestionRuleResponse.
        A description of the data ingestion rule.

        :param description: The description of this TwitterDataIngestionRuleResponse.
        :type: str
        """
    ...
    def ingestion_rule_info(self) -> 'MessageInfo':
        """
        Gets the ingestion_rule_info of this TwitterDataIngestionRuleResponse.
        The Info about ingestion rule.

        :return: The ingestion_rule_info of this TwitterDataIngestionRuleResponse.
        :rtype: MessageInfo
        """
    ...
    def ingestion_rule_info(self, ingestion_rule_info: 'MessageInfo') -> None:
        """
        Sets the ingestion_rule_info of this TwitterDataIngestionRuleResponse.
        The Info about ingestion rule.

        :param ingestion_rule_info: The ingestion_rule_info of this TwitterDataIngestionRuleResponse.
        :type: MessageInfo
        """
    ...
    def self_uri(self) -> str:
        """
        Gets the self_uri of this TwitterDataIngestionRuleResponse.
        The URI for this object

        :return: The self_uri of this TwitterDataIngestionRuleResponse.
        :rtype: str
        """
    ...
    def self_uri(self, self_uri: str) -> None:
        """
        Sets the self_uri of this TwitterDataIngestionRuleResponse.
        The URI for this object

        :param self_uri: The self_uri of this TwitterDataIngestionRuleResponse.
        :type: str
        """
