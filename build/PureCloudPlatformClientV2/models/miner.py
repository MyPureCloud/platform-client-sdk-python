...
class Miner(object):
    ...
    def language(self, language: str) -> None:
        ...
        allowed_values = ["en-us", "en-gb", "en-au", "en-in", "en-za", "es-us", "es-es", "fr-fr", "fr-ca", "de-de", "pt-pt", "pt-br", "it-it", "nl-nl", "de-ch", "ja-jp", "ko-kr", "hi-in", "ar-001", "ar-ae", "ar-bh", "ar-eg", "ar-il", "ar-sa", "ar-tn", "da-dk", "fi-fi", "sv-se", "nb-no"]
