...
class DialerOutboundSettingsConfigChangeAtzmTimeSlotWithTimeZone(object):
    """
    ...
    def __init__(self):
        """
        DialerOutboundSettingsConfigChangeAtzmTimeSlotWithTimeZone - a model defined in Swagger
