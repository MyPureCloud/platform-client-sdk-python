...
if TYPE_CHECKING:
    from . import WfmBuShortTermForecastImportCompleteTopicModificationIntervalOffsetValue
...
class WfmBuShortTermForecastImportCompleteTopicBuForecastModification(object):
    ...
    @property
    def values(self) -> List['WfmBuShortTermForecastImportCompleteTopicModificationIntervalOffsetValue']:
        """
    ...
    @values.setter
    def values(self, values: List['WfmBuShortTermForecastImportCompleteTopicModificationIntervalOffsetValue']) -> None:
        """
