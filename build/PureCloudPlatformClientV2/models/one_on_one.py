...
class OneOnOne(object):
    ...
    def __init__(self) -> None:
        """
        OneOnOne - a model defined in Swagger
    ...
    def pinned_messages(self) -> List['AddressableEntityRef']:
        """
        Gets the pinned_messages of this OneOnOne.
        Room's pinned messages

        :return: The pinned_messages of this OneOnOne.
    ...
    def pinned_messages(self, pinned_messages: List['AddressableEntityRef']) -> None:
        """
        Sets the pinned_messages of this OneOnOne.
        Room's pinned messages

        :param pinned_messages: The pinned_messages of this OneOnOne.
