...
class SettingDirection(object):
    ...
    def __init__(self) -> None:
        """
        SettingDirection - a model defined in Swagger
    ...
    def inbound(self) -> str:
        """
        Gets the inbound of this SettingDirection.
        Status for the Inbound Direction

        :return: The inbound of this SettingDirection.
        :rtype: str
        """
        return self._inbound

    @inbound.setter
    def inbound(self, inbound: str) -> None:
        """
        Sets the inbound of this SettingDirection.
        Status for the Inbound Direction
        ...
        if inbound.lower() not in map(str.lower, allowed_values):
            ...
            self._inbound = "outdated_sdk_version"
        else:
    ...
    def outbound(self) -> str:
        """
        Gets the outbound of this SettingDirection.
        Status for the Outbound Direction

        :return: The outbound of this SettingDirection.
        :rtype: str
        """
        return self._outbound

    @outbound.setter
    def outbound(self, outbound: str) -> None:
        """
        Sets the outbound of this SettingDirection.
        Status for the Outbound Direction
        ...
        if outbound.lower() not in map(str.lower, allowed_values):
            ...
            self._outbound = "outdated_sdk_version"
        else:
