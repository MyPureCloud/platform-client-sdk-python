...
class TimeOffIntegrationStatusResponse(object):
    """
    ...
    def __init__(self) -> None:
        """
        TimeOffIntegrationStatusResponse - a model defined in Swagger
    ...
    def time_off_request(self) -> 'TimeOffRequestReference':
        """
        Gets the time_off_request of this TimeOffIntegrationStatusResponse.
        The time off request associated with this integration status

        :return: The time_off_request of this TimeOffIntegrationStatusResponse.
    ...
    def time_off_request(self, time_off_request: 'TimeOffRequestReference') -> None:
        """
        Sets the time_off_request of this TimeOffIntegrationStatusResponse.
        The time off request associated with this integration status

        :param time_off_request: The time_off_request of this TimeOffIntegrationStatusResponse.
    ...
    def integration_status(self) -> str:
        """
        Gets the integration_status of this TimeOffIntegrationStatusResponse.
        The value of integration status for the time off request

        :return: The integration_status of this TimeOffIntegrationStatusResponse.
        :rtype: str
        """
    ...
    def integration_status(self, integration_status: str) -> None:
        """
        Sets the integration_status of this TimeOffIntegrationStatusResponse.
        The value of integration status for the time off request

        :param integration_status: The integration_status of this TimeOffIntegrationStatusResponse.
        :type: str
        """
