...
class ActionMap(object):
    ...
    def __init__(self) -> None:
        """
        ActionMap - a model defined in Swagger
    ...
    def id(self) -> str:
        """
        Gets the id of this ActionMap.
        The globally unique identifier for the object.

        :return: The id of this ActionMap.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id: str) -> None:
        """
        Sets the id of this ActionMap.
        The globally unique identifier for the object.

        :param id: The id of this ActionMap.
        :type: str
        """
    ...
    def version(self) -> int:
        """
        Gets the version of this ActionMap.
        The version of the action map.

        :return: The version of this ActionMap.
        :rtype: int
        """
    ...
    def version(self, version: int) -> None:
        """
        Sets the version of this ActionMap.
        The version of the action map.

        :param version: The version of this ActionMap.
        :type: int
        """
    ...
    def is_active(self) -> bool:
        """
        Gets the is_active of this ActionMap.
        Whether the action map is active.

        :return: The is_active of this ActionMap.
        :rtype: bool
        """
    ...
    def is_active(self, is_active: bool) -> None:
        """
        Sets the is_active of this ActionMap.
        Whether the action map is active.

        :param is_active: The is_active of this ActionMap.
        :type: bool
        """
    ...
    def display_name(self) -> str:
        """
        Gets the display_name of this ActionMap.
        Display name of the action map.

        :return: The display_name of this ActionMap.
        :rtype: str
        """
    ...
    def display_name(self, display_name: str) -> None:
        """
        Sets the display_name of this ActionMap.
        Display name of the action map.

        :param display_name: The display_name of this ActionMap.
        :type: str
        """
    ...
    def trigger_with_segments(self) -> List[str]:
        """
        Gets the trigger_with_segments of this ActionMap.
        Trigger action map if any segment in the list is assigned to a given customer.

        :return: The trigger_with_segments of this ActionMap.
        :rtype: list[str]
        """
    ...
    def trigger_with_segments(self, trigger_with_segments: List[str]) -> None:
        """
        Sets the trigger_with_segments of this ActionMap.
        Trigger action map if any segment in the list is assigned to a given customer.

        :param trigger_with_segments: The trigger_with_segments of this ActionMap.
        :type: list[str]
        """
    ...
    def trigger_with_event_conditions(self) -> List['EventCondition']:
        """
        Gets the trigger_with_event_conditions of this ActionMap.
        List of event conditions that must be satisfied to trigger the action map.

        :return: The trigger_with_event_conditions of this ActionMap.
    ...
    def trigger_with_event_conditions(self, trigger_with_event_conditions: List['EventCondition']) -> None:
        """
        Sets the trigger_with_event_conditions of this ActionMap.
        List of event conditions that must be satisfied to trigger the action map.

        :param trigger_with_event_conditions: The trigger_with_event_conditions of this ActionMap.
    ...
    def page_url_conditions(self) -> List['UrlCondition']:
        """
        Gets the page_url_conditions of this ActionMap.
        URL conditions that a page must match for web actions to be displayable.

        :return: The page_url_conditions of this ActionMap.
    ...
    def page_url_conditions(self, page_url_conditions: List['UrlCondition']) -> None:
        """
        Sets the page_url_conditions of this ActionMap.
        URL conditions that a page must match for web actions to be displayable.

        :param page_url_conditions: The page_url_conditions of this ActionMap.
    ...
    def activation(self) -> 'Activation':
        """
        Gets the activation of this ActionMap.
        Type of activation.

        :return: The activation of this ActionMap.
        :rtype: Activation
        """
    ...
    def activation(self, activation: 'Activation') -> None:
        """
        Sets the activation of this ActionMap.
        Type of activation.

        :param activation: The activation of this ActionMap.
        :type: Activation
        """
    ...
    def weight(self) -> int:
        """
        Gets the weight of this ActionMap.
        Weight of the action map with higher number denoting higher weight.

        :return: The weight of this ActionMap.
        :rtype: int
        """
        return self._weight
    ...
    def weight(self, weight: int) -> None:
        """
        Sets the weight of this ActionMap.
        Weight of the action map with higher number denoting higher weight.

        :param weight: The weight of this ActionMap.
        :type: int
        """
    ...
    @property
    def action(self) -> 'ActionMapAction':
        """
        Gets the action of this ActionMap.
        The action that will be executed if this action map is triggered.

        :return: The action of this ActionMap.
        :rtype: ActionMapAction
        """
        return self._action

    @action.setter
    def action(self, action: 'ActionMapAction') -> None:
        """
        Sets the action of this ActionMap.
        The action that will be executed if this action map is triggered.

        :param action: The action of this ActionMap.
    ...
    @property
    def action_map_schedule_groups(self) -> 'ActionMapScheduleGroups':
        """
        Gets the action_map_schedule_groups of this ActionMap.
        The action map's associated schedule groups.

        :return: The action_map_schedule_groups of this ActionMap.
        :rtype: ActionMapScheduleGroups
        """
        return self._action_map_schedule_groups

    @action_map_schedule_groups.setter
    def action_map_schedule_groups(self, action_map_schedule_groups: 'ActionMapScheduleGroups') -> None:
        """
        Sets the action_map_schedule_groups of this ActionMap.
        The action map's associated schedule groups.

        :param action_map_schedule_groups: The action_map_schedule_groups of this ActionMap.
    ...
    def ignore_frequency_cap(self) -> bool:
        """
        Gets the ignore_frequency_cap of this ActionMap.
        Override organization-level frequency cap and always offer web engagements from this action map.

        :return: The ignore_frequency_cap of this ActionMap.
        :rtype: bool
        """
    ...
    def ignore_frequency_cap(self, ignore_frequency_cap: bool) -> None:
        """
        Sets the ignore_frequency_cap of this ActionMap.
        Override organization-level frequency cap and always offer web engagements from this action map.

        :param ignore_frequency_cap: The ignore_frequency_cap of this ActionMap.
        :type: bool
        """
    ...
    def self_uri(self) -> str:
        """
        Gets the self_uri of this ActionMap.
        The URI for this object

        :return: The self_uri of this ActionMap.
        :rtype: str
        """
    ...
    def self_uri(self, self_uri: str) -> None:
        """
        Sets the self_uri of this ActionMap.
        The URI for this object

        :param self_uri: The self_uri of this ActionMap.
        :type: str
        """
    ...
    def created_date(self) -> datetime:
        """
        Gets the created_date of this ActionMap.
        ...
        :return: The created_date of this ActionMap.
        :rtype: datetime
        """
    ...
    def created_date(self, created_date: datetime) -> None:
        """
        Sets the created_date of this ActionMap.
        Timestamp indicating when the action map was created. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z

        :param created_date: The created_date of this ActionMap.
        :type: datetime
        """
    ...
    def modified_date(self) -> datetime:
        """
        Gets the modified_date of this ActionMap.
        ...
        :return: The modified_date of this ActionMap.
        :rtype: datetime
        """
    ...
    def modified_date(self, modified_date: datetime) -> None:
        """
        Sets the modified_date of this ActionMap.
        Timestamp indicating when the action map was last updated. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z

        :param modified_date: The modified_date of this ActionMap.
        :type: datetime
        """
    ...
    def start_date(self) -> datetime:
        """
        Gets the start_date of this ActionMap.
        ...
        :return: The start_date of this ActionMap.
        :rtype: datetime
        """
    ...
    def start_date(self, start_date: datetime) -> None:
        """
        Sets the start_date of this ActionMap.
        Timestamp at which the action map is scheduled to start firing. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z

        :param start_date: The start_date of this ActionMap.
        :type: datetime
        """
    ...
    def end_date(self) -> datetime:
        """
        Gets the end_date of this ActionMap.
        ...
        :return: The end_date of this ActionMap.
        :rtype: datetime
        """
    ...
    def end_date(self, end_date: datetime) -> None:
        """
        Sets the end_date of this ActionMap.
        Timestamp at which the action map is scheduled to stop firing. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z

        :param end_date: The end_date of this ActionMap.
        :type: datetime
        """
