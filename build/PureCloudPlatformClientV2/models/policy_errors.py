...
if TYPE_CHECKING:
    from . import PolicyErrorMessage
...
class PolicyErrors(object):
    ...
    @property
    def policy_error_messages(self) -> List['PolicyErrorMessage']:
        """
    ...
    def policy_error_messages(self, policy_error_messages: List['PolicyErrorMessage']) -> None:
        """
