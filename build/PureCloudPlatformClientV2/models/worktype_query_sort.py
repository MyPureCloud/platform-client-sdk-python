...
class WorktypeQuerySort(object):
    """
    ...
    def __init__(self) -> None:
        """
        WorktypeQuerySort - a model defined in Swagger
    ...
    def name(self) -> str:
        """
        Gets the name of this WorktypeQuerySort.
        ...
        :return: The name of this WorktypeQuerySort.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name: str) -> None:
        """
        Sets the name of this WorktypeQuerySort.
        Specify an attribute for sorting. It's possible to use an attribute both for sorting and in the query at the same time, but these restrictions apply: Only the operators EQ, LT, LTE, GT, GTE, BETWEEN and BEGINS_WITH are supported and the attribute can't be present in more than one filter.

        :param name: The name of this WorktypeQuerySort.
        :type: str
        """
    ...
    def ascending(self) -> bool:
        """
        Gets the ascending of this WorktypeQuerySort.
        Sort Ascending

        :return: The ascending of this WorktypeQuerySort.
        :rtype: bool
        """
    ...
    def ascending(self, ascending: bool) -> None:
        """
        Sets the ascending of this WorktypeQuerySort.
        Sort Ascending

        :param ascending: The ascending of this WorktypeQuerySort.
        :type: bool
        """
