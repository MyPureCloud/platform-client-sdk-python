...
class TimeOffRequestListing(object):
    ...
    def __init__(self) -> None:
        """
        TimeOffRequestListing - a model defined in Swagger
    ...
    def download_url(self) -> str:
        """
        Gets the download_url of this TimeOffRequestListing.
        ...
        :return: The download_url of this TimeOffRequestListing.
        :rtype: str
        """
    ...
    def download_url(self, download_url: str) -> None:
        """
        Sets the download_url of this TimeOffRequestListing.
        URL from which to fetch results for requests with a large result set. If populated, the downloaded data will conform to the same schema as would normally be returned, excepting downloaded data will never itself contain a downloadUrl

        :param download_url: The download_url of this TimeOffRequestListing.
        :type: str
        """
