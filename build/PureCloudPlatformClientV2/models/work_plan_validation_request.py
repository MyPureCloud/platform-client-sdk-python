...
if TYPE_CHECKING:
    from . import DeletableUserReference
    from . import ListWrapperShiftStartVariance
    from . import SetWrapperDayOfWeek
    from . import WorkPlanShift

class WorkPlanValidationRequest(object):
    """
    ...
    def __init__(self) -> None:
        """
        WorkPlanValidationRequest - a model defined in Swagger
    ...
    def id(self) -> str:
        """
        Gets the id of this WorkPlanValidationRequest.
        The globally unique identifier for the object.

        :return: The id of this WorkPlanValidationRequest.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id: str) -> None:
        """
        Sets the id of this WorkPlanValidationRequest.
        The globally unique identifier for the object.

        :param id: The id of this WorkPlanValidationRequest.
        :type: str
        """
    ...
    def name(self) -> str:
        """
        Gets the name of this WorkPlanValidationRequest.


        :return: The name of this WorkPlanValidationRequest.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name: str) -> None:
        """
        Sets the name of this WorkPlanValidationRequest.


        :param name: The name of this WorkPlanValidationRequest.
        :type: str
        """
    ...
    def enabled(self) -> bool:
        """
        Gets the enabled of this WorkPlanValidationRequest.
        Whether the work plan is enabled for scheduling

        :return: The enabled of this WorkPlanValidationRequest.
        :rtype: bool
        """
    ...
    def enabled(self, enabled: bool) -> None:
        """
        Sets the enabled of this WorkPlanValidationRequest.
        Whether the work plan is enabled for scheduling

        :param enabled: The enabled of this WorkPlanValidationRequest.
        :type: bool
        """
    ...
    def constrain_weekly_paid_time(self) -> bool:
        """
        Gets the constrain_weekly_paid_time of this WorkPlanValidationRequest.
        Whether the weekly paid time constraint is enabled for this work plan

        :return: The constrain_weekly_paid_time of this WorkPlanValidationRequest.
        :rtype: bool
        """
    ...
    def constrain_weekly_paid_time(self, constrain_weekly_paid_time: bool) -> None:
        """
        Sets the constrain_weekly_paid_time of this WorkPlanValidationRequest.
        Whether the weekly paid time constraint is enabled for this work plan

        :param constrain_weekly_paid_time: The constrain_weekly_paid_time of this WorkPlanValidationRequest.
        :type: bool
        """
    ...
    def flexible_weekly_paid_time(self) -> bool:
        """
        Gets the flexible_weekly_paid_time of this WorkPlanValidationRequest.
        Whether the weekly paid time constraint is flexible for this work plan

        :return: The flexible_weekly_paid_time of this WorkPlanValidationRequest.
        :rtype: bool
        """
    ...
    def flexible_weekly_paid_time(self, flexible_weekly_paid_time: bool) -> None:
        """
        Sets the flexible_weekly_paid_time of this WorkPlanValidationRequest.
        Whether the weekly paid time constraint is flexible for this work plan

        :param flexible_weekly_paid_time: The flexible_weekly_paid_time of this WorkPlanValidationRequest.
        :type: bool
        """
    ...
    def weekly_exact_paid_minutes(self) -> int:
        """
        Gets the weekly_exact_paid_minutes of this WorkPlanValidationRequest.
        Exact weekly paid time in minutes for this work plan. Used if flexibleWeeklyPaidTime == false

        :return: The weekly_exact_paid_minutes of this WorkPlanValidationRequest.
        :rtype: int
        """
    ...
    def weekly_exact_paid_minutes(self, weekly_exact_paid_minutes: int) -> None:
        """
        Sets the weekly_exact_paid_minutes of this WorkPlanValidationRequest.
        Exact weekly paid time in minutes for this work plan. Used if flexibleWeeklyPaidTime == false

        :param weekly_exact_paid_minutes: The weekly_exact_paid_minutes of this WorkPlanValidationRequest.
        :type: int
        """
    ...
    def weekly_minimum_paid_minutes(self) -> int:
        """
        Gets the weekly_minimum_paid_minutes of this WorkPlanValidationRequest.
        Minimum weekly paid time in minutes for this work plan. Used if flexibleWeeklyPaidTime == true

        :return: The weekly_minimum_paid_minutes of this WorkPlanValidationRequest.
        :rtype: int
        """
    ...
    def weekly_minimum_paid_minutes(self, weekly_minimum_paid_minutes: int) -> None:
        """
        Sets the weekly_minimum_paid_minutes of this WorkPlanValidationRequest.
        Minimum weekly paid time in minutes for this work plan. Used if flexibleWeeklyPaidTime == true

        :param weekly_minimum_paid_minutes: The weekly_minimum_paid_minutes of this WorkPlanValidationRequest.
        :type: int
        """
    ...
    def weekly_maximum_paid_minutes(self) -> int:
        """
        Gets the weekly_maximum_paid_minutes of this WorkPlanValidationRequest.
        Maximum weekly paid time in minutes for this work plan. Used if flexibleWeeklyPaidTime == true

        :return: The weekly_maximum_paid_minutes of this WorkPlanValidationRequest.
        :rtype: int
        """
    ...
    def weekly_maximum_paid_minutes(self, weekly_maximum_paid_minutes: int) -> None:
        """
        Sets the weekly_maximum_paid_minutes of this WorkPlanValidationRequest.
        Maximum weekly paid time in minutes for this work plan. Used if flexibleWeeklyPaidTime == true

        :param weekly_maximum_paid_minutes: The weekly_maximum_paid_minutes of this WorkPlanValidationRequest.
        :type: int
        """
    ...
    @property
    def constrain_paid_time_granularity(self) -> bool:
        """
    ...
    def constrain_paid_time_granularity(self, constrain_paid_time_granularity: bool) -> None:
        """
    ...
    @property
    def paid_time_granularity_minutes(self) -> int:
        """
        Gets the paid_time_granularity_minutes of this WorkPlanValidationRequest.
        Granularity in minutes allowed for shift paid time in this work plan. Used if constrainPaidTimeGranularity == true

        :return: The paid_time_granularity_minutes of this WorkPlanValidationRequest.
        :rtype: int
        """
        return self._paid_time_granularity_minutes

    @paid_time_granularity_minutes.setter
    def paid_time_granularity_minutes(self, paid_time_granularity_minutes: int) -> None:
        """
        Sets the paid_time_granularity_minutes of this WorkPlanValidationRequest.
        Granularity in minutes allowed for shift paid time in this work plan. Used if constrainPaidTimeGranularity == true

        :param paid_time_granularity_minutes: The paid_time_granularity_minutes of this WorkPlanValidationRequest.
        :type: int
        """
    ...
    @property
    def constrain_minimum_time_between_shifts(self) -> bool:
        """
        Gets the constrain_minimum_time_between_shifts of this WorkPlanValidationRequest.
        Whether the minimum time between shifts constraint is enabled for this work plan

        :return: The constrain_minimum_time_between_shifts of this WorkPlanValidationRequest.
        :rtype: bool
        """
        return self._constrain_minimum_time_between_shifts

    @constrain_minimum_time_between_shifts.setter
    def constrain_minimum_time_between_shifts(self, constrain_minimum_time_between_shifts: bool) -> None:
        """
        Sets the constrain_minimum_time_between_shifts of this WorkPlanValidationRequest.
        Whether the minimum time between shifts constraint is enabled for this work plan

        :param constrain_minimum_time_between_shifts: The constrain_minimum_time_between_shifts of this WorkPlanValidationRequest.
        :type: bool
        """
    ...
    @property
    def minimum_time_between_shifts_minutes(self) -> int:
        """
        Gets the minimum_time_between_shifts_minutes of this WorkPlanValidationRequest.
        Minimum time between shifts in minutes defined in this work plan. Used if constrainMinimumTimeBetweenShifts == true

        :return: The minimum_time_between_shifts_minutes of this WorkPlanValidationRequest.
        :rtype: int
        """
        return self._minimum_time_between_shifts_minutes

    @minimum_time_between_shifts_minutes.setter
    def minimum_time_between_shifts_minutes(self, minimum_time_between_shifts_minutes: int) -> None:
        """
        Sets the minimum_time_between_shifts_minutes of this WorkPlanValidationRequest.
        Minimum time between shifts in minutes defined in this work plan. Used if constrainMinimumTimeBetweenShifts == true

        :param minimum_time_between_shifts_minutes: The minimum_time_between_shifts_minutes of this WorkPlanValidationRequest.
        :type: int
        """
    ...
    @property
    def maximum_days(self) -> int:
        """
        Gets the maximum_days of this WorkPlanValidationRequest.
        Maximum number days in a week allowed to be scheduled for this work plan

        :return: The maximum_days of this WorkPlanValidationRequest.
        :rtype: int
        """
        return self._maximum_days

    @maximum_days.setter
    def maximum_days(self, maximum_days: int) -> None:
        """
        Sets the maximum_days of this WorkPlanValidationRequest.
        Maximum number days in a week allowed to be scheduled for this work plan

        :param maximum_days: The maximum_days of this WorkPlanValidationRequest.
        :type: int
        """
    ...
    @property
    def minimum_consecutive_non_working_minutes_per_week(self) -> int:
        """
    ...
    def minimum_consecutive_non_working_minutes_per_week(self, minimum_consecutive_non_working_minutes_per_week: int) -> None:
        """
    ...
    @property
    def constrain_maximum_consecutive_working_weekends(self) -> bool:
        """
    ...
    def constrain_maximum_consecutive_working_weekends(self, constrain_maximum_consecutive_working_weekends: bool) -> None:
        """
    ...
    @property
    def maximum_consecutive_working_weekends(self) -> int:
        """
    ...
    def maximum_consecutive_working_weekends(self, maximum_consecutive_working_weekends: int) -> None:
        """
    ...
    @property
    def minimum_working_days_per_week(self) -> int:
        """
        ...
        :return: The minimum_working_days_per_week of this WorkPlanValidationRequest.
        :rtype: int
        """
        return self._minimum_working_days_per_week

    @minimum_working_days_per_week.setter
    def minimum_working_days_per_week(self, minimum_working_days_per_week: int) -> None:
        """
        Sets the minimum_working_days_per_week of this WorkPlanValidationRequest.
        The minimum number of days that agents assigned to a work plan must work per week

        :param minimum_working_days_per_week: The minimum_working_days_per_week of this WorkPlanValidationRequest.
        :type: int
        """
    ...
    @property
    def constrain_maximum_consecutive_working_days(self) -> bool:
        """
    ...
    def constrain_maximum_consecutive_working_days(self, constrain_maximum_consecutive_working_days: bool) -> None:
        """
    ...
    @property
    def maximum_consecutive_working_days(self) -> int:
        """
    ...
    def maximum_consecutive_working_days(self, maximum_consecutive_working_days: int) -> None:
        """
    ...
    @property
    def minimum_shift_start_distance_minutes(self) -> int:
        """
    ...
    def minimum_shift_start_distance_minutes(self, minimum_shift_start_distance_minutes: int) -> None:
        """
    ...
    @property
    def minimum_days_off_per_planning_period(self) -> int:
        """
    ...
    def minimum_days_off_per_planning_period(self, minimum_days_off_per_planning_period: int) -> None:
        """
    ...
    @property
    def maximum_days_off_per_planning_period(self) -> int:
        """
    ...
    def maximum_days_off_per_planning_period(self, maximum_days_off_per_planning_period: int) -> None:
        """
    ...
    @property
    def minimum_paid_minutes_per_planning_period(self) -> int:
        """
    ...
    def minimum_paid_minutes_per_planning_period(self, minimum_paid_minutes_per_planning_period: int) -> None:
        """
    ...
    @property
    def maximum_paid_minutes_per_planning_period(self) -> int:
        """
    ...
    def maximum_paid_minutes_per_planning_period(self, maximum_paid_minutes_per_planning_period: int) -> None:
        """
    ...
    def constrain_maximum_working_weekends_per_planning_period(self) -> bool:
        """
        Gets the constrain_maximum_working_weekends_per_planning_period of this WorkPlanValidationRequest.
        Whether to constrain the maximum working weekends in the planning period

        :return: The constrain_maximum_working_weekends_per_planning_period of this WorkPlanValidationRequest.
        :rtype: bool
        """
    ...
    def constrain_maximum_working_weekends_per_planning_period(self, constrain_maximum_working_weekends_per_planning_period: bool) -> None:
        """
        Sets the constrain_maximum_working_weekends_per_planning_period of this WorkPlanValidationRequest.
        Whether to constrain the maximum working weekends in the planning period

        :param constrain_maximum_working_weekends_per_planning_period: The constrain_maximum_working_weekends_per_planning_period of this WorkPlanValidationRequest.
        :type: bool
        """
    ...
    def maximum_working_weekends_per_planning_period(self) -> int:
        """
        Gets the maximum_working_weekends_per_planning_period of this WorkPlanValidationRequest.
        Maximum working weekends in the planning period

        :return: The maximum_working_weekends_per_planning_period of this WorkPlanValidationRequest.
        :rtype: int
        """
    ...
    def maximum_working_weekends_per_planning_period(self, maximum_working_weekends_per_planning_period: int) -> None:
        """
        Sets the maximum_working_weekends_per_planning_period of this WorkPlanValidationRequest.
        Maximum working weekends in the planning period

        :param maximum_working_weekends_per_planning_period: The maximum_working_weekends_per_planning_period of this WorkPlanValidationRequest.
        :type: int
        """
    ...
    def optional_days(self) -> 'SetWrapperDayOfWeek':
        ...
        :return: The optional_days of this WorkPlanValidationRequest.
    ...
    def optional_days(self, optional_days: 'SetWrapperDayOfWeek') -> None:
        """
        Sets the optional_days of this WorkPlanValidationRequest.
        Optional days to schedule for this work plan

        :param optional_days: The optional_days of this WorkPlanValidationRequest.
    ...
    @property
    def shift_start_variance_type(self) -> str:
        """
    ...
    def shift_start_variance_type(self, shift_start_variance_type: str) -> None:
        """
    ...
    def shift_start_variance_period(self) -> str:
        """
        Gets the shift_start_variance_period of this WorkPlanValidationRequest.
        The length of the period over which the maximum shift start time variance is applied

        :return: The shift_start_variance_period of this WorkPlanValidationRequest.
        :rtype: str
        """
    ...
    def shift_start_variance_period(self, shift_start_variance_period: str) -> None:
        """
        Sets the shift_start_variance_period of this WorkPlanValidationRequest.
        The length of the period over which the maximum shift start time variance is applied

        :param shift_start_variance_period: The shift_start_variance_period of this WorkPlanValidationRequest.
        :type: str
        """
    ...
    def shift_start_variances(self) -> 'ListWrapperShiftStartVariance':
        """
        Gets the shift_start_variances of this WorkPlanValidationRequest.
        Variance in minutes among start times of shifts in this work plan

        :return: The shift_start_variances of this WorkPlanValidationRequest.
        :rtype: ListWrapperShiftStartVariance
        """
        return self._shift_start_variances

    @shift_start_variances.setter
    def shift_start_variances(self, shift_start_variances: 'ListWrapperShiftStartVariance') -> None:
        """
        Sets the shift_start_variances of this WorkPlanValidationRequest.
        Variance in minutes among start times of shifts in this work plan

        :param shift_start_variances: The shift_start_variances of this WorkPlanValidationRequest.
    ...
    @property
    def shifts(self) -> List['WorkPlanShift']:
        """
        Gets the shifts of this WorkPlanValidationRequest.
        Shifts in this work plan

        :return: The shifts of this WorkPlanValidationRequest.
        :rtype: list[WorkPlanShift]
        """
        return self._shifts

    @shifts.setter
    def shifts(self, shifts: List['WorkPlanShift']) -> None:
        """
        Sets the shifts of this WorkPlanValidationRequest.
        Shifts in this work plan

        :param shifts: The shifts of this WorkPlanValidationRequest.
    ...
    @property
    def agents(self) -> List['DeletableUserReference']:
        """
        Gets the agents of this WorkPlanValidationRequest.
        Agents in this work plan

        :return: The agents of this WorkPlanValidationRequest.
        :rtype: list[DeletableUserReference]
        """
        return self._agents

    @agents.setter
    def agents(self, agents: List['DeletableUserReference']) -> None:
        """
        Sets the agents of this WorkPlanValidationRequest.
        Agents in this work plan

        :param agents: The agents of this WorkPlanValidationRequest.
    ...
    def self_uri(self) -> str:
        """
        Gets the self_uri of this WorkPlanValidationRequest.
        The URI for this object

        :return: The self_uri of this WorkPlanValidationRequest.
        :rtype: str
        """
    ...
    def self_uri(self, self_uri: str) -> None:
        """
        Sets the self_uri of this WorkPlanValidationRequest.
        The URI for this object

        :param self_uri: The self_uri of this WorkPlanValidationRequest.
        :type: str
        """
