...
class ReportRunEntry(object):
    ...
    @run_time.setter
    def run_time(self, run_time: datetime) -> None:
        """
    ...
    @run_status.setter
    def run_status(self, run_status: str) -> None:
        """
    ...
    @property
    def run_duration_msec(self) -> int:
        """
    ...
    def run_duration_msec(self, run_duration_msec: int) -> None:
        """
    ...
    @report_url.setter
    def report_url(self, report_url: str) -> None:
        """
    ...
    @schedule_uri.setter
    def schedule_uri(self, schedule_uri: str) -> None:
        """
