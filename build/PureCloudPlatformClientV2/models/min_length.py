...
class MinLength(object):
    ...
    def __init__(self):
        """
        MinLength - a model defined in Swagger
    ...
    def min(self):
        """
        Gets the min of this MinLength.
        ...
        :return: The min of this MinLength.
        :rtype: int
        """
        return self._min
    ...
    def min(self, min):
        """
        Sets the min of this MinLength.
        A non-negative integer for a text-based schema field denoting the minimum smallest length a string field can contain for a schema instance.

        :param min: The min of this MinLength.
        :type: int
        """
    ...
    def max(self):
        """
        Gets the max of this MinLength.
        ...
        :return: The max of this MinLength.
        :rtype: int
        """
        return self._max
    ...
    def max(self, max):
        """
        Sets the max of this MinLength.
        A non-negative integer for a text-based schema field denoting the maximum smallest length string the field can contain for a schema instance.

        :param max: The max of this MinLength.
        :type: int
        """
