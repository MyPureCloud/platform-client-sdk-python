...
if TYPE_CHECKING:
    from . import SchedulingProcessingError
...
class SchedulingStatusResponse(object):
    ...
    @property
    def error_details(self) -> List['SchedulingProcessingError']:
        """
    ...
    def error_details(self, error_details: List['SchedulingProcessingError']) -> None:
        """
    ...
    @property
    def scheduling_result_uri(self) -> str:
        """
    ...
    def scheduling_result_uri(self, scheduling_result_uri: str) -> None:
        """
