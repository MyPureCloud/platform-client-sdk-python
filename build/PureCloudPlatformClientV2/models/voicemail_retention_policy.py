...
class VoicemailRetentionPolicy(object):
    ...
    @property
    def voicemail_retention_policy_type(self) -> str:
        """
    ...
    def voicemail_retention_policy_type(self, voicemail_retention_policy_type: str) -> None:
        """
    ...
    def number_of_days(self, number_of_days: int) -> None:
        """
