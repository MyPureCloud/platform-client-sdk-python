...
class ActionEntityListing(object):
    """
    ...
    def __init__(self) -> None:
        """
        ActionEntityListing - a model defined in Swagger
    ...
    @property
    def entities(self) -> List['Action']:
        """
        Gets the entities of this ActionEntityListing.


        :return: The entities of this ActionEntityListing.
        :rtype: list[Action]
        """
        return self._entities

    @entities.setter
    def entities(self, entities: List['Action']) -> None:
        """
        Sets the entities of this ActionEntityListing.


        :param entities: The entities of this ActionEntityListing.
        :type: list[Action]
        """
    ...
    def page_size(self) -> int:
        """
        Gets the page_size of this ActionEntityListing.


        :return: The page_size of this ActionEntityListing.
        :rtype: int
        """
    ...
    def page_size(self, page_size: int) -> None:
        """
        Sets the page_size of this ActionEntityListing.


        :param page_size: The page_size of this ActionEntityListing.
        :type: int
        """
    ...
    def page_number(self) -> int:
        """
        Gets the page_number of this ActionEntityListing.


        :return: The page_number of this ActionEntityListing.
        :rtype: int
        """
    ...
    def page_number(self, page_number: int) -> None:
        """
        Sets the page_number of this ActionEntityListing.


        :param page_number: The page_number of this ActionEntityListing.
        :type: int
        """
    ...
    def total(self) -> int:
        """
        Gets the total of this ActionEntityListing.


        :return: The total of this ActionEntityListing.
        :rtype: int
        """
        return self._total
    ...
    def total(self, total: int) -> None:
        """
        Sets the total of this ActionEntityListing.


        :param total: The total of this ActionEntityListing.
        :type: int
        """
    ...
    def page_count(self) -> int:
        """
        Gets the page_count of this ActionEntityListing.


        :return: The page_count of this ActionEntityListing.
        :rtype: int
        """
    ...
    def page_count(self, page_count: int) -> None:
        """
        Sets the page_count of this ActionEntityListing.


        :param page_count: The page_count of this ActionEntityListing.
        :type: int
        """
