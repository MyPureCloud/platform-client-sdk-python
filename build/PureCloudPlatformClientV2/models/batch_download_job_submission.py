...
if TYPE_CHECKING:
    from . import BatchDownloadRequest
...
class BatchDownloadJobSubmission(object):
    ...
    @property
    def batch_download_request_list(self) -> List['BatchDownloadRequest']:
        """
    ...
    def batch_download_request_list(self, batch_download_request_list: List['BatchDownloadRequest']) -> None:
        """
