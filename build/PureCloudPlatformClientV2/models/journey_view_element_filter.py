...
class JourneyViewElementFilter(object):
    ...
    def __init__(self) -> None:
        """
        JourneyViewElementFilter - a model defined in Swagger
    ...
    def type(self) -> str:
        """
        Gets the type of this JourneyViewElementFilter.
        Boolean operation to apply to the provided predicates and clauses. Valid values: And

        :return: The type of this JourneyViewElementFilter.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type: str) -> None:
        """
        Sets the type of this JourneyViewElementFilter.
        Boolean operation to apply to the provided predicates and clauses. Valid values: And

        :param type: The type of this JourneyViewElementFilter.
        :type: str
        """
    ...
    @property
    def predicates(self) -> List['JourneyViewElementFilterPredicate']:
        """
        Gets the predicates of this JourneyViewElementFilter.
        predicates

        :return: The predicates of this JourneyViewElementFilter.
        :rtype: list[JourneyViewElementFilterPredicate]
        """
        return self._predicates

    @predicates.setter
    def predicates(self, predicates: List['JourneyViewElementFilterPredicate']) -> None:
        """
        Sets the predicates of this JourneyViewElementFilter.
        predicates

        :param predicates: The predicates of this JourneyViewElementFilter.
        :type: list[JourneyViewElementFilterPredicate]
        """
