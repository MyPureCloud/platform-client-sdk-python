...
class OpenIntegrationRequest(object):
    """
    ...
    def __init__(self):
        """
        OpenIntegrationRequest - a model defined in Swagger
    ...
    def id(self):
        """
        Gets the id of this OpenIntegrationRequest.
        The globally unique identifier for the object.

        :return: The id of this OpenIntegrationRequest.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this OpenIntegrationRequest.
        The globally unique identifier for the object.

        :param id: The id of this OpenIntegrationRequest.
        :type: str
        """
    ...
    def name(self):
        """
        Gets the name of this OpenIntegrationRequest.
        The name of the Open messaging integration.

        :return: The name of this OpenIntegrationRequest.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this OpenIntegrationRequest.
        The name of the Open messaging integration.

        :param name: The name of this OpenIntegrationRequest.
        :type: str
        """
    ...
    def supported_content(self):
        """
        Gets the supported_content of this OpenIntegrationRequest.
        Defines the SupportedContent profile configured for an integration

        :return: The supported_content of this OpenIntegrationRequest.
    ...
    def supported_content(self, supported_content):
        """
        Sets the supported_content of this OpenIntegrationRequest.
        Defines the SupportedContent profile configured for an integration

        :param supported_content: The supported_content of this OpenIntegrationRequest.
    ...
    def outbound_notification_webhook_url(self):
        """
        Gets the outbound_notification_webhook_url of this OpenIntegrationRequest.
        The outbound notification webhook URL for the Open messaging integration.

        :return: The outbound_notification_webhook_url of this OpenIntegrationRequest.
        :rtype: str
        """
    ...
    def outbound_notification_webhook_url(self, outbound_notification_webhook_url):
        """
        Sets the outbound_notification_webhook_url of this OpenIntegrationRequest.
        The outbound notification webhook URL for the Open messaging integration.

        :param outbound_notification_webhook_url: The outbound_notification_webhook_url of this OpenIntegrationRequest.
        :type: str
        """
    ...
    def webhook_headers(self):
        """
        Gets the webhook_headers of this OpenIntegrationRequest.
        The user specified headers for the Open messaging integration.

        :return: The webhook_headers of this OpenIntegrationRequest.
        :rtype: dict(str, str)
        """
    ...
    def webhook_headers(self, webhook_headers):
        """
        Sets the webhook_headers of this OpenIntegrationRequest.
        The user specified headers for the Open messaging integration.

        :param webhook_headers: The webhook_headers of this OpenIntegrationRequest.
        :type: dict(str, str)
        """
    ...
    def self_uri(self):
        """
        Gets the self_uri of this OpenIntegrationRequest.
        The URI for this object

        :return: The self_uri of this OpenIntegrationRequest.
        :rtype: str
        """
    ...
    def self_uri(self, self_uri):
        """
        Sets the self_uri of this OpenIntegrationRequest.
        The URI for this object

        :param self_uri: The self_uri of this OpenIntegrationRequest.
        :type: str
        """
