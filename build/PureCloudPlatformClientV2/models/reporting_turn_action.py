...
class ReportingTurnAction(object):
    ...
    def action_type(self, action_type):
        ...
        :type: str
        """
        allowed_values = ["AddFlowMilestoneAction", "AskForNLUIntentAction", "AskForBooleanAction", "AskForSlotAction", "AskForNLUNextIntentAction", "BotState", "CallTaskAction", "ClearSlotAction", "DisconnectAction", "EndTaskAction", "ExitBotFlowAction", "UpdateVariableAction", "CommunicateAction", "DecisionAction", "FindGroupAction", "SwitchAction", "DataAction", "DataTableLookupAction", "GetExternalContactAction", "GetExternalOrganizationAction", "LoopAction", "ExitLoopAction", "NextLoopAction", "LoopUntilAction", "SetActiveIntentAction", "SetFlowOutcomeAction", "InitializeFlowOutcomeAction", "AskForStringAction", "SendResponseAction", "GetResponseAction", "ExtractSecureDataAction", "SecureAction", "TransferTaskAction", "DigitalMenuAction", "WaitForInputAction", "ShowKnowledgeArticleAction", "FindSystemPromptAction", "FindUserPromptAction", "TransferPureMatchAction", "FindQueueAction", "FindQueueByIdAction", "SetLocaleAction", "Unknown"]
