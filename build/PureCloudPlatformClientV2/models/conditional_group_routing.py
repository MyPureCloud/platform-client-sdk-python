...
if TYPE_CHECKING:
    from . import ConditionalGroupRoutingRule

class ConditionalGroupRouting(object):
    """
    ...
    def __init__(self) -> None:
        """
        ConditionalGroupRouting - a model defined in Swagger
        ...
        """
        self.swagger_types = {
            'rules': 'list[ConditionalGroupRoutingRule]'
        }
