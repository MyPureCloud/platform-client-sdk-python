...
class KnowledgeDocumentCopy(object):
    """
    ...
    def __init__(self) -> None:
        """
        KnowledgeDocumentCopy - a model defined in Swagger
    ...
    def document_variation_id(self) -> str:
        """
        Gets the document_variation_id of this KnowledgeDocumentCopy.
        The variation of the document whose content was copied.

        :return: The document_variation_id of this KnowledgeDocumentCopy.
        :rtype: str
        """
    ...
    def document_variation_id(self, document_variation_id: str) -> None:
        """
        Sets the document_variation_id of this KnowledgeDocumentCopy.
        The variation of the document whose content was copied.

        :param document_variation_id: The document_variation_id of this KnowledgeDocumentCopy.
        :type: str
        """
    ...
    def document_version_id(self) -> str:
        """
        Gets the document_version_id of this KnowledgeDocumentCopy.
        The version of the document whose content was copied.

        :return: The document_version_id of this KnowledgeDocumentCopy.
        :rtype: str
        """
    ...
    def document_version_id(self, document_version_id: str) -> None:
        """
        Sets the document_version_id of this KnowledgeDocumentCopy.
        The version of the document whose content was copied.

        :param document_version_id: The document_version_id of this KnowledgeDocumentCopy.
        :type: str
        """
    ...
    def search_id(self) -> str:
        """
        Gets the search_id of this KnowledgeDocumentCopy.
        The search that surfaced the document whose content was copied.

        :return: The search_id of this KnowledgeDocumentCopy.
        :rtype: str
        """
    ...
    def search_id(self, search_id: str) -> None:
        """
        Sets the search_id of this KnowledgeDocumentCopy.
        The search that surfaced the document whose content was copied.

        :param search_id: The search_id of this KnowledgeDocumentCopy.
        :type: str
        """
    ...
    def query_type(self) -> str:
        """
        Gets the query_type of this KnowledgeDocumentCopy.
        The type of the query that surfaced the document.

        :return: The query_type of this KnowledgeDocumentCopy.
        :rtype: str
        """
    ...
    def query_type(self, query_type: str) -> None:
        """
        Sets the query_type of this KnowledgeDocumentCopy.
        The type of the query that surfaced the document.

        :param query_type: The query_type of this KnowledgeDocumentCopy.
        :type: str
        """
    ...
    def surfacing_method(self) -> str:
        """
        Gets the surfacing_method of this KnowledgeDocumentCopy.
        ...
        :return: The surfacing_method of this KnowledgeDocumentCopy.
        :rtype: str
        """
    ...
    def surfacing_method(self, surfacing_method: str) -> None:
        """
        Sets the surfacing_method of this KnowledgeDocumentCopy.
        The method how knowledge was surfaced. Article: Full article was shown. Snippet: A snippet from the article was shown. Highlight: A highlighted answer in a snippet was shown.Generative: A generated answer in a snippet was shown.

        :param surfacing_method: The surfacing_method of this KnowledgeDocumentCopy.
        :type: str
        """
    ...
    def session_id(self) -> str:
        """
        Gets the session_id of this KnowledgeDocumentCopy.
        Knowledge session ID.

        :return: The session_id of this KnowledgeDocumentCopy.
        :rtype: str
        """
    ...
    def session_id(self, session_id: str) -> None:
        """
        Sets the session_id of this KnowledgeDocumentCopy.
        Knowledge session ID.

        :param session_id: The session_id of this KnowledgeDocumentCopy.
        :type: str
        """
    ...
    def conversation_context(self) -> 'KnowledgeConversationContext':
        """
        Gets the conversation_context of this KnowledgeDocumentCopy.
        Conversation context information, if the document content is copied in the context of a conversation.

        :return: The conversation_context of this KnowledgeDocumentCopy.
    ...
    def conversation_context(self, conversation_context: 'KnowledgeConversationContext') -> None:
        """
        Sets the conversation_context of this KnowledgeDocumentCopy.
        Conversation context information, if the document content is copied in the context of a conversation.

        :param conversation_context: The conversation_context of this KnowledgeDocumentCopy.
    ...
    def application(self) -> 'KnowledgeSearchClientApplication':
        """
        Gets the application of this KnowledgeDocumentCopy.
        The client application in which the document content was copied.

        :return: The application of this KnowledgeDocumentCopy.
    ...
    def application(self, application: 'KnowledgeSearchClientApplication') -> None:
        """
        Sets the application of this KnowledgeDocumentCopy.
        The client application in which the document content was copied.

        :param application: The application of this KnowledgeDocumentCopy.
