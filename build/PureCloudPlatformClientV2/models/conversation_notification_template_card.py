...
class ConversationNotificationTemplateCard(object):
    """
    ...
    def __init__(self) -> None:
        """
        ConversationNotificationTemplateCard - a model defined in Swagger
    ...
    def header(self) -> 'ConversationNotificationTemplateHeader':
        """
        Gets the header of this ConversationNotificationTemplateCard.
        The template header.

        :return: The header of this ConversationNotificationTemplateCard.
    ...
    def header(self, header: 'ConversationNotificationTemplateHeader') -> None:
        """
        Sets the header of this ConversationNotificationTemplateCard.
        The template header.

        :param header: The header of this ConversationNotificationTemplateCard.
    ...
    def body(self) -> 'ConversationNotificationTemplateBody':
        """
        Gets the body of this ConversationNotificationTemplateCard.
        The template body.

        :return: The body of this ConversationNotificationTemplateCard.
    ...
    def body(self, body: 'ConversationNotificationTemplateBody') -> None:
        """
        Sets the body of this ConversationNotificationTemplateCard.
        The template body.

        :param body: The body of this ConversationNotificationTemplateCard.
    ...
    def buttons(self) -> List['ConversationNotificationTemplateButton']:
        """
        Gets the buttons of this ConversationNotificationTemplateCard.
        Template buttons.

        :return: The buttons of this ConversationNotificationTemplateCard.
    ...
    def buttons(self, buttons: List['ConversationNotificationTemplateButton']) -> None:
        """
        Sets the buttons of this ConversationNotificationTemplateCard.
        Template buttons.

        :param buttons: The buttons of this ConversationNotificationTemplateCard.
