...
if TYPE_CHECKING:
    ...
    from . import QueueConversationSocialExpressionEventTopicRecordersState
...
class QueueConversationSocialExpressionEventTopicCall(object):
    ...
    def __init__(self) -> None:
        ...
        self.swagger_types = {
            ...
            'recording': 'bool',
            'recording_state': 'str',
            'recorders_state': 'QueueConversationSocialExpressionEventTopicRecordersState',
            'muted': 'bool',
            'confined': 'bool',
            'held': 'bool',
            'secure_pause': 'bool',
    ...
    @property
    def recorders_state(self) -> 'QueueConversationSocialExpressionEventTopicRecordersState':
        """
        Gets the recorders_state of this QueueConversationSocialExpressionEventTopicCall.


        :return: The recorders_state of this QueueConversationSocialExpressionEventTopicCall.
        :rtype: QueueConversationSocialExpressionEventTopicRecordersState
        """
        return self._recorders_state

    @recorders_state.setter
    def recorders_state(self, recorders_state: 'QueueConversationSocialExpressionEventTopicRecordersState') -> None:
        """
        Sets the recorders_state of this QueueConversationSocialExpressionEventTopicCall.


        :param recorders_state: The recorders_state of this QueueConversationSocialExpressionEventTopicCall.
        :type: QueueConversationSocialExpressionEventTopicRecordersState
        """
    ...
    def secure_pause(self) -> bool:
        """
        Gets the secure_pause of this QueueConversationSocialExpressionEventTopicCall.
        True when the recording of this call is in secure pause status.

        :return: The secure_pause of this QueueConversationSocialExpressionEventTopicCall.
        :rtype: bool
        """
    ...
    def secure_pause(self, secure_pause: bool) -> None:
        """
        Sets the secure_pause of this QueueConversationSocialExpressionEventTopicCall.
        True when the recording of this call is in secure pause status.

        :param secure_pause: The secure_pause of this QueueConversationSocialExpressionEventTopicCall.
        :type: bool
        """
    ...
    @property
    def other(self) -> 'QueueConversationSocialExpressionEventTopicAddress':
        """
    ...
    @other.setter
    def other(self, other: 'QueueConversationSocialExpressionEventTopicAddress') -> None:
        """
    ...
    @property
    def disconnect_reasons(self) -> List['QueueConversationSocialExpressionEventTopicDisconnectReason']:
        """
    ...
    def disconnect_reasons(self, disconnect_reasons: List['QueueConversationSocialExpressionEventTopicDisconnectReason']) -> None:
        """
    ...
    @property
    def fax_status(self) -> 'QueueConversationSocialExpressionEventTopicFaxStatus':
        """
    ...
    @fax_status.setter
    def fax_status(self, fax_status: 'QueueConversationSocialExpressionEventTopicFaxStatus') -> None:
        """
    ...
    def queue_media_settings(self) -> 'QueueConversationSocialExpressionEventTopicQueueMediaSettings':
        """
        Gets the queue_media_settings of this QueueConversationSocialExpressionEventTopicCall.


        :return: The queue_media_settings of this QueueConversationSocialExpressionEventTopicCall.
    ...
    def queue_media_settings(self, queue_media_settings: 'QueueConversationSocialExpressionEventTopicQueueMediaSettings') -> None:
        """
        Sets the queue_media_settings of this QueueConversationSocialExpressionEventTopicCall.


        :param queue_media_settings: The queue_media_settings of this QueueConversationSocialExpressionEventTopicCall.
    ...
    def transfer_source(self) -> str:
        """
        Gets the transfer_source of this QueueConversationSocialExpressionEventTopicCall.
        Indicates how call reaches the agent.

        :return: The transfer_source of this QueueConversationSocialExpressionEventTopicCall.
        :rtype: str
        """
    ...
    def transfer_source(self, transfer_source: str) -> None:
        """
        Sets the transfer_source of this QueueConversationSocialExpressionEventTopicCall.
        Indicates how call reaches the agent.

        :param transfer_source: The transfer_source of this QueueConversationSocialExpressionEventTopicCall.
        :type: str
        """
    ...
    def public_ip_address(self) -> str:
        """
        Gets the public_ip_address of this QueueConversationSocialExpressionEventTopicCall.
        The reported client IP of the phone for the call.

        :return: The public_ip_address of this QueueConversationSocialExpressionEventTopicCall.
        :rtype: str
        """
    ...
    def public_ip_address(self, public_ip_address: str) -> None:
        """
        Sets the public_ip_address of this QueueConversationSocialExpressionEventTopicCall.
        The reported client IP of the phone for the call.

        :param public_ip_address: The public_ip_address of this QueueConversationSocialExpressionEventTopicCall.
        :type: str
        """
