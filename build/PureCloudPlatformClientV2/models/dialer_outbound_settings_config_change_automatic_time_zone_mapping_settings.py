...
if TYPE_CHECKING:
    from . import DialerOutboundSettingsConfigChangeCallableWindow

class DialerOutboundSettingsConfigChangeAutomaticTimeZoneMappingSettings(object):
    """
    ...
    def __init__(self) -> None:
        """
        DialerOutboundSettingsConfigChangeAutomaticTimeZoneMappingSettings - a model defined in Swagger
        ...
        """
        self.swagger_types = {
            'callable_windows': 'list[DialerOutboundSettingsConfigChangeCallableWindow]'
        }
    ...
    @property
    def callable_windows(self) -> List['DialerOutboundSettingsConfigChangeCallableWindow']:
        """
    ...
    def callable_windows(self, callable_windows: List['DialerOutboundSettingsConfigChangeCallableWindow']) -> None:
        """
