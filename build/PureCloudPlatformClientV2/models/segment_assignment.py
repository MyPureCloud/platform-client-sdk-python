...
class SegmentAssignment(object):
    ...
    def date_for_unassignment(self) -> datetime:
        """
        Gets the date_for_unassignment of this SegmentAssignment.
        ...
        :return: The date_for_unassignment of this SegmentAssignment.
        :rtype: datetime
        """
    ...
    def date_for_unassignment(self, date_for_unassignment: datetime) -> None:
        """
        Sets the date_for_unassignment of this SegmentAssignment.
        Date indicating when a segment is scheduled to be unassigned. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z

        :param date_for_unassignment: The date_for_unassignment of this SegmentAssignment.
        :type: datetime
        """
