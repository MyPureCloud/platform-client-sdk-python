...
class CreateTimeOffPlanBusinessUnitAssociation(object):
    """
    ...
    def __init__(self) -> None:
        """
        CreateTimeOffPlanBusinessUnitAssociation - a model defined in Swagger
    ...
    def management_unit_ids(self) -> List[str]:
        """
        Gets the management_unit_ids of this CreateTimeOffPlanBusinessUnitAssociation.
        The IDs of management units to which this time-off plan applies. This must not be set if staffingGroupIds is populated

        :return: The management_unit_ids of this CreateTimeOffPlanBusinessUnitAssociation.
        :rtype: list[str]
        """
    ...
    def management_unit_ids(self, management_unit_ids: List[str]) -> None:
        """
        Sets the management_unit_ids of this CreateTimeOffPlanBusinessUnitAssociation.
        The IDs of management units to which this time-off plan applies. This must not be set if staffingGroupIds is populated

        :param management_unit_ids: The management_unit_ids of this CreateTimeOffPlanBusinessUnitAssociation.
        :type: list[str]
        """
    ...
    def staffing_group_ids(self) -> List[str]:
        """
        Gets the staffing_group_ids of this CreateTimeOffPlanBusinessUnitAssociation.
        The IDs of staffing groups to which this time-off plan applies. This must not be set if managementUnitIds is populated

        :return: The staffing_group_ids of this CreateTimeOffPlanBusinessUnitAssociation.
        :rtype: list[str]
        """
    ...
    def staffing_group_ids(self, staffing_group_ids: List[str]) -> None:
        """
        Sets the staffing_group_ids of this CreateTimeOffPlanBusinessUnitAssociation.
        The IDs of staffing groups to which this time-off plan applies. This must not be set if managementUnitIds is populated

        :param staffing_group_ids: The staffing_group_ids of this CreateTimeOffPlanBusinessUnitAssociation.
        :type: list[str]
        """
