...
class ExternalOrganizationIdentifier(object):
    ...
    def __init__(self) -> None:
        """
        ExternalOrganizationIdentifier - a model defined in Swagger
    ...
    def division(self) -> 'WritableStarrableDivision':
        """
        Gets the division of this ExternalOrganizationIdentifier.
        The division to which this entity belongs.

        :return: The division of this ExternalOrganizationIdentifier.
    ...
    def division(self, division: 'WritableStarrableDivision') -> None:
        """
        Sets the division of this ExternalOrganizationIdentifier.
        The division to which this entity belongs.

        :param division: The division of this ExternalOrganizationIdentifier.
    ...
    def type(self) -> str:
        """
        Gets the type of this ExternalOrganizationIdentifier.
        The type of this identifier

        :return: The type of this ExternalOrganizationIdentifier.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type: str) -> None:
        """
        Sets the type of this ExternalOrganizationIdentifier.
        The type of this identifier

        :param type: The type of this ExternalOrganizationIdentifier.
        :type: str
        """
        if isinstance(type, int):
            type = str(type)
        allowed_values = ["ExternalId"]
    ...
    def date_created(self) -> datetime:
        """
        Gets the date_created of this ExternalOrganizationIdentifier.
        Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z

        :return: The date_created of this ExternalOrganizationIdentifier.
        :rtype: datetime
        """
    ...
    def date_created(self, date_created: datetime) -> None:
        """
        Sets the date_created of this ExternalOrganizationIdentifier.
        Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z

        :param date_created: The date_created of this ExternalOrganizationIdentifier.
        :type: datetime
        """
