...
class AgentScheduleBid(object):
    ...
    def __init__(self) -> None:
        """
        AgentScheduleBid - a model defined in Swagger
    ...
    def id(self) -> str:
        """
        Gets the id of this AgentScheduleBid.
        The ID of the schedule bid

        :return: The id of this AgentScheduleBid.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id: str) -> None:
        """
        Sets the id of this AgentScheduleBid.
        The ID of the schedule bid

        :param id: The id of this AgentScheduleBid.
        :type: str
        """
    ...
    def name(self) -> str:
        """
        Gets the name of this AgentScheduleBid.


        :return: The name of this AgentScheduleBid.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name: str) -> None:
        """
        Sets the name of this AgentScheduleBid.


        :param name: The name of this AgentScheduleBid.
        :type: str
        """
    ...
    def bid_window_start_date(self) -> date:
        """
        Gets the bid_window_start_date of this AgentScheduleBid.
        ...
        :return: The bid_window_start_date of this AgentScheduleBid.
        :rtype: date
        """
    ...
    def bid_window_start_date(self, bid_window_start_date: date) -> None:
        """
        Sets the bid_window_start_date of this AgentScheduleBid.
        The bid start date when agents can start participating in schedule bidding relative to the business unit time zone in yyyy-MM-dd format. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd

        :param bid_window_start_date: The bid_window_start_date of this AgentScheduleBid.
        :type: date
        """
    ...
    def bid_window_end_date(self) -> date:
        """
        Gets the bid_window_end_date of this AgentScheduleBid.
        ...
        :return: The bid_window_end_date of this AgentScheduleBid.
        :rtype: date
        """
    ...
    def bid_window_end_date(self, bid_window_end_date: date) -> None:
        """
        Sets the bid_window_end_date of this AgentScheduleBid.
        The bid end date relative to the business unit time zone in yyyy-MM-dd format. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd

        :param bid_window_end_date: The bid_window_end_date of this AgentScheduleBid.
        :type: date
        """
    ...
    def effective_date(self) -> date:
        """
        Gets the effective_date of this AgentScheduleBid.
        ...
        :return: The effective_date of this AgentScheduleBid.
        :rtype: date
        """
    ...
    def effective_date(self, effective_date: date) -> None:
        """
        Sets the effective_date of this AgentScheduleBid.
        The date when schedule sets would be effective for schedule generation relative to the business unit time zone in yyyy-MM-dd format. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd

        :param effective_date: The effective_date of this AgentScheduleBid.
        :type: date
        """
    ...
    def status(self) -> str:
        """
        Gets the status of this AgentScheduleBid.
        The state of the bid

        :return: The status of this AgentScheduleBid.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status: str) -> None:
        """
        Sets the status of this AgentScheduleBid.
        The state of the bid

        :param status: The status of this AgentScheduleBid.
        :type: str
        """
    ...
    def bid_type(self) -> str:
        """
        Gets the bid_type of this AgentScheduleBid.
        The type of the bid

        :return: The bid_type of this AgentScheduleBid.
        :rtype: str
        """
    ...
    def bid_type(self, bid_type: str) -> None:
        """
        Sets the bid_type of this AgentScheduleBid.
        The type of the bid

        :param bid_type: The bid_type of this AgentScheduleBid.
        :type: str
        """
    ...
    def self_uri(self) -> str:
        """
        Gets the self_uri of this AgentScheduleBid.
        The URI for this object

        :return: The self_uri of this AgentScheduleBid.
        :rtype: str
        """
    ...
    def self_uri(self, self_uri: str) -> None:
        """
        Sets the self_uri of this AgentScheduleBid.
        The URI for this object

        :param self_uri: The self_uri of this AgentScheduleBid.
        :type: str
        """
