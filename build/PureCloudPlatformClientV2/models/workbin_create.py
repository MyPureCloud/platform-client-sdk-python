...
class WorkbinCreate(object):
    ...
    def __init__(self) -> None:
        """
        WorkbinCreate - a model defined in Swagger
    ...
    def name(self) -> str:
        """
        Gets the name of this WorkbinCreate.
        Workbin name. Valid length between 3 and 256 characters.

        :return: The name of this WorkbinCreate.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name: str) -> None:
        """
        Sets the name of this WorkbinCreate.
        Workbin name. Valid length between 3 and 256 characters.

        :param name: The name of this WorkbinCreate.
        :type: str
        """
    ...
    def division_id(self) -> str:
        """
        Gets the division_id of this WorkbinCreate.
        The ID of the division the Workbin belongs to. Defaults to home division ID.

        :return: The division_id of this WorkbinCreate.
        :rtype: str
        """
    ...
    def division_id(self, division_id: str) -> None:
        """
        Sets the division_id of this WorkbinCreate.
        The ID of the division the Workbin belongs to. Defaults to home division ID.

        :param division_id: The division_id of this WorkbinCreate.
        :type: str
        """
