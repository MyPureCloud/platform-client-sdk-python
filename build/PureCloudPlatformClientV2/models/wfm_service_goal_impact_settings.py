...
class WfmServiceGoalImpactSettings(object):
    """
    ...
    def __init__(self) -> None:
        """
        WfmServiceGoalImpactSettings - a model defined in Swagger
    ...
    def service_level(self) -> 'WfmServiceGoalImpact':
        """
        Gets the service_level of this WfmServiceGoalImpactSettings.
        Allowed service level percent increase and decrease

        :return: The service_level of this WfmServiceGoalImpactSettings.
    ...
    def service_level(self, service_level: 'WfmServiceGoalImpact') -> None:
        """
        Sets the service_level of this WfmServiceGoalImpactSettings.
        Allowed service level percent increase and decrease

        :param service_level: The service_level of this WfmServiceGoalImpactSettings.
    ...
    def average_speed_of_answer(self) -> 'WfmServiceGoalImpact':
        """
        Gets the average_speed_of_answer of this WfmServiceGoalImpactSettings.
        Allowed average speed of answer percent increase and decrease

        :return: The average_speed_of_answer of this WfmServiceGoalImpactSettings.
        :rtype: WfmServiceGoalImpact
        """
    ...
    def average_speed_of_answer(self, average_speed_of_answer: 'WfmServiceGoalImpact') -> None:
        """
        Sets the average_speed_of_answer of this WfmServiceGoalImpactSettings.
        Allowed average speed of answer percent increase and decrease

        :param average_speed_of_answer: The average_speed_of_answer of this WfmServiceGoalImpactSettings.
        :type: WfmServiceGoalImpact
        """
    ...
    def abandon_rate(self) -> 'WfmServiceGoalImpact':
        """
        Gets the abandon_rate of this WfmServiceGoalImpactSettings.
        Allowed abandon rate percent increase and decrease

        :return: The abandon_rate of this WfmServiceGoalImpactSettings.
        :rtype: WfmServiceGoalImpact
        """
    ...
    def abandon_rate(self, abandon_rate: 'WfmServiceGoalImpact') -> None:
        """
        Sets the abandon_rate of this WfmServiceGoalImpactSettings.
        Allowed abandon rate percent increase and decrease

        :param abandon_rate: The abandon_rate of this WfmServiceGoalImpactSettings.
        :type: WfmServiceGoalImpact
        """
