...
class V2ConversationMessageTypingEventForWorkflowTopicConversationMessageEvent(object):
    ...
    def __init__(self) -> None:
        """
        V2ConversationMessageTypingEventForWorkflowTopicConversationMessageEvent - a model defined in Swagger
    ...
    def event_type(self) -> str:
        """
        Gets the event_type of this V2ConversationMessageTypingEventForWorkflowTopicConversationMessageEvent.


        :return: The event_type of this V2ConversationMessageTypingEventForWorkflowTopicConversationMessageEvent.
        :rtype: str
        """
    ...
    def event_type(self, event_type: str) -> None:
        """
        Sets the event_type of this V2ConversationMessageTypingEventForWorkflowTopicConversationMessageEvent.


        :param event_type: The event_type of this V2ConversationMessageTypingEventForWorkflowTopicConversationMessageEvent.
        :type: str
        """
    ...
    def typing(self) -> 'V2ConversationMessageTypingEventForWorkflowTopicConversationEventTyping':
        """
        Gets the typing of this V2ConversationMessageTypingEventForWorkflowTopicConversationMessageEvent.


        :return: The typing of this V2ConversationMessageTypingEventForWorkflowTopicConversationMessageEvent.
        :rtype: V2ConversationMessageTypingEventForWorkflowTopicConversationEventTyping
        """
        return self._typing

    @typing.setter
    def typing(self, typing: 'V2ConversationMessageTypingEventForWorkflowTopicConversationEventTyping') -> None:
        """
        Sets the typing of this V2ConversationMessageTypingEventForWorkflowTopicConversationMessageEvent.


        :param typing: The typing of this V2ConversationMessageTypingEventForWorkflowTopicConversationMessageEvent.
