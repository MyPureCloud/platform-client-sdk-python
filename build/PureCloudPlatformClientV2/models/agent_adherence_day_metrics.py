...
class AgentAdherenceDayMetrics(object):
    """
    ...
    def __init__(self) -> None:
        """
        AgentAdherenceDayMetrics - a model defined in Swagger
    ...
    def day_start_offset_seconds(self) -> int:
        """
        Gets the day_start_offset_seconds of this AgentAdherenceDayMetrics.
        Start of day offset in seconds relative to query start time

        :return: The day_start_offset_seconds of this AgentAdherenceDayMetrics.
        :rtype: int
        """
    ...
    def day_start_offset_seconds(self, day_start_offset_seconds: int) -> None:
        """
        Sets the day_start_offset_seconds of this AgentAdherenceDayMetrics.
        Start of day offset in seconds relative to query start time

        :param day_start_offset_seconds: The day_start_offset_seconds of this AgentAdherenceDayMetrics.
        :type: int
        """
    ...
    def adherence_schedule_seconds(self) -> int:
        """
        Gets the adherence_schedule_seconds of this AgentAdherenceDayMetrics.
        Duration of schedule in seconds included for adherence percentage calculation

        :return: The adherence_schedule_seconds of this AgentAdherenceDayMetrics.
        :rtype: int
        """
    ...
    def adherence_schedule_seconds(self, adherence_schedule_seconds: int) -> None:
        """
        Sets the adherence_schedule_seconds of this AgentAdherenceDayMetrics.
        Duration of schedule in seconds included for adherence percentage calculation

        :param adherence_schedule_seconds: The adherence_schedule_seconds of this AgentAdherenceDayMetrics.
        :type: int
        """
    ...
    def conformance_schedule_seconds(self) -> int:
        """
        Gets the conformance_schedule_seconds of this AgentAdherenceDayMetrics.
        Total scheduled duration in seconds for OnQueue activities

        :return: The conformance_schedule_seconds of this AgentAdherenceDayMetrics.
        :rtype: int
        """
    ...
    def conformance_schedule_seconds(self, conformance_schedule_seconds: int) -> None:
        """
        Sets the conformance_schedule_seconds of this AgentAdherenceDayMetrics.
        Total scheduled duration in seconds for OnQueue activities

        :param conformance_schedule_seconds: The conformance_schedule_seconds of this AgentAdherenceDayMetrics.
        :type: int
        """
    ...
    def conformance_actual_seconds(self) -> int:
        """
        Gets the conformance_actual_seconds of this AgentAdherenceDayMetrics.
        Total actually worked duration in seconds for OnQueue activities

        :return: The conformance_actual_seconds of this AgentAdherenceDayMetrics.
        :rtype: int
        """
    ...
    def conformance_actual_seconds(self, conformance_actual_seconds: int) -> None:
        """
        Sets the conformance_actual_seconds of this AgentAdherenceDayMetrics.
        Total actually worked duration in seconds for OnQueue activities

        :param conformance_actual_seconds: The conformance_actual_seconds of this AgentAdherenceDayMetrics.
        :type: int
        """
    ...
    def exception_count(self) -> int:
        """
        Gets the exception_count of this AgentAdherenceDayMetrics.
        Total number of adherence exceptions for this user

        :return: The exception_count of this AgentAdherenceDayMetrics.
        :rtype: int
        """
    ...
    def exception_count(self, exception_count: int) -> None:
        """
        Sets the exception_count of this AgentAdherenceDayMetrics.
        Total number of adherence exceptions for this user

        :param exception_count: The exception_count of this AgentAdherenceDayMetrics.
        :type: int
        """
    ...
    def exception_duration_seconds(self) -> int:
        """
        Gets the exception_duration_seconds of this AgentAdherenceDayMetrics.
        Total duration in seconds of adherence exceptions for this user

        :return: The exception_duration_seconds of this AgentAdherenceDayMetrics.
        :rtype: int
        """
    ...
    def exception_duration_seconds(self, exception_duration_seconds: int) -> None:
        """
        Sets the exception_duration_seconds of this AgentAdherenceDayMetrics.
        Total duration in seconds of adherence exceptions for this user

        :param exception_duration_seconds: The exception_duration_seconds of this AgentAdherenceDayMetrics.
        :type: int
        """
    ...
    def impact_seconds(self) -> int:
        """
        Gets the impact_seconds of this AgentAdherenceDayMetrics.
        The impact duration in seconds of current adherence state for this user

        :return: The impact_seconds of this AgentAdherenceDayMetrics.
        :rtype: int
        """
    ...
    def impact_seconds(self, impact_seconds: int) -> None:
        """
        Sets the impact_seconds of this AgentAdherenceDayMetrics.
        The impact duration in seconds of current adherence state for this user

        :param impact_seconds: The impact_seconds of this AgentAdherenceDayMetrics.
        :type: int
        """
    ...
    def schedule_length_seconds(self) -> int:
        """
        Gets the schedule_length_seconds of this AgentAdherenceDayMetrics.
        Total duration in seconds for all scheduled activities

        :return: The schedule_length_seconds of this AgentAdherenceDayMetrics.
        :rtype: int
        """
    ...
    def schedule_length_seconds(self, schedule_length_seconds: int) -> None:
        """
        Sets the schedule_length_seconds of this AgentAdherenceDayMetrics.
        Total duration in seconds for all scheduled activities

        :param schedule_length_seconds: The schedule_length_seconds of this AgentAdherenceDayMetrics.
        :type: int
        """
    ...
    def actual_length_seconds(self) -> int:
        """
        Gets the actual_length_seconds of this AgentAdherenceDayMetrics.
        Total duration in seconds for all actually worked activities

        :return: The actual_length_seconds of this AgentAdherenceDayMetrics.
        :rtype: int
        """
    ...
    def actual_length_seconds(self, actual_length_seconds: int) -> None:
        """
        Sets the actual_length_seconds of this AgentAdherenceDayMetrics.
        Total duration in seconds for all actually worked activities

        :param actual_length_seconds: The actual_length_seconds of this AgentAdherenceDayMetrics.
        :type: int
        """
    ...
    def adherence_percentage(self) -> float:
        """
        Gets the adherence_percentage of this AgentAdherenceDayMetrics.
        Total adherence percentage for this user, in the scale of 0 - 100

        :return: The adherence_percentage of this AgentAdherenceDayMetrics.
        :rtype: float
        """
    ...
    def adherence_percentage(self, adherence_percentage: float) -> None:
        """
        Sets the adherence_percentage of this AgentAdherenceDayMetrics.
        Total adherence percentage for this user, in the scale of 0 - 100

        :param adherence_percentage: The adherence_percentage of this AgentAdherenceDayMetrics.
        :type: float
        """
    ...
    def conformance_percentage(self) -> float:
        """
        Gets the conformance_percentage of this AgentAdherenceDayMetrics.
        ...
        :return: The conformance_percentage of this AgentAdherenceDayMetrics.
        :rtype: float
        """
    ...
    def conformance_percentage(self, conformance_percentage: float) -> None:
        """
        Sets the conformance_percentage of this AgentAdherenceDayMetrics.
        Total conformance percentage for this user, in the scale of 0 - 100. Conformance percentage can be greater than 100 when the actual on queue time is greater than the scheduled on queue time for the same period.

        :param conformance_percentage: The conformance_percentage of this AgentAdherenceDayMetrics.
        :type: float
        """
