...
class JourneyCustomerSession(object):
    """
    ...
    def __init__(self):
        """
        JourneyCustomerSession - a model defined in Swagger
    ...
    def id(self):
        """
        Gets the id of this JourneyCustomerSession.
        An ID of a Customer/User's session within the Journey System at a point-in-time

        :return: The id of this JourneyCustomerSession.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this JourneyCustomerSession.
        An ID of a Customer/User's session within the Journey System at a point-in-time

        :param id: The id of this JourneyCustomerSession.
        :type: str
        """
