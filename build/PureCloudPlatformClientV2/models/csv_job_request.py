...
class CsvJobRequest(object):
    ...
    def __init__(self) -> None:
        """
        CsvJobRequest - a model defined in Swagger
    ...
    def upload_id(self) -> str:
        """
        Gets the upload_id of this CsvJobRequest.
        Upload for the csv job

        :return: The upload_id of this CsvJobRequest.
        :rtype: str
        """
    ...
    def upload_id(self, upload_id: str) -> None:
        """
        Sets the upload_id of this CsvJobRequest.
        Upload for the csv job

        :param upload_id: The upload_id of this CsvJobRequest.
        :type: str
        """
    ...
    def settings_id(self) -> str:
        """
        Gets the settings_id of this CsvJobRequest.
        Settings for the csv job

        :return: The settings_id of this CsvJobRequest.
        :rtype: str
        """
        return self._settings_id

    @settings_id.setter
    def settings_id(self, settings_id: str) -> None:
        """
        Sets the settings_id of this CsvJobRequest.
        Settings for the csv job

        :param settings_id: The settings_id of this CsvJobRequest.
        :type: str
        """
