...
class TimeOffPlanBusinessUnitAssociation(object):
    """
    ...
    def __init__(self) -> None:
        """
        TimeOffPlanBusinessUnitAssociation - a model defined in Swagger
    ...
    def management_units(self) -> List['ManagementUnitReference']:
        """
        Gets the management_units of this TimeOffPlanBusinessUnitAssociation.
        Management units to which this time-off plan applies. This must not be set if staffingGroups is populated

        :return: The management_units of this TimeOffPlanBusinessUnitAssociation.
    ...
    def management_units(self, management_units: List['ManagementUnitReference']) -> None:
        """
        Sets the management_units of this TimeOffPlanBusinessUnitAssociation.
        Management units to which this time-off plan applies. This must not be set if staffingGroups is populated

        :param management_units: The management_units of this TimeOffPlanBusinessUnitAssociation.
    ...
    def staffing_groups(self) -> List['StaffingGroupReference']:
        """
        Gets the staffing_groups of this TimeOffPlanBusinessUnitAssociation.
        Staffing groups to which this time-off plan applies. This must not be set if managementUnits is populated

        :return: The staffing_groups of this TimeOffPlanBusinessUnitAssociation.
    ...
    def staffing_groups(self, staffing_groups: List['StaffingGroupReference']) -> None:
        """
        Sets the staffing_groups of this TimeOffPlanBusinessUnitAssociation.
        Staffing groups to which this time-off plan applies. This must not be set if managementUnits is populated

        :param staffing_groups: The staffing_groups of this TimeOffPlanBusinessUnitAssociation.
