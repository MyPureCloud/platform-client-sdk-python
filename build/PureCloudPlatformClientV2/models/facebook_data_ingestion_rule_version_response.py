...
class FacebookDataIngestionRuleVersionResponse(object):
    """
    ...
    def __init__(self) -> None:
        """
        FacebookDataIngestionRuleVersionResponse - a model defined in Swagger
    ...
    def id(self) -> str:
        """
        Gets the id of this FacebookDataIngestionRuleVersionResponse.
        ID of the Facebook data ingestion rule.

        :return: The id of this FacebookDataIngestionRuleVersionResponse.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id: str) -> None:
        """
        Sets the id of this FacebookDataIngestionRuleVersionResponse.
        ID of the Facebook data ingestion rule.

        :param id: The id of this FacebookDataIngestionRuleVersionResponse.
        :type: str
        """
    ...
    def name(self) -> str:
        """
        Gets the name of this FacebookDataIngestionRuleVersionResponse.
        The name of the data ingestion rule.

        :return: The name of this FacebookDataIngestionRuleVersionResponse.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name: str) -> None:
        """
        Sets the name of this FacebookDataIngestionRuleVersionResponse.
        The name of the data ingestion rule.

        :param name: The name of this FacebookDataIngestionRuleVersionResponse.
        :type: str
        """
    ...
    def description(self) -> str:
        """
        Gets the description of this FacebookDataIngestionRuleVersionResponse.
        A description of the data ingestion rule.

        :return: The description of this FacebookDataIngestionRuleVersionResponse.
        :rtype: str
        """
    ...
    def description(self, description: str) -> None:
        """
        Sets the description of this FacebookDataIngestionRuleVersionResponse.
        A description of the data ingestion rule.

        :param description: The description of this FacebookDataIngestionRuleVersionResponse.
        :type: str
        """
    ...
    def status(self) -> str:
        """
        Gets the status of this FacebookDataIngestionRuleVersionResponse.
        The status of the data ingestion rule.

        :return: The status of this FacebookDataIngestionRuleVersionResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status: str) -> None:
        """
        Sets the status of this FacebookDataIngestionRuleVersionResponse.
        The status of the data ingestion rule.

        :param status: The status of this FacebookDataIngestionRuleVersionResponse.
        :type: str
        """
    ...
    def version(self) -> int:
        """
        Gets the version of this FacebookDataIngestionRuleVersionResponse.
        The version number of the data ingestion rule.

        :return: The version of this FacebookDataIngestionRuleVersionResponse.
        :rtype: int
        """
    ...
    def version(self, version: int) -> None:
        """
        Sets the version of this FacebookDataIngestionRuleVersionResponse.
        The version number of the data ingestion rule.

        :param version: The version of this FacebookDataIngestionRuleVersionResponse.
        :type: int
        """
    ...
    def ingestion_rule_info(self) -> 'MessageInfo':
        """
        Gets the ingestion_rule_info of this FacebookDataIngestionRuleVersionResponse.
        The Info about ingestion rule.

        :return: The ingestion_rule_info of this FacebookDataIngestionRuleVersionResponse.
        :rtype: MessageInfo
        """
    ...
    def ingestion_rule_info(self, ingestion_rule_info: 'MessageInfo') -> None:
        """
        Sets the ingestion_rule_info of this FacebookDataIngestionRuleVersionResponse.
        The Info about ingestion rule.

        :param ingestion_rule_info: The ingestion_rule_info of this FacebookDataIngestionRuleVersionResponse.
        :type: MessageInfo
        """
    ...
    def countries(self) -> List[str]:
        """
        Gets the countries of this FacebookDataIngestionRuleVersionResponse.
        ...
        :return: The countries of this FacebookDataIngestionRuleVersionResponse.
        :rtype: list[str]
        """
    ...
    def countries(self, countries: List[str]) -> None:
        """
        Sets the countries of this FacebookDataIngestionRuleVersionResponse.
        The countries is available only on twitter data ingestion rule. ISO 3166-1 alpha-2 country codes where Data Ingestion Rules should apply. Defaults to worldwide.

        :param countries: The countries of this FacebookDataIngestionRuleVersionResponse.
        :type: list[str]
        """
    ...
    def self_uri(self) -> str:
        """
        Gets the self_uri of this FacebookDataIngestionRuleVersionResponse.
        The URI for this object

        :return: The self_uri of this FacebookDataIngestionRuleVersionResponse.
        :rtype: str
        """
    ...
    def self_uri(self, self_uri: str) -> None:
        """
        Sets the self_uri of this FacebookDataIngestionRuleVersionResponse.
        The URI for this object

        :param self_uri: The self_uri of this FacebookDataIngestionRuleVersionResponse.
        :type: str
        """
