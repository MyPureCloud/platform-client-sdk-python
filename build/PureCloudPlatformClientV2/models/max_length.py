...
class MaxLength(object):
    ...
    def __init__(self):
        """
        MaxLength - a model defined in Swagger
    ...
    def min(self):
        """
        Gets the min of this MaxLength.
        ...
        :return: The min of this MaxLength.
        :rtype: int
        """
        return self._min
    ...
    def min(self, min):
        """
        Sets the min of this MaxLength.
        A non-negative integer for a text-based schema field denoting the minimum largest length string the field can contain for a schema instance.

        :param min: The min of this MaxLength.
        :type: int
        """
    ...
    def max(self):
        """
        Gets the max of this MaxLength.
        ...
        :return: The max of this MaxLength.
        :rtype: int
        """
        return self._max
    ...
    def max(self, max):
        """
        Sets the max of this MaxLength.
        A non-negative integer for a text-based schema field denoting the maximum largest string the field can contain for a schema instance.

        :param max: The max of this MaxLength.
        :type: int
        """
