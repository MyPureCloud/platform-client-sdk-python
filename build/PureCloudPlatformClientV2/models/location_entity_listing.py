...
class LocationEntityListing(object):
    """
    ...
    def __init__(self) -> None:
        """
        LocationEntityListing - a model defined in Swagger
        ...
        """
        self.swagger_types = {
            'entities': 'list[LocationDefinition]',
            'page_size': 'int',
            'page_number': 'int',
            'total': 'int',
            'next_uri': 'str',
    ...
    @property
    def entities(self) -> List['LocationDefinition']:
        """
        Gets the entities of this LocationEntityListing.


        :return: The entities of this LocationEntityListing.
        :rtype: list[LocationDefinition]
        """
        return self._entities

    @entities.setter
    def entities(self, entities: List['LocationDefinition']) -> None:
        """
        Sets the entities of this LocationEntityListing.


        :param entities: The entities of this LocationEntityListing.
    ...
    def page_size(self) -> int:
        """
        Gets the page_size of this LocationEntityListing.


        :return: The page_size of this LocationEntityListing.
        :rtype: int
        """
    ...
    def page_size(self, page_size: int) -> None:
        """
        Sets the page_size of this LocationEntityListing.


        :param page_size: The page_size of this LocationEntityListing.
        :type: int
        """
    ...
    def page_number(self) -> int:
        """
        Gets the page_number of this LocationEntityListing.


        :return: The page_number of this LocationEntityListing.
        :rtype: int
        """
    ...
    def page_number(self, page_number: int) -> None:
        """
        Sets the page_number of this LocationEntityListing.


        :param page_number: The page_number of this LocationEntityListing.
        :type: int
        """
    ...
    def total(self) -> int:
        """
        Gets the total of this LocationEntityListing.


        :return: The total of this LocationEntityListing.
        :rtype: int
        """
        return self._total
    ...
    def total(self, total: int) -> None:
        """
        Sets the total of this LocationEntityListing.


        :param total: The total of this LocationEntityListing.
        :type: int
        """
    ...
    def page_count(self) -> int:
        """
        Gets the page_count of this LocationEntityListing.


        :return: The page_count of this LocationEntityListing.
        :rtype: int
        """
    ...
    def page_count(self, page_count: int) -> None:
        """
        Sets the page_count of this LocationEntityListing.


        :param page_count: The page_count of this LocationEntityListing.
        :type: int
        """
