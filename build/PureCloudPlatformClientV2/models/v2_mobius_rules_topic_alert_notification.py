...
class V2MobiusRulesTopicAlertNotification(object):
    ...
    def __init__(self) -> None:
        """
        V2MobiusRulesTopicAlertNotification - a model defined in Swagger
    ...
    def notification_types(self) -> List[str]:
        """
        Gets the notification_types of this V2MobiusRulesTopicAlertNotification.


        :return: The notification_types of this V2MobiusRulesTopicAlertNotification.
        :rtype: list[str]
        """
    ...
    def notification_types(self, notification_types: List[str]) -> None:
        """
        Sets the notification_types of this V2MobiusRulesTopicAlertNotification.


        :param notification_types: The notification_types of this V2MobiusRulesTopicAlertNotification.
        :type: list[str]
        """
