...
if TYPE_CHECKING:
    from . import DialerCampaignProgressEventUriReference
...
class DialerCampaignProgressEventCampaignProgress(object):
    ...
    @property
    def campaign(self) -> 'DialerCampaignProgressEventUriReference':
        """
    ...
    @campaign.setter
    def campaign(self, campaign: 'DialerCampaignProgressEventUriReference') -> None:
        """
    ...
    def number_of_contacts_skipped(self) -> Dict[str, int]:
        """
        Gets the number_of_contacts_skipped of this DialerCampaignProgressEventCampaignProgress.
        A map of skipped reasons and the number of contacts associated with each.

        :return: The number_of_contacts_skipped of this DialerCampaignProgressEventCampaignProgress.
        :rtype: dict(str, int)
        """
    ...
    def number_of_contacts_skipped(self, number_of_contacts_skipped: Dict[str, int]) -> None:
        """
        Sets the number_of_contacts_skipped of this DialerCampaignProgressEventCampaignProgress.
        A map of skipped reasons and the number of contacts associated with each.

        :param number_of_contacts_skipped: The number_of_contacts_skipped of this DialerCampaignProgressEventCampaignProgress.
        :type: dict(str, int)
        """
    ...
    def get_additional_properties(self) -> Dict[str, object]:
        """
        Gets the get_additional_properties of this DialerCampaignProgressEventCampaignProgress.


        :return: The get_additional_properties of this DialerCampaignProgressEventCampaignProgress.
        :rtype: dict(str, object)
        """
    ...
    def get_additional_properties(self, get_additional_properties: Dict[str, object]) -> None:
        """
        Sets the get_additional_properties of this DialerCampaignProgressEventCampaignProgress.


        :param get_additional_properties: The get_additional_properties of this DialerCampaignProgressEventCampaignProgress.
        :type: dict(str, object)
        """
