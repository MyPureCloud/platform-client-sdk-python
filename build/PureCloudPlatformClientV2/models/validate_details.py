...
class ValidateDetails(object):
    ...
    def __init__(self) -> None:
        """
        ValidateDetails - a model defined in Swagger
    ...
    def flow(self, flow: 'ArchitectFlowReference') -> None:
        """
        Sets the flow of this ValidateDetails.
        The flow to validate. If you do not provide the flow ID, you must provide both the name and type.

        :param flow: The flow of this ValidateDetails.
