...
class TimeOffRequestListItem(object):
    """
    ...
    def __init__(self) -> None:
        """
        TimeOffRequestListItem - a model defined in Swagger
    ...
    def id(self) -> str:
        """
        Gets the id of this TimeOffRequestListItem.
        The globally unique identifier for the object.

        :return: The id of this TimeOffRequestListItem.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id: str) -> None:
        """
        Sets the id of this TimeOffRequestListItem.
        The globally unique identifier for the object.

        :param id: The id of this TimeOffRequestListItem.
        :type: str
        """
    ...
    def user(self) -> 'UserReference':
        """
        Gets the user of this TimeOffRequestListItem.
        The user that the time off request belongs to

        :return: The user of this TimeOffRequestListItem.
        :rtype: UserReference
        """
        return self._user
    ...
    def user(self, user: 'UserReference') -> None:
        """
        Sets the user of this TimeOffRequestListItem.
        The user that the time off request belongs to

        :param user: The user of this TimeOffRequestListItem.
        :type: UserReference
        """
    ...
    def is_full_day_request(self) -> bool:
        """
        Gets the is_full_day_request of this TimeOffRequestListItem.
        Whether this is a full day request (false means partial day)

        :return: The is_full_day_request of this TimeOffRequestListItem.
        :rtype: bool
        """
    ...
    def is_full_day_request(self, is_full_day_request: bool) -> None:
        """
        Sets the is_full_day_request of this TimeOffRequestListItem.
        Whether this is a full day request (false means partial day)

        :param is_full_day_request: The is_full_day_request of this TimeOffRequestListItem.
        :type: bool
        """
    ...
    def marked_as_read(self) -> bool:
        """
        Gets the marked_as_read of this TimeOffRequestListItem.
        Deprecated - Always returns true.

        :return: The marked_as_read of this TimeOffRequestListItem.
        :rtype: bool
        """
    ...
    def marked_as_read(self, marked_as_read: bool) -> None:
        """
        Sets the marked_as_read of this TimeOffRequestListItem.
        Deprecated - Always returns true.

        :param marked_as_read: The marked_as_read of this TimeOffRequestListItem.
        :type: bool
        """
    ...
    def activity_code_id(self) -> str:
        """
        Gets the activity_code_id of this TimeOffRequestListItem.
        The ID of the activity code associated with this time off request. Activity code must be of the TimeOff category

        :return: The activity_code_id of this TimeOffRequestListItem.
        :rtype: str
        """
    ...
    def activity_code_id(self, activity_code_id: str) -> None:
        """
        Sets the activity_code_id of this TimeOffRequestListItem.
        The ID of the activity code associated with this time off request. Activity code must be of the TimeOff category

        :param activity_code_id: The activity_code_id of this TimeOffRequestListItem.
        :type: str
        """
    ...
    def paid(self) -> bool:
        """
        Gets the paid of this TimeOffRequestListItem.
        Whether this is a paid time off request

        :return: The paid of this TimeOffRequestListItem.
        :rtype: bool
        """
        return self._paid
    ...
    def paid(self, paid: bool) -> None:
        """
        Sets the paid of this TimeOffRequestListItem.
        Whether this is a paid time off request

        :param paid: The paid of this TimeOffRequestListItem.
        :type: bool
        """
    ...
    def status(self) -> str:
        """
        Gets the status of this TimeOffRequestListItem.
        The status of this time off request

        :return: The status of this TimeOffRequestListItem.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status: str) -> None:
        """
        Sets the status of this TimeOffRequestListItem.
        The status of this time off request

        :param status: The status of this TimeOffRequestListItem.
        :type: str
        """
    ...
    def substatus(self) -> str:
        """
        Gets the substatus of this TimeOffRequestListItem.
        The substatus of this time off request

        :return: The substatus of this TimeOffRequestListItem.
        :rtype: str
        """
    ...
    def substatus(self, substatus: str) -> None:
        """
        Sets the substatus of this TimeOffRequestListItem.
        The substatus of this time off request

        :param substatus: The substatus of this TimeOffRequestListItem.
        :type: str
        """
    ...
    def partial_day_start_date_times(self) -> List[datetime]:
        """
        Gets the partial_day_start_date_times of this TimeOffRequestListItem.
        A set of start date-times in ISO-8601 format for partial day requests.  Will be not empty if isFullDayRequest == false

        :return: The partial_day_start_date_times of this TimeOffRequestListItem.
        :rtype: list[datetime]
        """
    ...
    def partial_day_start_date_times(self, partial_day_start_date_times: List[datetime]) -> None:
        """
        Sets the partial_day_start_date_times of this TimeOffRequestListItem.
        A set of start date-times in ISO-8601 format for partial day requests.  Will be not empty if isFullDayRequest == false

        :param partial_day_start_date_times: The partial_day_start_date_times of this TimeOffRequestListItem.
        :type: list[datetime]
        """
    ...
    def full_day_management_unit_dates(self) -> List[str]:
        """
        Gets the full_day_management_unit_dates of this TimeOffRequestListItem.
        ...
        :return: The full_day_management_unit_dates of this TimeOffRequestListItem.
        :rtype: list[str]
        """
    ...
    def full_day_management_unit_dates(self, full_day_management_unit_dates: List[str]) -> None:
        """
        Sets the full_day_management_unit_dates of this TimeOffRequestListItem.
        A set of dates in yyyy-MM-dd format.  Should be interpreted in the management unit's configured time zone.  Will be not empty if isFullDayRequest == true

        :param full_day_management_unit_dates: The full_day_management_unit_dates of this TimeOffRequestListItem.
        :type: list[str]
        """
    ...
    def daily_duration_minutes(self) -> int:
        """
        Gets the daily_duration_minutes of this TimeOffRequestListItem.
        The daily duration of this time off request in minutes

        :return: The daily_duration_minutes of this TimeOffRequestListItem.
        :rtype: int
        """
    ...
    def daily_duration_minutes(self, daily_duration_minutes: int) -> None:
        """
        Sets the daily_duration_minutes of this TimeOffRequestListItem.
        The daily duration of this time off request in minutes

        :param daily_duration_minutes: The daily_duration_minutes of this TimeOffRequestListItem.
        :type: int
        """
    ...
    def duration_minutes(self) -> List[int]:
        """
        Gets the duration_minutes of this TimeOffRequestListItem.
        Daily durations for each day of this time off request in minutes

        :return: The duration_minutes of this TimeOffRequestListItem.
        :rtype: list[int]
        """
    ...
    def duration_minutes(self, duration_minutes: List[int]) -> None:
        """
        Sets the duration_minutes of this TimeOffRequestListItem.
        Daily durations for each day of this time off request in minutes

        :param duration_minutes: The duration_minutes of this TimeOffRequestListItem.
        :type: list[int]
        """
    ...
    def payable_minutes(self) -> List[int]:
        """
        Gets the payable_minutes of this TimeOffRequestListItem.
        Payable minutes for each day of this time off request

        :return: The payable_minutes of this TimeOffRequestListItem.
        :rtype: list[int]
        """
    ...
    def payable_minutes(self, payable_minutes: List[int]) -> None:
        """
        Sets the payable_minutes of this TimeOffRequestListItem.
        Payable minutes for each day of this time off request

        :param payable_minutes: The payable_minutes of this TimeOffRequestListItem.
        :type: list[int]
        """
    ...
    def full_day_earliest_start_offset_minutes(self) -> List[int]:
        """
        Gets the full_day_earliest_start_offset_minutes of this TimeOffRequestListItem.
        ...
        :return: The full_day_earliest_start_offset_minutes of this TimeOffRequestListItem.
        :rtype: list[int]
        """
    ...
    def full_day_earliest_start_offset_minutes(self, full_day_earliest_start_offset_minutes: List[int]) -> None:
        """
        Sets the full_day_earliest_start_offset_minutes of this TimeOffRequestListItem.
        Earliest start offset in minutes for each full-day request date. Values may be null when time-off estimation is disabled or no estimate is available

        :param full_day_earliest_start_offset_minutes: The full_day_earliest_start_offset_minutes of this TimeOffRequestListItem.
        :type: list[int]
        """
    ...
    def full_day_latest_end_offset_minutes(self) -> List[int]:
        """
        Gets the full_day_latest_end_offset_minutes of this TimeOffRequestListItem.
        ...
        :return: The full_day_latest_end_offset_minutes of this TimeOffRequestListItem.
        :rtype: list[int]
        """
    ...
    def full_day_latest_end_offset_minutes(self, full_day_latest_end_offset_minutes: List[int]) -> None:
        """
        Sets the full_day_latest_end_offset_minutes of this TimeOffRequestListItem.
        Latest end offset in minutes for each full-day request date. Values may be null when time-off estimation is disabled or no estimate is available

        :param full_day_latest_end_offset_minutes: The full_day_latest_end_offset_minutes of this TimeOffRequestListItem.
        :type: list[int]
        """
    ...
    def notes(self) -> str:
        """
        Gets the notes of this TimeOffRequestListItem.
        Notes about the time off request

        :return: The notes of this TimeOffRequestListItem.
        :rtype: str
        """
        return self._notes
    ...
    def notes(self, notes: str) -> None:
        """
        Sets the notes of this TimeOffRequestListItem.
        Notes about the time off request

        :param notes: The notes of this TimeOffRequestListItem.
        :type: str
        """
    ...
    def submitted_by(self) -> 'UserReference':
        """
        Gets the submitted_by of this TimeOffRequestListItem.
        The user who submitted this time off request. The id may be 'System' if it was an automated process

        :return: The submitted_by of this TimeOffRequestListItem.
        :rtype: UserReference
        """
    ...
    def submitted_by(self, submitted_by: 'UserReference') -> None:
        """
        Sets the submitted_by of this TimeOffRequestListItem.
        The user who submitted this time off request. The id may be 'System' if it was an automated process

        :param submitted_by: The submitted_by of this TimeOffRequestListItem.
        :type: UserReference
        """
    ...
    def submitted_date(self) -> datetime:
        """
        Gets the submitted_date of this TimeOffRequestListItem.
        ...
        :return: The submitted_date of this TimeOffRequestListItem.
        :rtype: datetime
        """
    ...
    def submitted_date(self, submitted_date: datetime) -> None:
        """
        Sets the submitted_date of this TimeOffRequestListItem.
        The timestamp when this request was submitted. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z

        :param submitted_date: The submitted_date of this TimeOffRequestListItem.
        :type: datetime
        """
    ...
    def reviewed_by(self) -> 'UserReference':
        """
        Gets the reviewed_by of this TimeOffRequestListItem.
        The user who reviewed this time off request. The id may be 'System' if it was an automated process

        :return: The reviewed_by of this TimeOffRequestListItem.
        :rtype: UserReference
        """
    ...
    def reviewed_by(self, reviewed_by: 'UserReference') -> None:
        """
        Sets the reviewed_by of this TimeOffRequestListItem.
        The user who reviewed this time off request. The id may be 'System' if it was an automated process

        :param reviewed_by: The reviewed_by of this TimeOffRequestListItem.
        :type: UserReference
        """
    ...
    def reviewed_date(self) -> datetime:
        """
        Gets the reviewed_date of this TimeOffRequestListItem.
        ...
        :return: The reviewed_date of this TimeOffRequestListItem.
        :rtype: datetime
        """
    ...
    def reviewed_date(self, reviewed_date: datetime) -> None:
        """
        Sets the reviewed_date of this TimeOffRequestListItem.
        The timestamp when this request was reviewed. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z

        :param reviewed_date: The reviewed_date of this TimeOffRequestListItem.
        :type: datetime
        """
    ...
    def sync_version(self) -> int:
        """
        Gets the sync_version of this TimeOffRequestListItem.
        The sync version of this time off request for which the scheduled activity is associated

        :return: The sync_version of this TimeOffRequestListItem.
        :rtype: int
        """
    ...
    def sync_version(self, sync_version: int) -> None:
        """
        Sets the sync_version of this TimeOffRequestListItem.
        The sync version of this time off request for which the scheduled activity is associated

        :param sync_version: The sync_version of this TimeOffRequestListItem.
        :type: int
        """
    ...
    def metadata(self) -> 'WfmVersionedEntityMetadata':
        """
        Gets the metadata of this TimeOffRequestListItem.
        The version metadata of the time off request

        :return: The metadata of this TimeOffRequestListItem.
    ...
    def metadata(self, metadata: 'WfmVersionedEntityMetadata') -> None:
        """
        Sets the metadata of this TimeOffRequestListItem.
        The version metadata of the time off request

        :param metadata: The metadata of this TimeOffRequestListItem.
    ...
    def self_uri(self) -> str:
        """
        Gets the self_uri of this TimeOffRequestListItem.
        The URI for this object

        :return: The self_uri of this TimeOffRequestListItem.
        :rtype: str
        """
    ...
    def self_uri(self, self_uri: str) -> None:
        """
        Sets the self_uri of this TimeOffRequestListItem.
        The URI for this object

        :param self_uri: The self_uri of this TimeOffRequestListItem.
        :type: str
        """
