...
class WorkPlanConstraintMessage(object):
    """
    ...
    def __init__(self) -> None:
        """
        WorkPlanConstraintMessage - a model defined in Swagger
    ...
    def type(self) -> str:
        """
        Gets the type of this WorkPlanConstraintMessage.
        Type of the work plan constraint in this message

        :return: The type of this WorkPlanConstraintMessage.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type: str) -> None:
        """
        Sets the type of this WorkPlanConstraintMessage.
        Type of the work plan constraint in this message
    ...
    def arguments(self) -> List['WorkPlanValidationMessageArgument']:
        """
        Gets the arguments of this WorkPlanConstraintMessage.
        ...
        :return: The arguments of this WorkPlanConstraintMessage.
    ...
    def arguments(self, arguments: List['WorkPlanValidationMessageArgument']) -> None:
        """
        Sets the arguments of this WorkPlanConstraintMessage.
        Arguments of the message that provide information about the constraint that is being conflicted with, such as the value of the constraint

        :param arguments: The arguments of this WorkPlanConstraintMessage.
