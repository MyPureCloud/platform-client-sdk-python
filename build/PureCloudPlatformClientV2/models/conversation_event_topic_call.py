...
if TYPE_CHECKING:
    ...
    from . import ConversationEventTopicRecordersState
...
class ConversationEventTopicCall(object):
    ...
    def __init__(self) -> None:
        ...
        self.swagger_types = {
            ...
            'recording': 'bool',
            'recording_state': 'str',
            'recorders_state': 'ConversationEventTopicRecordersState',
            'muted': 'bool',
            'confined': 'bool',
            'held': 'bool',
            'secure_pause': 'bool',
    ...
    def initial_state(self) -> str:
        """
        Gets the initial_state of this ConversationEventTopicCall.


        :return: The initial_state of this ConversationEventTopicCall.
        :rtype: str
        """
    ...
    def initial_state(self, initial_state: str) -> None:
        """
        Sets the initial_state of this ConversationEventTopicCall.
    ...
    @property
    def recorders_state(self) -> 'ConversationEventTopicRecordersState':
        """
        Gets the recorders_state of this ConversationEventTopicCall.


        :return: The recorders_state of this ConversationEventTopicCall.
        :rtype: ConversationEventTopicRecordersState
        """
        return self._recorders_state

    @recorders_state.setter
    def recorders_state(self, recorders_state: 'ConversationEventTopicRecordersState') -> None:
        """
        Sets the recorders_state of this ConversationEventTopicCall.


        :param recorders_state: The recorders_state of this ConversationEventTopicCall.
        :type: ConversationEventTopicRecordersState
        """
    ...
    def secure_pause(self) -> bool:
        """
        Gets the secure_pause of this ConversationEventTopicCall.
        True when the recording of this call is in secure pause status.

        :return: The secure_pause of this ConversationEventTopicCall.
        :rtype: bool
        """
    ...
    def secure_pause(self, secure_pause: bool) -> None:
        """
        Sets the secure_pause of this ConversationEventTopicCall.
        True when the recording of this call is in secure pause status.

        :param secure_pause: The secure_pause of this ConversationEventTopicCall.
        :type: bool
        """
    ...
    @property
    def other(self) -> 'ConversationEventTopicAddress':
        """
    ...
    @other.setter
    def other(self, other: 'ConversationEventTopicAddress') -> None:
        """
    ...
    @property
    def disconnect_reasons(self) -> List['ConversationEventTopicDisconnectReason']:
        """
    ...
    def disconnect_reasons(self, disconnect_reasons: List['ConversationEventTopicDisconnectReason']) -> None:
        """
    ...
    @property
    def fax_status(self) -> 'ConversationEventTopicFaxStatus':
        """
    ...
    @fax_status.setter
    def fax_status(self, fax_status: 'ConversationEventTopicFaxStatus') -> None:
        """
    ...
    def barged_time(self) -> datetime:
        """
        Gets the barged_time of this ConversationEventTopicCall.
        The timestamp when this participant was connected to the barge conference in the provider clock.

        :return: The barged_time of this ConversationEventTopicCall.
        :rtype: datetime
        """
    ...
    def barged_time(self, barged_time: datetime) -> None:
        """
        Sets the barged_time of this ConversationEventTopicCall.
        The timestamp when this participant was connected to the barge conference in the provider clock.

        :param barged_time: The barged_time of this ConversationEventTopicCall.
        :type: datetime
        """
    ...
    def after_call_work(self) -> 'ConversationEventTopicAfterCallWork':
        """
        Gets the after_call_work of this ConversationEventTopicCall.


        :return: The after_call_work of this ConversationEventTopicCall.
    ...
    def after_call_work(self, after_call_work: 'ConversationEventTopicAfterCallWork') -> None:
        """
        Sets the after_call_work of this ConversationEventTopicCall.


        :param after_call_work: The after_call_work of this ConversationEventTopicCall.
    ...
    def queue_media_settings(self) -> 'ConversationEventTopicQueueMediaSettings':
        """
        Gets the queue_media_settings of this ConversationEventTopicCall.


        :return: The queue_media_settings of this ConversationEventTopicCall.
    ...
    def queue_media_settings(self, queue_media_settings: 'ConversationEventTopicQueueMediaSettings') -> None:
        """
        Sets the queue_media_settings of this ConversationEventTopicCall.


        :param queue_media_settings: The queue_media_settings of this ConversationEventTopicCall.
    ...
    def public_ip_address(self) -> str:
        """
        Gets the public_ip_address of this ConversationEventTopicCall.
        The reported client IP of the phone for the call.

        :return: The public_ip_address of this ConversationEventTopicCall.
        :rtype: str
        """
    ...
    def public_ip_address(self, public_ip_address: str) -> None:
        """
        Sets the public_ip_address of this ConversationEventTopicCall.
        The reported client IP of the phone for the call.

        :param public_ip_address: The public_ip_address of this ConversationEventTopicCall.
        :type: str
        """
