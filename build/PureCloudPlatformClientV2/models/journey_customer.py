...
class JourneyCustomer(object):
    ...
    def __init__(self):
        """
        JourneyCustomer - a model defined in Swagger
    ...
    def id(self):
        """
        Gets the id of this JourneyCustomer.
        ...
        :return: The id of this JourneyCustomer.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this JourneyCustomer.
        An ID of a customer within the Journey System at a point-in-time.  Note that a customer entity can have multiple customerIds based on the stitching process.  Depending on the context within the PureCloud conversation, this may or may not be mutable.

        :param id: The id of this JourneyCustomer.
        :type: str
        """
