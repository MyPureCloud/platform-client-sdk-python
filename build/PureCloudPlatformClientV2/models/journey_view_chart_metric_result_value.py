...
class JourneyViewChartMetricResultValue(object):
    ...
    def __init__(self) -> None:
        """
        JourneyViewChartMetricResultValue - a model defined in Swagger
    ...
    @property
    def group_by_attributes(self) -> List['GroupByAttribute']:
        """
        Gets the group_by_attributes of this JourneyViewChartMetricResultValue.
        Group by attributes for this metric

        :return: The group_by_attributes of this JourneyViewChartMetricResultValue.
        :rtype: list[GroupByAttribute]
        """
        return self._group_by_attributes

    @group_by_attributes.setter
    def group_by_attributes(self, group_by_attributes: List['GroupByAttribute']) -> None:
        """
        Sets the group_by_attributes of this JourneyViewChartMetricResultValue.
        Group by attributes for this metric

        :param group_by_attributes: The group_by_attributes of this JourneyViewChartMetricResultValue.
        :type: list[GroupByAttribute]
        """
