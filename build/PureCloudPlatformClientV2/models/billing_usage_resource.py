...
class BillingUsageResource(object):
    """
    ...
    def __init__(self):
        """
        BillingUsageResource - a model defined in Swagger
    ...
    def name(self):
        """
        Gets the name of this BillingUsageResource.
        Identifies the resource (e.g. license user, device).

        :return: The name of this BillingUsageResource.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this BillingUsageResource.
        Identifies the resource (e.g. license user, device).

        :param name: The name of this BillingUsageResource.
        :type: str
        """
