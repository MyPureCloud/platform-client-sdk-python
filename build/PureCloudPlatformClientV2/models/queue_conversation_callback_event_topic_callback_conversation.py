...
class QueueConversationCallbackEventTopicCallbackConversation(object):
    ...
    def access_attributes(self) -> List[str]:
        """
        Gets the access_attributes of this QueueConversationCallbackEventTopicCallbackConversation.


        :return: The access_attributes of this QueueConversationCallbackEventTopicCallbackConversation.
        :rtype: list[str]
        """
    ...
    def access_attributes(self, access_attributes: List[str]) -> None:
        """
        Sets the access_attributes of this QueueConversationCallbackEventTopicCallbackConversation.


        :param access_attributes: The access_attributes of this QueueConversationCallbackEventTopicCallbackConversation.
        :type: list[str]
        """
    ...
    def inactivity_timeout(self) -> datetime:
        """
        Gets the inactivity_timeout of this QueueConversationCallbackEventTopicCallbackConversation.


        :return: The inactivity_timeout of this QueueConversationCallbackEventTopicCallbackConversation.
        :rtype: datetime
        """
    ...
    def inactivity_timeout(self, inactivity_timeout: datetime) -> None:
        """
        Sets the inactivity_timeout of this QueueConversationCallbackEventTopicCallbackConversation.


        :param inactivity_timeout: The inactivity_timeout of this QueueConversationCallbackEventTopicCallbackConversation.
        :type: datetime
        """
