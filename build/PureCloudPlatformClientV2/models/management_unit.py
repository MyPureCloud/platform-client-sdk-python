...
if TYPE_CHECKING:
    ...
    from . import ManagementUnitSettingsResponse
...
class ManagementUnit(object):
    ...
    @property
    def settings(self) -> 'ManagementUnitSettingsResponse':
        """
    ...
    @settings.setter
    def settings(self, settings: 'ManagementUnitSettingsResponse') -> None:
        """
