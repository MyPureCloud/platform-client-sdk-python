...
if TYPE_CHECKING:
    from . import FlowMetricsTopicFlowOutcome
    from . import FlowMetricsTopicFlowProposedAgent
    from . import FlowMetricsTopicFlowScoredAgent
...
class FlowMetricsTopicFlowMetricRecord(object):
    ...
    def active_routing(self) -> str:
        """
        Gets the active_routing of this FlowMetricsTopicFlowMetricRecord.
        Active routing method

        :return: The active_routing of this FlowMetricsTopicFlowMetricRecord.
        :rtype: str
        """
    ...
    def active_routing(self, active_routing: str) -> None:
        """
        Sets the active_routing of this FlowMetricsTopicFlowMetricRecord.
        Active routing method

        :param active_routing: The active_routing of this FlowMetricsTopicFlowMetricRecord.
        :type: str
        """
    ...
    def disconnect_type(self, disconnect_type: str) -> None:
        ...
        allowed_values = ["client", "conferenceTransfer", "consultTransfer", "endpoint", "endpointDnd", "error", "forwardTransfer", "inactivity", "noAnswerTransfer", "notAvailableTransfer", "other", "peer", "sessionExpired", "spam", "system", "takeover", "timeout", "transfer", "transferDnd", "transportFailure", "uncallable"]
    ...
    def flow_type(self, flow_type: str) -> None:
        ...
        allowed_values = ["bot", "commonmodule", "digitalbot", "emailsend", "inboundcall", "inboundchat", "inboundemail", "inboundshortmessage", "inqueuecall", "inqueueemail", "inqueueshortmessage", "outboundcall", "securecall", "speech", "surveyinvite", "voice", "voicemail", "voicesurvey", "workflow", "workitem"]
    ...
    @property
    def proposed_agents(self) -> List['FlowMetricsTopicFlowProposedAgent']:
        """
    ...
    def proposed_agents(self, proposed_agents: List['FlowMetricsTopicFlowProposedAgent']) -> None:
        """
    ...
    @property
    def outcomes(self) -> List['FlowMetricsTopicFlowOutcome']:
        """
    ...
    @outcomes.setter
    def outcomes(self, outcomes: List['FlowMetricsTopicFlowOutcome']) -> None:
        """
    ...
    @property
    def scored_agents(self) -> List['FlowMetricsTopicFlowScoredAgent']:
        """
    ...
    def scored_agents(self, scored_agents: List['FlowMetricsTopicFlowScoredAgent']) -> None:
        """
