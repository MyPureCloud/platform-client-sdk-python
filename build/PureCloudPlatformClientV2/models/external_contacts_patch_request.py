...
if TYPE_CHECKING:
    from . import ContactsPatchChange

class ExternalContactsPatchRequest(object):
    """
    ...
    def __init__(self) -> None:
        """
        ExternalContactsPatchRequest - a model defined in Swagger
        ...
        """
        self.swagger_types = {
            'changes': 'list[ContactsPatchChange]'
        }
