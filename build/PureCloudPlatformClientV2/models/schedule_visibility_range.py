...
class ScheduleVisibilityRange(object):
    """
    ...
    def __init__(self) -> None:
        """
        ScheduleVisibilityRange - a model defined in Swagger
    ...
    def end_date(self, end_date: datetime) -> None:
        """
        Sets the end_date of this ScheduleVisibilityRange.
        The schedule visibility end time in ISO-8601, the schedule is visible up to (but not including) that exact time)

        :param end_date: The end_date of this ScheduleVisibilityRange.
        :type: datetime
        """
    ...
    def end_business_unit_date(self) -> date:
        """
        Gets the end_business_unit_date of this ScheduleVisibilityRange.
        ...
        :return: The end_business_unit_date of this ScheduleVisibilityRange.
        :rtype: date
        """
    ...
    def end_business_unit_date(self, end_business_unit_date: date) -> None:
        """
        Sets the end_business_unit_date of this ScheduleVisibilityRange.
        The schedule visibility end date interpreted in the business unit time zone in yyyy-MM-dd format, the schedule is visible up to (but not including) that exact date. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd

        :param end_business_unit_date: The end_business_unit_date of this ScheduleVisibilityRange.
        :type: date
        """
