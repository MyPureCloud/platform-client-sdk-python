...
class DocumentBodyBlockWithHighlight(object):
    ...
    def __init__(self) -> None:
        """
        DocumentBodyBlockWithHighlight - a model defined in Swagger
    ...
    def type(self) -> str:
        """
        Gets the type of this DocumentBodyBlockWithHighlight.
        ...
        :return: The type of this DocumentBodyBlockWithHighlight.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type: str) -> None:
        """
        Sets the type of this DocumentBodyBlockWithHighlight.
        The type of the block for the body. This determines which body block object (paragraph, list, video, image or table) would have a value.

        :param type: The type of this DocumentBodyBlockWithHighlight.
        :type: str
        """
    ...
    def image(self) -> 'DocumentBodyImage':
        """
        Gets the image of this DocumentBodyBlockWithHighlight.
        Image. It must contain a value if the type of the block is Image.

        :return: The image of this DocumentBodyBlockWithHighlight.
    ...
    def image(self, image: 'DocumentBodyImage') -> None:
        """
        Sets the image of this DocumentBodyBlockWithHighlight.
        Image. It must contain a value if the type of the block is Image.

        :param image: The image of this DocumentBodyBlockWithHighlight.
    ...
    def video(self) -> 'DocumentBodyVideo':
        """
        Gets the video of this DocumentBodyBlockWithHighlight.
        Video. It must contain a value if the type of the block is Video.

        :return: The video of this DocumentBodyBlockWithHighlight.
    ...
    def video(self, video: 'DocumentBodyVideo') -> None:
        """
        Sets the video of this DocumentBodyBlockWithHighlight.
        Video. It must contain a value if the type of the block is Video.

        :param video: The video of this DocumentBodyBlockWithHighlight.
    ...
    def paragraph(self) -> 'DocumentBodyParagraphWithHighlight':
        ...
        :return: The paragraph of this DocumentBodyBlockWithHighlight.
    ...
    def paragraph(self, paragraph: 'DocumentBodyParagraphWithHighlight') -> None:
        """
        Sets the paragraph of this DocumentBodyBlockWithHighlight.
        Paragraph. It must contain a value if the type of the block is Paragraph.

        :param paragraph: The paragraph of this DocumentBodyBlockWithHighlight.
