...
class JourneyContext(object):
    ...
    def __init__(self) -> None:
        """
        JourneyContext - a model defined in Swagger
    ...
    def customer(self, customer: 'JourneyCustomer') -> None:
        """
        Sets the customer of this JourneyContext.
        A subset of the Journey System's customer data at a point-in-time (for external linkage and internal usage/context)

        :param customer: The customer of this JourneyContext.
    ...
    def customer_session(self) -> 'JourneyCustomerSession':
        """
        Gets the customer_session of this JourneyContext.
        ...
        :return: The customer_session of this JourneyContext.
    ...
    def customer_session(self, customer_session: 'JourneyCustomerSession') -> None:
        """
        Sets the customer_session of this JourneyContext.
        A subset of the Journey System's tracked customer session data at a point-in-time (for external linkage and internal usage/context)

        :param customer_session: The customer_session of this JourneyContext.
    ...
    @property
    def triggering_action(self) -> 'JourneyAction':
        """
        Gets the triggering_action of this JourneyContext.
        ...
        :return: The triggering_action of this JourneyContext.
        :rtype: JourneyAction
        """
        return self._triggering_action

    @triggering_action.setter
    def triggering_action(self, triggering_action: 'JourneyAction') -> None:
        """
        Sets the triggering_action of this JourneyContext.
        A subset of the Journey System's action data relevant to a part of a conversation (for external linkage and internal usage/context)

        :param triggering_action: The triggering_action of this JourneyContext.
        :type: JourneyAction
        """
