...
class LicenseAssignmentRequest(object):
    ...
    @property
    def user_ids_add(self) -> List[str]:
        """
    ...
    @user_ids_add.setter
    def user_ids_add(self, user_ids_add: List[str]) -> None:
        """
    ...
    @property
    def user_ids_remove(self) -> List[str]:
        """
    ...
    def user_ids_remove(self, user_ids_remove: List[str]) -> None:
        """
