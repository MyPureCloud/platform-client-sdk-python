...
class EstimateAvailableFullDayTimeOffResponse(object):
    ...
    def override_date_type(self) -> str:
        """
        Gets the override_date_type of this EstimateAvailableFullDayTimeOffResponse.
        The override date type, if the requested day is an override date

        :return: The override_date_type of this EstimateAvailableFullDayTimeOffResponse.
        :rtype: str
        """
    ...
    def override_date_type(self, override_date_type: str) -> None:
        """
        Sets the override_date_type of this EstimateAvailableFullDayTimeOffResponse.
        The override date type, if the requested day is an override date

        :param override_date_type: The override_date_type of this EstimateAvailableFullDayTimeOffResponse.
        :type: str
        """
