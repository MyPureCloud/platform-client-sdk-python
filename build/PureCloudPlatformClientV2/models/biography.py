...
class Biography(object):
    ...
    @biography.setter
    def biography(self, biography: str) -> None:
        """
    ...
    @interests.setter
    def interests(self, interests: List[str]) -> None:
        """
    ...
    @hobbies.setter
    def hobbies(self, hobbies: List[str]) -> None:
        """
    ...
    @spouse.setter
    def spouse(self, spouse: str) -> None:
        """
    ...
    @education.setter
    def education(self, education: List['Education']) -> None:
        """
