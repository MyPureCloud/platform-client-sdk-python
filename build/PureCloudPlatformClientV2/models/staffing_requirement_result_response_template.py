...
class StaffingRequirementResultResponseTemplate(object):
    """
    ...
    def __init__(self) -> None:
        """
        StaffingRequirementResultResponseTemplate - a model defined in Swagger
    ...
    def requirement_results(self) -> List['PlanningGroupRequirementOutput']:
        """
        Gets the requirement_results of this StaffingRequirementResultResponseTemplate.
        List of staffing requirement results

        :return: The requirement_results of this StaffingRequirementResultResponseTemplate.
    ...
    def requirement_results(self, requirement_results: List['PlanningGroupRequirementOutput']) -> None:
        """
        Sets the requirement_results of this StaffingRequirementResultResponseTemplate.
        List of staffing requirement results

        :param requirement_results: The requirement_results of this StaffingRequirementResultResponseTemplate.
