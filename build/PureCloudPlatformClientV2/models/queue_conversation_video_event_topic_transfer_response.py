...
if TYPE_CHECKING:
    from . import QueueConversationVideoEventTopicTransferDestination
    from . import QueueConversationVideoEventTopicTransferInitiator
    from . import QueueConversationVideoEventTopicTransferModifedBy

class QueueConversationVideoEventTopicTransferResponse(object):
    """
    ...
    def __init__(self) -> None:
        """
        QueueConversationVideoEventTopicTransferResponse - a model defined in Swagger
        ...
        self.swagger_types = {
            ...
            'initiator': 'QueueConversationVideoEventTopicTransferInitiator',
            'modified_by': 'QueueConversationVideoEventTopicTransferModifedBy',
            'destination': 'QueueConversationVideoEventTopicTransferDestination',
            'transfer_type': 'str'
        }
    ...
    def id(self, id: str) -> None:
        """
        Sets the id of this QueueConversationVideoEventTopicTransferResponse.
        The id of the command.
    ...
    def state(self, state: str) -> None:
        """
        Sets the state of this QueueConversationVideoEventTopicTransferResponse.
    ...
    def date_issued(self, date_issued: datetime) -> None:
        """
        Sets the date_issued of this QueueConversationVideoEventTopicTransferResponse.
        The date/time that this command was issued.
    ...
    @property
    def initiator(self) -> 'QueueConversationVideoEventTopicTransferInitiator':
        """
        Gets the initiator of this QueueConversationVideoEventTopicTransferResponse.


        :return: The initiator of this QueueConversationVideoEventTopicTransferResponse.
        :rtype: QueueConversationVideoEventTopicTransferInitiator
        """
        return self._initiator

    @initiator.setter
    def initiator(self, initiator: 'QueueConversationVideoEventTopicTransferInitiator') -> None:
        """
        Sets the initiator of this QueueConversationVideoEventTopicTransferResponse.


        :param initiator: The initiator of this QueueConversationVideoEventTopicTransferResponse.
        :type: QueueConversationVideoEventTopicTransferInitiator
        """
    ...
    @property
    def modified_by(self) -> 'QueueConversationVideoEventTopicTransferModifedBy':
        """
        Gets the modified_by of this QueueConversationVideoEventTopicTransferResponse.


        :return: The modified_by of this QueueConversationVideoEventTopicTransferResponse.
        :rtype: QueueConversationVideoEventTopicTransferModifedBy
        """
        return self._modified_by

    @modified_by.setter
    def modified_by(self, modified_by: 'QueueConversationVideoEventTopicTransferModifedBy') -> None:
        """
        Sets the modified_by of this QueueConversationVideoEventTopicTransferResponse.


        :param modified_by: The modified_by of this QueueConversationVideoEventTopicTransferResponse.
        :type: QueueConversationVideoEventTopicTransferModifedBy
        """
    ...
    @property
    def destination(self) -> 'QueueConversationVideoEventTopicTransferDestination':
        """
    ...
    @destination.setter
    def destination(self, destination: 'QueueConversationVideoEventTopicTransferDestination') -> None:
        """
        Sets the destination of this QueueConversationVideoEventTopicTransferResponse.
    ...
    def transfer_type(self, transfer_type: str) -> None:
        """
        Sets the transfer_type of this QueueConversationVideoEventTopicTransferResponse.
        The type of transfer to perform.
