...
if TYPE_CHECKING:
    ...
    from . import QueueConversationScreenShareEventTopicQueueMediaSettings
...
class QueueConversationScreenShareEventTopicScreenShareMediaParticipant(object):
    ...
    def external_contact_initial_division_id(self) -> str:
        """
        Gets the external_contact_initial_division_id of this QueueConversationScreenShareEventTopicScreenShareMediaParticipant.


        :return: The external_contact_initial_division_id of this QueueConversationScreenShareEventTopicScreenShareMediaParticipant.
        :rtype: str
        """
    ...
    def external_contact_initial_division_id(self, external_contact_initial_division_id: str) -> None:
        """
        Sets the external_contact_initial_division_id of this QueueConversationScreenShareEventTopicScreenShareMediaParticipant.


        :param external_contact_initial_division_id: The external_contact_initial_division_id of this QueueConversationScreenShareEventTopicScreenShareMediaParticipant.
        :type: str
        """
    ...
    def park_time(self) -> datetime:
        """
        Gets the park_time of this QueueConversationScreenShareEventTopicScreenShareMediaParticipant.


        :return: The park_time of this QueueConversationScreenShareEventTopicScreenShareMediaParticipant.
        :rtype: datetime
        """
    ...
    def park_time(self, park_time: datetime) -> None:
        """
        Sets the park_time of this QueueConversationScreenShareEventTopicScreenShareMediaParticipant.


        :param park_time: The park_time of this QueueConversationScreenShareEventTopicScreenShareMediaParticipant.
        :type: datetime
        """
    ...
    @property
    def queue_media_settings(self) -> 'QueueConversationScreenShareEventTopicQueueMediaSettings':
        """
        Gets the queue_media_settings of this QueueConversationScreenShareEventTopicScreenShareMediaParticipant.


        :return: The queue_media_settings of this QueueConversationScreenShareEventTopicScreenShareMediaParticipant.
        :rtype: QueueConversationScreenShareEventTopicQueueMediaSettings
        """
        return self._queue_media_settings

    @queue_media_settings.setter
    def queue_media_settings(self, queue_media_settings: 'QueueConversationScreenShareEventTopicQueueMediaSettings') -> None:
        """
        Sets the queue_media_settings of this QueueConversationScreenShareEventTopicScreenShareMediaParticipant.


        :param queue_media_settings: The queue_media_settings of this QueueConversationScreenShareEventTopicScreenShareMediaParticipant.
        :type: QueueConversationScreenShareEventTopicQueueMediaSettings
        """
