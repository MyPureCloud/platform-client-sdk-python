...
class ManagementUnitUserListing(object):
    """
    ...
    def __init__(self) -> None:
        """
        ManagementUnitUserListing - a model defined in Swagger
    ...
    def management_unit(self) -> 'ManagementUnitReference':
        """
        Gets the management_unit of this ManagementUnitUserListing.
        The management unit associated with the users

        :return: The management_unit of this ManagementUnitUserListing.
    ...
    def management_unit(self, management_unit: 'ManagementUnitReference') -> None:
        """
        Sets the management_unit of this ManagementUnitUserListing.
        The management unit associated with the users

        :param management_unit: The management_unit of this ManagementUnitUserListing.
    ...
    def users(self) -> List['UserReference']:
        """
        Gets the users of this ManagementUnitUserListing.
        Users in the management unit

        :return: The users of this ManagementUnitUserListing.
    ...
    def users(self, users: List['UserReference']) -> None:
        """
        Sets the users of this ManagementUnitUserListing.
        Users in the management unit

        :param users: The users of this ManagementUnitUserListing.
