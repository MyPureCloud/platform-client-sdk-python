...
if TYPE_CHECKING:
    from . import GKNDocumentationSearchCriteria
...
class GKNDocumentationSearchRequest(object):
    ...
    @property
    def query(self) -> List['GKNDocumentationSearchCriteria']:
        """
    ...
    @query.setter
    def query(self, query: List['GKNDocumentationSearchCriteria']) -> None:
        """
