...
class AuditTopicAuditLogMessage(object):
    ...
    def action(self, action):
        ...
        :type: str
        """
        allowed_values = ["View", "Create", "Update", "Move", "Copy", "Download", "ShareAdd", "ShareRemove", "Fax", "VersionCreate", "TagAdd", "TagRemove", "TagUpdate", "Delete", "MemberAdd", "MemberUpdate", "MemberRemove", "Authorize", "Deauthorize", "Authenticate", "ChangePassword", "Revoke", "Activate", "Checkin", "Checkout", "Deactivate", "Debug", "Publish", "Revert", "Save", "Transcode", "Upload", "Read", "Execute", "Abandon", "Archive", "Export", "RestoreRequest", "RestoreComplete", "UpdateRetention", "ApplyProtection", "RevokeProtection", "Rotate", "DeleteAll", "Reassign", "Unarchive", "Assign", "Unassign", "Reset", "Reschedule", "Unpublish", "Purge", "Processed", "Enable", "Disable", "Recycle", "Append", "Restore", "Open", "Approved", "Rejected", "Rollback", "ImplementingChange", "ChangeImplemented", "ImplementingRollback", "RollbackImplemented", "Write", "Replace", "UpdateInService", "UpdateOutOfService", "Cycle", "Scale", "IpAllowlistClear", "Add", "AddPairingRole", "Verify", "Cancel", "HardDelete", "EnableCapture", "DownloadCapture"]
