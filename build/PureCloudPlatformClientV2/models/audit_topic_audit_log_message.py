...
class AuditTopicAuditLogMessage(object):
    ...
    def action(self, action: str) -> None:
        ...
        if isinstance(action, int):
            action = str(action)
        allowed_values = ["View", "Create", "Update", "Delete", "Move", "Copy", "Download", "ShareAdd", "ShareRemove", "Fax", "VersionCreate", "TagAdd", "TagRemove", "TagUpdate", "Add", "Remove", "MemberAdd", "MemberUpdate", "MemberRemove", "Authorize", "Deauthorize", "Authenticate", "ChangePassword", "Revoke", "Checkin", "Checkout", "Deactivate", "Debug", "Publish", "Revert", "Save", "Transcode", "Upload", "WrapupCodeAdd", "WrapupCodeRemove", "Read", "Execute", "Abandon", "Archive", "Export", "RestoreRequest", "RestoreComplete", "UpdateRetention", "ApplyProtection", "RevokeProtection", "Rotate", "DeleteAll", "delete", "Reassign", "Unarchive", "Activate", "Assign", "Unassign", "Reset", "Reschedule", "Unpublish", "Purge", "Processed", "Enable", "Disable", "Recycle", "Append", "Restore", "Open", "Approved", "Rejected", "Rollback", "ImplementingChange", "ChangeImplemented", "ImplementingRollback", "RollbackImplemented", "Write", "Replace", "UpdateInService", "UpdateOutOfService", "Cycle", "Scale", "IpAllowlistClear", "AddPairingRole", "Verify", "RestoreDeleted", "RestoreAll", "Approve", "Reject", "Reverse", "Cancel", "HardDelete", "SoftDelete", "EnableCapture", "DownloadCapture", "Initiate", "ReverseManually"]
