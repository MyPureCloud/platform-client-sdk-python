...
class AuditTopicAuditLogMessage(object):
    ...
    def service_name(self, service_name):
        ...
        :type: str
        """
        allowed_values = ["Architect", "ContactCenter", "ContentManagement", "Groups", "LanguageUnderstanding", "Outbound", "PeoplePermissions", "PredictiveEngagement", "Presence", "Quality", "ResponseManagement", "Routing", "SpeechAndTextAnalytics", "Telephony", "TopicsDefinitions", "Triggers", "WebDeployments", "WorkforceManagement"]
    ...
    def action(self, action):
        ...
        :type: str
        """
        allowed_values = ["Create", "View", "Update", "Move", "Delete", "Download", "Upload", "MemberAdd", "MemberUpdate", "MemberRemove", "Read", "ApplyProtection", "RevokeProtection", "UpdateRetention", "ReadAll", "Execute", "Publish", "Unpublish", "Activate", "Checkin", "Checkout", "Deactivate", "Debug", "Save", "Revert", "Transcode", "Enable", "Disable", "Authorize", "Deauthorize", "Authenticate", "ChangePassword", "Revoke", "Export", "Append", "Recycle", "Purge", "Processed"]
    ...
    def entity_type(self, entity_type):
        ...
        :type: str
        """
        allowed_values = ["AccessToken", "AttemptLimits", "AuthOrganization", "AuthUser", "BulkActions", "CallAnalysisResponseSet", "CallableTimeSet", "Campaign", "CampaignRule", "CampaignSchedule", "ClickstreamSettings", "Configuration", "ConfigurationVersion", "ContactList", "ContactListFilter", "DID", "DIDPool", "DNCList", "DependencyTrackingBuild", "Deployment", "Document", "Edge", "EdgeGroup", "EmergencyGroup", "EventType", "Extension", "ExtensionPool", "Feedback", "Flow", "FlowMilestone", "FlowOutcome", "Forecast", "HistoricalData", "IVR", "Line", "LineBase", "MaxOrgRoutingUtilizationCapacity", "MessagingCampaign", "NumberPlan", "OAuthClient", "OAuthClientAuthorization", "OrganizationAuthorizationTrust", "OrganizationAuthorizationUserTrust", "OrganizationSettings", "OutboundRoute", "Outcome", "Phone", "PhoneBase", "Predictor", "Program", "Prompt", "PromptResource", "Queue", "Recording", "Response", "Role", "RoutingTranscriptionSettings", "RuleSet", "Schedule", "ScheduleGroup", "Segment", "Sequence", "SequenceSchedule", "SessionType", "Site", "SpeechTextAnalyticsSettings", "Team", "Topic", "TranscriptionSettings", "Trigger", "Trunk", "TrunkBase", "UserPresence", "VoicemailPolicy", "VoicemailUserPolicy", "WorkPlan", "Workspace", "WrapUpCodeMapping", "WrapupCode"]
