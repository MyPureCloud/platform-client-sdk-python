...
class AuditTopicAuditLogMessage(object):
    ...
    def entity_type(self, entity_type):
        ...
        :type: str
        """
        allowed_values = ["AccessToken", "ActionMap", "ActionTemplate", "Assignment", "AttemptLimits", "AuthOrganization", "AuthUser", "BulkActions", "CallAnalysisResponseSet", "CallableTimeSet", "Campaign", "CampaignRule", "CampaignSchedule", "ClickstreamSettings", "Configuration", "ConfigurationVersion", "ContactList", "ContactListFilter", "DashboardSettings", "DID", "DIDPool", "DNCList", "DependencyTrackingBuild", "Deployment", "Document", "DynamicGroup", "Edge", "EdgeGroup", "EmergencyGroup", "EventType", "Exports", "Extension", "ExtensionPool", "ExternalMetricsDefinition", "ExternalMetricsData", "Feedback", "Flow", "FlowMilestone", "FlowOutcome", "Forecast", "HistoricalData", "InsightSettings", "IVR", "Line", "LineBase", "MaxOrgRoutingUtilizationCapacity", "MessagingCampaign", "Metric", "Module", "NumberPlan", "OAuthClient", "OAuthClientAuthorization", "OrganizationAuthorizationTrust", "OrganizationAuthorizationUserTrust", "OrganizationSettings", "OutboundRoute", "Outcome", "Phone", "PhoneBase", "Predictor", "Profile", "ProfileMembers", "Program", "Prompt", "PromptResource", "Queue", "Recording", "Response", "Role", "RoutingTranscriptionSettings", "Rule", "RuleSet", "Schedule", "ScheduledExports", "ScheduleGroup", "Segment", "Sequence", "SequenceSchedule", "SessionType", "Site", "SpeechTextAnalyticsSettings", "Status", "Team", "Topic", "TranscriptionSettings", "Trigger", "Trunk", "TrunkBase", "UserPresence", "VoicemailPolicy", "VoicemailUserPolicy", "WorkPlan", "Workspace", "WrapUpCodeMapping", "WrapupCode"]
