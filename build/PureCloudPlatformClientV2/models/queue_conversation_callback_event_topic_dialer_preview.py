...
if TYPE_CHECKING:
    from . import QueueConversationCallbackEventTopicPhoneNumberColumn
...
class QueueConversationCallbackEventTopicDialerPreview(object):
    ...
    @property
    def phone_number_columns(self) -> List['QueueConversationCallbackEventTopicPhoneNumberColumn']:
        """
    ...
    def phone_number_columns(self, phone_number_columns: List['QueueConversationCallbackEventTopicPhoneNumberColumn']) -> None:
        """
