...
class SupportCenterScreen(object):
    """
    ...
    def __init__(self):
        """
        SupportCenterScreen - a model defined in Swagger
        ...
        self.swagger_types = {
            'type': 'str',
            'module_settings': 'list[SupportCenterModuleSetting]'
        }
    ...
    @module_settings.setter
    def module_settings(self, module_settings):
        """
