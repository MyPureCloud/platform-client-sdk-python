...
if TYPE_CHECKING:
    from . import AnalyticsRoutingStatusRecord
    from . import AnalyticsUserPresenceRecord
...
class AnalyticsUserDetail(object):
    ...
    @property
    def primary_presence(self) -> List['AnalyticsUserPresenceRecord']:
        """
    ...
    def primary_presence(self, primary_presence: List['AnalyticsUserPresenceRecord']) -> None:
        """
    ...
    @property
    def routing_status(self) -> List['AnalyticsRoutingStatusRecord']:
        """
    ...
    def routing_status(self, routing_status: List['AnalyticsRoutingStatusRecord']) -> None:
        """
