...
class ConversationQueueMediaSettings(object):
    """
    ...
    def __init__(self) -> None:
        """
        ConversationQueueMediaSettings - a model defined in Swagger
    ...
    def alerting_timeout_seconds(self) -> int:
        """
        Gets the alerting_timeout_seconds of this ConversationQueueMediaSettings.
        Specifies how long the agent has to answer an interaction before being marked as not responding.

        :return: The alerting_timeout_seconds of this ConversationQueueMediaSettings.
        :rtype: int
        """
    ...
    def alerting_timeout_seconds(self, alerting_timeout_seconds: int) -> None:
        """
        Sets the alerting_timeout_seconds of this ConversationQueueMediaSettings.
        Specifies how long the agent has to answer an interaction before being marked as not responding.

        :param alerting_timeout_seconds: The alerting_timeout_seconds of this ConversationQueueMediaSettings.
        :type: int
        """
    ...
    def auto_answer_alert_tone_seconds(self) -> float:
        """
        Gets the auto_answer_alert_tone_seconds of this ConversationQueueMediaSettings.
        Specifies the duration of the alerting sound to be played for auto answered interactions.

        :return: The auto_answer_alert_tone_seconds of this ConversationQueueMediaSettings.
        :rtype: float
        """
    ...
    def auto_answer_alert_tone_seconds(self, auto_answer_alert_tone_seconds: float) -> None:
        """
        Sets the auto_answer_alert_tone_seconds of this ConversationQueueMediaSettings.
        Specifies the duration of the alerting sound to be played for auto answered interactions.

        :param auto_answer_alert_tone_seconds: The auto_answer_alert_tone_seconds of this ConversationQueueMediaSettings.
        :type: float
        """
    ...
    def manual_answer_alert_tone_seconds(self) -> float:
        """
        Gets the manual_answer_alert_tone_seconds of this ConversationQueueMediaSettings.
        Specifies the duration of the alerting sound to be played for manually answered interactions.

        :return: The manual_answer_alert_tone_seconds of this ConversationQueueMediaSettings.
        :rtype: float
        """
    ...
    def manual_answer_alert_tone_seconds(self, manual_answer_alert_tone_seconds: float) -> None:
        """
        Sets the manual_answer_alert_tone_seconds of this ConversationQueueMediaSettings.
        Specifies the duration of the alerting sound to be played for manually answered interactions.

        :param manual_answer_alert_tone_seconds: The manual_answer_alert_tone_seconds of this ConversationQueueMediaSettings.
        :type: float
        """
    ...
    def enable_auto_answer(self) -> bool:
        """
        Gets the enable_auto_answer of this ConversationQueueMediaSettings.
        Flag to indicate if auto answer is enabled for the given media type or media subtype.

        :return: The enable_auto_answer of this ConversationQueueMediaSettings.
        :rtype: bool
        """
    ...
    def enable_auto_answer(self, enable_auto_answer: bool) -> None:
        """
        Sets the enable_auto_answer of this ConversationQueueMediaSettings.
        Flag to indicate if auto answer is enabled for the given media type or media subtype.

        :param enable_auto_answer: The enable_auto_answer of this ConversationQueueMediaSettings.
        :type: bool
        """
