...
if TYPE_CHECKING:
    from . import WfmForecastModificationIntervalOffsetValue

class BuForecastModificationResponse(object):
    """
    ...
    def __init__(self) -> None:
        """
        BuForecastModificationResponse - a model defined in Swagger
    ...
    def type(self) -> str:
        """
        Gets the type of this BuForecastModificationResponse.
        The type of the modification

        :return: The type of this BuForecastModificationResponse.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type: str) -> None:
        """
        Sets the type of this BuForecastModificationResponse.
        The type of the modification

        :param type: The type of this BuForecastModificationResponse.
        :type: str
        """
    ...
    def start_interval_index(self) -> int:
        """
        Gets the start_interval_index of this BuForecastModificationResponse.
        The number of intervals past referenceStartDate representing the first interval to which this modification applies

        :return: The start_interval_index of this BuForecastModificationResponse.
        :rtype: int
        """
    ...
    def start_interval_index(self, start_interval_index: int) -> None:
        """
        Sets the start_interval_index of this BuForecastModificationResponse.
        The number of intervals past referenceStartDate representing the first interval to which this modification applies

        :param start_interval_index: The start_interval_index of this BuForecastModificationResponse.
        :type: int
        """
    ...
    def end_interval_index(self) -> int:
        """
        Gets the end_interval_index of this BuForecastModificationResponse.
        The number of intervals past referenceStartDate representing the last interval to which this modification applies

        :return: The end_interval_index of this BuForecastModificationResponse.
        :rtype: int
        """
    ...
    def end_interval_index(self, end_interval_index: int) -> None:
        """
        Sets the end_interval_index of this BuForecastModificationResponse.
        The number of intervals past referenceStartDate representing the last interval to which this modification applies

        :param end_interval_index: The end_interval_index of this BuForecastModificationResponse.
        :type: int
        """
    ...
    def metric(self) -> str:
        """
        Gets the metric of this BuForecastModificationResponse.
        The metric to which this modification applies

        :return: The metric of this BuForecastModificationResponse.
        :rtype: str
        """
        return self._metric
    ...
    def metric(self, metric: str) -> None:
        """
        Sets the metric of this BuForecastModificationResponse.
        The metric to which this modification applies

        :param metric: The metric of this BuForecastModificationResponse.
        :type: str
        """
    ...
    def legacy_metric(self) -> str:
        """
        Gets the legacy_metric of this BuForecastModificationResponse.
        The legacy metric to which this modification applies if applicable

        :return: The legacy_metric of this BuForecastModificationResponse.
        :rtype: str
        """
    ...
    def legacy_metric(self, legacy_metric: str) -> None:
        """
        Sets the legacy_metric of this BuForecastModificationResponse.
        The legacy metric to which this modification applies if applicable

        :param legacy_metric: The legacy_metric of this BuForecastModificationResponse.
        :type: str
        """
    ...
    def value(self) -> float:
        """
        Gets the value of this BuForecastModificationResponse.
        The value of the modification

        :return: The value of this BuForecastModificationResponse.
        :rtype: float
        """
        return self._value
    ...
    def value(self, value: float) -> None:
        """
        Sets the value of this BuForecastModificationResponse.
        The value of the modification

        :param value: The value of this BuForecastModificationResponse.
        :type: float
        """
    ...
    @property
    def values(self) -> List['WfmForecastModificationIntervalOffsetValue']:
        """
        Gets the values of this BuForecastModificationResponse.
        The list of modification values. Only applicable for grid-type modifications

        :return: The values of this BuForecastModificationResponse.
        :rtype: list[WfmForecastModificationIntervalOffsetValue]
        """
        return self._values

    @values.setter
    def values(self, values: List['WfmForecastModificationIntervalOffsetValue']) -> None:
        """
        Sets the values of this BuForecastModificationResponse.
        The list of modification values. Only applicable for grid-type modifications

        :param values: The values of this BuForecastModificationResponse.
    ...
    def display_granularity(self) -> str:
        ...
        :return: The display_granularity of this BuForecastModificationResponse.
        :rtype: str
        """
    ...
    def display_granularity(self, display_granularity: str) -> None:
        """
        Sets the display_granularity of this BuForecastModificationResponse.
        The client side display granularity of the modification, expressed in the ISO-8601 duration format. Periods are represented as an ISO-8601 string. For example: P1D or P1DT12H

        :param display_granularity: The display_granularity of this BuForecastModificationResponse.
        :type: str
        """
    ...
    def granularity(self) -> str:
        """
        Gets the granularity of this BuForecastModificationResponse.
        ...
        :return: The granularity of this BuForecastModificationResponse.
        :rtype: str
        """
    ...
    def granularity(self, granularity: str) -> None:
        """
        Sets the granularity of this BuForecastModificationResponse.
        The actual granularity of the modification as stored behind the scenes, expressed in the ISO-8601 duration format. Periods are represented as an ISO-8601 string. For example: P1D or P1DT12H

        :param granularity: The granularity of this BuForecastModificationResponse.
        :type: str
        """
    ...
    def enabled(self) -> bool:
        """
        Gets the enabled of this BuForecastModificationResponse.
        Whether the modification is enabled for the forecast

        :return: The enabled of this BuForecastModificationResponse.
        :rtype: bool
        """
    ...
    def enabled(self, enabled: bool) -> None:
        """
        Sets the enabled of this BuForecastModificationResponse.
        Whether the modification is enabled for the forecast

        :param enabled: The enabled of this BuForecastModificationResponse.
        :type: bool
        """
    ...
    def planning_group_ids(self) -> List[str]:
        """
        Gets the planning_group_ids of this BuForecastModificationResponse.
        The IDs of the planning groups to which this forecast modification applies

        :return: The planning_group_ids of this BuForecastModificationResponse.
        :rtype: list[str]
        """
    ...
    def planning_group_ids(self, planning_group_ids: List[str]) -> None:
        """
        Sets the planning_group_ids of this BuForecastModificationResponse.
        The IDs of the planning groups to which this forecast modification applies

        :param planning_group_ids: The planning_group_ids of this BuForecastModificationResponse.
        :type: list[str]
        """
