...
if TYPE_CHECKING:
    ...
    from . import RequestExternalSegment
    from . import RequestJourney

class JourneySegmentRequest(object):
    """
    ...
    def __init__(self) -> None:
        """
        JourneySegmentRequest - a model defined in Swagger
        ...
        self.swagger_types = {
            ...
            'external_segment': 'RequestExternalSegment',
    ...
    def is_active(self) -> bool:
        """
        Gets the is_active of this JourneySegmentRequest.
        Whether or not the segment is active.

        :return: The is_active of this JourneySegmentRequest.
        :rtype: bool
        """
    ...
    def is_active(self, is_active: bool) -> None:
        """
        Sets the is_active of this JourneySegmentRequest.
        Whether or not the segment is active.

        :param is_active: The is_active of this JourneySegmentRequest.
        :type: bool
        """
    ...
    def display_name(self) -> str:
        """
        Gets the display_name of this JourneySegmentRequest.
        The display name of the segment.

        :return: The display_name of this JourneySegmentRequest.
        :rtype: str
        """
    ...
    def display_name(self, display_name: str) -> None:
        """
        Sets the display_name of this JourneySegmentRequest.
        The display name of the segment.

        :param display_name: The display_name of this JourneySegmentRequest.
        :type: str
        """
    ...
    def version(self) -> int:
        """
        Gets the version of this JourneySegmentRequest.
        The version of the segment.

        :return: The version of this JourneySegmentRequest.
        :rtype: int
        """
    ...
    def version(self, version: int) -> None:
        """
        Sets the version of this JourneySegmentRequest.
        The version of the segment.

        :param version: The version of this JourneySegmentRequest.
        :type: int
        """
    ...
    def description(self) -> str:
        """
        Gets the description of this JourneySegmentRequest.
        A description of the segment.

        :return: The description of this JourneySegmentRequest.
        :rtype: str
        """
    ...
    def description(self, description: str) -> None:
        """
        Sets the description of this JourneySegmentRequest.
        A description of the segment.

        :param description: The description of this JourneySegmentRequest.
        :type: str
        """
    ...
    def should_display_to_agent(self) -> bool:
        """
        Gets the should_display_to_agent of this JourneySegmentRequest.
        Whether or not the segment should be displayed to agent/supervisor users.

        :return: The should_display_to_agent of this JourneySegmentRequest.
        :rtype: bool
        """
    ...
    def should_display_to_agent(self, should_display_to_agent: bool) -> None:
        """
        Sets the should_display_to_agent of this JourneySegmentRequest.
        Whether or not the segment should be displayed to agent/supervisor users.

        :param should_display_to_agent: The should_display_to_agent of this JourneySegmentRequest.
        :type: bool
        """
    ...
    @property
    def external_segment(self) -> 'RequestExternalSegment':
        """
        Gets the external_segment of this JourneySegmentRequest.
        Details of an entity corresponding to this segment in an external system.

        :return: The external_segment of this JourneySegmentRequest.
        :rtype: RequestExternalSegment
        """
        return self._external_segment

    @external_segment.setter
    def external_segment(self, external_segment: 'RequestExternalSegment') -> None:
        """
        Sets the external_segment of this JourneySegmentRequest.
        Details of an entity corresponding to this segment in an external system.

        :param external_segment: The external_segment of this JourneySegmentRequest.
        :type: RequestExternalSegment
        """
    ...
    def assignment_expiration_days(self) -> int:
        """
        Gets the assignment_expiration_days of this JourneySegmentRequest.
        Time, in days, from when the segment is assigned until it is automatically unassigned.

        :return: The assignment_expiration_days of this JourneySegmentRequest.
        :rtype: int
        """
    ...
    def assignment_expiration_days(self, assignment_expiration_days: int) -> None:
        """
        Sets the assignment_expiration_days of this JourneySegmentRequest.
        Time, in days, from when the segment is assigned until it is automatically unassigned.

        :param assignment_expiration_days: The assignment_expiration_days of this JourneySegmentRequest.
        :type: int
        """
