...
class MessageMediaParticipant(object):
    ...
    def start_alerting_time(self) -> datetime:
        """
        Gets the start_alerting_time of this MessageMediaParticipant.
        ...
        :return: The start_alerting_time of this MessageMediaParticipant.
        :rtype: datetime
        """
    ...
    def start_alerting_time(self, start_alerting_time: datetime) -> None:
        """
        Sets the start_alerting_time of this MessageMediaParticipant.
        The timestamp when it is first put into an alerting state. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z

        :param start_alerting_time: The start_alerting_time of this MessageMediaParticipant.
        :type: datetime
        """
    ...
    def media_roles(self) -> List[str]:
        """
        Gets the media_roles of this MessageMediaParticipant.
        List of roles this participant's media has had on the conversation, ie monitor, coach, etc

        :return: The media_roles of this MessageMediaParticipant.
        :rtype: list[str]
        """
    ...
    def media_roles(self, media_roles: List[str]) -> None:
        """
        Sets the media_roles of this MessageMediaParticipant.
        List of roles this participant's media has had on the conversation, ie monitor, coach, etc

        :param media_roles: The media_roles of this MessageMediaParticipant.
        :type: list[str]
        """
    ...
    def external_contact_initial_division_id(self) -> str:
        """
        Gets the external_contact_initial_division_id of this MessageMediaParticipant.
        ...
        :return: The external_contact_initial_division_id of this MessageMediaParticipant.
        :rtype: str
        """
    ...
    def external_contact_initial_division_id(self, external_contact_initial_division_id: str) -> None:
        """
        Sets the external_contact_initial_division_id of this MessageMediaParticipant.
        If this participant represents an external contact, then this will be the initial division for the external contact. This value will not be updated if the external contact is reassigned.

        :param external_contact_initial_division_id: The external_contact_initial_division_id of this MessageMediaParticipant.
        :type: str
        """
