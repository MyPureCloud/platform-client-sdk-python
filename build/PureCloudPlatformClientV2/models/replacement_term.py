...
class ReplacementTerm(object):
    ...
    def type(self, type: str) -> None:
        ...
        if isinstance(type, int):
            type = str(type)
        allowed_values = ["NAME", "ADDRESS", "PHONE", "EMAIL", "TWITTER", "INSTAGRAM", "FACEBOOK", "APPLE_MESSAGES", "WHATSAPP", "EXTERNAL_ID"]
    ...
    def existing_value(self, existing_value: str) -> None:
        """
    ...
    def updated_value(self, updated_value: str) -> None:
        """
