...
class UserChatSettings(object):
    ...
    def __init__(self) -> None:
        """
        UserChatSettings - a model defined in Swagger
    ...
    def muted(self) -> bool:
        """
        Gets the muted of this UserChatSettings.
        Whether or not to enable muting notifications

        :return: The muted of this UserChatSettings.
        :rtype: bool
        """
        return self._muted
    ...
    def muted(self, muted: bool) -> None:
        """
        Sets the muted of this UserChatSettings.
        Whether or not to enable muting notifications

        :param muted: The muted of this UserChatSettings.
        :type: bool
        """
    ...
    def mentions_only(self) -> bool:
        """
        Gets the mentions_only of this UserChatSettings.
        Whether or not to enable notifications for mentions only

        :return: The mentions_only of this UserChatSettings.
        :rtype: bool
        """
    ...
    def mentions_only(self, mentions_only: bool) -> None:
        """
        Sets the mentions_only of this UserChatSettings.
        Whether or not to enable notifications for mentions only

        :param mentions_only: The mentions_only of this UserChatSettings.
        :type: bool
        """
    ...
    def notify_on_reactions(self) -> bool:
        """
        Gets the notify_on_reactions of this UserChatSettings.
        Whether or not to enable notifications for reactions on a user's own messages

        :return: The notify_on_reactions of this UserChatSettings.
        :rtype: bool
        """
    ...
    def notify_on_reactions(self, notify_on_reactions: bool) -> None:
        """
        Sets the notify_on_reactions of this UserChatSettings.
        Whether or not to enable notifications for reactions on a user's own messages

        :param notify_on_reactions: The notify_on_reactions of this UserChatSettings.
        :type: bool
        """
