...
if TYPE_CHECKING:
    from . import AnalyticsAgentGroup
    from . import AnalyticsConversationSegment
    from . import AnalyticsFlow
    from . import AnalyticsMediaEndpointStat
    from . import AnalyticsProposedAgent
    from . import AnalyticsSessionMetric
...
class AnalyticsSession(object):
    ...
    @acw_skipped.setter
    def acw_skipped(self, acw_skipped: bool) -> None:
        """
    ...
    def address_other(self, address_other: str) -> None:
        """
    ...
    @address_self.setter
    def address_self(self, address_self: str) -> None:
        """
    ...
    @property
    def delivery_status_change_date(self) -> datetime:
        """
    ...
    def delivery_status_change_date(self, delivery_status_change_date: datetime) -> None:
        """
    ...
    @property
    def disposition_analyzer(self) -> str:
        """
    ...
    def disposition_analyzer(self, disposition_analyzer: str) -> None:
        """
    ...
    def disposition_name(self, disposition_name: str) -> None:
        """
    ...
    def media_bridge_id(self, media_bridge_id: str) -> None:
        """
    ...
    def media_type(self, media_type: str) -> None:
        ...
        allowed_values = ["callback", "chat", "cobrowse", "email", "message", "internalmessage", "screenshare", "unknown", "video", "voice"]
    ...
    def protocol_call_id(self, protocol_call_id: str) -> None:
        """
    ...
    @property
    def remote_name_displayable(self) -> str:
        """
    ...
    def remote_name_displayable(self, remote_name_displayable: str) -> None:
        """
    ...
    @property
    def video_address_self(self) -> str:
        """
    ...
    def video_address_self(self, video_address_self: str) -> None:
        """
    ...
    def media_endpoint_stats(self, media_endpoint_stats: List['AnalyticsMediaEndpointStat']) -> None:
        """
    ...
    @flow.setter
    def flow(self, flow: 'AnalyticsFlow') -> None:
        """
    ...
    @property
    def metrics(self) -> List['AnalyticsSessionMetric']:
        """
    ...
    @metrics.setter
    def metrics(self, metrics: List['AnalyticsSessionMetric']) -> None:
        """
    ...
    @property
    def segments(self) -> List['AnalyticsConversationSegment']:
        """
    ...
    @segments.setter
    def segments(self, segments: List['AnalyticsConversationSegment']) -> None:
        """
