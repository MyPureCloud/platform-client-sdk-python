...
if TYPE_CHECKING:
    from . import WfmBuScheduleRunTopicBuScheduleRun
...
class WfmBuScheduleRunTopicBuSchedulingRunProgressNotification(object):
    ...
    @property
    def result(self) -> 'WfmBuScheduleRunTopicBuScheduleRun':
        """
    ...
    @result.setter
    def result(self, result: 'WfmBuScheduleRunTopicBuScheduleRun') -> None:
        """
