...
class CreateAdminTimeOffRequest(object):
    ...
    def full_day_earliest_start_offset_minutes(self) -> List[int]:
        """
        Gets the full_day_earliest_start_offset_minutes of this CreateAdminTimeOffRequest.
        ...
        :return: The full_day_earliest_start_offset_minutes of this CreateAdminTimeOffRequest.
        :rtype: list[int]
        """
    ...
    def full_day_earliest_start_offset_minutes(self, full_day_earliest_start_offset_minutes: List[int]) -> None:
        """
        Sets the full_day_earliest_start_offset_minutes of this CreateAdminTimeOffRequest.
        Earliest start offset in minutes for each full-day request date. Values may be null when time-off estimation is disabled or no estimate is available

        :param full_day_earliest_start_offset_minutes: The full_day_earliest_start_offset_minutes of this CreateAdminTimeOffRequest.
        :type: list[int]
        """
    ...
    def full_day_latest_end_offset_minutes(self) -> List[int]:
        """
        Gets the full_day_latest_end_offset_minutes of this CreateAdminTimeOffRequest.
        ...
        :return: The full_day_latest_end_offset_minutes of this CreateAdminTimeOffRequest.
        :rtype: list[int]
        """
    ...
    def full_day_latest_end_offset_minutes(self, full_day_latest_end_offset_minutes: List[int]) -> None:
        """
        Sets the full_day_latest_end_offset_minutes of this CreateAdminTimeOffRequest.
        Latest end offset in minutes for each full-day request date. Values may be null when time-off estimation is disabled or no estimate is available

        :param full_day_latest_end_offset_minutes: The full_day_latest_end_offset_minutes of this CreateAdminTimeOffRequest.
        :type: list[int]
        """
