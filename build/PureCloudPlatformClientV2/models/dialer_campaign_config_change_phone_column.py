...
class DialerCampaignConfigChangePhoneColumn(object):
    """
    ...
    def __init__(self) -> None:
        """
        DialerCampaignConfigChangePhoneColumn - a model defined in Swagger
    ...
    def get_additional_properties(self) -> Dict[str, object]:
        """
        Gets the get_additional_properties of this DialerCampaignConfigChangePhoneColumn.


        :return: The get_additional_properties of this DialerCampaignConfigChangePhoneColumn.
        :rtype: dict(str, object)
        """
    ...
    def get_additional_properties(self, get_additional_properties: Dict[str, object]) -> None:
        """
        Sets the get_additional_properties of this DialerCampaignConfigChangePhoneColumn.


        :param get_additional_properties: The get_additional_properties of this DialerCampaignConfigChangePhoneColumn.
        :type: dict(str, object)
        """
