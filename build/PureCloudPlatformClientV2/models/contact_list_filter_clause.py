...
if TYPE_CHECKING:
    from . import ContactListFilterPredicate
...
class ContactListFilterClause(object):
    ...
    @property
    def predicates(self) -> List['ContactListFilterPredicate']:
        """
    ...
    @predicates.setter
    def predicates(self, predicates: List['ContactListFilterPredicate']) -> None:
        """
