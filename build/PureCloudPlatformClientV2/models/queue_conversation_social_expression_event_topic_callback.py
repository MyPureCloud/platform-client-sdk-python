...
if TYPE_CHECKING:
    ...
    from . import QueueConversationSocialExpressionEventTopicDialerPreview
    from . import QueueConversationSocialExpressionEventTopicQueueMediaSettings
    from . import QueueConversationSocialExpressionEventTopicVoicemail
...
class QueueConversationSocialExpressionEventTopicCallback(object):
    ...
    def initial_state(self) -> str:
        """
        Gets the initial_state of this QueueConversationSocialExpressionEventTopicCallback.


        :return: The initial_state of this QueueConversationSocialExpressionEventTopicCallback.
        :rtype: str
        """
    ...
    def initial_state(self, initial_state: str) -> None:
        """
        Sets the initial_state of this QueueConversationSocialExpressionEventTopicCallback.


        :param initial_state: The initial_state of this QueueConversationSocialExpressionEventTopicCallback.
        :type: str
        """
    ...
    @property
    def dialer_preview(self) -> 'QueueConversationSocialExpressionEventTopicDialerPreview':
        """
    ...
    def dialer_preview(self, dialer_preview: 'QueueConversationSocialExpressionEventTopicDialerPreview') -> None:
        """
    ...
    @property
    def voicemail(self) -> 'QueueConversationSocialExpressionEventTopicVoicemail':
        """
    ...
    @voicemail.setter
    def voicemail(self, voicemail: 'QueueConversationSocialExpressionEventTopicVoicemail') -> None:
        """
    ...
    def caller_id(self) -> str:
        """
        Gets the caller_id of this QueueConversationSocialExpressionEventTopicCallback.
        The phone number displayed to recipients of the phone call. The value should conform to the E164 format.

        :return: The caller_id of this QueueConversationSocialExpressionEventTopicCallback.
        :rtype: str
        """
    ...
    def caller_id(self, caller_id: str) -> None:
        """
        Sets the caller_id of this QueueConversationSocialExpressionEventTopicCallback.
        The phone number displayed to recipients of the phone call. The value should conform to the E164 format.

        :param caller_id: The caller_id of this QueueConversationSocialExpressionEventTopicCallback.
        :type: str
        """
    ...
    def caller_id_name(self) -> str:
        """
        Gets the caller_id_name of this QueueConversationSocialExpressionEventTopicCallback.
        The name displayed to recipients of the phone call.

        :return: The caller_id_name of this QueueConversationSocialExpressionEventTopicCallback.
        :rtype: str
        """
    ...
    def caller_id_name(self, caller_id_name: str) -> None:
        """
        Sets the caller_id_name of this QueueConversationSocialExpressionEventTopicCallback.
        The name displayed to recipients of the phone call.

        :param caller_id_name: The caller_id_name of this QueueConversationSocialExpressionEventTopicCallback.
        :type: str
        """
    ...
    def queue_media_settings(self) -> 'QueueConversationSocialExpressionEventTopicQueueMediaSettings':
        """
        Gets the queue_media_settings of this QueueConversationSocialExpressionEventTopicCallback.
        Represents the queue setting for this media.

        :return: The queue_media_settings of this QueueConversationSocialExpressionEventTopicCallback.
    ...
    def queue_media_settings(self, queue_media_settings: 'QueueConversationSocialExpressionEventTopicQueueMediaSettings') -> None:
        """
        Sets the queue_media_settings of this QueueConversationSocialExpressionEventTopicCallback.
        Represents the queue setting for this media.

        :param queue_media_settings: The queue_media_settings of this QueueConversationSocialExpressionEventTopicCallback.
