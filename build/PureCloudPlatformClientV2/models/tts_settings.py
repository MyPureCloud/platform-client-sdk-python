...
class TtsSettings(object):
    ...
    def default_engine(self, default_engine: str) -> None:
        """
    ...
    @property
    def language_overrides(self) -> List['LanguageOverride']:
        """
    ...
    def language_overrides(self, language_overrides: List['LanguageOverride']) -> None:
        """
