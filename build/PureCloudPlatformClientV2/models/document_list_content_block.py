...
class DocumentListContentBlock(object):
    ...
    def __init__(self) -> None:
        """
        DocumentListContentBlock - a model defined in Swagger
    ...
    def type(self) -> str:
        """
        Gets the type of this DocumentListContentBlock.
        The type of the list block.

        :return: The type of this DocumentListContentBlock.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type: str) -> None:
        """
        Sets the type of this DocumentListContentBlock.
        The type of the list block.

        :param type: The type of this DocumentListContentBlock.
        :type: str
        """
    ...
    def text(self) -> 'DocumentText':
        """
        Gets the text of this DocumentListContentBlock.
        Text. It must contain a value if the type of the block is Text.

        :return: The text of this DocumentListContentBlock.
        :rtype: DocumentText
        """
        return self._text
    ...
    def text(self, text: 'DocumentText') -> None:
        """
        Sets the text of this DocumentListContentBlock.
        Text. It must contain a value if the type of the block is Text.

        :param text: The text of this DocumentListContentBlock.
        :type: DocumentText
        """
    ...
    def image(self) -> 'DocumentBodyImage':
        """
        Gets the image of this DocumentListContentBlock.
        Image. It must contain a value if the type of the block is Image.

        :return: The image of this DocumentListContentBlock.
    ...
    def image(self, image: 'DocumentBodyImage') -> None:
        """
        Sets the image of this DocumentListContentBlock.
        Image. It must contain a value if the type of the block is Image.

        :param image: The image of this DocumentListContentBlock.
