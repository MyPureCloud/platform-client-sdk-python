...
if TYPE_CHECKING:
    from . import CreateWorkPlanActivity
...
class CreateWorkPlanShift(object):
    ...
    @property
    def constrain_stop_time(self) -> bool:
        """
    ...
    def constrain_stop_time(self, constrain_stop_time: bool) -> None:
        """
    ...
    @property
    def constrain_earliest_stop_time(self) -> bool:
        """
    ...
    def constrain_earliest_stop_time(self, constrain_earliest_stop_time: bool) -> None:
        """
    ...
    @property
    def start_increment_minutes(self) -> int:
        """
    ...
    def start_increment_minutes(self, start_increment_minutes: int) -> None:
        """
    ...
    @property
    def constrain_contiguous_work_time(self) -> bool:
        """
    ...
    def constrain_contiguous_work_time(self, constrain_contiguous_work_time: bool) -> None:
        """
    ...
    @property
    def minimum_contiguous_work_time_minutes(self) -> int:
        """
    ...
    def minimum_contiguous_work_time_minutes(self, minimum_contiguous_work_time_minutes: int) -> None:
        """
    ...
    @property
    def maximum_contiguous_work_time_minutes(self) -> int:
        """
    ...
    def maximum_contiguous_work_time_minutes(self, maximum_contiguous_work_time_minutes: int) -> None:
        """
    ...
    @property
    def constrain_day_off(self) -> bool:
        """
    ...
    def constrain_day_off(self, constrain_day_off: bool) -> None:
        """
    ...
    @day_off_rule.setter
    def day_off_rule(self, day_off_rule: str) -> None:
        """
    ...
    def planning_period_constraints(self) -> 'PlanningPeriodShiftConstraints':
        """
        Gets the planning_period_constraints of this CreateWorkPlanShift.
        Planning period constraints

        :return: The planning_period_constraints of this CreateWorkPlanShift.
    ...
    def planning_period_constraints(self, planning_period_constraints: 'PlanningPeriodShiftConstraints') -> None:
        """
        Sets the planning_period_constraints of this CreateWorkPlanShift.
        Planning period constraints

        :param planning_period_constraints: The planning_period_constraints of this CreateWorkPlanShift.
    ...
    @property
    def activities(self) -> List['CreateWorkPlanActivity']:
        """
    ...
    @activities.setter
    def activities(self, activities: List['CreateWorkPlanActivity']) -> None:
        """
