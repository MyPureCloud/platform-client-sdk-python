...
class RecurrenceSettingsBase(object):
    """
    ...
    def __init__(self) -> None:
        """
        RecurrenceSettingsBase - a model defined in Swagger
    ...
    def end_after(self) -> 'RecurrenceEndSettings':
        """
        Gets the end_after of this RecurrenceSettingsBase.
        Settings controlling when to end the recurrence for the activity plan

        :return: The end_after of this RecurrenceSettingsBase.
    ...
    def end_after(self, end_after: 'RecurrenceEndSettings') -> None:
        """
        Sets the end_after of this RecurrenceSettingsBase.
        Settings controlling when to end the recurrence for the activity plan

        :param end_after: The end_after of this RecurrenceSettingsBase.
