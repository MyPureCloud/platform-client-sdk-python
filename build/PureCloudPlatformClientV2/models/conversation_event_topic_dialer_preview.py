...
if TYPE_CHECKING:
    from . import ConversationEventTopicPhoneNumberColumn
...
class ConversationEventTopicDialerPreview(object):
    ...
    @property
    def phone_number_columns(self) -> List['ConversationEventTopicPhoneNumberColumn']:
        """
    ...
    def phone_number_columns(self, phone_number_columns: List['ConversationEventTopicPhoneNumberColumn']) -> None:
        """
