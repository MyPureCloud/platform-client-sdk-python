...
if TYPE_CHECKING:
    from . import CallBasic
    from . import CallbackBasic
...
class ParticipantBasic(object):
    ...
    def external_contact_initial_division_id(self) -> str:
        """
        Gets the external_contact_initial_division_id of this ParticipantBasic.
        ...
        :return: The external_contact_initial_division_id of this ParticipantBasic.
        :rtype: str
        """
    ...
    def external_contact_initial_division_id(self, external_contact_initial_division_id: str) -> None:
        """
        Sets the external_contact_initial_division_id of this ParticipantBasic.
        If this participant represents an external contact, then this will be the initial division for the external contact. This value will not be updated if the external contact is reassigned.

        :param external_contact_initial_division_id: The external_contact_initial_division_id of this ParticipantBasic.
        :type: str
        """
    ...
    def media_roles(self) -> List[str]:
        """
        Gets the media_roles of this ParticipantBasic.
        List of roles this participant's media has had on the conversation, ie monitor, coach, etc.

        :return: The media_roles of this ParticipantBasic.
        :rtype: list[str]
        """
    ...
    def media_roles(self, media_roles: List[str]) -> None:
        """
        Sets the media_roles of this ParticipantBasic.
        List of roles this participant's media has had on the conversation, ie monitor, coach, etc.

        :param media_roles: The media_roles of this ParticipantBasic.
        :type: list[str]
        """
    ...
    def conversation_routing_data(self) -> 'ConversationRoutingData':
        """
        Gets the conversation_routing_data of this ParticipantBasic.
        Information on how a communication should be routed to an agent.

        :return: The conversation_routing_data of this ParticipantBasic.
    ...
    def conversation_routing_data(self, conversation_routing_data: 'ConversationRoutingData') -> None:
        """
        Sets the conversation_routing_data of this ParticipantBasic.
        Information on how a communication should be routed to an agent.

        :param conversation_routing_data: The conversation_routing_data of this ParticipantBasic.
    ...
    def alerting_timeout_ms(self) -> int:
        """
        Gets the alerting_timeout_ms of this ParticipantBasic.
        Specifies how long the agent has to answer an interaction before being marked as not responding.

        :return: The alerting_timeout_ms of this ParticipantBasic.
        :rtype: int
        """
    ...
    def alerting_timeout_ms(self, alerting_timeout_ms: int) -> None:
        """
        Sets the alerting_timeout_ms of this ParticipantBasic.
        Specifies how long the agent has to answer an interaction before being marked as not responding.

        :param alerting_timeout_ms: The alerting_timeout_ms of this ParticipantBasic.
        :type: int
        """
    ...
    def coached_participant_id(self) -> str:
        """
        Gets the coached_participant_id of this ParticipantBasic.
        If this participant is a coach, then this will be the id of the participant that is being coached.

        :return: The coached_participant_id of this ParticipantBasic.
        :rtype: str
        """
    ...
    def coached_participant_id(self, coached_participant_id: str) -> None:
        """
        Sets the coached_participant_id of this ParticipantBasic.
        If this participant is a coach, then this will be the id of the participant that is being coached.

        :param coached_participant_id: The coached_participant_id of this ParticipantBasic.
        :type: str
        """
    ...
    @calls.setter
    def calls(self, calls: List['CallBasic']) -> None:
        """
    ...
    @property
    def callbacks(self) -> List['CallbackBasic']:
        """
    ...
    @callbacks.setter
    def callbacks(self, callbacks: List['CallbackBasic']) -> None:
        """
    ...
    def internal_messages(self) -> List['InternalMessage']:
        """
        Gets the internal_messages of this ParticipantBasic.


        :return: The internal_messages of this ParticipantBasic.
    ...
    def internal_messages(self, internal_messages: List['InternalMessage']) -> None:
        """
        Sets the internal_messages of this ParticipantBasic.


        :param internal_messages: The internal_messages of this ParticipantBasic.
    ...
    def screen_monitorings(self) -> List['ScreenMonitoring']:
        """
        Gets the screen_monitorings of this ParticipantBasic.


        :return: The screen_monitorings of this ParticipantBasic.
    ...
    def screen_monitorings(self, screen_monitorings: List['ScreenMonitoring']) -> None:
        """
        Sets the screen_monitorings of this ParticipantBasic.


        :param screen_monitorings: The screen_monitorings of this ParticipantBasic.
    ...
    def flagged_reason(self) -> str:
        """
        Gets the flagged_reason of this ParticipantBasic.
        The reason specifying why participant flagged the conversation.

        :return: The flagged_reason of this ParticipantBasic.
        :rtype: str
        """
    ...
    def flagged_reason(self, flagged_reason: str) -> None:
        """
        Sets the flagged_reason of this ParticipantBasic.
        The reason specifying why participant flagged the conversation.

        :param flagged_reason: The flagged_reason of this ParticipantBasic.
        :type: str
        """
