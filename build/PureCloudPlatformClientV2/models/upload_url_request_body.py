...
class UploadUrlRequestBody(object):
    """
    ...
    def __init__(self):
        """
        UploadUrlRequestBody - a model defined in Swagger
    ...
    def content_length_bytes(self):
        """
        Gets the content_length_bytes of this UploadUrlRequestBody.
        The expected content length (in bytes) of the gzip-encoded data that will be PUT to the returned signed URL

        :return: The content_length_bytes of this UploadUrlRequestBody.
        :rtype: int
        """
    ...
    def content_length_bytes(self, content_length_bytes):
        """
        Sets the content_length_bytes of this UploadUrlRequestBody.
        The expected content length (in bytes) of the gzip-encoded data that will be PUT to the returned signed URL

        :param content_length_bytes: The content_length_bytes of this UploadUrlRequestBody.
        :type: int
        """
