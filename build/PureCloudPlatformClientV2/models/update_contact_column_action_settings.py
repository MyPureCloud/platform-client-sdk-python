...
class UpdateContactColumnActionSettings(object):
    """
    ...
    def __init__(self) -> None:
        """
        UpdateContactColumnActionSettings - a model defined in Swagger
    ...
    def properties(self) -> Dict[str, str]:
        """
        Gets the properties of this UpdateContactColumnActionSettings.
        A mapping of contact columns to their new values.

        :return: The properties of this UpdateContactColumnActionSettings.
        :rtype: dict(str, str)
        """
    ...
    def properties(self, properties: Dict[str, str]) -> None:
        """
        Sets the properties of this UpdateContactColumnActionSettings.
        A mapping of contact columns to their new values.

        :param properties: The properties of this UpdateContactColumnActionSettings.
        :type: dict(str, str)
        """
    ...
    def update_option(self) -> str:
        """
        Gets the update_option of this UpdateContactColumnActionSettings.
        The type of update to make to the specified contact column(s).

        :return: The update_option of this UpdateContactColumnActionSettings.
        :rtype: str
        """
    ...
    def update_option(self, update_option: str) -> None:
        """
        Sets the update_option of this UpdateContactColumnActionSettings.
        The type of update to make to the specified contact column(s).
