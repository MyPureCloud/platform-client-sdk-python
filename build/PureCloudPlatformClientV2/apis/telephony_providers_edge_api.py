...
from ..models import AlertablePresences
from ..models import CertificateAuthorityEntityListing
from ..models import DID
from ..models import DIDEntityListing
...
from ..models import DomainLogicalInterface
from ..models import DomainPhysicalInterface
...
from ..models import EdgeLogsJobUploadRequest
from ..models import EdgeMetrics
from ..models import EdgeNetworkDiagnostic
from ..models import EdgeNetworkDiagnosticRequest
from ..models import EdgeNetworkDiagnosticResponse
from ..models import EdgeOfflineConfiguration
from ..models import EdgeOfflineConfigurationResponse
from ..models import EdgeRebootParameters
from ..models import EdgeServiceStateRequest
from ..models import EdgeTrunkBase
from ..models import EdgeVersionReport
from ..models import ErrorBody
from ..models import ExpiredEdgeListing
from ..models import Extension
from ..models import ExtensionEntityListing
from ..models import ExtensionPool
from ..models import ExtensionPoolDivisionViewEntityListing
from ..models import ExtensionPoolEntityListing
from ..models import Line
from ..models import LineBase
...
from ..models import PhoneBase
from ..models import PhoneBaseEntityListing
from ..models import PhoneEntityListing
from ..models import PhoneMetaBaseEntityListing
...
from ..models import TelephonySearchRequest
from ..models import TimeZoneEntityListing
from ..models import Trunk
from ..models import TrunkBase
from ..models import TrunkBaseEntityListing
from ..models import TrunkBasesSearchResponse
from ..models import TrunkEntityListing
from ..models import TrunkInstanceSearchResponse
from ..models import TrunkMetabaseEntityListing
from ..models import TrunkMetrics
from ..models import TrunkRecordingEnabledCount
from ..models import ValidateAddressRequest
from ..models import ValidateAddressResponse
from ..models import VmPairingInfo
...
class TelephonyProvidersEdgeApi(object):
    ...
    def delete_telephony_providers_edges_alertablepresences(self, **kwargs) -> None:
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_telephony_providers_edges_alertablepresences(callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_telephony_providers_edges_alertablepresences" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/api/v2/telephony/providers/edges/alertablepresences'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_telephony_providers_edges_alertablepresences(self, **kwargs) -> 'AlertablePresences':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_telephony_providers_edges_alertablepresences(callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_telephony_providers_edges_alertablepresences" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='AlertablePresences',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
    ...
    def get_telephony_providers_edges_expired(self, **kwargs) -> 'ExpiredEdgeListing':
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_telephony_providers_edges_expired(callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_telephony_providers_edges_expired" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/api/v2/telephony/providers/edges/expired'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='ExpiredEdgeListing',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
    ...
    def get_telephony_providers_edges_extensionpools_divisionviews(self, **kwargs) -> 'ExtensionPoolDivisionViewEntityListing':
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_telephony_providers_edges_extensionpools_divisionviews(callback=callback_function)
        ...
        :param str sort_by: Sort by
        :param str sort_order: Sort order
        :param list[str] id: ID of the Extension Pools to filter by.
        :param str name: Name of the Extension Pools to filter by.
        :param list[str] division_id: List of divisionIds on which to filter.
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_telephony_providers_edges_extensionpools_divisionviews" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/api/v2/telephony/providers/edges/extensionpools/divisionviews'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='ExtensionPoolDivisionViewEntityListing',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
    ...
    def get_telephony_providers_edges_trunkbasesettings_site_site_id(self, site_id: str, **kwargs) -> 'TrunkBaseEntityListing':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_telephony_providers_edges_trunkbasesettings_site_site_id(site_id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str site_id: Site ID for trunk bases (required)
        :param int page_number: Page number
        :param int page_size: Page size
        :param str sort_by: Value by which to sort
        :param str sort_order: Sort order
        ...
        all_params = ['site_id', 'page_number', 'page_size', 'sort_by', 'sort_order']
        all_params.append('callback')
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_telephony_providers_edges_trunkbasesettings_site_site_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'site_id' is set
        if ('site_id' not in params) or (params['site_id'] is None):
            raise ValueError("Missing the required parameter `site_id` when calling `get_telephony_providers_edges_trunkbasesettings_site_site_id`")


        resource_path = '/api/v2/telephony/providers/edges/trunkbasesettings/site/{siteId}'.replace('{format}', 'json')
        path_params = {}
        if 'site_id' in params:
            path_params['siteId'] = params['site_id']
    ...
    def post_telephony_providers_edge_offlineconfiguration(self, edge_id: str, body: 'EdgeOfflineConfiguration', **kwargs) -> 'EdgeOfflineConfigurationResponse':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_telephony_providers_edge_offlineconfiguration(edge_id, body, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_telephony_providers_edge_offlineconfiguration" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'edge_id' is set
        if ('edge_id' not in params) or (params['edge_id'] is None):
            raise ValueError("Missing the required parameter `edge_id` when calling `post_telephony_providers_edge_offlineconfiguration`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_telephony_providers_edge_offlineconfiguration`")


        resource_path = '/api/v2/telephony/providers/edges/{edgeId}/offlineconfiguration'.replace('{format}', 'json')
        path_params = {}
        if 'edge_id' in params:
            path_params['edgeId'] = params['edge_id']
    ...
    def post_telephony_providers_edges_trunkbasesettings_search(self, body: 'TelephonySearchRequest', **kwargs) -> 'TrunkBasesSearchResponse':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_telephony_providers_edges_trunkbasesettings_search(body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param TelephonySearchRequest body: Telephony search request (required)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_telephony_providers_edges_trunkbasesettings_search" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_telephony_providers_edges_trunkbasesettings_search`")


        resource_path = '/api/v2/telephony/providers/edges/trunkbasesettings/search'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'POST',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='TrunkBasesSearchResponse',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def post_telephony_providers_edges_trunks_search(self, body: 'TelephonySearchRequest', **kwargs) -> 'TrunkInstanceSearchResponse':
        """
        Search for trunks
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_telephony_providers_edges_trunks_search(body, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_telephony_providers_edges_trunks_search" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_telephony_providers_edges_trunks_search`")


        resource_path = '/api/v2/telephony/providers/edges/trunks/search'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'POST',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='TrunkInstanceSearchResponse',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
    ...
    def put_telephony_providers_edges_alertablepresences(self, body: 'AlertablePresences', **kwargs) -> None:
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_telephony_providers_edges_alertablepresences(body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param AlertablePresences body: Alertable Presences Overrides (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method put_telephony_providers_edges_alertablepresences" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_telephony_providers_edges_alertablepresences`")
