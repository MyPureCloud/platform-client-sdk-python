...
from ..models import ActionCertificateListing
...
from ..models import WebhookInvocationResponse
...
class IntegrationsApi(object):
    ...
    def get_integrations_actions_certificates(self, **kwargs) -> 'ActionCertificateListing':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_integrations_actions_certificates(callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str status: Indicates the validity of the certificate in question.
        :param str type: Indicates the type of the certificate.
        :return: ActionCertificateListing
                 If the method is called asynchronously,
                 returns the request thread.
        """

        all_params = ['status', 'type']
        all_params.append('callback')
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_integrations_actions_certificates" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/api/v2/integrations/actions/certificates'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='ActionCertificateListing',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
    ...
    def get_integrations_credentials_listing(self, **kwargs) -> 'CredentialInfoCursorListing':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_integrations_credentials_listing(callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_integrations_credentials_listing" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/api/v2/integrations/credentials/listing'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='CredentialInfoCursorListing',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
    ...
    def get_integrations_speech_audioconnector(self, **kwargs) -> 'AudioConnectorIntegrationEntityListing':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_integrations_speech_audioconnector(callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_integrations_speech_audioconnector" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/api/v2/integrations/speech/audioconnector'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='AudioConnectorIntegrationEntityListing',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def get_integrations_speech_audioconnector_integration_id(self, integration_id: str, **kwargs) -> 'AudioConnectorIntegration':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_integrations_speech_audioconnector_integration_id(integration_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_integrations_speech_audioconnector_integration_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'integration_id' is set
        if ('integration_id' not in params) or (params['integration_id'] is None):
            raise ValueError("Missing the required parameter `integration_id` when calling `get_integrations_speech_audioconnector_integration_id`")


        resource_path = '/api/v2/integrations/speech/audioconnector/{integrationId}'.replace('{format}', 'json')
        path_params = {}
        if 'integration_id' in params:
            path_params['integrationId'] = params['integration_id']
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='AudioConnectorIntegration',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
    ...
    def post_integrations_webhook_events(self, token_id: str, body: object, **kwargs) -> 'WebhookInvocationResponse':
        """
        Invoke Webhook
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_integrations_webhook_events(token_id, body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str token_id: The token of the webhook to be invoked (required)
        :param object body: Webhook Invocation Payload (required)
        :return: WebhookInvocationResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """

        all_params = ['token_id', 'body']
        all_params.append('callback')
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_integrations_webhook_events" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('token_id' not in params) or (params['token_id'] is None):
            raise ValueError("Missing the required parameter `token_id` when calling `post_integrations_webhook_events`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_integrations_webhook_events`")


        resource_path = '/api/v2/integrations/webhooks/{tokenId}/events'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'POST',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='WebhookInvocationResponse',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
