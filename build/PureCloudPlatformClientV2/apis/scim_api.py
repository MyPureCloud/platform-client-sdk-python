...
class SCIMApi(object):
    ...
    def delete_scim_group(self, group_id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_scim_group(group_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method delete_scim_group" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('group_id' not in params) or (params['group_id'] is None):
            raise ValueError("Missing the required parameter `group_id` when calling `delete_scim_group`")
    ...
    def delete_scim_v2_group(self, group_id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_scim_v2_group(group_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_scim_v2_group" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'group_id' is set
        if ('group_id' not in params) or (params['group_id'] is None):
            raise ValueError("Missing the required parameter `group_id` when calling `delete_scim_v2_group`")
    ...
    def post_scim_groups(self, body, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_scim_groups(body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_scim_groups" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_scim_groups`")
    ...
    def post_scim_v2_groups(self, body, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_scim_v2_groups(body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_scim_v2_groups" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_scim_v2_groups`")
