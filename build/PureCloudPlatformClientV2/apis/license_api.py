...
from ..models import LicenseBatchAssignmentRequest
from ..models import LicenseDefinition
from ..models import LicenseOrgToggle
from ..models import LicenseUpdateStatus
from ..models import LicenseUser
from ..models import UserLicensesEntityListing
...
class LicenseApi(object):
    ...
    def post_license_infer(self, **kwargs) -> List[str]:
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_license_infer(callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param list[str] body: The roleIds to use while inferring licenses
        :return: list[str]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_license_infer" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/api/v2/license/infer'.replace('{format}', 'json')
        path_params = {}
    ...
    def post_license_infer_permissions(self, **kwargs) -> List[str]:
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_license_infer_permissions(callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param list[str] body: The permissions to use while inferring licenses
        :return: list[str]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_license_infer_permissions" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/api/v2/license/infer/permissions'.replace('{format}', 'json')
        path_params = {}
