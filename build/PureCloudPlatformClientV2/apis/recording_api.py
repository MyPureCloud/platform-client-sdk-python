...
class RecordingApi(object):
    ...
    def get_recordings_screensessions_details(self, **kwargs) -> 'ScreenRecordingActiveSessions':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_recordings_screensessions_details(callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_recordings_screensessions_details" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/api/v2/recordings/screensessions/details'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='ScreenRecordingActiveSessions',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
