...
from ..models import CreateExternalEventsConfigurationRequest
...
from ..models import JourneyExternalEventsSchema
from ..models import JourneyExternalEventsSchemaListing
from ..models import JourneyJsonSchemaRequest
from ..models import JourneySchemaUpdateRequest
...
class JourneyApi(object):
    ...
    def delete_journey_externalevents_configuration(self, config_id: str, **kwargs) -> None:
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_journey_externalevents_configuration(config_id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str config_id: The ID of the external event configuration. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_journey_externalevents_configuration" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('config_id' not in params) or (params['config_id'] is None):
            raise ValueError("Missing the required parameter `config_id` when calling `delete_journey_externalevents_configuration`")


        resource_path = '/api/v2/journey/externalevents/configurations/{configId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_journey_externalevents_schema(self, schema_id: str, **kwargs) -> None:
        """
        Delete a schema
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_journey_externalevents_schema(schema_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_journey_externalevents_schema" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('schema_id' not in params) or (params['schema_id'] is None):
            raise ValueError("Missing the required parameter `schema_id` when calling `delete_journey_externalevents_schema`")


        resource_path = '/api/v2/journey/externalevents/schemas/{schemaId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_journey_externalevents_configuration(self, config_id: str, **kwargs) -> 'ExternalEventsConfiguration':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_journey_externalevents_configuration(config_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_journey_externalevents_configuration" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'config_id' is set
        if ('config_id' not in params) or (params['config_id'] is None):
            raise ValueError("Missing the required parameter `config_id` when calling `get_journey_externalevents_configuration`")
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='ExternalEventsConfiguration',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def get_journey_externalevents_configurations(self, **kwargs) -> 'ExternalEventsConfigurationListing':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_journey_externalevents_configurations(callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_journey_externalevents_configurations" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if 'page_size' in params and params['page_size'] > 20: 
            raise ValueError("Invalid value for parameter `page_size` when calling `get_journey_externalevents_configurations`, must be a value less than or equal to  `20`")
        if 'page_size' in params and params['page_size'] < 1: 
            raise ValueError("Invalid value for parameter `page_size` when calling `get_journey_externalevents_configurations`, must be a value greater than or equal to `1`")
        if 'page_number' in params and params['page_number'] < 1: 
            raise ValueError("Invalid value for parameter `page_number` when calling `get_journey_externalevents_configurations`, must be a value greater than or equal to `1`")

        resource_path = '/api/v2/journey/externalevents/configurations'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='ExternalEventsConfigurationListing',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def get_journey_externalevents_schema(self, schema_id: str, **kwargs) -> 'JourneyExternalEventsSchema':
        """
        Get a schema
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_journey_externalevents_schema(schema_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_journey_externalevents_schema" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'schema_id' is set
        if ('schema_id' not in params) or (params['schema_id'] is None):
            raise ValueError("Missing the required parameter `schema_id` when calling `get_journey_externalevents_schema`")
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='JourneyExternalEventsSchema',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def get_journey_externalevents_schema_version(self, schema_id: str, version_id: str, **kwargs) -> 'JourneyExternalEventsSchema':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_journey_externalevents_schema_version(schema_id, version_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_journey_externalevents_schema_version" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'schema_id' is set
        if ('schema_id' not in params) or (params['schema_id'] is None):
            raise ValueError("Missing the required parameter `schema_id` when calling `get_journey_externalevents_schema_version`")
        # verify the required parameter 'version_id' is set
        if ('version_id' not in params) or (params['version_id'] is None):
            raise ValueError("Missing the required parameter `version_id` when calling `get_journey_externalevents_schema_version`")


        resource_path = '/api/v2/journey/externalevents/schemas/{schemaId}/versions/{versionId}'.replace('{format}', 'json')
        path_params = {}
        if 'schema_id' in params:
            path_params['schemaId'] = params['schema_id']
    ...
    def get_journey_externalevents_schema_versions(self, schema_id: str, **kwargs) -> 'JourneyExternalEventsSchemaListing':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_journey_externalevents_schema_versions(schema_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_journey_externalevents_schema_versions" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'schema_id' is set
        if ('schema_id' not in params) or (params['schema_id'] is None):
            raise ValueError("Missing the required parameter `schema_id` when calling `get_journey_externalevents_schema_versions`")


        resource_path = '/api/v2/journey/externalevents/schemas/{schemaId}/versions'.replace('{format}', 'json')
        path_params = {}
        if 'schema_id' in params:
            path_params['schemaId'] = params['schema_id']
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='JourneyExternalEventsSchemaListing',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def get_journey_externalevents_schemas(self, **kwargs) -> 'JourneyExternalEventsSchemaListing':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_journey_externalevents_schemas(callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_journey_externalevents_schemas" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/api/v2/journey/externalevents/schemas'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_journey_externalevents_schemas_coretype(self, core_type_name: str, **kwargs) -> 'Coretype':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_journey_externalevents_schemas_coretype(core_type_name, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str core_type_name: Name of core type (required)
        :return: Coretype
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_journey_externalevents_schemas_coretype" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('core_type_name' not in params) or (params['core_type_name'] is None):
            raise ValueError("Missing the required parameter `core_type_name` when calling `get_journey_externalevents_schemas_coretype`")


        resource_path = '/api/v2/journey/externalevents/schemas/coretypes/{coreTypeName}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_journey_externalevents_schemas_coretypes(self, **kwargs) -> 'CoretypeListing':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_journey_externalevents_schemas_coretypes(callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_journey_externalevents_schemas_coretypes" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/api/v2/journey/externalevents/schemas/coretypes'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_journey_externalevents_schemas_limits(self, **kwargs) -> 'SchemaQuantityLimits':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_journey_externalevents_schemas_limits(callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_journey_externalevents_schemas_limits" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/api/v2/journey/externalevents/schemas/limits'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_journey_views_jobs_me(self, **kwargs) -> 'JourneyViewJobListing':
        """
        Get my jobs
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_journey_views_jobs_me(callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_journey_views_jobs_me" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/api/v2/journey/views/jobs/me'.replace('{format}', 'json')
        path_params = {}
    ...
    def patch_journey_externalevents_configuration(self, config_id: str, **kwargs) -> 'ExternalEventsConfiguration':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.patch_journey_externalevents_configuration(config_id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str config_id: The ID of the external event configuration. (required)
        :param UpdateExternalEventsConfigurationRequest body: 
        :return: ExternalEventsConfiguration
                 If the method is called asynchronously,
                 returns the request thread.
        """

        all_params = ['config_id', 'body']
        all_params.append('callback')
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method patch_journey_externalevents_configuration" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'config_id' is set
        if ('config_id' not in params) or (params['config_id'] is None):
            raise ValueError("Missing the required parameter `config_id` when calling `patch_journey_externalevents_configuration`")
    ...
    def post_journey_externalevents_configuration_events(self, configuration_id: str, **kwargs) -> 'ExternalEventsResponse':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_journey_externalevents_configuration_events(configuration_id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str configuration_id: The ID of the external event configuration. (required)
        :param ExternalEventsRequest body: 
        :return: ExternalEventsResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """

        all_params = ['configuration_id', 'body']
        all_params.append('callback')
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_journey_externalevents_configuration_events" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('configuration_id' not in params) or (params['configuration_id'] is None):
            raise ValueError("Missing the required parameter `configuration_id` when calling `post_journey_externalevents_configuration_events`")


        resource_path = '/api/v2/journey/externalevents/configurations/{configurationId}/events'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'POST',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='ExternalEventsResponse',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def post_journey_externalevents_configurations(self, **kwargs) -> 'ExternalEventsConfiguration':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_journey_externalevents_configurations(callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param CreateExternalEventsConfigurationRequest body: 
        :return: ExternalEventsConfiguration
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_journey_externalevents_configurations" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def post_journey_externalevents_schemas(self, body: 'JourneyJsonSchemaRequest', **kwargs) -> 'JourneyExternalEventsSchema':
        """
        Create a schema
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_journey_externalevents_schemas(body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param JourneyJsonSchemaRequest body: Schema create request body (required)
        :return: JourneyExternalEventsSchema
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_journey_externalevents_schemas" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_journey_externalevents_schemas`")
    ...
    def put_journey_externalevents_schema(self, schema_id: str, body: 'JourneySchemaUpdateRequest', **kwargs) -> 'JourneyExternalEventsSchema':
        """
        Update a schema
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_journey_externalevents_schema(schema_id, body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str schema_id: Schema ID (required)
        :param JourneySchemaUpdateRequest body: Schema update request body (required)
        :return: JourneyExternalEventsSchema
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method put_journey_externalevents_schema" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'schema_id' is set
        if ('schema_id' not in params) or (params['schema_id'] is None):
            raise ValueError("Missing the required parameter `schema_id` when calling `put_journey_externalevents_schema`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_journey_externalevents_schema`")
