...
from ..models import KnowledgeSearchPreviewRequest
from ..models import KnowledgeSearchPreviewResponse
from ..models import KnowledgeSettingListing
from ..models import KnowledgeSettingsRequest
from ..models import KnowledgeSettingsResponse
from ..models import KnowledgeSourcesSearchRequest
from ..models import KnowledgeSourcesSearchResponse
...
class KnowledgeApi(object):
    ...
    def delete_knowledge_setting(self, knowledge_setting_id: str, **kwargs) -> None:
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_knowledge_setting(knowledge_setting_id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str knowledge_setting_id: Knowledge Setting ID. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """

        all_params = ['knowledge_setting_id']
        all_params.append('callback')
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_knowledge_setting" % key
                )
            params[key] = val
        del params['kwargs']

        # verify the required parameter 'knowledge_setting_id' is set
        if ('knowledge_setting_id' not in params) or (params['knowledge_setting_id'] is None):
            raise ValueError("Missing the required parameter `knowledge_setting_id` when calling `delete_knowledge_setting`")


        resource_path = '/api/v2/knowledge/settings/{knowledgeSettingId}'.replace('{format}', 'json')
        path_params = {}
        if 'knowledge_setting_id' in params:
            path_params['knowledgeSettingId'] = params['knowledge_setting_id']
    ...
    def get_knowledge_setting(self, knowledge_setting_id: str, **kwargs) -> 'KnowledgeSettingsResponse':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_knowledge_setting(knowledge_setting_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_knowledge_setting" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'knowledge_setting_id' is set
        if ('knowledge_setting_id' not in params) or (params['knowledge_setting_id'] is None):
            raise ValueError("Missing the required parameter `knowledge_setting_id` when calling `get_knowledge_setting`")
    ...
    def get_knowledge_settings(self, **kwargs) -> 'KnowledgeSettingListing':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_knowledge_settings(callback=callback_function)
        ...
        :param str after: The cursor that points to the end of the set of entities that has been returned.
        :param str page_size: Number of entities to return. Maximum of 200.
        :param str name: Knowledge setting name to search upon.
        :param str source_id: Source ID to filter knowledge settings by.
        :param str sort_by: Field to sort the knowledge settings on.
        :param str sort_order: Sorting order for knowledge settings.
        :return: KnowledgeSettingListing
                 If the method is called asynchronously,
                 returns the request thread.
        """

        all_params = ['before', 'after', 'page_size', 'name', 'source_id', 'sort_by', 'sort_order']
        all_params.append('callback')
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_knowledge_settings" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/api/v2/knowledge/settings'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='KnowledgeSettingListing',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
    ...
    def patch_knowledge_knowledgebase_chunks_search_search_id(self, knowledge_base_id: str, search_id: str, **kwargs) -> None:
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.patch_knowledge_knowledgebase_chunks_search_search_id(knowledge_base_id, search_id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str knowledge_base_id: Knowledge Base ID (required)
        :param str search_id: Unique identifier of search request (required)
        :param ChunkSearchRegisterRequest body: 
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method patch_knowledge_knowledgebase_chunks_search_search_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'knowledge_base_id' is set
        if ('knowledge_base_id' not in params) or (params['knowledge_base_id'] is None):
            raise ValueError("Missing the required parameter `knowledge_base_id` when calling `patch_knowledge_knowledgebase_chunks_search_search_id`")
        # verify the required parameter 'search_id' is set
        if ('search_id' not in params) or (params['search_id'] is None):
            raise ValueError("Missing the required parameter `search_id` when calling `patch_knowledge_knowledgebase_chunks_search_search_id`")


        resource_path = '/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/chunks/search/{searchId}'.replace('{format}', 'json')
        path_params = {}
        if 'knowledge_base_id' in params:
            path_params['knowledgeBaseId'] = params['knowledge_base_id']
        if 'search_id' in params:
    ...
    def patch_knowledge_setting(self, knowledge_setting_id: str, body: 'KnowledgeSettingsRequest', **kwargs) -> 'KnowledgeSettingsResponse':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.patch_knowledge_setting(knowledge_setting_id, body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str knowledge_setting_id: Knowledge Setting ID. (required)
        :param KnowledgeSettingsRequest body:  (required)
        :return: KnowledgeSettingsResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """

        all_params = ['knowledge_setting_id', 'body']
        all_params.append('callback')
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method patch_knowledge_setting" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'knowledge_setting_id' is set
        if ('knowledge_setting_id' not in params) or (params['knowledge_setting_id'] is None):
            raise ValueError("Missing the required parameter `knowledge_setting_id` when calling `patch_knowledge_setting`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `patch_knowledge_setting`")
    ...
    def post_knowledge_knowledgebase_chunks_search(self, knowledge_base_id: str, **kwargs) -> 'KnowledgeDocumentChunkResponse':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_knowledge_knowledgebase_chunks_search(knowledge_base_id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str knowledge_base_id: Knowledge Base ID (required)
        :param KnowledgeDocumentChunkRequest body: 
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_knowledge_knowledgebase_chunks_search" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'knowledge_base_id' is set
        if ('knowledge_base_id' not in params) or (params['knowledge_base_id'] is None):
            raise ValueError("Missing the required parameter `knowledge_base_id` when calling `post_knowledge_knowledgebase_chunks_search`")


        resource_path = '/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/chunks/search'.replace('{format}', 'json')
        path_params = {}
        if 'knowledge_base_id' in params:
            path_params['knowledgeBaseId'] = params['knowledge_base_id']
        ...
        response = self.api_client.call_api(resource_path, 'POST',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='KnowledgeDocumentChunkResponse',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
    ...
    def post_knowledge_search(self, **kwargs) -> 'KnowledgeSourcesSearchResponse':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_knowledge_search(callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param KnowledgeSourcesSearchRequest body: 
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_knowledge_search" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/api/v2/knowledge/search'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'POST',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='KnowledgeSourcesSearchResponse',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def post_knowledge_search_preview(self, **kwargs) -> 'KnowledgeSearchPreviewResponse':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_knowledge_search_preview(callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param KnowledgeSearchPreviewRequest body: 
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_knowledge_search_preview" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/api/v2/knowledge/search/preview'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'POST',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='KnowledgeSearchPreviewResponse',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def post_knowledge_settings(self, **kwargs) -> 'KnowledgeSettingsResponse':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_knowledge_settings(callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param KnowledgeSettingsRequest body: 
        :return: KnowledgeSettingsResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_knowledge_settings" % key
                )
            params[key] = val
        del params['kwargs']
