...
class WebDeploymentsApi(object):
    ...
    def get_webdeployments_deployment_identityresolution(self, deployment_id: str, **kwargs) -> 'IdentityResolutionConfig':
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_webdeployments_deployment_identityresolution(deployment_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_webdeployments_deployment_identityresolution" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'deployment_id' is set
        if ('deployment_id' not in params) or (params['deployment_id'] is None):
            raise ValueError("Missing the required parameter `deployment_id` when calling `get_webdeployments_deployment_identityresolution`")


        resource_path = '/api/v2/webdeployments/deployments/{deploymentId}/identityresolution'.replace('{format}', 'json')
        path_params = {}
        if 'deployment_id' in params:
            path_params['deploymentId'] = params['deployment_id']
    ...
    def put_webdeployments_deployment_identityresolution(self, deployment_id: str, body: 'IdentityResolutionConfig', **kwargs) -> 'IdentityResolutionConfig':
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_webdeployments_deployment_identityresolution(deployment_id, body, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method put_webdeployments_deployment_identityresolution" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'deployment_id' is set
        if ('deployment_id' not in params) or (params['deployment_id'] is None):
            raise ValueError("Missing the required parameter `deployment_id` when calling `put_webdeployments_deployment_identityresolution`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_webdeployments_deployment_identityresolution`")
