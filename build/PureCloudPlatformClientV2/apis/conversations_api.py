...
from ..models import OpenMessagingIdentityResolutionConfig
...
from ..models import TwitterIntegrationUpdateRequest
from ..models import TwitterOAuthSettings
from ..models import TwitterSignupOAuthSettings
from ..models import UploadMediaRequest
from ..models import VideoConferenceDetails
...
class ConversationsApi(object):
    ...
    def delete_conversations_messaging_setting(self, message_setting_id: str, **kwargs) -> None:
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_conversations_messaging_setting(message_setting_id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str message_setting_id: Message Setting ID (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_conversations_messaging_setting" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('message_setting_id' not in params) or (params['message_setting_id'] is None):
            raise ValueError("Missing the required parameter `message_setting_id` when calling `delete_conversations_messaging_setting`")


        resource_path = '/api/v2/conversations/messaging/settings/{messageSettingId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_conversations_messaging_settings_default(self, **kwargs) -> None:
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_conversations_messaging_settings_default(callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_conversations_messaging_settings_default" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/api/v2/conversations/messaging/settings/default'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_conversation_suggestion(self, conversation_id: str, suggestion_id: str, **kwargs) -> 'Suggestion':
        """
        Get Suggestion.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_conversation_suggestion(conversation_id, suggestion_id, callback=callback_function)
        ...
        all_params = ['conversation_id', 'suggestion_id']
        all_params.append('callback')
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_conversation_suggestion" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'conversation_id' is set
        if ('conversation_id' not in params) or (params['conversation_id'] is None):
            raise ValueError("Missing the required parameter `conversation_id` when calling `get_conversation_suggestion`")
        # verify the required parameter 'suggestion_id' is set
        if ('suggestion_id' not in params) or (params['suggestion_id'] is None):
            raise ValueError("Missing the required parameter `suggestion_id` when calling `get_conversation_suggestion`")
    ...
    def get_conversation_suggestions(self, conversation_id: str, **kwargs) -> 'SuggestionListing':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_conversation_suggestions(conversation_id, callback=callback_function)
        ...
        :param str type: Suggestion type to filter by.
        :param str state: Suggestion state to filter Copilot suggestions.
        :return: SuggestionListing
                 If the method is called asynchronously,
                 returns the request thread.
        """

        all_params = ['conversation_id', 'before', 'after', 'page_size', 'type', 'state']
        all_params.append('callback')
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_conversation_suggestions" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'conversation_id' is set
        if ('conversation_id' not in params) or (params['conversation_id'] is None):
            raise ValueError("Missing the required parameter `conversation_id` when calling `get_conversation_suggestions`")


        resource_path = '/api/v2/conversations/{conversationId}/suggestions'.replace('{format}', 'json')
        path_params = {}
        if 'conversation_id' in params:
            path_params['conversationId'] = params['conversation_id']
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='SuggestionListing',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
    ...
    def get_conversations_messaging_identityresolution_integrations_facebook_integration_id(self, integration_id: str, **kwargs) -> 'IdentityResolutionConfig':
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_conversations_messaging_identityresolution_integrations_facebook_integration_id(integration_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_conversations_messaging_identityresolution_integrations_facebook_integration_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'integration_id' is set
        if ('integration_id' not in params) or (params['integration_id'] is None):
            raise ValueError("Missing the required parameter `integration_id` when calling `get_conversations_messaging_identityresolution_integrations_facebook_integration_id`")
    ...
    def get_conversations_messaging_identityresolution_integrations_open_integration_id(self, integration_id: str, **kwargs) -> 'OpenMessagingIdentityResolutionConfig':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_conversations_messaging_identityresolution_integrations_open_integration_id(integration_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_conversations_messaging_identityresolution_integrations_open_integration_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'integration_id' is set
        if ('integration_id' not in params) or (params['integration_id'] is None):
            raise ValueError("Missing the required parameter `integration_id` when calling `get_conversations_messaging_identityresolution_integrations_open_integration_id`")


        resource_path = '/api/v2/conversations/messaging/identityresolution/integrations/open/{integrationId}'.replace('{format}', 'json')
        path_params = {}
        if 'integration_id' in params:
            path_params['integrationId'] = params['integration_id']
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='OpenMessagingIdentityResolutionConfig',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
    ...
    def get_conversations_messaging_identityresolution_integrations_whatsapp_integration_id(self, integration_id: str, **kwargs) -> 'IdentityResolutionConfig':
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_conversations_messaging_identityresolution_integrations_whatsapp_integration_id(integration_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_conversations_messaging_identityresolution_integrations_whatsapp_integration_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'integration_id' is set
        if ('integration_id' not in params) or (params['integration_id'] is None):
            raise ValueError("Missing the required parameter `integration_id` when calling `get_conversations_messaging_identityresolution_integrations_whatsapp_integration_id`")


        resource_path = '/api/v2/conversations/messaging/identityresolution/integrations/whatsapp/{integrationId}'.replace('{format}', 'json')
        path_params = {}
        if 'integration_id' in params:
            path_params['integrationId'] = params['integration_id']
    ...
    def get_conversations_messaging_integration_twitter_oauth_settings(self, integration_id: str, **kwargs) -> 'TwitterOAuthSettings':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_conversations_messaging_integration_twitter_oauth_settings(integration_id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str integration_id: Integration Id of an existing integration that needs to be patched with new oauth settings (required)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_conversations_messaging_integration_twitter_oauth_settings" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'integration_id' is set
        if ('integration_id' not in params) or (params['integration_id'] is None):
            raise ValueError("Missing the required parameter `integration_id` when calling `get_conversations_messaging_integration_twitter_oauth_settings`")


        resource_path = '/api/v2/conversations/messaging/integrations/{integrationId}/twitter/oauth/settings'.replace('{format}', 'json')
        path_params = {}
        if 'integration_id' in params:
            path_params['integrationId'] = params['integration_id']
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='TwitterOAuthSettings',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
    ...
    def get_conversations_messaging_integrations_twitter_oauth_settings(self, **kwargs) -> 'TwitterSignupOAuthSettings':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_conversations_messaging_integrations_twitter_oauth_settings(callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_conversations_messaging_integrations_twitter_oauth_settings" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/api/v2/conversations/messaging/integrations/twitter/oauth/settings'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='TwitterSignupOAuthSettings',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
    ...
    def get_conversations_messaging_setting(self, message_setting_id: str, **kwargs) -> 'MessagingSetting':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_conversations_messaging_setting(message_setting_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_conversations_messaging_setting" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'message_setting_id' is set
        if ('message_setting_id' not in params) or (params['message_setting_id'] is None):
            raise ValueError("Missing the required parameter `message_setting_id` when calling `get_conversations_messaging_setting`")
    ...
    def get_conversations_messaging_settings(self, **kwargs) -> 'MessagingConfigListing':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_conversations_messaging_settings(callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_conversations_messaging_settings" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/api/v2/conversations/messaging/settings'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_conversations_messaging_settings_default(self, **kwargs) -> 'MessagingSetting':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_conversations_messaging_settings_default(callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_conversations_messaging_settings_default" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def get_conversations_video_details(self, conference_id: str, **kwargs) -> 'VideoConferenceDetails':
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_conversations_video_details(conference_id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str conference_id: conferenceId (required)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_conversations_video_details" % key
                )
            params[key] = val
        del params['kwargs']

        # verify the required parameter 'conference_id' is set
        if ('conference_id' not in params) or (params['conference_id'] is None):
            raise ValueError("Missing the required parameter `conference_id` when calling `get_conversations_video_details`")


        resource_path = '/api/v2/conversations/videos/{conferenceId}/details'.replace('{format}', 'json')
        path_params = {}
        if 'conference_id' in params:
            path_params['conferenceId'] = params['conference_id']
    ...
    def patch_conversation_summary_feedback(self, conversation_id: str, summary_id: str, **kwargs) -> None:
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.patch_conversation_summary_feedback(conversation_id, summary_id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str conversation_id: Conversation ID (required)
        :param str summary_id: Summary ID (required)
        :param FeedbackUpdateRequest body: 
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method patch_conversation_summary_feedback" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'conversation_id' is set
        if ('conversation_id' not in params) or (params['conversation_id'] is None):
            raise ValueError("Missing the required parameter `conversation_id` when calling `patch_conversation_summary_feedback`")
        # verify the required parameter 'summary_id' is set
        if ('summary_id' not in params) or (params['summary_id'] is None):
            raise ValueError("Missing the required parameter `summary_id` when calling `patch_conversation_summary_feedback`")


        resource_path = '/api/v2/conversations/{conversationId}/summaries/{summaryId}/feedback'.replace('{format}', 'json')
        path_params = {}
        if 'conversation_id' in params:
            path_params['conversationId'] = params['conversation_id']
        if 'summary_id' in params:
    ...
    def patch_conversations_messaging_integrations_twitter_integration_id(self, integration_id: str, body: 'TwitterIntegrationUpdateRequest', **kwargs) -> 'TwitterIntegration':
        """
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str integration_id: Integration ID (required)
        :param TwitterIntegrationUpdateRequest body: TwitterIntegrationUpdateRequest (required)
        :return: TwitterIntegration
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def patch_conversations_messaging_setting(self, message_setting_id: str, body: 'MessagingSettingPatchRequest', **kwargs) -> 'MessagingSetting':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.patch_conversations_messaging_setting(message_setting_id, body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str message_setting_id: Message Setting ID (required)
        :param MessagingSettingPatchRequest body: MessagingSetting (required)
        :return: MessagingSetting
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method patch_conversations_messaging_setting" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'message_setting_id' is set
        if ('message_setting_id' not in params) or (params['message_setting_id'] is None):
            raise ValueError("Missing the required parameter `message_setting_id` when calling `patch_conversations_messaging_setting`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `patch_conversations_messaging_setting`")
    ...
    def post_conversation_barge(self, conversation_id: str, **kwargs) -> None:
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_conversation_barge(conversation_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_conversation_barge" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'conversation_id' is set
        if ('conversation_id' not in params) or (params['conversation_id'] is None):
            raise ValueError("Missing the required parameter `conversation_id` when calling `post_conversation_barge`")


        resource_path = '/api/v2/conversations/{conversationId}/barge'.replace('{format}', 'json')
        path_params = {}
        if 'conversation_id' in params:
            path_params['conversationId'] = params['conversation_id']
    ...
    def post_conversation_suggestion_engagement(self, conversation_id: str, suggestion_id: str, body: 'SuggestionEngagement', **kwargs) -> 'SuggestionEngagement':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_conversation_suggestion_engagement(conversation_id, suggestion_id, body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str conversation_id: Conversation ID (required)
        :param str suggestion_id: Suggestion ID (required)
        :param SuggestionEngagement body:  (required)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_conversation_suggestion_engagement" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'conversation_id' is set
        if ('conversation_id' not in params) or (params['conversation_id'] is None):
            raise ValueError("Missing the required parameter `conversation_id` when calling `post_conversation_suggestion_engagement`")
        # verify the required parameter 'suggestion_id' is set
        if ('suggestion_id' not in params) or (params['suggestion_id'] is None):
            raise ValueError("Missing the required parameter `suggestion_id` when calling `post_conversation_suggestion_engagement`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_conversation_suggestion_engagement`")


        resource_path = '/api/v2/conversations/{conversationId}/suggestions/{suggestionId}/engagement'.replace('{format}', 'json')
        path_params = {}
        if 'conversation_id' in params:
            path_params['conversationId'] = params['conversation_id']
        if 'suggestion_id' in params:
        ...
        response = self.api_client.call_api(resource_path, 'POST',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='SuggestionEngagement',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
    ...
    def post_conversation_suggestions_feedback(self, conversation_id: str, body: 'Feedback', **kwargs) -> None:
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_conversation_suggestions_feedback(conversation_id, body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str conversation_id: Conversation ID (required)
        :param Feedback body: SuggestionFeedback (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_conversation_suggestions_feedback" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'conversation_id' is set
        if ('conversation_id' not in params) or (params['conversation_id'] is None):
            raise ValueError("Missing the required parameter `conversation_id` when calling `post_conversation_suggestions_feedback`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_conversation_suggestions_feedback`")


        resource_path = '/api/v2/conversations/{conversationId}/suggestions/feedback'.replace('{format}', 'json')
        path_params = {}
        if 'conversation_id' in params:
            path_params['conversationId'] = params['conversation_id']
    ...
    def post_conversation_summary_feedback(self, conversation_id: str, summary_id: str, **kwargs) -> None:
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_conversation_summary_feedback(conversation_id, summary_id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str conversation_id: Conversation ID (required)
        :param str summary_id: Summary ID (required)
        :param FeedbackAddRequest body: 
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_conversation_summary_feedback" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'conversation_id' is set
        if ('conversation_id' not in params) or (params['conversation_id'] is None):
            raise ValueError("Missing the required parameter `conversation_id` when calling `post_conversation_summary_feedback`")
        # verify the required parameter 'summary_id' is set
        if ('summary_id' not in params) or (params['summary_id'] is None):
            raise ValueError("Missing the required parameter `summary_id` when calling `post_conversation_summary_feedback`")
    ...
    def post_conversations_call_participant_barge(self, conversation_id: str, participant_id: str, **kwargs) -> None:
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_conversations_call_participant_barge(conversation_id, participant_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_conversations_call_participant_barge" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'conversation_id' is set
        if ('conversation_id' not in params) or (params['conversation_id'] is None):
            raise ValueError("Missing the required parameter `conversation_id` when calling `post_conversations_call_participant_barge`")
        # verify the required parameter 'participant_id' is set
        if ('participant_id' not in params) or (params['participant_id'] is None):
            raise ValueError("Missing the required parameter `participant_id` when calling `post_conversations_call_participant_barge`")


        resource_path = '/api/v2/conversations/calls/{conversationId}/participants/{participantId}/barge'.replace('{format}', 'json')
        path_params = {}
        if 'conversation_id' in params:
            path_params['conversationId'] = params['conversation_id']
        if 'participant_id' in params:
    ...
    @deprecated("post_conversations_message_communication_messages_media is deprecated")
    ...
    def post_conversations_message_communication_messages_media_uploads(self, conversation_id: str, communication_id: str, body: 'UploadMediaRequest', **kwargs) -> 'MessageMediaUploadData':
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_conversations_message_communication_messages_media_uploads(conversation_id, communication_id, body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str conversation_id: conversationId (required)
        :param str communication_id: communicationId (required)
        :param UploadMediaRequest body: request (required)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_conversations_message_communication_messages_media_uploads" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'conversation_id' is set
        if ('conversation_id' not in params) or (params['conversation_id'] is None):
            raise ValueError("Missing the required parameter `conversation_id` when calling `post_conversations_message_communication_messages_media_uploads`")
        # verify the required parameter 'communication_id' is set
        if ('communication_id' not in params) or (params['communication_id'] is None):
            raise ValueError("Missing the required parameter `communication_id` when calling `post_conversations_message_communication_messages_media_uploads`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_conversations_message_communication_messages_media_uploads`")


        resource_path = '/api/v2/conversations/messages/{conversationId}/communications/{communicationId}/messages/media/uploads'.replace('{format}', 'json')
        path_params = {}
        if 'conversation_id' in params:
            path_params['conversationId'] = params['conversation_id']
        if 'communication_id' in params:
        ...
        response = self.api_client.call_api(resource_path, 'POST',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='MessageMediaUploadData',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def post_conversations_message_communication_socialmedia_messages(self, conversation_id: str, communication_id: str, body: 'AdditionalSocialMediaMessage', **kwargs) -> 'SocialMediaMessageData':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_conversations_message_communication_socialmedia_messages(conversation_id, communication_id, body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str conversation_id: conversationId (required)
        :param str communication_id: communicationId (required)
        :param AdditionalSocialMediaMessage body: Message (required)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_conversations_message_communication_socialmedia_messages" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'conversation_id' is set
        if ('conversation_id' not in params) or (params['conversation_id'] is None):
            raise ValueError("Missing the required parameter `conversation_id` when calling `post_conversations_message_communication_socialmedia_messages`")
        # verify the required parameter 'communication_id' is set
        if ('communication_id' not in params) or (params['communication_id'] is None):
            raise ValueError("Missing the required parameter `communication_id` when calling `post_conversations_message_communication_socialmedia_messages`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_conversations_message_communication_socialmedia_messages`")


        resource_path = '/api/v2/conversations/messages/{conversationId}/communications/{communicationId}/socialmedia/messages'.replace('{format}', 'json')
        path_params = {}
        if 'conversation_id' in params:
            path_params['conversationId'] = params['conversation_id']
        if 'communication_id' in params:
        ...
        response = self.api_client.call_api(resource_path, 'POST',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='SocialMediaMessageData',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
    ...
    def post_conversations_message_participant_monitor(self, conversation_id: str, participant_id: str, **kwargs) -> None:
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_conversations_message_participant_monitor(conversation_id, participant_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_conversations_message_participant_monitor" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'conversation_id' is set
        if ('conversation_id' not in params) or (params['conversation_id'] is None):
            raise ValueError("Missing the required parameter `conversation_id` when calling `post_conversations_message_participant_monitor`")
        # verify the required parameter 'participant_id' is set
        if ('participant_id' not in params) or (params['participant_id'] is None):
            raise ValueError("Missing the required parameter `participant_id` when calling `post_conversations_message_participant_monitor`")


        resource_path = '/api/v2/conversations/messages/{conversationId}/participants/{participantId}/monitor'.replace('{format}', 'json')
        path_params = {}
        if 'conversation_id' in params:
            path_params['conversationId'] = params['conversation_id']
        if 'participant_id' in params:
    ...
    def post_conversations_messaging_settings(self, body: 'MessagingSettingRequest', **kwargs) -> 'MessagingSetting':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_conversations_messaging_settings(body, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_conversations_messaging_settings" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_conversations_messaging_settings`")
    ...
    def post_conversations_video_agentconference_communication(self, conversation_id: str, communication_id: str, **kwargs) -> 'VideoConferenceDetails':
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_conversations_video_agentconference_communication(conversation_id, communication_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_conversations_video_agentconference_communication" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'conversation_id' is set
        if ('conversation_id' not in params) or (params['conversation_id'] is None):
            raise ValueError("Missing the required parameter `conversation_id` when calling `post_conversations_video_agentconference_communication`")
        # verify the required parameter 'communication_id' is set
        if ('communication_id' not in params) or (params['communication_id'] is None):
            raise ValueError("Missing the required parameter `communication_id` when calling `post_conversations_video_agentconference_communication`")


        resource_path = '/api/v2/conversations/videos/{conversationId}/agentconference/communications/{communicationId}'.replace('{format}', 'json')
        path_params = {}
        if 'conversation_id' in params:
            path_params['conversationId'] = params['conversation_id']
        if 'communication_id' in params:
    ...
    @deprecated("put_conversations_cobrowsesession_recordingstate is deprecated")
    ...
    def put_conversations_messaging_identityresolution_integrations_facebook_integration_id(self, integration_id: str, body: 'IdentityResolutionConfig', **kwargs) -> 'IdentityResolutionConfig':
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_conversations_messaging_identityresolution_integrations_facebook_integration_id(integration_id, body, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method put_conversations_messaging_identityresolution_integrations_facebook_integration_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'integration_id' is set
        if ('integration_id' not in params) or (params['integration_id'] is None):
            raise ValueError("Missing the required parameter `integration_id` when calling `put_conversations_messaging_identityresolution_integrations_facebook_integration_id`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_conversations_messaging_identityresolution_integrations_facebook_integration_id`")
    ...
    def put_conversations_messaging_identityresolution_integrations_open_integration_id(self, integration_id: str, body: 'OpenMessagingIdentityResolutionConfig', **kwargs) -> 'OpenMessagingIdentityResolutionConfig':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_conversations_messaging_identityresolution_integrations_open_integration_id(integration_id, body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str integration_id: Integration ID (required)
        :param OpenMessagingIdentityResolutionConfig body:  (required)
        :return: OpenMessagingIdentityResolutionConfig
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method put_conversations_messaging_identityresolution_integrations_open_integration_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'integration_id' is set
        if ('integration_id' not in params) or (params['integration_id'] is None):
            raise ValueError("Missing the required parameter `integration_id` when calling `put_conversations_messaging_identityresolution_integrations_open_integration_id`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_conversations_messaging_identityresolution_integrations_open_integration_id`")
    ...
    def put_conversations_messaging_identityresolution_integrations_whatsapp_integration_id(self, integration_id: str, body: 'IdentityResolutionConfig', **kwargs) -> 'IdentityResolutionConfig':
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_conversations_messaging_identityresolution_integrations_whatsapp_integration_id(integration_id, body, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method put_conversations_messaging_identityresolution_integrations_whatsapp_integration_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'integration_id' is set
        if ('integration_id' not in params) or (params['integration_id'] is None):
            raise ValueError("Missing the required parameter `integration_id` when calling `put_conversations_messaging_identityresolution_integrations_whatsapp_integration_id`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_conversations_messaging_identityresolution_integrations_whatsapp_integration_id`")
    ...
    def put_conversations_messaging_settings_default(self, body: 'MessagingSettingDefaultRequest', **kwargs) -> 'MessagingSetting':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_conversations_messaging_settings_default(body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param MessagingSettingDefaultRequest body: MessagingSetting (required)
        :return: MessagingSetting
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method put_conversations_messaging_settings_default" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_conversations_messaging_settings_default`")
