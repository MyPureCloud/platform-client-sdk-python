...
from ..models import AgentUtilizationAggregateQueryResponse
from ..models import AgentUtilizationAggregationQuery
from ..models import AgentUtilizationAsyncAggregateQueryResponse
from ..models import AgentUtilizationAsyncAggregationQuery
...
from ..models import CaseManagementAggregateQueryResponse
from ..models import CaseManagementAggregationQuery
from ..models import CaseManagementAsyncAggregateQueryResponse
from ..models import CaseManagementAsyncAggregationQuery
...
from ..models import CopilotAggregateQueryResponse
from ..models import CopilotAggregationQuery
from ..models import CopilotAsyncAggregateQueryResponse
from ..models import CopilotAsyncAggregationQuery
...
class AnalyticsApi(object):
    ...
    def delete_analytics_actions_aggregates_job(self, job_id: str, **kwargs) -> None:
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_analytics_actions_aggregates_job(job_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method delete_analytics_actions_aggregates_job" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('job_id' not in params) or (params['job_id'] is None):
            raise ValueError("Missing the required parameter `job_id` when calling `delete_analytics_actions_aggregates_job`")
    ...
    def delete_analytics_agentcopilots_aggregates_job(self, job_id: str, **kwargs) -> None:
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_analytics_agentcopilots_aggregates_job(job_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_analytics_agentcopilots_aggregates_job" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'job_id' is set
        if ('job_id' not in params) or (params['job_id'] is None):
            raise ValueError("Missing the required parameter `job_id` when calling `delete_analytics_agentcopilots_aggregates_job`")
    ...
    def delete_analytics_agentutilizations_aggregates_job(self, job_id: str, **kwargs) -> None:
        """
        Delete/cancel an async request for agent utilization aggregates
        
	    delete_analytics_agentutilizations_aggregates_job is a preview method and is subject to both breaking and non-breaking changes at any time without notice
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_analytics_agentutilizations_aggregates_job(job_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_analytics_agentutilizations_aggregates_job" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'job_id' is set
        if ('job_id' not in params) or (params['job_id'] is None):
            raise ValueError("Missing the required parameter `job_id` when calling `delete_analytics_agentutilizations_aggregates_job`")


        resource_path = '/api/v2/analytics/agentutilizations/aggregates/jobs/{jobId}'.replace('{format}', 'json')
        path_params = {}
        if 'job_id' in params:
            path_params['jobId'] = params['job_id']
    ...
    def delete_analytics_bots_aggregates_job(self, job_id: str, **kwargs) -> None:
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_analytics_bots_aggregates_job(job_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_analytics_bots_aggregates_job" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'job_id' is set
        if ('job_id' not in params) or (params['job_id'] is None):
            raise ValueError("Missing the required parameter `job_id` when calling `delete_analytics_bots_aggregates_job`")
    ...
    def delete_analytics_casemanagement_aggregates_job(self, job_id: str, **kwargs) -> None:
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_analytics_casemanagement_aggregates_job(job_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_analytics_casemanagement_aggregates_job" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'job_id' is set
        if ('job_id' not in params) or (params['job_id'] is None):
            raise ValueError("Missing the required parameter `job_id` when calling `delete_analytics_casemanagement_aggregates_job`")


        resource_path = '/api/v2/analytics/casemanagement/aggregates/jobs/{jobId}'.replace('{format}', 'json')
        path_params = {}
        if 'job_id' in params:
            path_params['jobId'] = params['job_id']
    ...
    def delete_analytics_copilots_aggregates_job(self, job_id: str, **kwargs) -> None:
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_analytics_copilots_aggregates_job(job_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_analytics_copilots_aggregates_job" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'job_id' is set
        if ('job_id' not in params) or (params['job_id'] is None):
            raise ValueError("Missing the required parameter `job_id` when calling `delete_analytics_copilots_aggregates_job`")


        resource_path = '/api/v2/analytics/copilots/aggregates/jobs/{jobId}'.replace('{format}', 'json')
        path_params = {}
        if 'job_id' in params:
            path_params['jobId'] = params['job_id']
    ...
    def delete_analytics_evaluations_aggregates_job(self, job_id: str, **kwargs) -> None:
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_analytics_evaluations_aggregates_job(job_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_analytics_evaluations_aggregates_job" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'job_id' is set
        if ('job_id' not in params) or (params['job_id'] is None):
            raise ValueError("Missing the required parameter `job_id` when calling `delete_analytics_evaluations_aggregates_job`")
    ...
    def delete_analytics_flowexecutions_aggregates_job(self, job_id: str, **kwargs) -> None:
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_analytics_flowexecutions_aggregates_job(job_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_analytics_flowexecutions_aggregates_job" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'job_id' is set
        if ('job_id' not in params) or (params['job_id'] is None):
            raise ValueError("Missing the required parameter `job_id` when calling `delete_analytics_flowexecutions_aggregates_job`")
    ...
    def delete_analytics_flows_aggregates_job(self, job_id: str, **kwargs) -> None:
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_analytics_flows_aggregates_job(job_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_analytics_flows_aggregates_job" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'job_id' is set
        if ('job_id' not in params) or (params['job_id'] is None):
            raise ValueError("Missing the required parameter `job_id` when calling `delete_analytics_flows_aggregates_job`")
    ...
    def delete_analytics_knowledge_aggregates_job(self, job_id: str, **kwargs) -> None:
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_analytics_knowledge_aggregates_job(job_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_analytics_knowledge_aggregates_job" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'job_id' is set
        if ('job_id' not in params) or (params['job_id'] is None):
            raise ValueError("Missing the required parameter `job_id` when calling `delete_analytics_knowledge_aggregates_job`")
    ...
    def delete_analytics_resolutions_aggregates_job(self, job_id: str, **kwargs) -> None:
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_analytics_resolutions_aggregates_job(job_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_analytics_resolutions_aggregates_job" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'job_id' is set
        if ('job_id' not in params) or (params['job_id'] is None):
            raise ValueError("Missing the required parameter `job_id` when calling `delete_analytics_resolutions_aggregates_job`")
    ...
    def delete_analytics_summaries_aggregates_job(self, job_id: str, **kwargs) -> None:
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_analytics_summaries_aggregates_job(job_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_analytics_summaries_aggregates_job" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'job_id' is set
        if ('job_id' not in params) or (params['job_id'] is None):
            raise ValueError("Missing the required parameter `job_id` when calling `delete_analytics_summaries_aggregates_job`")
    ...
    def delete_analytics_surveys_aggregates_job(self, job_id: str, **kwargs) -> None:
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_analytics_surveys_aggregates_job(job_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_analytics_surveys_aggregates_job" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'job_id' is set
        if ('job_id' not in params) or (params['job_id'] is None):
            raise ValueError("Missing the required parameter `job_id` when calling `delete_analytics_surveys_aggregates_job`")
    ...
    def delete_analytics_taskmanagement_aggregates_job(self, job_id: str, **kwargs) -> None:
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_analytics_taskmanagement_aggregates_job(job_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_analytics_taskmanagement_aggregates_job" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'job_id' is set
        if ('job_id' not in params) or (params['job_id'] is None):
            raise ValueError("Missing the required parameter `job_id` when calling `delete_analytics_taskmanagement_aggregates_job`")
    ...
    def delete_analytics_transcripts_aggregates_job(self, job_id: str, **kwargs) -> None:
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_analytics_transcripts_aggregates_job(job_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_analytics_transcripts_aggregates_job" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'job_id' is set
        if ('job_id' not in params) or (params['job_id'] is None):
            raise ValueError("Missing the required parameter `job_id` when calling `delete_analytics_transcripts_aggregates_job`")
    ...
    def delete_analytics_users_aggregates_job(self, job_id: str, **kwargs) -> None:
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_analytics_users_aggregates_job(job_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_analytics_users_aggregates_job" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'job_id' is set
        if ('job_id' not in params) or (params['job_id'] is None):
            raise ValueError("Missing the required parameter `job_id` when calling `delete_analytics_users_aggregates_job`")
    ...
    def get_analytics_agentutilizations_aggregates_job(self, job_id: str, **kwargs) -> 'AsyncQueryStatus':
        """
        Get status for async query for agent utilization aggregates
        
	    get_analytics_agentutilizations_aggregates_job is a preview method and is subject to both breaking and non-breaking changes at any time without notice
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_analytics_agentutilizations_aggregates_job(job_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_analytics_agentutilizations_aggregates_job" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'job_id' is set
        if ('job_id' not in params) or (params['job_id'] is None):
            raise ValueError("Missing the required parameter `job_id` when calling `get_analytics_agentutilizations_aggregates_job`")
    ...
    def get_analytics_agentutilizations_aggregates_job_results(self, job_id: str, **kwargs) -> 'AgentUtilizationAsyncAggregateQueryResponse':
        """
        Fetch a page of results for an async aggregates query
        
	    get_analytics_agentutilizations_aggregates_job_results is a preview method and is subject to both breaking and non-breaking changes at any time without notice
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_analytics_agentutilizations_aggregates_job_results(job_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_analytics_agentutilizations_aggregates_job_results" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'job_id' is set
        if ('job_id' not in params) or (params['job_id'] is None):
            raise ValueError("Missing the required parameter `job_id` when calling `get_analytics_agentutilizations_aggregates_job_results`")


        resource_path = '/api/v2/analytics/agentutilizations/aggregates/jobs/{jobId}/results'.replace('{format}', 'json')
        path_params = {}
        if 'job_id' in params:
            path_params['jobId'] = params['job_id']
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='AgentUtilizationAsyncAggregateQueryResponse',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
    ...
    def get_analytics_casemanagement_aggregates_job(self, job_id: str, **kwargs) -> 'AsyncQueryStatus':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_analytics_casemanagement_aggregates_job(job_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_analytics_casemanagement_aggregates_job" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'job_id' is set
        if ('job_id' not in params) or (params['job_id'] is None):
            raise ValueError("Missing the required parameter `job_id` when calling `get_analytics_casemanagement_aggregates_job`")
    ...
    def get_analytics_casemanagement_aggregates_job_results(self, job_id: str, **kwargs) -> 'CaseManagementAsyncAggregateQueryResponse':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_analytics_casemanagement_aggregates_job_results(job_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_analytics_casemanagement_aggregates_job_results" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'job_id' is set
        if ('job_id' not in params) or (params['job_id'] is None):
            raise ValueError("Missing the required parameter `job_id` when calling `get_analytics_casemanagement_aggregates_job_results`")


        resource_path = '/api/v2/analytics/casemanagement/aggregates/jobs/{jobId}/results'.replace('{format}', 'json')
        path_params = {}
        if 'job_id' in params:
            path_params['jobId'] = params['job_id']
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='CaseManagementAsyncAggregateQueryResponse',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
    ...
    def get_analytics_copilots_aggregates_job(self, job_id: str, **kwargs) -> 'AsyncQueryStatus':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_analytics_copilots_aggregates_job(job_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_analytics_copilots_aggregates_job" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'job_id' is set
        if ('job_id' not in params) or (params['job_id'] is None):
            raise ValueError("Missing the required parameter `job_id` when calling `get_analytics_copilots_aggregates_job`")
    ...
    def get_analytics_copilots_aggregates_job_results(self, job_id: str, **kwargs) -> 'CopilotAsyncAggregateQueryResponse':
        """
        Fetch a page of results for an async aggregates query
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_analytics_copilots_aggregates_job_results(job_id, callback=callback_function)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_analytics_copilots_aggregates_job_results" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'job_id' is set
        if ('job_id' not in params) or (params['job_id'] is None):
            raise ValueError("Missing the required parameter `job_id` when calling `get_analytics_copilots_aggregates_job_results`")


        resource_path = '/api/v2/analytics/copilots/aggregates/jobs/{jobId}/results'.replace('{format}', 'json')
        path_params = {}
        if 'job_id' in params:
            path_params['jobId'] = params['job_id']
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='CopilotAsyncAggregateQueryResponse',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
    ...
    def post_analytics_agentutilizations_aggregates_jobs(self, body: 'AgentUtilizationAsyncAggregationQuery', **kwargs) -> 'AsyncQueryResponse':
        """
        Query for agent utilization aggregates asynchronously
        
	    post_analytics_agentutilizations_aggregates_jobs is a preview method and is subject to both breaking and non-breaking changes at any time without notice
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_analytics_agentutilizations_aggregates_jobs(body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param AgentUtilizationAsyncAggregationQuery body: query (required)
        :return: AsyncQueryResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_analytics_agentutilizations_aggregates_jobs" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_analytics_agentutilizations_aggregates_jobs`")


        resource_path = '/api/v2/analytics/agentutilizations/aggregates/jobs'.replace('{format}', 'json')
        path_params = {}
    ...
    def post_analytics_agentutilizations_aggregates_query(self, body: 'AgentUtilizationAggregationQuery', **kwargs) -> 'AgentUtilizationAggregateQueryResponse':
        """
        Query for agent utilization aggregates
        
	    post_analytics_agentutilizations_aggregates_query is a preview method and is subject to both breaking and non-breaking changes at any time without notice
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_analytics_agentutilizations_aggregates_query(body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param AgentUtilizationAggregationQuery body: query (required)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_analytics_agentutilizations_aggregates_query" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_analytics_agentutilizations_aggregates_query`")


        resource_path = '/api/v2/analytics/agentutilizations/aggregates/query'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'POST',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='AgentUtilizationAggregateQueryResponse',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
    ...
    def post_analytics_casemanagement_aggregates_jobs(self, body: 'CaseManagementAsyncAggregationQuery', **kwargs) -> 'AsyncQueryResponse':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_analytics_casemanagement_aggregates_jobs(body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param CaseManagementAsyncAggregationQuery body: query (required)
        :return: AsyncQueryResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_analytics_casemanagement_aggregates_jobs" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_analytics_casemanagement_aggregates_jobs`")


        resource_path = '/api/v2/analytics/casemanagement/aggregates/jobs'.replace('{format}', 'json')
        path_params = {}
    ...
    def post_analytics_casemanagement_aggregates_query(self, body: 'CaseManagementAggregationQuery', **kwargs) -> 'CaseManagementAggregateQueryResponse':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_analytics_casemanagement_aggregates_query(body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param CaseManagementAggregationQuery body: query (required)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_analytics_casemanagement_aggregates_query" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_analytics_casemanagement_aggregates_query`")


        resource_path = '/api/v2/analytics/casemanagement/aggregates/query'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'POST',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='CaseManagementAggregateQueryResponse',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
    ...
    def post_analytics_copilots_aggregates_jobs(self, body: 'CopilotAsyncAggregationQuery', **kwargs) -> 'AsyncQueryResponse':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_analytics_copilots_aggregates_jobs(body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param CopilotAsyncAggregationQuery body: query (required)
        :return: AsyncQueryResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_analytics_copilots_aggregates_jobs" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_analytics_copilots_aggregates_jobs`")


        resource_path = '/api/v2/analytics/copilots/aggregates/jobs'.replace('{format}', 'json')
        path_params = {}
    ...
    def post_analytics_copilots_aggregates_query(self, body: 'CopilotAggregationQuery', **kwargs) -> 'CopilotAggregateQueryResponse':
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_analytics_copilots_aggregates_query(body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param CopilotAggregationQuery body: query (required)
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_analytics_copilots_aggregates_query" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_analytics_copilots_aggregates_query`")


        resource_path = '/api/v2/analytics/copilots/aggregates/query'.replace('{format}', 'json')
        path_params = {}
        ...
        response = self.api_client.call_api(resource_path, 'POST',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='CopilotAggregateQueryResponse',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
