...
| **kpi_assessments** | [**list[KeyPerformanceIndicatorAssessment]**](KeyPerformanceIndicatorAssessment.html) | A set of key performance indicators applied on the queue to determine suitability of Predictive Routing. | [optional] |
