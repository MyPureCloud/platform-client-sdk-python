...
|------------ | ------------- | ------------- | -------------|
| **date_start** | datetime | The start date/time of this activity. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z | [optional] |
