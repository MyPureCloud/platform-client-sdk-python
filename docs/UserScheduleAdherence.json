...
| **business_unit** | [**BusinessUnitReference**](BusinessUnitReference.html) | The business unit to which this user belongs | [optional] |
...
| **scheduled_activity_code** | [**ActivityCodeSummary**](ActivityCodeSummary.html) | Activity code for which the user is currently scheduled | [optional] |
...
| **adherence_explanation** | [**RealTimeAdherenceExplanation**](RealTimeAdherenceExplanation.html) | Currently applicable explanation for the adherence state | [optional] |
