...
| **dnc_lists** | [**list[DomainEntityRef]**](DomainEntityRef.html) | DncLists for this Campaign to check before placing a call. | [optional] |
...
| **rule_sets** | [**list[DomainEntityRef]**](DomainEntityRef.html) | Rule sets to be applied while this campaign is dialing. | [optional] |
...
| **dynamic_line_balancing_settings** | [**DynamicLineBalancingSettings**](DynamicLineBalancingSettings.html) | Dynamic line balancing settings | [optional] |
