...
| **offered_per_day** | list[float] | Forecast offered counts per day for this planning group | |
| **average_handle_time_seconds_per_day** | list[float] | Forecast average handle time per day in seconds | |
