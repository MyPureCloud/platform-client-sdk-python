...
| **reviewed_by** | [UserReference](UserReference) | The user who reviewed the enrollment | [optional] |
| **date_reviewed** | datetime | The date the enrollment was reviewed. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z | [optional] |
