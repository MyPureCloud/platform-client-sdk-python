...
| **submitted_by** | [**UserReference**](UserReference.html) | User who submitted the job | [optional] |
| **status** | **str** | Job status | [optional] |
| **error_info** | [**ErrorInfo**](ErrorInfo.html) | Information about errors, if any | [optional] |
