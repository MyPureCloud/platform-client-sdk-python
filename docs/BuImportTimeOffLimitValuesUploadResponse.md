...
| **upload_body_schema** | [BuImportTimeOffLimitValuesSchema](BuImportTimeOffLimitValuesSchema) | Always null. Defines the schema of the json body to be PUT to the url. The json body should be gzip encoded before uploading | [optional] |
