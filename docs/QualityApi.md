...
> [**EvaluationFormDivisionViewListing**](EvaluationFormDivisionViewListing) get_quality_publishedforms_evaluations_divisionviews(id, page_size=page_size, page_number=page_number, name=name, division_id=division_id)
...
# create an instance of the API class
api_instance = PureCloudPlatformClientV2.QualityApi()
id = ['id_example'] # list[str] | A comma-delimited list of valid, published evaluation form ids
page_size = 25 # int | Page size (optional) (default to 25)
page_number = 1 # int | Page number (optional) (default to 1)
name = 'name_example' # str | Name (optional)
division_id = 'division_id_example' # str | divisionId (optional)

try:
    # Get the published evaluation forms across any division.
    api_response = api_instance.get_quality_publishedforms_evaluations_divisionviews(id, page_size=page_size, page_number=page_number, name=name, division_id=division_id)
    pprint(api_response)
except ApiException as e:
...
|Name | Type | Description  | Notes|
|------------- | ------------- | ------------- | -------------|
| **id** | [**list[str]**](str)| A comma-delimited list of valid, published evaluation form ids |  |
| **page_size** | **int**| Page size | [optional] [default to 25] |
| **page_number** | **int**| Page number | [optional] [default to 1] |
| **name** | **str**| Name | [optional]  |
| **division_id** | **str**| divisionId | [optional]  |
...
> [**SurveyFormDivisionViewListing**](SurveyFormDivisionViewListing) get_quality_publishedforms_surveys_divisionviews(id, page_size=page_size, page_number=page_number, name=name, division_id=division_id)
...
try:
    # Get the published and enabled survey forms across any division.
    api_response = api_instance.get_quality_publishedforms_surveys_divisionviews(id, page_size=page_size, page_number=page_number, name=name, division_id=division_id)
    pprint(api_response)
except ApiException as e:
