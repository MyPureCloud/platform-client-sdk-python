...
| **contact_list** | [**DomainEntityRef**](DomainEntityRef.html) | The contact list the filter is based on. Required if sourceType is ContactList | [optional] |
| **contact_list_template** | [**DomainEntityRef**](DomainEntityRef.html) | The contact list template the filter is based on. Required if sourceType is ContactListTemplate | [optional] |
