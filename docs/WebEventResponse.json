...
| **mkt_campaign** | [**JourneyCampaign**](JourneyCampaign.html) | Urchin Tracking Module (UTM) parameters used to track the effectiveness of online marketing campaigns. | [optional] |
...
| **attributes** | [**dict(str, CustomEventAttribute)**](CustomEventAttribute.html) | User-defined attributes associated with a particular event. These attributes provide additional context about the event. For example, items_in_cart or subscription_level. | |
