...
|------------ | ------------- | ------------- | -------------|
| **time_off_request** | [**TimeOffRequestReference**](TimeOffRequestReference.html) | The time off request for this wait list position | [optional] |
| **time_off_limit** | [**TimeOffLimitReference**](TimeOffLimitReference.html) | The time off limit for which time off request is waitlisted | [optional] |
