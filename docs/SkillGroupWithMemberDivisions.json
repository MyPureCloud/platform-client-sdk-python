...
| **skill_conditions** | [**list[SkillGroupCondition]**](SkillGroupCondition.html) | Conditions for this group | |
| **member_divisions** | **list[str]** | Member divisions for this skill group | [optional] |
