...
| **scope** | **str** | The target entity that a segment applies to. | [optional] |
...
| **external_segment** | [**RequestExternalSegment**](RequestExternalSegment.html) | Details of an entity corresponding to this segment in an external system. | [optional] |
