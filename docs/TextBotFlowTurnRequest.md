...
| **input_event_rich_media** | [TextBotsRichMediaInputEvent](TextBotsRichMediaInputEvent) | The data for the Rich Media input event of this turn if it is a Rich Media input event. Only one inputEvent may be set. Only ButtonResponse, PaymentResponse, Form, Presence are supported. | [optional] |
