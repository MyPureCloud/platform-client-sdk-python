...
| **created_by** | [**JourneyViewUser**](JourneyViewUser.html) | User that has created the view. | [optional] |
| **modified_by** | [**JourneyViewUser**](JourneyViewUser.html) | User that has modified the view. | [optional] |
