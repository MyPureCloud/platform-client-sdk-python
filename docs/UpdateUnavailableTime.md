...
| **time_span** | [WfmTimeSpan](WfmTimeSpan) | Exact date, time and length of the unavailability time in granularity of minutes. Must be specified when creating a new unavailable time span | [optional] |
